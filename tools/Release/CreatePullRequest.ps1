...
$prUrl = $responseContent.html_url

Write-Host
Write-Host -ForegroundColor Green "A new release branch at $branchName has been created and pushed; a PR for that branch was created at $prUrl"