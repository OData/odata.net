...
namespace Microsoft.OData.Client {
    ...
    internal static class Strings {
        ...
        internal static string Context_ExecuteExpectsGetOrPost {
            get {
                return Microsoft.OData.Client.TextRes.GetString(Microsoft.OData.Client.TextRes.Context_ExecuteExpectsGetOrPost);
            }
        }
        ...
        internal static string DataServiceClientFormat_JsonVerboseUnsupported(object p0) {
            return Microsoft.OData.Client.TextRes.GetString(Microsoft.OData.Client.TextRes.DataServiceClientFormat_JsonVerboseUnsupported,p0);
        }
