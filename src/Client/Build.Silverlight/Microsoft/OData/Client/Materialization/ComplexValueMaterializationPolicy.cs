...
namespace Microsoft.OData.Client.Materialization
{
    ...
    internal class ComplexValueMaterializationPolicy : StructuralValueMaterializationPolicy
    {
        ...
        {
            //// BUGUG #906034 - we decide whether the type is primitive or complex only based on the payload. If there is a mismatch we throw a random exception. 
            ...
            // BUGBUG: #905420 - We should call type resolver for complex types for projections if they are not instantiated by the user directly 
            ...
            // Bug #905420 is about investigating when we actually do call type resolver and fix it so that we call it when needed and don't
