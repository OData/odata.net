...
namespace Microsoft.OData.Service.Http
{
    ...
    /// Provides an HTTP-specific implementation of the WebResponse class.
    /// </summary>
    internal sealed class XHRHttpWebResponse : Microsoft.OData.Service.Http.HttpWebResponse
    {
        #region Fields.
        ...
        private Microsoft.OData.Service.Http.XHRHttpWebRequest request;
        ...
        internal XHRHttpWebResponse(Microsoft.OData.Service.Http.XHRHttpWebRequest request, int statusCode, string responseHeaders)
        {
            Debug.Assert(request != null, "request can't be null.");
            this.request = request;
            NormalizeResponseStatus(ref statusCode);
            this.statusCode = statusCode;
            this.headers = new Microsoft.OData.Service.Http.XHRWebHeaderCollection();
        ...
        internal Microsoft.OData.Service.Http.XHRHttpWebRequest InternalRequest
        {
            set
            {
                this.request = value;
        ...
        private void ParseHeaders(string responseHeaders)
        {
            ...
            catch (Exception e)
            {
                ...
                string message = Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebResponse.ParseHeaders.2");
