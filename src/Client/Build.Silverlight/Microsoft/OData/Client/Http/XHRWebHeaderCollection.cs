...
namespace Microsoft.OData.Service.Http
{
    ...
    internal sealed class XHRWebHeaderCollection : WebHeaderCollection
    {
        ...
        private Microsoft.OData.Service.Http.WebHeaderCollectionType collectionType;

        /// <summary>
        /// Initializes a new instance of the WebHeaderCollection class.
        /// </summary>
        public XHRWebHeaderCollection() : this(Microsoft.OData.Service.Http.WebHeaderCollectionType.Unknown)
        {
        }
        ...
        internal XHRWebHeaderCollection(Microsoft.OData.Service.Http.WebHeaderCollectionType type)
        {
        ...
        private bool AllowHttpRequestHeader
        {
            get
            {
                if (this.collectionType == Microsoft.OData.Service.Http.WebHeaderCollectionType.Unknown)
                {
                    this.collectionType = Microsoft.OData.Service.Http.WebHeaderCollectionType.WebRequest;
                }

                return
                    ((this.collectionType == Microsoft.OData.Service.Http.WebHeaderCollectionType.WebRequest) ||
                     (this.collectionType == Microsoft.OData.Service.Http.WebHeaderCollectionType.HttpWebRequest));
            }
        }
        ...
        private NameValueFromDictionary InnerCollection
        {
            get
            {
                ...
                {
                    this.innerCollection = new NameValueFromDictionary(ApproxHighAvgNumHeaders, Microsoft.OData.Service.Http.CaseInsensitiveAscii.StaticInstance);
                }
        ...
        public override string this[string name]
        {
            ...
            set
            {
                name = Microsoft.OData.Service.Http.ValidationHelper.CheckBadChars(name, false);
                value = Microsoft.OData.Service.Http.ValidationHelper.CheckBadChars(value, true);
        ...
        public override string this[Microsoft.OData.Service.Http.HttpRequestHeader header]
        {
            get
            {
                if (!this.AllowHttpRequestHeader)
                {
                    ...
                    throw new InvalidOperationException(
                        Microsoft.OData.Client.Strings.HttpWeb_Internal("WebHeaderCollection.this[HttpRequestHeader].get"));
                }
            ...
            set
            {
                if (!this.AllowHttpRequestHeader)
                {
                    // throw new InvalidOperationException("SR.GetString(SR.net_headers_req)");
                    throw new InvalidOperationException(
                        Microsoft.OData.Client.Strings.HttpWeb_Internal("WebHeaderCollection.this[HttpRequestHeader].set"));
                }
        ...
        {
            if ((this.collectionType == Microsoft.OData.Service.Http.WebHeaderCollectionType.HttpWebRequest) && HeaderInfoTable.GetHeaderInfo(headerName).IsRequestRestricted)
            {
                ...
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("WebHeaderCollection.ThrowOnRestrictedHeader"));
            }
        }        
    }
}
