            ...
            if (items != null)
            {
                ...
                foreach (object item in items)
                {
                    ...
                    else
                    {
                        ...
                        {
                            // Here, isElementNullable is true
                            object materializedValue =
                                this.primitiveValueMaterializationPolicy.MaterializePrimitiveDataValueCollectionElement(
                                    collectionItemType, wireTypeName, /*item*/ null);
                            addValueToBackingICollectionInstance(collectionInstance, materializedValue);
                        }
                    }
                }
