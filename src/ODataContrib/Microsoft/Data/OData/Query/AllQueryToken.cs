...
namespace Microsoft.Data.OData.Query
{
    ...
    /// </summary>
    public sealed class AllQueryToken : QueryToken
    {
        /// <summary>
        /// The parent token.
        /// </summary>
        ...
        /// <summary>
        /// The expression component of All.
        /// </summary>
        private readonly QueryToken expression;

        /// <summary>
        /// Create a AllQueryToken given the expression, parameter, and parent
        /// </summary>
        ...
        public AllQueryToken(QueryToken expression, string parameter, QueryToken parent)
        {
