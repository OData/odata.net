...
namespace Microsoft.OData.Service.Providers
{
    ...
    internal partial class ObjectContextServiceProvider : BaseServiceProvider, IDataServiceUpdateProvider2, IDataServiceEntityFrameworkProvider
    {
            ...
            ProviderMetadataCacheItem metadataCacheItem)
        {
            ...
            // inherit to 'true'.
            foreach (object namedStream in clrType.GetCustomAttributes(typeof(Microsoft.OData.Client.NamedStreamAttribute), baseResourceType == null))
            {
                resourceType.AddProperty(new ResourceProperty(((Microsoft.OData.Client.NamedStreamAttribute)namedStream).Name, ResourcePropertyKind.Stream, PrimitiveResourceTypeMap.TypeMap.GetPrimitive(typeof(System.IO.Stream))));
            }
