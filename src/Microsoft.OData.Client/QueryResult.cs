    ...
    internal class QueryResult : BaseAsyncResult
    {
        ...
        protected virtual void SetHttpWebResponse(IODataResponseMessage response)
        {
            ...
            else
            {
                ...
                Console.WriteLine($"String content length is {stringContentLength}");
            }
        ...
        private void AsyncEndRead(IAsyncResult asyncResult)
        {
            ...
            try
            {
                ...
                if (count > 0)
                {
                    ...
                    {
                        Console.WriteLine($"Unexpected writer greater than stream capacity, count {count}, cap {(outResponseStream as MemoryStream).Capacity}");
                    }
