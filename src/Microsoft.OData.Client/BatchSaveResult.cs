                            ...
                            if (!insideChangeset)
                            {
                                ...
                                try
                                {
                                    if (exception == null)
                                    {
                                        ...
                                        MaterializeObject materializer = DataServiceRequest.Materialize(
                                            responseInfo,
                                ...
                                if (qresponse == null)
                                {
                                    if (this.Queries != null)
                                    {
                                        ...
                                        {
                                            qresponse = QueryOperationResponse.GetInstance(query.ElementType, this.currentOperationResponse.Headers, query, MaterializeObject.EmptyResults);
                                        }
                                        else
                                        {
                                            qresponse = QueryOperationResponse.GetInstance(query.ElementType, this.currentOperationResponse.Headers, query, MaterializeObject.EmptyResults);
