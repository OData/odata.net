...
namespace Microsoft.OData.Client
{
    ...
    public sealed class QueryOperationResponse<T> : QueryOperationResponse, IEnumerable<T>
    {
        ...
        /// <summary>Gets a <see cref="Microsoft.OData.Client.DataServiceQueryContinuation`1" /> object that contains the URI that is used to retrieve the next results page.</summary>
        ...
        /// <summary>Executes the <see cref="Microsoft.OData.Client.DataServiceQuery`1" /> and gets <see cref="Microsoft.OData.Client.QueryOperationResponse`1" /> items.</summary>
