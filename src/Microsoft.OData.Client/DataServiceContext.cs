...
#pragma warning restore 0169, 0649
        ...
        public Task<QueryOperationResponse> LoadPropertyAsync(object entity, string propertyName, CancellationToken cancellationToken)
        {
        ...
        /// <param name="nextLinkUri">The URI used to load the next results page.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public Task<QueryOperationResponse> LoadPropertyAsync(object entity, string propertyName, Uri nextLinkUri, CancellationToken cancellationToken)
        {
        ...
        /// <param name="continuation">A <see cref="T:Microsoft.OData.Client.DataServiceQueryContinuation`1" /> object that represents the next page of related entity data to return from the data service.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public Task<QueryOperationResponse> LoadPropertyAsync(object entity, string propertyName, DataServiceQueryContinuation continuation, CancellationToken cancellationToken)
        {
        ...
        /// <exception cref="T:System.ArgumentNullException">Any of the parameters supplied to the method is null.</exception>
        /// <exception cref="T:System.ArgumentException">The <paramref name="entity" /> is not tracked by this <see cref="T:Microsoft.OData.Client.DataServiceContext" />.-or-The <paramref name="entity" /> is in the <see cref="F:Microsoft.OData.Client.EntityStates.Added" /> state.-or-The <paramref name="entity" /> is not a Media Link Entry and does not have a related binary data stream.</exception>
        public Task<DataServiceStreamResponse> GetReadStreamAsync(object entity, DataServiceRequestArgs args, CancellationToken cancellationToken)
        {
        ...
        /// <param name="args">Instance of the <see cref="T:Microsoft.OData.Client.DataServiceRequestArgs" /> class that contains settings for the HTTP request message.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public Task<DataServiceStreamResponse> GetReadStreamAsync(object entity, string name, DataServiceRequestArgs args, CancellationToken cancellationToken)
        {
        ...
        {
            return this.ExecuteBatchAsync(CancellationToken.None, queries);
        }
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <param name="queries">The array of query requests to include in the batch request.</param>
        public Task<DataServiceResponse> ExecuteBatchAsync(CancellationToken cancellationToken, params DataServiceRequest[] queries)
        {
            return this.FromAsync((callback, state) => this.BeginExecuteBatch(callback, state, queries), this.EndExecuteBatch, cancellationToken);
        }
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <typeparam name="TElement">The type returned by the query.</typeparam>
        public Task<IEnumerable<TElement>> ExecuteAsync<TElement>(Uri requestUri, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <param name="operationParameters">The operation parameters used.</param>
        public Task<OperationResponse> ExecuteAsync(Uri requestUri, string httpMethod, CancellationToken cancellationToken, params OperationParameter[] operationParameters)
        {
        ...
        /// <param name="operationParameters">The operation parameters used.</param>
        /// <typeparam name="TElement">The type returned by the query.</typeparam>
        public Task<IEnumerable<TElement>> ExecuteAsync<TElement>(Uri requestUri, string httpMethod, bool singleResult, CancellationToken cancellationToken, params OperationParameter[] operationParameters)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <typeparam name="TElement">The type returned by the query.</typeparam>
        public Task<IEnumerable<TElement>> ExecuteAsync<TElement>(Uri requestUri, string httpMethod, CancellationToken cancellationToken, params OperationParameter[] operationParameters)
        {
        ...
        {
            return this.ExecuteAsync(continuation, CancellationToken.None);
        }
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <typeparam name="TElement">The type returned by the query.</typeparam>
        public Task<IEnumerable<TElement>> ExecuteAsync<TElement>(DataServiceQueryContinuation<TElement> continuation, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        /// <returns>A task that represents a <see cref="T:Microsoft.OData.Client.DataServiceResponse" /> object that indicates the result of the batch operation.</returns>
        public Task<DataServiceResponse> SaveChangesAsync(CancellationToken cancellationToken)
        {
        ...
        /// <param name="options">A member of the <see cref="T:Microsoft.OData.Client.SaveChangesOptions" /> enumeration for how the client can save the pending set of changes.</param>
        /// <param name="cancellationToken">The token to monitor for cancellation requests.</param>
        public Task<DataServiceResponse> SaveChangesAsync(SaveChangesOptions options, CancellationToken cancellationToken)
        {
            return this.FromAsync(this.BeginSaveChanges, this.EndSaveChanges, options, cancellationToken);
        }
        ...
        {
            return this.LoadPropertyAllPagesAsync(entity, propertyName, CancellationToken.None);
        }
        ...
        internal Task<QueryOperationResponse> LoadPropertyAllPagesAsync(object entity, string propertyName, CancellationToken cancellationToken)
        {
            ...
            return currentTask.ContinueWith(
                t => this.ContinuePageAsync(t.Result, entity, propertyName, cancellationToken),
        ...
        #region cancellable task helpers
