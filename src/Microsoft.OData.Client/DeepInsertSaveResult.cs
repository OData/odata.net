...
namespace Microsoft.OData.Client
{
    ...
    internal class DeepInsertSaveResult : BaseSaveResult
    {
        ...
        /// <returns>An instance of <see cref="MaterializeObject"/> that can be used to materialize the response.</returns>
        protected override MaterializeObject GetMaterializer(EntityDescriptor entityDescriptor, ResponseInfo responseInfo)
        {
            ...
            {
                return new MaterializeObject(responseInfo, new[] { materializerEntry.Entry }, entityDescriptor.Entity.GetType(), materializerEntry.Format, base.MaterializerCache, false);
            }
