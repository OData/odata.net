...
namespace Microsoft.OData.Client
{
    ...
    internal sealed class TextRes {
        ...
        internal const string Deserialize_MismatchObjectLinkLocalSimple = "Deserialize_MismatchObjectLinkLocalSimple";
        internal const string Deserialize_MismatchObjectLinkFeedPropertyNotCollection = "Deserialize_MismatchObjectLinkFeedPropertyNotCollection";
        internal const string Deserialize_MismatchObjectLinkEntryPropertyIsCollection = "Deserialize_MismatchObjectLinkEntryPropertyIsCollection";
        ...
        internal const string ObjectParser_SingleEntry_NoneFound = "ObjectParser_SingleEntry_NoneFound";
        internal const string ObjectParser_SingleEntry_MultipleFound = "ObjectParser_SingleEntry_MultipleFound";
        internal const string ObjectParser_SingleEntry_ExpectedFeedOrEntry = "ObjectParser_SingleEntry_ExpectedFeedOrEntry";
        internal const string ObjectMaterializer_CannotAssignNull = "ObjectMaterializer_CannotAssignNull";
        internal const string ObjectMaterializer_EntryIntoCollectionMismatch = "ObjectMaterializer_EntryIntoCollectionMismatch";
        internal const string ObjectMaterializer_EntryToAccessIsNull = "ObjectMaterializer_EntryToAccessIsNull";
        internal const string ObjectMaterializer_EntryToInitializeIsNull = "ObjectMaterializer_EntryToInitializeIsNull";
        internal const string ObjectMaterializer_ProjectEntityTypeMismatch = "ObjectMaterializer_ProjectEntityTypeMismatch";
        internal const string ObjectMaterializer_PropertyMissing = "ObjectMaterializer_PropertyMissing";
        internal const string ObjectMaterializer_PropertyNotExpectedEntry = "ObjectMaterializer_PropertyNotExpectedEntry";
        internal const string ObjectMaterializer_DataServiceCollectionNotSupportedForNonEntities = "ObjectMaterializer_DataServiceCollectionNotSupportedForNonEntities";
        internal const string ObjectMaterializer_NoParameterlessCtorForCollectionProperty = "ObjectMaterializer_NoParameterlessCtorForCollectionProperty";
        internal const string ObjectMaterializer_InvalidCollectionItem = "ObjectMaterializer_InvalidCollectionItem";
        internal const string ObjectMaterializer_InvalidEntityType = "ObjectMaterializer_InvalidEntityType";
        internal const string ObjectMaterializer_InvalidNonEntityType = "ObjectMaterializer_InvalidNonEntityType";
        internal const string ObjectMaterializer_CollectionExpectedCollection = "ObjectMaterializer_CollectionExpectedCollection";
        internal const string ObjectMaterializer_InvalidResponsePayload = "ObjectMaterializer_InvalidResponsePayload";
        internal const string ObjectMaterializer_InvalidContentTypeEncountered = "ObjectMaterializer_InvalidContentTypeEncountered";
        internal const string ObjectMaterializer_MaterializationTypeError = "ObjectMaterializer_MaterializationTypeError";
        internal const string ObjectMaterializer_ResetAfterEnumeratorCreationError = "ObjectMaterializer_ResetAfterEnumeratorCreationError";
        internal const string ObjectMaterializer_TypeShouldBeCollectionError = "ObjectMaterializer_TypeShouldBeCollectionError";
