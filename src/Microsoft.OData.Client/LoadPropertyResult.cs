...
namespace Microsoft.OData.Client
{
    ...
    internal class LoadPropertyResult : QueryResult
    {
        ...
        {
            MaterializeObject results = null;
        ...
        /// <summary>
        /// Load property data from the response
        /// </summary>
        /// <param name="property">The property being loaded</param>
        /// <returns>property values as IEnumerable.</returns>
        private MaterializeObject ReadPropertyFromAtom(ClientPropertyAnnotation property)
        {
            DataServiceContext context = (DataServiceContext)this.Source;
            ...
            try
            {
                ...
                using (MaterializeObject materializer = this.GetMaterializer(this.plan))
                {
                ...
                return MaterializeObject.CreateWrapper(context, results, continuation);
            }
            finally
            {
        ...
        /// <param name="property">The property being loaded</param>
        /// <returns>property values as IEnumerable.</returns>
        private MaterializeObject ReadPropertyFromRawData(ClientPropertyAnnotation property)
        {
            DataServiceContext context = (DataServiceContext)this.Source;
            ...
            try
            {
                ...
                return MaterializeObject.CreateWrapper(context, results);
            }
            finally
            {
                context.ApplyingChanges = merging;
