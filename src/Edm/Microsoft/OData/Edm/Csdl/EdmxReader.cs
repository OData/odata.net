...
namespace Microsoft.OData.Edm.Csdl
{
    ...
    public class EdmxReader
    {
        ...
        /// TODO chalenh remove
        /// </summary>
        /// <param name="reader">The param.</param>
        /// <param name="references">The param.</param>
        /// <param name="model">The param.</param>
        /// <param name="errors">The param.</param>
        ...
        /// </summary>
        /// <param name="reader">The param.</param>
        /// <param name="reference">The param.</param>
        /// <param name="model">The param.</param>
        /// <param name="errors">The param.</param>
        /// <returns>The param.</returns>
        ...
        /// <summary>
        /// TODO challenh remove
        /// </summary>
        /// <param name="reader">The param.</param>
        /// <param name="referencedModels">The param.</param>
        /// <returns>The param.</returns>
        public static IEdmModel Parse(XmlReader reader, IEnumerable<IEdmModel> referencedModels)
        {
            return Parse(reader, (Func<Uri, XmlReader>)null);
        }

        /// <summary>
        /// TODO challenh REF remove
        /// </summary>
        /// <param name="reader">The param.</param>
        /// <param name="referencedModel">The param.</param>
        /// <returns>The param.</returns>
        ...
        private List<CsdlModel> LoadAndParseReferencedEdmxFiles(Version mainEdmxVersion)
        {
            ...
            if (this.edmReferences.Count > 0 && this.getReferencedModelReaderFunc == null)
            {
                // TODO challenh REF add exception message
            ...
            foreach (var tmp in this.edmReferences)
            {
                ...
                referencedEdmxReader.ParseEdmxFile(out referencedEdmxVersion);
                ...
                IEnumerable<EdmError> referencedAstModelErrors;
                if (referencedEdmxReader.csdlParser.GetResult(out referencedAstModel, out referencedAstModelErrors))
                {
                    referencedAstModel.AddIncludes(tmp.Includes);
                    referencedAstModel.AddIncludeAnnotations(tmp.IncludeAnnotations);
                    referencedAstModels.Add(referencedAstModel);
                }
                else
                {
                    this.errors.AddRange(referencedAstModelErrors);
                }
            }
