...
#if ODATALIB_ASYNC
        /// <summary>
        /// Asynchronously start writing an inline feed.
        /// </summary>
        /// <param name="inlineFeed">The inline feed to write.</param>
        /// <returns>A task instance that represents the asynchronous write operation.</returns>
        public abstract Task WriteStartAsync(ODataFeed inlineFeed);
#endif
