//---------------------------------------------------------------------
// <copyright file="BasicWriterValidator.cs" company="Microsoft">
...
namespace Microsoft.OData
{
    ...
    internal sealed class BasicWriterValidator : IBasicWriterValidator
    {
        /// <summary>
        ...
        {
            return WriterValidationUtils.ValidateNestedResourceInfo(nestedResourceInfo, declaringStructuredType, expandedPayloadKind, messageWriterSettings);
        }
