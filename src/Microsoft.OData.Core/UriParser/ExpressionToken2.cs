...
namespace Microsoft.OData.UriParser
{
    ...
    internal struct ExpressionToken2
    {
        /// <summary>Token representing gt keyword</summary>
        internal static readonly ExpressionToken2 GreaterThan = new ExpressionToken2 { Text = ExpressionConstants.KeywordGreaterThan, Kind = ExpressionTokenKind.Identifier, Position = 0 };

        /// <summary>Token representing eq keyword</summary>
        internal static readonly ExpressionToken2 EqualsTo = new ExpressionToken2 { Text = ExpressionConstants.KeywordEqual, Kind = ExpressionTokenKind.Identifier, Position = 0 };

        /// <summary>Token representing lt keyword</summary>
        internal static readonly ExpressionToken2 LessThan = new ExpressionToken2 { Text = ExpressionConstants.KeywordLessThan, Kind = ExpressionTokenKind.Identifier, Position = 0 };
