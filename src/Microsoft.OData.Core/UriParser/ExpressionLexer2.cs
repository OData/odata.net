...
namespace Microsoft.OData.UriParser
{
    ...
    internal class ExpressionLexer2
    {
        ...
        protected ExpressionToken2 token;
        ...
        internal ExpressionLexer2(string expression, bool moveToFirstToken, bool useSemicolonDelimiter)
        ...
        internal ExpressionLexer2(string expression, bool moveToFirstToken, bool useSemicolonDelimiter, bool parsingFunctionParameters)
        {
        ...
        /// <summary>Token being processed.</summary>
        internal ExpressionToken2 CurrentToken
        {
            get
            {
                return this.token;
        ...
        internal bool TryPeekNextToken(out ExpressionToken2 resultToken, out Exception error)
        {
            int savedTextPos = this.textPos;
            char? savedChar = this.ch;
            ExpressionToken2 savedToken = this.token;
        ...
        internal ExpressionToken2 NextToken()
        {
            Exception error = null;
            ExpressionToken2 nextToken = this.NextTokenImplementation(out error);
        ...
        /// <returns>The next token.</returns>
        internal ExpressionToken2 PeekNextToken()
        {
            ExpressionToken2 outToken;
            Exception error;
        ...
        /// </returns>
        internal ExpressionLexerPosition2 SnapshotPosition()
        {
            return new ExpressionLexerPosition2(this, this.textPos, this.token);
        }
        ...
        /// </remarks>
        internal void RestorePosition(ExpressionLexerPosition2 position)
        {
        ...
        protected virtual ExpressionToken2 NextTokenImplementation(out Exception error)
        {
            error = null;
        ...
        {
            ExpressionToken2 next = this.PeekNextToken();
        ...
        /// </summary>
        internal class ExpressionLexerPosition2
        {
            public ExpressionLexerPosition2(ExpressionLexer2 lexer, int? textPos, ExpressionToken2? token)
            {
                this.Lexer = lexer;
            ...
            public ExpressionLexer2 Lexer { get; private set; }

            public int? TextPos { get; private set; }

            public ExpressionToken2? Token { get; private set; }
        }
