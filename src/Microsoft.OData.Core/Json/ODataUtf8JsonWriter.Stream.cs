        ...
        private class ODataUtf8JsonWriteStream : Stream
        {
            ...
            protected override void Dispose(bool disposing)
            {
                ...
                if (this.numBytesNotWrittenFromPreviousChunk > 0)
                {
                    ...
                    this.jsonWriter.Base64EncodeAndWriteChunk(bytesNotProcessedFromPreviousChunk, isFinalBlock: true, out numBytesNotWrittenFromPreviousChunk);

                    // set numBytesNotWrittenFromPreviousChunk to 0.
                    this.numBytesNotWrittenFromPreviousChunk = 0;
                }
            ...
            public override async ValueTask DisposeAsync()
            {
                ...
                if (this.numBytesNotWrittenFromPreviousChunk > 0)
                {
                    ...
                    this.jsonWriter.Base64EncodeAndWriteChunk(bytesNotProcessedFromPreviousChunk.Span, isFinalBlock: true, out numBytesNotWrittenFromPreviousChunk);
            ...
            public override async Task WriteAsync(byte[] buffer, int offset, int count, CancellationToken token)
            {
                ...
                await this.WriteByteValueInChunksAsync(value);
            }
            ...
            private void WriteChunk(ReadOnlySpan<byte> chunk, int chunkLength, bool isFinalBlock)
            {
                ...
                this.jsonWriter.Base64EncodeAndWriteChunk(chunk.Slice(0, chunkLength), isFinalBlock, out numBytesNotWrittenFromPreviousChunk);
