//---------------------------------------------------------------------
// <copyright file="IStreamBasedJsonWriterFactoryAsync.cs" company="Microsoft">
...
{
    /// <summary>
    /// The interface of factories that create <see cref="IJsonWriterAsync"/> instances
    /// that write directly to a <see cref="Stream"/> rather than a <see cref="TextWriter"/>.
    /// </summary>
    [CLSCompliant(false)]
    public interface IStreamBasedJsonWriterFactoryAsync
    {
        /// <summary>
