...
namespace Microsoft.OData.Core.Atom
{
    ...
    internal class ODataAtomPropertyAndValueSerializer : ODataAtomSerializer
    {
            ...
            ProjectedPropertiesAnnotation projectedProperties)
        {
            ...
            IEdmComplexTypeReference complexTypeReference = TypeNameOracle.ResolveAndValidateTypeForComplexValue(this.Model, metadataTypeReference, complexValue, isOpenPropertyType).AsComplexOrNull();
            ...
            bool isWritingCollection)
        {
            ...
            // resolve the type name to the type; if no type name is specified we will use the 
            // type inferred from metadata
            IEdmCollectionTypeReference collectionTypeReference = (IEdmCollectionTypeReference)TypeNameOracle.ResolveAndValidateTypeForCollectionValue(this.Model, propertyTypeReference, collectionValue, isOpenPropertyType);
