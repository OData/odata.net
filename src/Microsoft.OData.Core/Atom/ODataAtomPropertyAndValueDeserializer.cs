//---------------------------------------------------------------------
// <copyright file="ODataAtomPropertyAndValueDeserializer.cs" company="Microsoft">
...
namespace Microsoft.OData.Core.Atom
{
    ...
    internal class ODataAtomPropertyAndValueDeserializer : ODataAtomDeserializer
    {
                ...
                do
                {
                    switch (this.XmlReader.NodeType)
                    {
                        case XmlNodeType.Element:
                            ...
                            {
                                // Reader versioning: Collection types should only be recognized in V3 payloads and higher.
        ...
        private object ReadNullValue(IEdmTypeReference expectedTypeReference, bool validateNullValue, string propertyName)
        {
            ...
            // ODataLib should not read/validate m:type if m:null=true is present
