//---------------------------------------------------------------------
// <copyright file="ODataAtomEntryMetadataDeserializer.cs" company="Microsoft">
    ...
    internal sealed class ODataAtomEntryMetadataDeserializer : ODataAtomMetadataDeserializer
    {
        ...
        private bool ShouldReadSingletonElement(bool alreadyExists)
        {
            ...
            if (alreadyExists)
            {
                ...
                // WCF DS Server will actually read all of them and use the last value.
                // We decided to take a breaking change and unify the behavior of WCF DS Server with WCF DS Client.
                // We will read the first value for EPM and ignore all the rest.
                return false;
            }
