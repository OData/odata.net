...
public interface IODataWriter<T>
{
    void Write(
...
public class ODataSelectExpandNode
{
...
public interface IODataAnnotationProvider
{
...
public class PocoODataSerializer : IODataSerializer
{
    ...
    private class PocoWriter<T> : IODataWriter<T>
    {
        ...
        private readonly JsonConverter<T>? _customConverter;
...
public class DictionaryODataSerializer : IODataSerializer
{
    public object GetWriter(Type type)
    {
...
public class CompositeODataSerializer : IODataSerializer
{
...
public class ODataSerializerService
{
...
public class ODataJsonConverterFactory : JsonConverterFactory
{
