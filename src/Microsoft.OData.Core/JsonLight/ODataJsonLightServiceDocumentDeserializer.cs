    ...
    internal sealed class ODataJsonLightServiceDocumentDeserializer : ODataJsonLightDeserializer
    {
        ...
        private async Task<ODataServiceDocument> ReadServiceDocumentImplementationAsync(PropertyAndAnnotationCollector propertyAndAnnotationCollector)
        {
            ...
            while (this.JsonReader.NodeType == JsonNodeType.Property)
            {
                ...
                {
                    throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_PropertyAnnotationInServiceDocument(
                        annotationName,
                ...
                await this.ProcessPropertyAsync(
                    ...
                    async (propertyParsingResult, propertyName) =>
                    {
                        ...
                        {
                            case PropertyParsingResult.ODataInstanceAnnotation:
                                throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_InstanceAnnotationInServiceDocument(
                                    propertyName,
                                    JsonLightConstants.ODataValuePropertyName));
                            ...
                            case PropertyParsingResult.PropertyWithValue:
                                if (string.Equals(JsonLightConstants.ODataValuePropertyName, propertyName, StringComparison.Ordinal))
                                {
                                    ...
                                    if (serviceDocumentElements[0] != null)
                                    {
                                        throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_DuplicatePropertiesInServiceDocument(
                                            JsonLightConstants.ODataValuePropertyName));
                                    }
                                ...
                                {
                                    throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_UnexpectedPropertyInServiceDocument(
                                        propertyName,
                                        JsonLightConstants.ODataValuePropertyName));
                                }
            ...
            if (serviceDocumentElements[0] == null)
            {
                throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_MissingValuePropertyInServiceDocument(
                    JsonLightConstants.ODataValuePropertyName));
            }
        ...
        private static void ValidateServiceDocumentElementHasNoRepeatedProperty(string property, string[] propertyValues)
        {
            ...
            {
                throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_DuplicatePropertiesInServiceDocumentElement(property));
            }
        }
        ...
        private static void ValidateServiceDocumentElementHasRequiredProperty(string property, string[] propertyValues)
        {
            ...
            {
                throw new ODataException(Strings.ODataJsonLightServiceDocumentDeserializer_MissingRequiredPropertyInServiceDocumentElement(property));
            }
        }
    }
}
