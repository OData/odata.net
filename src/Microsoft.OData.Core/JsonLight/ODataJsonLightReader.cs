...
namespace Microsoft.OData.JsonLight
{
    ...
    internal sealed class ODataJsonLightReader : ODataReaderCoreAsync
    {
        ...
        protected override async Task<bool> ReadAtStartImplementationAsync()
        {
            ...
            await this.jsonLightResourceDeserializer.ReadPayloadStartAsync(
                payloadKind,
                propertyAndAnnotationCollector,
                this.IsReadingNestedPayload,
        ...
        {
            return this.ReadAtResourceSetStartImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtResourceSetEndImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtResourceStartImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtResourceEndImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtPrimitiveAsynchronously();
        }
        ...
        {
            return this.ReadAtStreamAsynchronously();
        }
        ...
        {
            Stream stream;
            IJsonStreamReaderAsync streamReader = this.jsonLightInputContext.JsonReader as IJsonStreamReaderAsync;
            if (streamReader != null)
            {
        ...
        {
            TextReader reader;
            IJsonStreamReaderAsync jsonStreamReader = this.jsonLightInputContext.JsonReader as IJsonStreamReaderAsync;
            if (jsonStreamReader != null)
            {
        ...
        {
            return this.ReadAtNestedResourceInfoStartImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtNestedResourceInfoEndImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtEntityReferenceLinkAsynchronously();
        }
        ...
        {
            return this.ReadAtDeletedResourceStartImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtDeltaLinkImplementationAsynchronously();
        }
        ...
        {
            return this.ReadAtDeltaDeletedLinkImplementationAsynchronously();
        }
        ...
        private async Task<bool> ReadAtStartImplementationAsynchronously(PropertyAndAnnotationCollector propertyAndAnnotationCollector)
        {
            ...
            if (this.ReadingResourceSet)
            {
                ...
                if (this.ReadingDelta)
                {
                    ...
                    // Read top-level resource set annotations for delta resource sets.
                    await this.jsonLightResourceDeserializer.ReadTopLevelResourceSetAnnotationsAsync(
                        resourceSet,
                        propertyAndAnnotationCollector,
                ...
                else
                {
                    ...
                    if (!this.IsReadingNestedPayload)
                    {
                        ...
                        else
                        {
                            ...
                            //      {...}, <------------ complex object.
                            // ]
                            await this.jsonLightResourceDeserializer.JsonReader.ReadAsync()
                                .ConfigureAwait(false);
                        }
                    }
        ...
        ///                 on the node following the resource set end in case of an empty resource set
        /// </remarks>
        private async Task<bool> ReadAtResourceSetStartImplementationAsynchronously()
        {
        ...
        ///                 Any                         in case of expanded resource set in request, this might be the next item in the expanded array, which is not a resource
        /// </remarks>
        private async Task<bool> ReadAtResourceSetEndImplementationAsynchronously()
        {
            Debug.Assert(this.State == ODataReaderState.ResourceSetEnd || this.State == ODataReaderState.DeltaResourceSetEnd, "Not in (delta) resource set end state.");
            Debug.Assert(
                this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.Property ||
            ...
            if (isTopLevelResourceSet)
            {
                ...
                // read the end-of-payload
                await this.jsonLightResourceDeserializer.ReadPayloadEndAsync(this.IsReadingNestedPayload)
                    .ConfigureAwait(false);
            ...
            {
                // finish reading the expanded link
                await this.ReadExpandedNestedResourceInfoEndAsync(true)
                    .ConfigureAwait(false);
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'ResourceStart'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        ///                 JsonNodeType.EndObject              If no (more) properties exist in the resource's content
        /// </remarks>
        private async Task<bool> ReadAtResourceStartImplementationAsynchronously()
        {
            ODataResourceBase currentResource = this.Item as ODataResourceBase;
            if (currentResource != null && !this.IsReadingNestedPayload)
            {
            ...
            {
                await this.ReadNestedInfoAsync(this.CurrentResourceState.FirstNestedInfo)
                    .ConfigureAwait(false);
            }
            else
            {
        ...
        /// Post-Condition: The reader is positioned on the first node after the resource's end-object node
        /// </remarks>
        private async Task<bool> ReadAtResourceEndImplementationAsynchronously()
        {
            Debug.Assert(
                this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.EndObject ||
                (this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.PrimitiveValue &&
                await this.jsonLightResourceDeserializer.JsonReader.GetValueAsync().ConfigureAwait(false) == null),
                "Pre-Condition: JsonNodeType.EndObject or JsonNodeType.PrimitiveValue (null)");
            ...
            else if (isExpandedLinkContent)
            {
                ...
                // finish reading the expanded link
                await this.ReadExpandedNestedResourceInfoEndAsync(false)
                    .ConfigureAwait(false);
            }
            else
            {
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'Primitive'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        /// Post-Condition: The reader is positioned on the first node after the primitive value
        /// </remarks>
        private async Task<bool> ReadAtPrimitiveAsynchronously()
        {
            Debug.Assert(
                this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.PrimitiveValue,
                "Pre-Condition: JsonNodeType.PrimitiveValue (null or untyped)");
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'DeletedEntryStart'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        ///                 JsonNodeType.EndObject              If no (more) properties exist in the resource's content
        /// </remarks>
        private async Task<bool> ReadAtDeletedResourceStartImplementationAsynchronously()
        {
            Debug.Assert(this.CurrentScope is JsonLightDeletedResourceScope);
            ...
            return await this.ReadAtResourceStartImplementationAsynchronously()
                .ConfigureAwait(false);
        }

        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'EntityReferenceLink'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        ///                 Any:                            expanded collection link - the node after the entity reference link.
        /// </remarks>
        private async Task<bool> ReadAtEntityReferenceLinkAsynchronously()
        {
            this.PopScope(ODataReaderState.EntityReferenceLink);
            Debug.Assert(this.State == ODataReaderState.NestedResourceInfoStart,
                "this.State == ODataReaderState.NestedResourceInfoStart");
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'DeltaLink'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        /// Post-Condition: The reader is positioned on the first node after the link's end-object node.
        /// </remarks>
        private Task<bool> ReadAtDeltaLinkImplementationAsynchronously()
        {
            return this.EndDeltaLinkAsync(ODataReaderState.DeltaLink);
        }

        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'DeltaDeletedLink'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        /// Post-Condition: The reader is positioned on the first node after the link's end-object node.
        /// </remarks>
        private Task<bool> ReadAtDeltaDeletedLinkImplementationAsynchronously()
        {
        ...
        ///                                                     reporting projected navigation links missing in the payload
        /// </remarks>
        private async Task<bool> ReadAtNestedResourceInfoStartImplementationAsynchronously()
        {
            Debug.Assert(
                this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.Property ||
                this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.EndObject ||
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'NestedResourceInfoEnd'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        ///                 JsonNodeType.EndObject          end of the parent resource
        /// </remarks>
        private async Task<bool> ReadAtNestedResourceInfoEndImplementationAsynchronously()
        {
            this.PopScope(ODataReaderState.NestedResourceInfoEnd);
        ...
        /// <summary>
        /// Asynchronous implementation of the reader logic when in state 'Stream'.
        /// </summary>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if more items can be read from the reader; otherwise false.
        ...
        ///                 JsonNodeType.EndObject          end of the parent resource
        /// </remarks>
        private async Task<bool> ReadAtStreamAsynchronously()
        {
            this.PopScope(ODataReaderState.Stream);
            if (this.State == ODataReaderState.ResourceSetStart ||
                this.State == ODataReaderState.DeltaResourceSetStart)
        ...
        private async Task<bool> ReadAtNestedPropertyInfoAsynchronously()
        {
            ...
            if (streamPropertyInfo != null && !String.IsNullOrEmpty(streamPropertyInfo.ContentType))
            {
                await this.StartNestedStreamInfoAsync(
                    new ODataJsonLightReaderStreamInfo(
                        streamPropertyInfo.PrimitiveTypeKind,
                        streamPropertyInfo.ContentType)).ConfigureAwait(false);
            }
            else
            {
                await this.StartNestedStreamInfoAsync(
                    new ODataJsonLightReaderStreamInfo(propertyInfo.PrimitiveTypeKind)).ConfigureAwait(false);
            }
        ...
        private async Task<bool> ReadNextNestedInfoAsync()
        {
            ...
            ODataJsonLightReaderNestedInfo readerNestedInfo;
            IODataJsonLightReaderResourceState resourceState = this.CurrentResourceState;
            ...
            {
                readerNestedInfo = await this.jsonLightResourceDeserializer.ReadResourceContentAsync(resourceState)
                    .ConfigureAwait(false);
            }
            ...
            {
                await this.ReadNestedInfoAsync(readerNestedInfo)
                    .ConfigureAwait(false);
            }
        ...
        /// <summary>
        /// Asynchronously reads a nested resource info.
        /// </summary>
        /// <param name="nestedInfo">The nested info to be read</param>
        /// <returns>A task that represents the asynchronous read operation.</returns>
        private async Task ReadNestedInfoAsync(ODataJsonLightReaderNestedInfo nestedInfo)
        {
            ODataJsonLightReaderNestedResourceInfo readerNestedResourceInfo = nestedInfo as ODataJsonLightReaderNestedResourceInfo;
            if (readerNestedResourceInfo != null)
            {
            ...
            else
            {
                ...
                if (readerNestedStreamInfo != null)
                {
                    await this.StartNestedPropertyInfoAsync(readerNestedStreamInfo)
                        .ConfigureAwait(false);
                }
            }
        }
        ...
        private async Task StartDeltaLinkAsync(ODataReaderState state)
        {
            ...
            // Read source property.
            await this.jsonLightResourceDeserializer.ReadDeltaLinkSourceAsync(link)
                .ConfigureAwait(false);

            // Read relationship property.
            await this.jsonLightResourceDeserializer.ReadDeltaLinkRelationshipAsync(link)
                .ConfigureAwait(false);

            // Read target property.
            await this.jsonLightResourceDeserializer.ReadDeltaLinkTargetAsync(link)
                .ConfigureAwait(false);
        ...
        private async Task ReadResourceSetEndAsync()
        {
            ...
            await this.jsonLightResourceDeserializer.ReadResourceSetContentEndAsync()
                .ConfigureAwait(false);
            ...
            if (!this.IsReadingNestedPayload && (this.IsExpandedLinkContent || this.IsTopLevel))
            {
                // Temp ban reading the instance annotation after the resource set in parameter payload. (!this.IsReadingNestedPayload => !this.readingParameter)
                // Nested resource set payload won't have a NextLink annotation after the resource set itself since the payload is NOT pageable.
                await this.jsonLightResourceDeserializer.ReadNextLinkAnnotationAtResourceSetEndAsync(
        ...
        /// <summary>
        /// Asynchronously verifies that the current item is an <see cref="ODataNestedResourceInfo"/> instance,
        /// sets the cardinality of the link (IsCollection property) and moves the reader
        /// into state 'NestedResourceInfoEnd'.
        /// </summary>
        /// <returns>A task that represents the asynchronous read operation.</returns>
        /// <param name="isCollection">A flag indicating whether the link represents a collection or not.</param>
        private Task ReadExpandedNestedResourceInfoEndAsync(bool isCollection)
        {
            return TaskUtils.GetTaskForSynchronousOperation(() => this.ReadExpandedNestedResourceInfoEnd(isCollection));
        }
            ...
            SelectedPropertiesNode selectedProperties)
        {
            ...
            if (this.jsonLightResourceDeserializer.JsonReader.NodeType == JsonNodeType.PrimitiveValue)
            {
                object primitiveValue = await this.jsonLightResourceDeserializer.JsonReader.GetValueAsync()
                    .ConfigureAwait(false);
                ...
                else
                {
                    ...
                    if (resourceTypeReference.IsComplex() || resourceTypeReference.IsUntyped())
                    {
                        this.jsonLightResourceDeserializer.MessageReaderSettings.Validator.ValidateNullValue(
                            this.CurrentResourceTypeReference,
            ...
            if (this.ReadingResourceSet || this.IsExpandedLinkContent || (this.ReadingDelta && !this.IsTopLevel))
            {
                string contextUriStr = await this.jsonLightResourceDeserializer.ReadContextUriAnnotationAsync(
                    ODataPayloadKind.Resource,
                    propertyAndAnnotationCollector,
            ...
            if (this.ReadingDelta && (resourceKind == ODataDeltaKind.Resource || resourceKind == ODataDeltaKind.DeletedEntry))
            {
                deletedResource = await this.jsonLightResourceDeserializer.ReadDeletedResourceAsync()
                    .ConfigureAwait(false);
                if (deletedResource != null)
                {
                    resourceKind = ODataDeltaKind.DeletedEntry;
            ...
            switch (resourceKind)
            {
                ...
                case ODataDeltaKind.DeletedEntry:
                    ...
                    if (deletedResource == null)
                    {
                        deletedResource = await this.jsonLightResourceDeserializer.ReadDeletedEntryAsync()
                            .ConfigureAwait(false);
                        this.StartDeletedResource(
                            deletedResource,
                            source,
        ...
        private async Task ReadNextResourceSetItemAsync()
        {
            ...
            switch (this.jsonLightResourceDeserializer.JsonReader.NodeType)
            {
                case JsonNodeType.StartObject:
                    ...
                    await this.ReadResourceSetItemStartAsync(
                        propertyAndAnnotationCollector: null,
                        selectedProperties: this.CurrentJsonLightResourceSetScope.SelectedProperties).ConfigureAwait(false);
                    break;
                case JsonNodeType.StartArray:
                    // We are at the start of a nested resource set
                    await this.ReadResourceSetStartAsync(
                ...
                case JsonNodeType.PrimitiveValue:
                    ...
                    // Is this a stream, or a binary or string value with a collection that the client wants to read as a stream
                    if (!await TryReadPrimitiveAsStreamAsync(resourceType).ConfigureAwait(false))
                    {
                        // We are at a null value, or a non-null primitive value within an untyped collection
                        object primitiveValue = await this.jsonLightResourceDeserializer.JsonReader.GetValueAsync()
                            .ConfigureAwait(false);
        ...
        private async Task StartReadingResourceAsync()
        {
            ...
            // Read the odata.type annotation.
            await this.jsonLightResourceDeserializer.ReadResourceTypeNameAsync(this.CurrentResourceState)
                .ConfigureAwait(false);
            ...
            this.CurrentResourceState.FirstNestedInfo = await this.jsonLightResourceDeserializer.ReadResourceContentAsync(
        ...
        /// <summary>
        /// Asynchronously starts the nested property info.
        /// </summary>
        /// <param name="readerNestedPropertyInfo">The nested resource info for the nested resource info to start.</param>
        /// <returns>A task that represents the asynchronous read operation.</returns>
        private async Task StartNestedPropertyInfoAsync(ODataJsonLightReaderNestedPropertyInfo readerNestedPropertyInfo)
        {
            Debug.Assert(readerNestedPropertyInfo != null, "readerNestedResourceInfo != null");
            Debug.Assert(
                await this.jsonLightResourceDeserializer.JsonReader.CanStreamAsync().ConfigureAwait(false) || this.CurrentScope is JsonLightResourceSetScope,
                "Starting stream while not positioned on a primitive value or within an array");
        ...
        /// <summary>
        /// Asynchronously starts the nested stream info.
        /// </summary>
        /// <param name="readerStreamInfo">The nested resource info for the nested resource info to start.</param>
        /// <returns>A task that represents the asynchronous read operation.</returns>
        private async Task StartNestedStreamInfoAsync(ODataJsonLightReaderStreamInfo readerStreamInfo)
        {
            Debug.Assert(readerStreamInfo != null, "readerNestedResourceInfo != null");
            Debug.Assert(
                await this.jsonLightResourceDeserializer.JsonReader.CanStreamAsync().ConfigureAwait(false) || this.CurrentScope is JsonLightResourceSetScope,
        ...
        /// <summary>
        /// Checks if the value can be read as a stream.
        /// </summary>
        /// <param name="resourceType">The Edm type of the resource</param>
        /// <returns>
        /// A task that represents the asynchronous read operation.
        /// The value of the TResult parameter contains true if primitive can be read as a stream; otherwise false.
        /// </returns>
        private async Task<bool> TryReadPrimitiveAsStreamAsync(IEdmType resourceType)
        {
            Func<IEdmPrimitiveType, bool, string, IEdmProperty, bool> readAsStream = this.jsonLightInputContext.MessageReaderSettings.ReadAsStreamFunc;
                   ...
                   && readAsStream(resourceType as IEdmPrimitiveType, false, null, null)))
            {
                ...
                {
                    await this.StartNestedStreamInfoAsync(
                        new ODataJsonLightReaderStreamInfo(EdmPrimitiveTypeKind.None)).ConfigureAwait(false);
                }
                else if (resourceType.IsString())
                {
                    await this.StartNestedStreamInfoAsync(
                        new ODataJsonLightReaderStreamInfo(EdmPrimitiveTypeKind.String)).ConfigureAwait(false);
                }
                else if (resourceType.IsStream() || resourceType.IsBinary())
                {
                    await this.StartNestedStreamInfoAsync(
                        new ODataJsonLightReaderStreamInfo(EdmPrimitiveTypeKind.Binary)).ConfigureAwait(false);
                }
                else
                {
                    Debug.Assert(false, "We thought we could read as stream, but ran out of options");
