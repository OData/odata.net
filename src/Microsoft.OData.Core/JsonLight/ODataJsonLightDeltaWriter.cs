...
namespace Microsoft.OData.Core.JsonLight
{
    ...
    internal sealed class ODataJsonLightDeltaWriter : ODataDeltaWriter, IODataOutputInStreamErrorListener
    {
        ...
        /// <summary>
        /// Verifies that calling WriteStart inline feed is valid.
        /// </summary>
        /// <param name="synchronousCall">true if the call is to be synchronous; false otherwise.</param>
        /// <param name="inlineFeed">Inline feed to write.</param>
        private void VerifyCanWriteExpandedFeed(bool synchronousCall, ODataFeed inlineFeed)
        {
            this.VerifyNotDisposed();
            this.VerifyCallAllowed(synchronousCall);

            ExceptionUtils.CheckArgumentNotNull(inlineFeed, "expandedFeed");
        }
