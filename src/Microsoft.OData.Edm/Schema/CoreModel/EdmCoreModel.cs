...
namespace Microsoft.OData.Edm
{
    ...
    public class EdmCoreModel : EdmElement, IEdmModel, IEdmCoreModelElement
    {
        ...
        public static IEdmCollectionTypeReference GetCollection(IEdmTypeReference elementType) => new EdmCollectionTypeReference(new EdmCollectionType(elementType));
        ...
        /// </returns>
        public IEnumerable<IEdmOperation> FindDeclaredBoundOperations(string qualifiedName, IEdmType bindingType) => Enumerable.Empty<IEdmOperation>();
        ...
        public IEdmTerm FindDeclaredTerm(string qualifiedName) => null;
        ...
        public IEnumerable<IEdmOperationImport> FindOperationImportsByNameNonBindingParameterType(string operationImportName, IEnumerable<string> parameterNames) => Enumerable.Empty<IEdmOperationImport>();
        ...
        public IEdmPrimitiveType GetPrimitiveType(EdmPrimitiveTypeKind kind) => this.GetCoreModelPrimitiveType(kind);

        /// <summary>
        /// Gets Edm.PrimitiveType type.
        /// </summary>
        /// <returns>IEdmPrimitiveType type definition.</returns>
        public IEdmPrimitiveType GetPrimitiveType() => this.primitiveType;

        /// <summary>
        /// Gets Edm.ComplexType type.
        /// </summary>
        /// <returns>IEdmComplexType type definition.</returns>
        public IEdmComplexType GetComplexType() => this.complexType;

        /// <summary>
        /// Gets Edm.EntityType type.
        /// </summary>
        /// <returns>IEdmEntityType type definition.</returns>
        public IEdmEntityType GetEntityType() => this.entityType;

        /// <summary>
        /// Gets Edm.Untyped type.
        /// </summary>
        /// <returns>IEdmUntypedType type definition.</returns>
        public IEdmUntypedType GetUntypedType() => this.untypedType;
        ...
        public IEdmPathTypeReference GetAnnotationPath(bool isNullable) => new EdmPathTypeReference(this.GetPathType(EdmPathTypeKind.AnnotationPath), isNullable);
        ...
        public IEdmPathTypeReference GetPropertyPath(bool isNullable) => new EdmPathTypeReference(this.GetPathType(EdmPathTypeKind.PropertyPath), isNullable);
        ...
        public IEdmPathTypeReference GetNavigationPropertyPath(bool isNullable) => new EdmPathTypeReference(this.GetPathType(EdmPathTypeKind.NavigationPropertyPath), isNullable);
        ...
        public IEdmEntityTypeReference GetEntityType(bool isNullable) => new EdmEntityTypeReference(this.entityType, isNullable);
        ...
        public IEdmComplexTypeReference GetComplexType(bool isNullable) => new EdmComplexTypeReference(this.complexType, isNullable);
        ...
        public IEdmPrimitiveTypeReference GetPrimitiveType(bool isNullable) => new EdmPrimitiveTypeReference(this.primitiveType, isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetInt16(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Int16), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetInt32(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Int32), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetInt64(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Int64), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetBoolean(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Boolean), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetByte(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Byte), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetSByte(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.SByte), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference.</returns>
        public IEdmPrimitiveTypeReference GetGuid(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Guid), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new primitive type reference</returns>
        public IEdmPrimitiveTypeReference GetDate(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Date), isNullable);
        ...
        public IEdmTemporalTypeReference GetDateTimeOffset(bool isNullable) => new EdmTemporalTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.DateTimeOffset), isNullable);
        ...
        public IEdmTemporalTypeReference GetDuration(bool isNullable) => new EdmTemporalTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Duration), isNullable);
        ...
        public IEdmTemporalTypeReference GetTimeOfDay(bool isNullable) => new EdmTemporalTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.TimeOfDay), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new decimal type reference.</returns>
        public IEdmDecimalTypeReference GetDecimal(bool isNullable) => new EdmDecimalTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Decimal), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new decimal type reference.</returns>
        public IEdmPrimitiveTypeReference GetSingle(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Single), isNullable);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new decimal type reference.</returns>
        public IEdmPrimitiveTypeReference GetDouble(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Double), isNullable);
        ...
        public IEdmPrimitiveTypeReference GetStream(bool isNullable) => new EdmPrimitiveTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Stream), isNullable);
        ...
        public IEdmBinaryTypeReference GetBinary(bool isUnbounded, int? maxLength, bool isNullable) => new EdmBinaryTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Binary), isNullable, isUnbounded, maxLength);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new binary type reference.</returns>
        public IEdmBinaryTypeReference GetBinary(bool isNullable) => new EdmBinaryTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.Binary), isNullable);
        ...
        public IEdmStringTypeReference GetString(bool isUnbounded, int? maxLength, bool? isUnicode, bool isNullable) => new EdmStringTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.String), isNullable, isUnbounded, maxLength, isUnicode);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new string type reference.</returns>
        public IEdmStringTypeReference GetString(bool isNullable) => new EdmStringTypeReference(this.GetCoreModelPrimitiveType(EdmPrimitiveTypeKind.String), isNullable);

        /// <summary>
        /// Gets a reference to a Edm.Untyped type definition.
        /// </summary>
        /// <returns>A new Edm.Untyped type reference.</returns>
        public IEdmUntypedTypeReference GetUntyped() => GetUntyped(true);
        ...
        /// <param name="isNullable">Flag specifying if the referenced type should be nullable.</param>
        /// <returns>A new Edm.Untyped type reference.</returns>
        public IEdmUntypedTypeReference GetUntyped(bool isNullable) => new EdmUntypedTypeReference(this.GetUntypedType(), isNullable);
        ...
        public IEnumerable<IEdmVocabularyAnnotation> FindDeclaredVocabularyAnnotations(IEdmVocabularyAnnotatable element) => Enumerable.Empty<IEdmVocabularyAnnotation>();
