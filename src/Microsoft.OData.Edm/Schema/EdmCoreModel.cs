...
namespace Microsoft.OData.Edm
{
    ...
    public class EdmCoreModel : EdmElement, IEdmModel, IEdmValidCoreModelElement
    {
        ...
        public IEdmSchemaType FindDeclaredType(string qualifiedName)
        {
            ...
            else if (string.Equals(qualifiedName, CsdlConstants.TypeName_Untyped, StringComparison.Ordinal) || string.Equals(qualifiedName, CsdlConstants.TypeName_Untyped_Short, StringComparison.Ordinal))
            {
                return untypedType;
            }
