...
namespace Microsoft.OData.Edm
{
    public static class DateOnlyAndTimeOnlyExtensions
    {
        ...
        /// </summary>
        /// <param name="dateOnly">The <see cref="DateOnly"/> value to convert.</param>
        /// <param name="provider">The <see cref="IFormatProvider"/> provider to use.</param>
        /// <returns>A string representing the date in OData ISO 8601 format ("yyyy-MM-dd").</returns>
        public static string ToODataString(this DateOnly dateOnly, IFormatProvider provider)
        {
            return dateOnly.ToString("yyyy-MM-dd", provider);
        }
        ...
        /// <param name="provider">The <see cref="IFormatProvider"/> provider to use.</param>
        /// <returns>A string representing the time in OData ISO 8601 format ("HH:mm:ss.fffffff").</returns>
        public static string ToODataString(this TimeOnly timeOnly, IFormatProvider provider)
        {
            return timeOnly.ToString(@"HH:mm\:ss\.fffffff", provider);
        }
    }
}
