...
namespace Microsoft.OData.Edm
{
    ...
    internal class VocabularyAnnotationCache
    {
        ...
        public bool TryGetVocabularyAnnotations(IEdmVocabularyAnnotatable element, out IEnumerable<IEdmVocabularyAnnotation> annotations) => annotationsCache.TryGetValue(element, out annotations);
    }
}
