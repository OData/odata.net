...
namespace Microsoft.OData.Edm.Csdl.Parsing
{
    ...
    internal class EdmModelBuilder
    {
        ...
        public EdmModelBuilder(TextReader reader, CsdlSerializerOptions options)
        {
            if (reader == null)
            {
        ...
        internal IList<IEdmModel> BuildReferencedModels(IList<IEdmReference> edmReferences)
        {
            ...
            foreach (var edmReference in edmReferences)
            {
                ...
                EdmModelBuilder builder = new EdmModelBuilder(referencedJsonReader, options);
        ...
        internal IEdmModel BuildEdmModel(JsonPath jsonPath)
        {
            ...
            IList<IEdmModel> referencedModels = BuildReferencedModels(references);
            ...
            EdmTypeJsonBuilder builder = new EdmTypeJsonBuilder(model, schemaJsonItems);
