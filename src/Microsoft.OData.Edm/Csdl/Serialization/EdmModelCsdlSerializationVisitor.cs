...
namespace Microsoft.OData.Edm.Csdl.Serialization
{
    internal sealed class EdmModelCsdlSerializationVisitor : EdmModelVisitor
    {
        ...
        protected override async Task ProcessEntityTypeAsync(IEdmEntityType element)
        {
            ...
            if (element.DeclaredKeyRef != null && element.DeclaredKeyRef.Any())
            {
                await this.VisitEntityTypeDeclaredKeyAsync(element.DeclaredKeyRef).ConfigureAwait(false);
            }
        ...
        private async Task VisitEntityTypeDeclaredKeyAsync(IEnumerable<IEdmPropertyRef> keyProperties)
        {
