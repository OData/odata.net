...
namespace Microsoft.OData.Edm.Csdl
{
    ...
    public partial class CsdlReader
    {
        ...
        /// <param name="errors">Errors reported while parsing.</param>
        /// <returns>Success of the parse operation.</returns>
        public static bool TryParse(XmlReader reader, IEnumerable<IEdmModel> references, out IEdmModel model, out IEnumerable<EdmError> errors) => TryParse(reader, references, true /*includeDefaultVocabularies*/, out model, out errors);
        ...
        public static bool TryParse(XmlReader reader, IEnumerable<IEdmModel> references, bool includeDefaultVocabularies, out IEdmModel model, out IEnumerable<EdmError> errors)
        {
            ...
            CsdlReader edmxReader = new CsdlReader(reader, null);
            return edmxReader.TryParse(references, includeDefaultVocabularies, out model, out errors);
        }
        ...
        private void ParseRuntimeElement() => this.ParseTargetElement(CsdlConstants.Element_Runtime, this.runtimeParserLookup);

        private void ParseDataServicesElement() => this.ParseTargetElement(CsdlConstants.Element_DataServices, this.dataServicesParserLookup);
        ...
        private void ParseConceptualModelsElement() => this.ParseElement(CsdlConstants.Element_ConceptualModels, this.conceptualModelsParserLookup);
        ...
        private void RaiseEmptyFile() => this.RaiseError(EdmErrorCode.EmptyFile, SRResources.XmlParser_EmptySchemaTextReader);
        ...
        private void RaiseError(EdmErrorCode errorCode, string errorMessage) => this.errors.Add(new EdmError(this.Location(), errorCode, errorMessage));
    }
}
