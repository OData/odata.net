...
namespace Microsoft.OData.Edm.Csdl
{
    ...
    public static class SchemaReader
    {
        ...
        public static bool TryParse(IEnumerable<XmlReader> readers, out IEdmModel model, out IEnumerable<EdmError> errors) => TryParse(readers, Enumerable.Empty<IEdmModel>(), out model, out errors);
        ...
        /// <param name="errors">Errors reported while parsing.</param>
        /// <returns>Success of the parse operation.</returns>
        public static bool TryParse(IEnumerable<XmlReader> readers, IEdmModel reference, out IEdmModel model, out IEnumerable<EdmError> errors) => TryParse(readers, new IEdmModel[] { reference }, out model, out errors);
        ...
        /// <param name="errors">Errors reported while parsing.</param>
        /// <returns>Success of the parse operation.</returns>
        public static bool TryParse(IEnumerable<XmlReader> readers, IEnumerable<IEdmModel> references, out IEdmModel model, out IEnumerable<EdmError> errors) => TryParse(readers, references, true /*includeDefaultVocabularies*/, out model, out errors);
