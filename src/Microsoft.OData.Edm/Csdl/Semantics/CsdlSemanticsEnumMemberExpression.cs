...
namespace Microsoft.OData.Edm.Csdl.CsdlSemantics
{
    internal class CsdlSemanticsEnumMemberExpression : CsdlSemanticsExpression, IEdmEnumMemberExpression, IEdmCheckable
    {
        ...
        public CsdlSemanticsEnumMemberExpression(CsdlEnumMemberExpression expression, CsdlSemanticsModel model)
        ...
        private IEnumerable<IEdmEnumMember> ComputeReferenced()
        {
            ...
            return EdmEnumValueParser.TryParseEnumMember(this.expression.EnumMemberPath, this.Model, this.Location, out member) ? member : null;
        }
        ...
        private IEnumerable<EdmError> ComputeErrors()
        {
            ...
            {
                if (!EdmEnumValueParser.TryParseEnumMember(this.expression.EnumMemberPath, this.Model, this.Location, out member))
                {
                    return new EdmError[] { new EdmError(this.Location, EdmErrorCode.InvalidEnumMemberPath, Edm.Strings.CsdlParser_InvalidEnumMemberPath(this.expression.EnumMemberPath)) };
                }
            }
