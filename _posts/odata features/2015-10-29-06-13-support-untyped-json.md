...
Starting from ODataV3 5.7.0, undeclared property is better supported by ODataLib and OData Client.
...
* ODataUndeclaredPropertyBehaviorKinds.SupportUndeclaredValueProperty : read undeclared property as either an OData valid value instance or ODataUntyped instance.
...
The below messageWriterSettings will enable reading undeclared / untyped property.
{% highlight csharp %}
