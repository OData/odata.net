namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _selectOptionPC
    {
        ...
        {
            public _filter(__GeneratedOdata.CstNodes.Rules._filter _filter_1)
            {
                this._filter_1 = _filter_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._filter _filter_1 { get; }
        ...
        {
            public _search(__GeneratedOdata.CstNodes.Rules._search _search_1)
            {
                this._search_1 = _search_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._search _search_1 { get; }
        ...
        {
            public _inlinecount(__GeneratedOdata.CstNodes.Rules._inlinecount _inlinecount_1)
            {
                this._inlinecount_1 = _inlinecount_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._inlinecount _inlinecount_1 { get; }
        ...
        {
            public _orderby(__GeneratedOdata.CstNodes.Rules._orderby _orderby_1)
            {
                this._orderby_1 = _orderby_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._orderby _orderby_1 { get; }
        ...
        {
            public _skip(__GeneratedOdata.CstNodes.Rules._skip _skip_1)
            {
                this._skip_1 = _skip_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._skip _skip_1 { get; }
        ...
        {
            public _top(__GeneratedOdata.CstNodes.Rules._top _top_1)
            {
                this._top_1 = _top_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._top _top_1 { get; }
