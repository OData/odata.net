namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _charInJSON
    {
        ...
        {
            public _qcharⲻJSONⲻspecial(__GeneratedOdata.CstNodes.Rules._qcharⲻJSONⲻspecial _qcharⲻJSONⲻspecial_1)
            {
                this._qcharⲻJSONⲻspecial_1 = _qcharⲻJSONⲻspecial_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._qcharⲻJSONⲻspecial _qcharⲻJSONⲻspecial_1 { get; }
        ...
        public sealed class _escape_ⲤquotationⲻmarkⳆescapeⳆⲤʺx2FʺⳆʺx25x32x46ʺↃⳆʺx62ʺⳆʺx66ʺⳆʺx6EʺⳆʺx72ʺⳆʺx74ʺⳆʺx75ʺ_4HEXDIGↃ : _charInJSON
        {
            ...
            public __GeneratedOdata.CstNodes.Inners._ⲤquotationⲻmarkⳆescapeⳆⲤʺx2FʺⳆʺx25x32x46ʺↃⳆʺx62ʺⳆʺx66ʺⳆʺx6EʺⳆʺx72ʺⳆʺx74ʺⳆʺx75ʺ_4HEXDIGↃ _ⲤquotationⲻmarkⳆescapeⳆⲤʺx2FʺⳆʺx25x32x46ʺↃⳆʺx62ʺⳆʺx66ʺⳆʺx6EʺⳆʺx72ʺⳆʺx74ʺⳆʺx75ʺ_4HEXDIGↃ_1 { get; }
