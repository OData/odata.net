namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _navigationPropertyInUri
    {
        ...
        {
            public _singleNavPropInJSON(__GeneratedOdata.CstNodes.Rules._singleNavPropInJSON _singleNavPropInJSON_1)
            {
                this._singleNavPropInJSON_1 = _singleNavPropInJSON_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._singleNavPropInJSON _singleNavPropInJSON_1 { get; }
        ...
        {
            public _collectionNavPropInJSON(__GeneratedOdata.CstNodes.Rules._collectionNavPropInJSON _collectionNavPropInJSON_1)
            {
                this._collectionNavPropInJSON_1 = _collectionNavPropInJSON_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._collectionNavPropInJSON _collectionNavPropInJSON_1 { get; }
