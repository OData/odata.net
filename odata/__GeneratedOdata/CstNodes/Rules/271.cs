namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _primitiveValue
    {
        ...
        {
            public _durationValue(__GeneratedOdata.CstNodes.Rules._durationValue _durationValue_1)
            {
                this._durationValue_1 = _durationValue_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._durationValue _durationValue_1 { get; }
        ...
        {
            public _enumValue(__GeneratedOdata.CstNodes.Rules._enumValue _enumValue_1)
            {
                this._enumValue_1 = _enumValue_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._enumValue _enumValue_1 { get; }
        ...
        {
            public _fullCollectionLiteral(__GeneratedOdata.CstNodes.Rules._fullCollectionLiteral _fullCollectionLiteral_1)
            {
                this._fullCollectionLiteral_1 = _fullCollectionLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullCollectionLiteral _fullCollectionLiteral_1 { get; }
        ...
        {
            public _fullLineStringLiteral(__GeneratedOdata.CstNodes.Rules._fullLineStringLiteral _fullLineStringLiteral_1)
            {
                this._fullLineStringLiteral_1 = _fullLineStringLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullLineStringLiteral _fullLineStringLiteral_1 { get; }
        ...
        {
            public _fullMultiPointLiteral(__GeneratedOdata.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1)
            {
                this._fullMultiPointLiteral_1 = _fullMultiPointLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1 { get; }
        ...
        {
            public _fullMultiLineStringLiteral(__GeneratedOdata.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1)
            {
                this._fullMultiLineStringLiteral_1 = _fullMultiLineStringLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1 { get; }
        ...
        {
            public _fullMultiPolygonLiteral(__GeneratedOdata.CstNodes.Rules._fullMultiPolygonLiteral _fullMultiPolygonLiteral_1)
            {
                this._fullMultiPolygonLiteral_1 = _fullMultiPolygonLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullMultiPolygonLiteral _fullMultiPolygonLiteral_1 { get; }
        ...
        {
            public _fullPointLiteral(__GeneratedOdata.CstNodes.Rules._fullPointLiteral _fullPointLiteral_1)
            {
                this._fullPointLiteral_1 = _fullPointLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullPointLiteral _fullPointLiteral_1 { get; }
        ...
        {
            public _fullPolygonLiteral(__GeneratedOdata.CstNodes.Rules._fullPolygonLiteral _fullPolygonLiteral_1)
            {
                this._fullPolygonLiteral_1 = _fullPolygonLiteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._fullPolygonLiteral _fullPolygonLiteral_1 { get; }
        ...
        {
            public _binaryValue(__GeneratedOdata.CstNodes.Rules._binaryValue _binaryValue_1)
            {
                this._binaryValue_1 = _binaryValue_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._binaryValue _binaryValue_1 { get; }
