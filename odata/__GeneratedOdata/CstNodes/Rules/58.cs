namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _entityCastOption
    {
        ...
        {
            public _entityIdOption(__GeneratedOdata.CstNodes.Rules._entityIdOption _entityIdOption_1)
            {
                this._entityIdOption_1 = _entityIdOption_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._entityIdOption _entityIdOption_1 { get; }
