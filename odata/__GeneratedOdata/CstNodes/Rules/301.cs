namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _hour
    {
        ...
        {
            public _Ⲥʺx30ʺⳆʺx31ʺↃ_DIGIT(__GeneratedOdata.CstNodes.Inners._Ⲥʺx30ʺⳆʺx31ʺↃ _Ⲥʺx30ʺⳆʺx31ʺↃ_1, __GeneratedOdata.CstNodes.Rules._DIGIT _DIGIT_1)
            {
        ...
        {
            public _ʺx32ʺ_Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺⳆʺx33ʺↃ(__GeneratedOdata.CstNodes.Inners._ʺx32ʺ _ʺx32ʺ_1, __GeneratedOdata.CstNodes.Inners._Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺⳆʺx33ʺↃ _Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺⳆʺx33ʺↃ_1)
            {
            ...
            public __GeneratedOdata.CstNodes.Inners._Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺⳆʺx33ʺↃ _Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺⳆʺx33ʺↃ_1 { get; }
