namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _collectionNavPath
    {
        ...
        {
            public _keyPredicate_꘡singleNavigation꘡(__GeneratedOdata.CstNodes.Rules._keyPredicate _keyPredicate_1, __GeneratedOdata.CstNodes.Rules._singleNavigation? _singleNavigation_1)
            {
        ...
        {
            public _filterInPath_꘡collectionNavigation꘡(__GeneratedOdata.CstNodes.Rules._filterInPath _filterInPath_1, __GeneratedOdata.CstNodes.Rules._collectionNavigation? _collectionNavigation_1)
            {
                this._filterInPath_1 = _filterInPath_1;
                this._collectionNavigation_1 = _collectionNavigation_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._filterInPath _filterInPath_1 { get; }
        ...
        {
            public _each_꘡boundOperation꘡(__GeneratedOdata.CstNodes.Rules._each _each_1, __GeneratedOdata.CstNodes.Rules._boundOperation? _boundOperation_1)
            {
                this._each_1 = _each_1;
                this._boundOperation_1 = _boundOperation_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._each _each_1 { get; }
