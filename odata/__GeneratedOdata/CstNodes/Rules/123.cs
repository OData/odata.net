namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _inscopeVariableExpr
    {
        ...
        {
            public _implicitVariableExpr(__GeneratedOdata.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1)
            {
                this._implicitVariableExpr_1 = _implicitVariableExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1 { get; }
        ...
        {
            public _lambdaVariableExpr(__GeneratedOdata.CstNodes.Rules._lambdaVariableExpr _lambdaVariableExpr_1)
            {
