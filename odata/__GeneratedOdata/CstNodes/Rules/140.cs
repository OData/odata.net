namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _boolMethodCallExpr
    {
        ...
        {
            public _endsWithMethodCallExpr(__GeneratedOdata.CstNodes.Rules._endsWithMethodCallExpr _endsWithMethodCallExpr_1)
            {
                this._endsWithMethodCallExpr_1 = _endsWithMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._endsWithMethodCallExpr _endsWithMethodCallExpr_1 { get; }
        ...
        {
            public _startsWithMethodCallExpr(__GeneratedOdata.CstNodes.Rules._startsWithMethodCallExpr _startsWithMethodCallExpr_1)
            {
                this._startsWithMethodCallExpr_1 = _startsWithMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._startsWithMethodCallExpr _startsWithMethodCallExpr_1 { get; }
        ...
        {
            public _containsMethodCallExpr(__GeneratedOdata.CstNodes.Rules._containsMethodCallExpr _containsMethodCallExpr_1)
            {
                this._containsMethodCallExpr_1 = _containsMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._containsMethodCallExpr _containsMethodCallExpr_1 { get; }
        ...
        {
            public _intersectsMethodCallExpr(__GeneratedOdata.CstNodes.Rules._intersectsMethodCallExpr _intersectsMethodCallExpr_1)
            {
                this._intersectsMethodCallExpr_1 = _intersectsMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._intersectsMethodCallExpr _intersectsMethodCallExpr_1 { get; }
        ...
        {
            public _hasSubsetMethodCallExpr(__GeneratedOdata.CstNodes.Rules._hasSubsetMethodCallExpr _hasSubsetMethodCallExpr_1)
            {
                this._hasSubsetMethodCallExpr_1 = _hasSubsetMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._hasSubsetMethodCallExpr _hasSubsetMethodCallExpr_1 { get; }
        ...
        {
            public _hasSubsequenceMethodCallExpr(__GeneratedOdata.CstNodes.Rules._hasSubsequenceMethodCallExpr _hasSubsequenceMethodCallExpr_1)
            {
                this._hasSubsequenceMethodCallExpr_1 = _hasSubsequenceMethodCallExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._hasSubsequenceMethodCallExpr _hasSubsequenceMethodCallExpr_1 { get; }
