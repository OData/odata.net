namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _hierⲻpart
    {
        ...
        {
            public _ʺx2Fx2Fʺ_authority_pathⲻabempty(__GeneratedOdata.CstNodes.Inners._ʺx2Fx2Fʺ _ʺx2Fx2Fʺ_1, __GeneratedOdata.CstNodes.Rules._authority _authority_1, __GeneratedOdata.CstNodes.Rules._pathⲻabempty _pathⲻabempty_1)
            {
            ...
            public __GeneratedOdata.CstNodes.Inners._ʺx2Fx2Fʺ _ʺx2Fx2Fʺ_1 { get; }
            public __GeneratedOdata.CstNodes.Rules._authority _authority_1 { get; }
            public __GeneratedOdata.CstNodes.Rules._pathⲻabempty _pathⲻabempty_1 { get; }
        ...
        {
            public _pathⲻabsolute(__GeneratedOdata.CstNodes.Rules._pathⲻabsolute _pathⲻabsolute_1)
            {
                this._pathⲻabsolute_1 = _pathⲻabsolute_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._pathⲻabsolute _pathⲻabsolute_1 { get; }
        ...
        {
            public _pathⲻrootless(__GeneratedOdata.CstNodes.Rules._pathⲻrootless _pathⲻrootless_1)
            {
                this._pathⲻrootless_1 = _pathⲻrootless_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._pathⲻrootless _pathⲻrootless_1 { get; }
