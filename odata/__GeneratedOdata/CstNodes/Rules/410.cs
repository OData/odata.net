namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _pcharⲻnoⲻSQUOTE
    {
        ...
        {
            public _pctⲻencodedⲻnoⲻSQUOTE(__GeneratedOdata.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1)
            {
                this._pctⲻencodedⲻnoⲻSQUOTE_1 = _pctⲻencodedⲻnoⲻSQUOTE_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1 { get; }
