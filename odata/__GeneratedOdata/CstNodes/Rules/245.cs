namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _primitiveProperty
    {
        ...
        {
            public _primitiveNonKeyProperty(__GeneratedOdata.CstNodes.Rules._primitiveNonKeyProperty _primitiveNonKeyProperty_1)
            {
                this._primitiveNonKeyProperty_1 = _primitiveNonKeyProperty_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._primitiveNonKeyProperty _primitiveNonKeyProperty_1 { get; }
