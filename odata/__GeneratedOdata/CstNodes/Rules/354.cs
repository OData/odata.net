namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _preference
    {
        ...
        {
            public _allowEntityReferencesPreference(__GeneratedOdata.CstNodes.Rules._allowEntityReferencesPreference _allowEntityReferencesPreference_1)
            {
                this._allowEntityReferencesPreference_1 = _allowEntityReferencesPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._allowEntityReferencesPreference _allowEntityReferencesPreference_1 { get; }
        ...
        {
            public _callbackPreference(__GeneratedOdata.CstNodes.Rules._callbackPreference _callbackPreference_1)
            {
                this._callbackPreference_1 = _callbackPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._callbackPreference _callbackPreference_1 { get; }
        ...
        {
            public _continueOnErrorPreference(__GeneratedOdata.CstNodes.Rules._continueOnErrorPreference _continueOnErrorPreference_1)
            {
                this._continueOnErrorPreference_1 = _continueOnErrorPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._continueOnErrorPreference _continueOnErrorPreference_1 { get; }
        ...
        {
            public _includeAnnotationsPreference(__GeneratedOdata.CstNodes.Rules._includeAnnotationsPreference _includeAnnotationsPreference_1)
            {
                this._includeAnnotationsPreference_1 = _includeAnnotationsPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._includeAnnotationsPreference _includeAnnotationsPreference_1 { get; }
        ...
        {
            public _maxpagesizePreference(__GeneratedOdata.CstNodes.Rules._maxpagesizePreference _maxpagesizePreference_1)
            {
                this._maxpagesizePreference_1 = _maxpagesizePreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._maxpagesizePreference _maxpagesizePreference_1 { get; }
        ...
        {
            public _respondAsyncPreference(__GeneratedOdata.CstNodes.Rules._respondAsyncPreference _respondAsyncPreference_1)
            {
                this._respondAsyncPreference_1 = _respondAsyncPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._respondAsyncPreference _respondAsyncPreference_1 { get; }
        ...
        {
            public _returnPreference(__GeneratedOdata.CstNodes.Rules._returnPreference _returnPreference_1)
            {
                this._returnPreference_1 = _returnPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._returnPreference _returnPreference_1 { get; }
        ...
        {
            public _trackChangesPreference(__GeneratedOdata.CstNodes.Rules._trackChangesPreference _trackChangesPreference_1)
            {
                this._trackChangesPreference_1 = _trackChangesPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._trackChangesPreference _trackChangesPreference_1 { get; }
        ...
        {
            public _waitPreference(__GeneratedOdata.CstNodes.Rules._waitPreference _waitPreference_1)
            {
                this._waitPreference_1 = _waitPreference_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._waitPreference _waitPreference_1 { get; }
