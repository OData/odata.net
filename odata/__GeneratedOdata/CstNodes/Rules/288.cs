namespace __GeneratedOdata.CstNodes.Rules
{
    ...
    {
        public _int64Value(__GeneratedOdata.CstNodes.Rules._SIGN? _SIGN_1, System.Collections.Generic.IEnumerable<__GeneratedOdata.CstNodes.Rules._DIGIT> _DIGIT_1)
        {
