namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _expandOption
    {
        ...
        {
            public _expandRefOption(__GeneratedOdata.CstNodes.Rules._expandRefOption _expandRefOption_1)
            {
        ...
        {
            public _levels(__GeneratedOdata.CstNodes.Rules._levels _levels_1)
            {
