namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _systemQueryOption
    {
        ...
        {
            public _deltatoken(__GeneratedOdata.CstNodes.Rules._deltatoken _deltatoken_1)
            {
                this._deltatoken_1 = _deltatoken_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._deltatoken _deltatoken_1 { get; }
        ...
        {
            public _id(__GeneratedOdata.CstNodes.Rules._id _id_1)
            {
                this._id_1 = _id_1;
            }
        ...
        {
            public _schemaversion(__GeneratedOdata.CstNodes.Rules._schemaversion _schemaversion_1)
            {
                this._schemaversion_1 = _schemaversion_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._schemaversion _schemaversion_1 { get; }
        ...
        {
            public _skiptoken(__GeneratedOdata.CstNodes.Rules._skiptoken _skiptoken_1)
            {
                this._skiptoken_1 = _skiptoken_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._skiptoken _skiptoken_1 { get; }
        ...
        {
            public _index(__GeneratedOdata.CstNodes.Rules._index _index_1)
            {
                this._index_1 = _index_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._index _index_1 { get; }
