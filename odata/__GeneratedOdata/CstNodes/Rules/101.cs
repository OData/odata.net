namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _parameterValue
    {
        ...
        {
            public _arrayOrObject(__GeneratedOdata.CstNodes.Rules._arrayOrObject _arrayOrObject_1)
            {
                this._arrayOrObject_1 = _arrayOrObject_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._arrayOrObject _arrayOrObject_1 { get; }
        ...
        {
            public _commonExpr(__GeneratedOdata.CstNodes.Rules._commonExpr _commonExpr_1)
            {
