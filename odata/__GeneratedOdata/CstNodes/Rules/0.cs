namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _dummyStartRule
    {
        ...
        {
            public _odataUri(__GeneratedOdata.CstNodes.Rules._odataUri _odataUri_1)
            {
                this._odataUri_1 = _odataUri_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._odataUri _odataUri_1 { get; }
        ...
        {
            public _header(__GeneratedOdata.CstNodes.Rules._header _header_1)
            {
                this._header_1 = _header_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._header _header_1 { get; }
        ...
        {
            public _primitiveValue(__GeneratedOdata.CstNodes.Rules._primitiveValue _primitiveValue_1)
            {
                this._primitiveValue_1 = _primitiveValue_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._primitiveValue _primitiveValue_1 { get; }
