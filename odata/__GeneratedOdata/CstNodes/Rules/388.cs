namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _host
    {
        ...
        {
            public _IPⲻliteral(__GeneratedOdata.CstNodes.Rules._IPⲻliteral _IPⲻliteral_1)
            {
                this._IPⲻliteral_1 = _IPⲻliteral_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._IPⲻliteral _IPⲻliteral_1 { get; }
        ...
        {
            public _IPv4address(__GeneratedOdata.CstNodes.Rules._IPv4address _IPv4address_1)
            {
                this._IPv4address_1 = _IPv4address_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._IPv4address _IPv4address_1 { get; }
        ...
        {
            public _regⲻname(__GeneratedOdata.CstNodes.Rules._regⲻname _regⲻname_1)
            {
                this._regⲻname_1 = _regⲻname_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._regⲻname _regⲻname_1 { get; }
