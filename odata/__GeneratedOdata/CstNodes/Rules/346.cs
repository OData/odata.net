namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _header
    {
        ...
        {
            public _contentⲻid(__GeneratedOdata.CstNodes.Rules._contentⲻid _contentⲻid_1)
            {
                this._contentⲻid_1 = _contentⲻid_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._contentⲻid _contentⲻid_1 { get; }
        ...
        {
            public _entityid(__GeneratedOdata.CstNodes.Rules._entityid _entityid_1)
            {
                this._entityid_1 = _entityid_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._entityid _entityid_1 { get; }
        ...
        {
            public _isolation(__GeneratedOdata.CstNodes.Rules._isolation _isolation_1)
            {
                this._isolation_1 = _isolation_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._isolation _isolation_1 { get; }
        ...
        {
            public _odataⲻmaxversion(__GeneratedOdata.CstNodes.Rules._odataⲻmaxversion _odataⲻmaxversion_1)
            {
                this._odataⲻmaxversion_1 = _odataⲻmaxversion_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._odataⲻmaxversion _odataⲻmaxversion_1 { get; }
        ...
        {
            public _odataⲻversion(__GeneratedOdata.CstNodes.Rules._odataⲻversion _odataⲻversion_1)
            {
                this._odataⲻversion_1 = _odataⲻversion_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._odataⲻversion _odataⲻversion_1 { get; }
        ...
        {
            public _prefer(__GeneratedOdata.CstNodes.Rules._prefer _prefer_1)
            {
                this._prefer_1 = _prefer_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._prefer _prefer_1 { get; }
