namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _firstMemberExpr
    {
        ...
        {
            public _memberExpr(__GeneratedOdata.CstNodes.Rules._memberExpr _memberExpr_1)
            {
        ...
        {
            public _inscopeVariableExpr_꘡ʺx2Fʺ_memberExpr꘡(__GeneratedOdata.CstNodes.Rules._inscopeVariableExpr _inscopeVariableExpr_1, __GeneratedOdata.CstNodes.Inners._ʺx2Fʺ_memberExpr? _ʺx2Fʺ_memberExpr_1)
            {
                this._inscopeVariableExpr_1 = _inscopeVariableExpr_1;
                this._ʺx2Fʺ_memberExpr_1 = _ʺx2Fʺ_memberExpr_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._inscopeVariableExpr _inscopeVariableExpr_1 { get; }
            public __GeneratedOdata.CstNodes.Inners._ʺx2Fʺ_memberExpr? _ʺx2Fʺ_memberExpr_1 { get; }
