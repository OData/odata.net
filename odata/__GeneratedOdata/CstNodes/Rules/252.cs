namespace __GeneratedOdata.CstNodes.Rules
{
    public abstract class _navigationProperty
    {
        ...
        {
            public _entityNavigationProperty(__GeneratedOdata.CstNodes.Rules._entityNavigationProperty _entityNavigationProperty_1)
            {
        ...
        {
            public _entityColNavigationProperty(__GeneratedOdata.CstNodes.Rules._entityColNavigationProperty _entityColNavigationProperty_1)
            {
