namespace __GeneratedOdata.CstNodes.Inners
{
    public abstract class _searchPhraseⳆsearchWord
    {
        ...
        {
            public _searchPhrase(__GeneratedOdata.CstNodes.Rules._searchPhrase _searchPhrase_1)
            {
                this._searchPhrase_1 = _searchPhrase_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._searchPhrase _searchPhrase_1 { get; }
        ...
        {
            public _searchWord(__GeneratedOdata.CstNodes.Rules._searchWord _searchWord_1)
            {
                this._searchWord_1 = _searchWord_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._searchWord _searchWord_1 { get; }
