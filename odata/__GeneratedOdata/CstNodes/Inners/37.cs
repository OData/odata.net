namespace __GeneratedOdata.CstNodes.Inners
{
    public abstract class _parameterAliasⳆkeyPropertyValue
    {
        ...
        {
            public _keyPropertyValue(__GeneratedOdata.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1)
            {
                this._keyPropertyValue_1 = _keyPropertyValue_1;
            }
            
            public __GeneratedOdata.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1 { get; }
