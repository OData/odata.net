namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._positionLiteral> Instance { get; } = from _doubleValue_1 in __GeneratedOdata.Parsers.Rules._doubleValueParser.Instance
