namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._anyExpr> Instance { get; } = from _ʺx61x6Ex79ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx61x6Ex79ʺParser.Instance
