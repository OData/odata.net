namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectListItem> Instance { get; } = (_STARParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._selectListItem>(_allOperationsInSchemaParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._selectListItem>(_꘡qualifiedEntityTypeName_ʺx2Fʺ꘡_ⲤqualifiedActionNameⳆqualifiedFunctionNameⳆselectListPropertyↃParser.Instance);
        
        public static class _STARParser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectListItem._STAR> Instance { get; } = from _STAR_1 in __GeneratedOdata.Parsers.Rules._STARParser.Instance
select new __GeneratedOdata.CstNodes.Rules._selectListItem._STAR(_STAR_1);
        }
        
        public static class _allOperationsInSchemaParser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectListItem._allOperationsInSchema> Instance { get; } = from _allOperationsInSchema_1 in __GeneratedOdata.Parsers.Rules._allOperationsInSchemaParser.Instance
select new __GeneratedOdata.CstNodes.Rules._selectListItem._allOperationsInSchema(_allOperationsInSchema_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectListItem._꘡qualifiedEntityTypeName_ʺx2Fʺ꘡_ⲤqualifiedActionNameⳆqualifiedFunctionNameⳆselectListPropertyↃ> Instance { get; } = from _qualifiedEntityTypeName_ʺx2Fʺ_1 in __GeneratedOdata.Parsers.Inners._qualifiedEntityTypeName_ʺx2FʺParser.Instance.Optional()
