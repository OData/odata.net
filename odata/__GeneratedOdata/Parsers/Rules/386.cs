namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._authority> Instance { get; } = from _userinfo_ʺx40ʺ_1 in __GeneratedOdata.Parsers.Inners._userinfo_ʺx40ʺParser.Instance.Optional()
