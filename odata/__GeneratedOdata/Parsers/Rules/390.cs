namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._IPⲻliteral> Instance { get; } = from _ʺx5Bʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx5BʺParser.Instance
