namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._parameterAlias> Instance { get; } = from _AT_1 in __GeneratedOdata.Parsers.Rules._ATParser.Instance
