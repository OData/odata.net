namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._containmentNavigation> Instance { get; } = from _keyPredicate_1 in __GeneratedOdata.Parsers.Rules._keyPredicateParser.Instance
