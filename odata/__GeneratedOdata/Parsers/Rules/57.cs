namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._entityCastOptions> Instance { get; } = from _ⲤentityCastOption_ʺx26ʺↃ_1 in Inners._ⲤentityCastOption_ʺx26ʺↃParser.Instance.Many()
