namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._primitiveColInUri> Instance { get; } = from _beginⲻarray_1 in __GeneratedOdata.Parsers.Rules._beginⲻarrayParser.Instance
