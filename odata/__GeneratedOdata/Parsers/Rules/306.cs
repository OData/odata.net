namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._enumValue> Instance { get; } = from _singleEnumValue_1 in __GeneratedOdata.Parsers.Rules._singleEnumValueParser.Instance
