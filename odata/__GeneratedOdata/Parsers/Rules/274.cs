namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._binaryValue> Instance { get; } = from _Ⲥ4base64charↃ_1 in Inners._Ⲥ4base64charↃParser.Instance.Many()
