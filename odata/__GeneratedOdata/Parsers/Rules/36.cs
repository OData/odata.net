namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens> Instance { get; } = (_namespace_ʺx2Eʺ_entityFunctionParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens>(_namespace_ʺx2Eʺ_entityColFunctionParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens>(_namespace_ʺx2Eʺ_complexFunctionParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens>(_namespace_ʺx2Eʺ_complexColFunctionParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens>(_namespace_ʺx2Eʺ_primitiveFunctionParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens>(_namespace_ʺx2Eʺ_primitiveColFunctionParser.Instance);
        
        public static class _namespace_ʺx2Eʺ_entityFunctionParser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_entityFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
...
select new __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_entityFunction(_namespace_1, _ʺx2Eʺ_1, _entityFunction_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_entityColFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
...
select new __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_entityColFunction(_namespace_1, _ʺx2Eʺ_1, _entityColFunction_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_complexFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
...
select new __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_complexFunction(_namespace_1, _ʺx2Eʺ_1, _complexFunction_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_complexColFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
...
select new __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_complexColFunction(_namespace_1, _ʺx2Eʺ_1, _complexColFunction_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_primitiveFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
...
select new __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_primitiveFunction(_namespace_1, _ʺx2Eʺ_1, _primitiveFunction_1);
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._boundFunctionCallNoParens._namespace_ʺx2Eʺ_primitiveColFunction> Instance { get; } = from _namespace_1 in __GeneratedOdata.Parsers.Rules._namespaceParser.Instance
from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
