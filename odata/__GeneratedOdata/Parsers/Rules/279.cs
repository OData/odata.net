namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._decimalValue> Instance { get; } = (_꘡SIGN꘡_1ЖDIGIT_꘡ʺx2Eʺ_1ЖDIGIT꘡_꘡ʺx65ʺ_꘡SIGN꘡_1ЖDIGIT꘡Parser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._decimalValue>(_nanInfinityParser.Instance);
        
        public static class _꘡SIGN꘡_1ЖDIGIT_꘡ʺx2Eʺ_1ЖDIGIT꘡_꘡ʺx65ʺ_꘡SIGN꘡_1ЖDIGIT꘡Parser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._decimalValue._꘡SIGN꘡_1ЖDIGIT_꘡ʺx2Eʺ_1ЖDIGIT꘡_꘡ʺx65ʺ_꘡SIGN꘡_1ЖDIGIT꘡> Instance { get; } = from _SIGN_1 in __GeneratedOdata.Parsers.Rules._SIGNParser.Instance.Optional()
...
select new __GeneratedOdata.CstNodes.Rules._decimalValue._꘡SIGN꘡_1ЖDIGIT_꘡ʺx2Eʺ_1ЖDIGIT꘡_꘡ʺx65ʺ_꘡SIGN꘡_1ЖDIGIT꘡(_SIGN_1.GetOrElse(null), new __GeneratedOdata.CstNodes.Inners.HelperRangedAtLeast1<__GeneratedOdata.CstNodes.Rules._DIGIT>(_DIGIT_1), _ʺx2Eʺ_1ЖDIGIT_1.GetOrElse(null), _ʺx65ʺ_꘡SIGN꘡_1ЖDIGIT_1.GetOrElse(null));
        ...
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._decimalValue._nanInfinity> Instance { get; } = from _nanInfinity_1 in __GeneratedOdata.Parsers.Rules._nanInfinityParser.Instance
