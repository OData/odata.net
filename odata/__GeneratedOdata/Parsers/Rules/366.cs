namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._waitPreference> Instance { get; } = from _ʺx77x61x69x74ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx77x61x69x74ʺParser.Instance
