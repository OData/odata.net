namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._pctⲻencoded> Instance { get; } = from _ʺx25ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx25ʺParser.Instance
