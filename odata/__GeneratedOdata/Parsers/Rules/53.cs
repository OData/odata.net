namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._metadataOptions> Instance { get; } = from _metadataOption_1 in __GeneratedOdata.Parsers.Rules._metadataOptionParser.Instance
