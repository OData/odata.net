namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._yearMethodCallExpr> Instance { get; } = from _ʺx79x65x61x72ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx79x65x61x72ʺParser.Instance
