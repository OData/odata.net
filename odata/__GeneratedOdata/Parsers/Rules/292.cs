namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._dateTimeOffsetValue> Instance { get; } = from _year_1 in __GeneratedOdata.Parsers.Rules._yearParser.Instance
...
from _ʺx54ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx54ʺParser.Instance
...
from _Ⲥʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minuteↃ_1 in __GeneratedOdata.Parsers.Inners._Ⲥʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minuteↃParser.Instance
select new __GeneratedOdata.CstNodes.Rules._dateTimeOffsetValue(_year_1, _ʺx2Dʺ_1, _month_1, _ʺx2Dʺ_2, _day_1, _ʺx54ʺ_1, _hour_1, _ʺx3Aʺ_1, _minute_1, _ʺx3Aʺ_second_꘡ʺx2Eʺ_fractionalSeconds꘡_1.GetOrElse(null), _Ⲥʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minuteↃ_1);
    }
