namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Rules._dateTimeOffsetValue> Instance { get; } = from _year_1 in __GeneratedOdata.Parsers.Rules._yearParser.Instance
