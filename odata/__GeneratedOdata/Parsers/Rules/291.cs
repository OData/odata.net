namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._dateValue> Instance { get; } = from _year_1 in __GeneratedOdata.Parsers.Rules._yearParser.Instance
