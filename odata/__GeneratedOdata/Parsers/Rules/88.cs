namespace __GeneratedOdata.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectItem> Instance { get; } = (_STARParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._selectItem>(_allOperationsInSchemaParser.Instance).Or<char, __GeneratedOdata.CstNodes.Rules._selectItem>(_꘡ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2Fʺ꘡_ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃParser.Instance);
        
        public static class _STARParser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectItem._STAR> Instance { get; } = from _STAR_1 in __GeneratedOdata.Parsers.Rules._STARParser.Instance
select new __GeneratedOdata.CstNodes.Rules._selectItem._STAR(_STAR_1);
        }
        
        public static class _allOperationsInSchemaParser
        {
            public static IParser<char, __GeneratedOdata.CstNodes.Rules._selectItem._allOperationsInSchema> Instance { get; } = from _allOperationsInSchema_1 in __GeneratedOdata.Parsers.Rules._allOperationsInSchemaParser.Instance
