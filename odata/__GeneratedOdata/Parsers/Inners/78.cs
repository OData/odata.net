namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Inners._ʺx26ʺ_metadataOption> Instance { get; } = from _ʺx26ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx26ʺParser.Instance
