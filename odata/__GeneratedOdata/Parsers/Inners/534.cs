namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Inners._COMMA_singleEnumValue> Instance { get; } = from _COMMA_1 in __GeneratedOdata.Parsers.Rules._COMMAParser.Instance
