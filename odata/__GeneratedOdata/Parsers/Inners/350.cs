namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri> Instance { get; } = (_annotationInUriParser.Instance).Or<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri>(_primitivePropertyInUriParser.Instance).Or<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri>(_complexPropertyInUriParser.Instance).Or<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri>(_collectionPropertyInUriParser.Instance).Or<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri>(_navigationPropertyInUriParser.Instance);
        
        public static class _annotationInUriParser
        {
            public static Parser<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri._annotationInUri> Instance { get; } = from _annotationInUri_1 in __GeneratedOdata.Parsers.Rules._annotationInUriParser.Instance
...
select new __GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri._primitivePropertyInUri(_primitivePropertyInUri_1);
        ...
        {
            public static Parser<__GeneratedOdata.CstNodes.Inners._annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri._complexPropertyInUri> Instance { get; } = from _complexPropertyInUri_1 in __GeneratedOdata.Parsers.Rules._complexPropertyInUriParser.Instance
