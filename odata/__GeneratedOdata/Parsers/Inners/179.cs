...
select new __GeneratedOdata.CstNodes.Inners._STARⳆ1Жunreserved._STAR(_STAR_1);
        ...
        {
            public static Parser<__GeneratedOdata.CstNodes.Inners._STARⳆ1Жunreserved._1Жunreserved> Instance { get; } = from _unreserved_1 in __GeneratedOdata.Parsers.Rules._unreservedParser.Instance.Many()
select new __GeneratedOdata.CstNodes.Inners._STARⳆ1Жunreserved._1Жunreserved(_unreserved_1);
        }
    }
