namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Inners._ʺx2Eʺ_namespacePart> Instance { get; } = from _ʺx2Eʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx2EʺParser.Instance
