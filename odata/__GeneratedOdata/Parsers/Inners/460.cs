namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Inners._4base64char> Instance { get; } = from _base64char_1 in __GeneratedOdata.Parsers.Rules._base64charParser.Instance.Repeat(4, 4)
