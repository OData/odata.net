namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Inners._OPEN_parameterNames_CLOSE> Instance { get; } = from _OPEN_1 in __GeneratedOdata.Parsers.Rules._OPENParser.Instance
