namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Inners._commonExpr_BWS_COMMA_BWS> Instance { get; } = from _commonExpr_1 in __GeneratedOdata.Parsers.Rules._commonExprParser.Instance
