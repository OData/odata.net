namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static Parser<__GeneratedOdata.CstNodes.Inners._ʺx23ʺ_fragment> Instance { get; } = from _ʺx23ʺ_1 in __GeneratedOdata.Parsers.Inners._ʺx23ʺParser.Instance
