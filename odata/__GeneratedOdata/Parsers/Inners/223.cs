namespace __GeneratedOdata.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdata.CstNodes.Inners._EQ_customValue> Instance { get; } = from _EQ_1 in __GeneratedOdata.Parsers.Rules._EQParser.Instance
