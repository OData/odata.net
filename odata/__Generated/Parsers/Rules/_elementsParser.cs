namespace __Generated.Parsers.Rules
{
    ...
    {
        public static IParser<char, __Generated.CstNodes.Rules._elements> Instance { get; } = from _alternation_1 in __Generated.Parsers.Rules._alternationParser.Instance
