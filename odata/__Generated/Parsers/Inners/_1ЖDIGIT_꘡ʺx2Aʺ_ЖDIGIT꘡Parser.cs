namespace __Generated.Parsers.Inners
{
    ...
    {
        public static IParser<char, __Generated.CstNodes.Inners._1ЖDIGIT_꘡ʺx2Aʺ_ЖDIGIT꘡> Instance { get; } = from _DIGIT_1 in __Generated.Parsers.Rules._DIGITParser.Instance.Repeat(1, null)
