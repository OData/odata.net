namespace __Generated.Parsers.Inners
{
    ...
    {
        public static Parser<__Generated.CstNodes.Inners._WSPⳆVCHAR> Instance { get; } = (_WSPParser.Instance).Or<__Generated.CstNodes.Inners._WSPⳆVCHAR>(_VCHARParser.Instance);
