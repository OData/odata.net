namespace AbnfParser.CstNodes.Core
{
    ...
    public abstract class Char
    {
        ...
        {
            public TResult Visit(Char node, TContext context)
            {
                return node.Dispatch(this, context);
            }

            protected internal abstract TResult Accept(x01 node, TContext context);
            protected internal abstract TResult Accept(x02 node, TContext context);
            protected internal abstract TResult Accept(x03 node, TContext context);
            protected internal abstract TResult Accept(x04 node, TContext context);
            protected internal abstract TResult Accept(x05 node, TContext context);
            protected internal abstract TResult Accept(x06 node, TContext context);
            protected internal abstract TResult Accept(x07 node, TContext context);
            protected internal abstract TResult Accept(x08 node, TContext context);
            protected internal abstract TResult Accept(x09 node, TContext context);
            protected internal abstract TResult Accept(x0A node, TContext context);
            protected internal abstract TResult Accept(x0B node, TContext context);
            protected internal abstract TResult Accept(x0C node, TContext context);
            protected internal abstract TResult Accept(x0D node, TContext context);
            protected internal abstract TResult Accept(x0E node, TContext context);
            protected internal abstract TResult Accept(x0F node, TContext context);
            protected internal abstract TResult Accept(x10 node, TContext context);
            protected internal abstract TResult Accept(x11 node, TContext context);
            protected internal abstract TResult Accept(x12 node, TContext context);
            protected internal abstract TResult Accept(x13 node, TContext context);
            protected internal abstract TResult Accept(x14 node, TContext context);
            protected internal abstract TResult Accept(x15 node, TContext context);
            protected internal abstract TResult Accept(x16 node, TContext context);
            protected internal abstract TResult Accept(x17 node, TContext context);
            protected internal abstract TResult Accept(x18 node, TContext context);
            protected internal abstract TResult Accept(x19 node, TContext context);
            protected internal abstract TResult Accept(x1A node, TContext context);
            protected internal abstract TResult Accept(x1B node, TContext context);
            protected internal abstract TResult Accept(x1C node, TContext context);
            protected internal abstract TResult Accept(x1D node, TContext context);
            protected internal abstract TResult Accept(x1E node, TContext context);
            protected internal abstract TResult Accept(x1F node, TContext context);
            ...
            protected internal abstract TResult Accept(x7F node, TContext context);
        }
    ...
    public sealed class x47
    {
        private x47()
        {
        }

        public static x47 Instance { get; } = new x47();
    }

    public sealed class x48
    {
        private x48()
        {
        }

        public static x48 Instance { get; } = new x48();
    }

    public sealed class x49
    {
        private x49()
        {
        }

        public static x49 Instance { get; } = new x49();
    }

    public sealed class x4A
    {
        private x4A()
        {
        }

        public static x4A Instance { get; } = new x4A();
    }

    public sealed class x4B
    {
        private x4B()
        {
        }

        public static x4B Instance { get; } = new x4B();
    }

    public sealed class x4C
    {
        private x4C()
        {
        }

        public static x4C Instance { get; } = new x4C();
    }

    public sealed class x4D
    {
        private x4D()
        {
        }

        public static x4D Instance { get; } = new x4D();
    }

    public sealed class x4E
    {
        private x4E()
        {
        }

        public static x4E Instance { get; } = new x4E();
    }

    public sealed class x4F
    {
        private x4F()
        {
        }

        public static x4F Instance { get; } = new x4F();
    }

    public sealed class x50
    {
        private x50()
        {
        }

        public static x50 Instance { get; } = new x50();
    }

    public sealed class x51
    {
        private x51()
        {
        }

        public static x51 Instance { get; } = new x51();
    }

    public sealed class x52
    {
        private x52()
        {
        }

        public static x52 Instance { get; } = new x52();
    }

    public sealed class x53
    {
        private x53()
        {
        }

        public static x53 Instance { get; } = new x53();
    }

    public sealed class x54
    {
        private x54()
        {
        }

        public static x54 Instance { get; } = new x54();
    }

    public sealed class x55
    {
        private x55()
        {
        }

        public static x55 Instance { get; } = new x55();
    }

    public sealed class x56
    {
        private x56()
        {
        }

        public static x56 Instance { get; } = new x56();
    }

    public sealed class x57
    {
        private x57()
        {
        }

        public static x57 Instance { get; } = new x57();
    }

    public sealed class x58
    {
        private x58()
        {
        }

        public static x58 Instance { get; } = new x58();
    }

    public sealed class x59
    {
        private x59()
        {
        }

        public static x59 Instance { get; } = new x59();
    }

    public sealed class x5A
    {
        private x5A()
        {
        }
    ...
    public sealed class x61
    {
        ...
        public static x61 Instance { get; } = new x61();
    }
    ...
    public sealed class x63
    {
        private x63()
        {
        }

        public static x63 Instance { get; } = new x63();
    }
    ...
    public sealed class x65
    {
        private x65()
        {
        }

        public static x65 Instance { get; } = new x65();
    }

    public sealed class x66
    {
        private x66()
        {
        }

        public static x66 Instance { get; } = new x66();
    }

    public sealed class x67
    {
        private x67()
        {
        }

        public static x67 Instance { get; } = new x67();
    }

    public sealed class x68
    {
        private x68()
        {
        }

        public static x68 Instance { get; } = new x68();
    }

    public sealed class x69
    {
        private x69()
        {
        }

        public static x69 Instance { get; } = new x69();
    }

    public sealed class x6A
    {
        private x6A()
        {
        }

        public static x6A Instance { get; } = new x6A();
    }

    public sealed class x6B
    {
        private x6B()
        {
        }

        public static x6B Instance { get; } = new x6B();
    }

    public sealed class x6C
    {
        private x6C()
        {
        }

        public static x6C Instance { get; } = new x6C();
    }

    public sealed class x6D
    {
        private x6D()
        {
        }

        public static x6D Instance { get; } = new x6D();
    }

    public sealed class x6E
    {
        private x6E()
        {
        }

        public static x6E Instance { get; } = new x6E();
    }

    public sealed class x6F
    {
        private x6F()
        {
        }

        public static x6F Instance { get; } = new x6F();
    }

    public sealed class x70
    {
        private x70()
        {
        }

        public static x70 Instance { get; } = new x70();
    }

    public sealed class x71
    {
        private x71()
        {
        }

        public static x71 Instance { get; } = new x71();
    }

    public sealed class x72
    {
        private x72()
        {
        }

        public static x72 Instance { get; } = new x72();
    }

    public sealed class x73
    {
        private x73()
        {
        }

        public static x73 Instance { get; } = new x73();
    }

    public sealed class x74
    {
        private x74()
        {
        }

        public static x74 Instance { get; } = new x74();
    }

    public sealed class x75
    {
        private x75()
        {
        }

        public static x75 Instance { get; } = new x75();
    }

    public sealed class x76
    {
        private x76()
        {
        }

        public static x76 Instance { get; } = new x76();
    }

    public sealed class x77
    {
        private x77()
        {
        }

        public static x77 Instance { get; } = new x77();
    }
    ...
    public sealed class x79
    {
        private x79()
        {
        }

        public static x79 Instance { get; } = new x79();
    }

    public sealed class x7A
    {
        private x7A()
        {
        }
