namespace __GeneratedTest.Parsers.Rules
{
    ...
    public static class _CTLParser
    {
        ...
        {
            public static Parser<__Generated.CstNodes.Rules._CTL._Ⰳx00ⲻ1F> Instance { get; } = from _Ⰳx00ⲻ1F_1 in __GeneratedTest.Parsers.Inners._Ⰳx00ⲻ1FParser.Instance
select new __Generated.CstNodes.Rules._CTL._Ⰳx00ⲻ1F(_Ⰳx00ⲻ1F_1);
        }
        
        public static class _Ⰳx7FParser
        {
            public static Parser<__Generated.CstNodes.Rules._CTL._Ⰳx7F> Instance { get; } = from _Ⰳx7F_1 in __GeneratedTest.Parsers.Inners._Ⰳx7FParser.Instance
