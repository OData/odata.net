namespace __GeneratedTest.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedTest.CstNodes.Rules._proseⲻval> Instance { get; } = from _ʺx3Cʺ_1 in __GeneratedTest.Parsers.Inners._ʺx3CʺParser.Instance
...
select new __GeneratedTest.CstNodes.Rules._proseⲻval(_ʺx3Cʺ_1, _ⲤⰃx20ⲻ3DⳆⰃx3Fⲻ7EↃ_1, _ʺx3Eʺ_1);
    }
