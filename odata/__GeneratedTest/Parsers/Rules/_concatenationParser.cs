namespace __GeneratedTest.Parsers.Rules
{
    ...
    {
        public static Parser<__Generated.CstNodes.Rules._concatenation> Instance { get; } = from _repetition_1 in __GeneratedTest.Parsers.Rules._repetitionParser.Instance
