namespace __GeneratedTest.Parsers.Rules
{
    ...
    {
        public static Parser<__GeneratedTest.CstNodes.Rules._binⲻval> Instance { get; } = from _ʺx62ʺ_1 in __GeneratedTest.Parsers.Inners._ʺx62ʺParser.Instance
...
select new __GeneratedTest.CstNodes.Rules._binⲻval(_ʺx62ʺ_1, _BIT_1, _1ЖⲤʺx2Eʺ_1ЖBITↃⳆⲤʺx2Dʺ_1ЖBITↃ_1.GetOrElse(null));
    }
