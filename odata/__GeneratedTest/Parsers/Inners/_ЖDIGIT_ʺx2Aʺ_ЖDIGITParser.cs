namespace __GeneratedTest.Parsers.Inners
{
    ...
    {
        public static Parser<__Generated.CstNodes.Inners._ЖDIGIT_ʺx2Aʺ_ЖDIGIT> Instance { get; } = from _DIGIT_1 in __GeneratedTest.Parsers.Rules._DIGITParser.Instance.Many()
