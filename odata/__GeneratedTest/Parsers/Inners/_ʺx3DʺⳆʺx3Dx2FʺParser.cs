namespace __GeneratedTest.Parsers.Inners
{
    ...
    public static class _ʺx3DʺⳆʺx3Dx2FʺParser
    {
        ...
        {
            public static Parser<__Generated.CstNodes.Inners._ʺx3DʺⳆʺx3Dx2Fʺ._ʺx3Dʺ> Instance { get; } = from _ʺx3Dʺ_1 in __GeneratedTest.Parsers.Inners._ʺx3DʺParser.Instance
select new __Generated.CstNodes.Inners._ʺx3DʺⳆʺx3Dx2Fʺ._ʺx3Dʺ(_ʺx3Dʺ_1);
        }
        
        public static class _ʺx3Dx2FʺParser
        {
            public static Parser<__Generated.CstNodes.Inners._ʺx3DʺⳆʺx3Dx2Fʺ._ʺx3Dx2Fʺ> Instance { get; } = from _ʺx3Dx2Fʺ_1 in __GeneratedTest.Parsers.Inners._ʺx3Dx2FʺParser.Instance
