...
{
    public sealed class _divbyExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._divbyExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._divbyExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx64x69x76x62x79ʺTranscriber.Instance.Transcribe(value._ʺx64x69x76x62x79ʺ_1, builder);
