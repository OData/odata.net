...
{
    public sealed class _subExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._subExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._subExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx73x75x62ʺTranscriber.Instance.Transcribe(value._ʺx73x75x62ʺ_1, builder);
