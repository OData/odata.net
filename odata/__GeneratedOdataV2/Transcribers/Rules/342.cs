...
{
    public sealed class _geometryPointTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._geometryPoint>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._geometryPoint value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV2.Trancsribers.Rules._fullPointLiteralTranscriber.Instance.Transcribe(value._fullPointLiteral_1, builder);
