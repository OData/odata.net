...
{
    public sealed class _hourMethodCallExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._hourMethodCallExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._hourMethodCallExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Inners._ʺx68x6Fx75x72ʺTranscriber.Instance.Transcribe(value._ʺx68x6Fx75x72ʺ_1, builder);
