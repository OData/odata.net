...
{
    public sealed class _boundEntityColFunctionCallTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._boundEntityColFunctionCall>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._boundEntityColFunctionCall value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV2.Trancsribers.Rules._entityColFunctionTranscriber.Instance.Transcribe(value._entityColFunction_1, builder);
