...
{
    public sealed class _ltExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._ltExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._ltExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx6Cx74ʺTranscriber.Instance.Transcribe(value._ʺx6Cx74ʺ_1, builder);
