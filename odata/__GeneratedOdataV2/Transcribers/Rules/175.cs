...
{
    public sealed class _andExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._andExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._andExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx61x6Ex64ʺTranscriber.Instance.Transcribe(value._ʺx61x6Ex64ʺ_1, builder);
