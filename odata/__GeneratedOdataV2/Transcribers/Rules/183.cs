...
{
    public sealed class _inExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._inExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._inExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx69x6EʺTranscriber.Instance.Transcribe(value._ʺx69x6Eʺ_1, builder);
