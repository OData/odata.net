...
{
    public sealed class _gtExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._gtExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._gtExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx67x74ʺTranscriber.Instance.Transcribe(value._ʺx67x74ʺ_1, builder);
