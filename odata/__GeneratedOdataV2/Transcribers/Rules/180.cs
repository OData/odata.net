...
{
    public sealed class _leExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._leExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._leExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx6Cx65ʺTranscriber.Instance.Transcribe(value._ʺx6Cx65ʺ_1, builder);
