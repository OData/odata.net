...
{
    public sealed class _navigationTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._navigation>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._navigation value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV2.Trancsribers.Rules._navigationPropertyTranscriber.Instance.Transcribe(value._navigationProperty_1, builder);
