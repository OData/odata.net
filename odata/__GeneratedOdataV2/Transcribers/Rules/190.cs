...
{
    public sealed class _modExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Rules._modExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Rules._modExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV2.Trancsribers.Inners._ʺx6Dx6Fx64ʺTranscriber.Instance.Transcribe(value._ʺx6Dx6Fx64ʺ_1, builder);
