...
{
    public sealed class _OPEN_parameterNames_CLOSETranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Inners._OPEN_parameterNames_CLOSE>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Inners._OPEN_parameterNames_CLOSE value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._OPENTranscriber.Instance.Transcribe(value._OPEN_1, builder);
__GeneratedOdataV2.Trancsribers.Rules._parameterNamesTranscriber.Instance.Transcribe(value._parameterNames_1, builder);
