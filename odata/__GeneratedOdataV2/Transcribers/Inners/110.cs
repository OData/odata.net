...
{
    public sealed class _OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSETranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Inners._OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Inners._OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._OPENTranscriber.Instance.Transcribe(value._OPEN_1, builder);
__GeneratedOdataV2.Trancsribers.Rules._expandRefOptionTranscriber.Instance.Transcribe(value._expandRefOption_1, builder);
