...
{
    public sealed class _OPEN_selectOptionPC_ЖⲤSEMI_selectOptionPCↃ_CLOSETranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV2.CstNodes.Inners._OPEN_selectOptionPC_ЖⲤSEMI_selectOptionPCↃ_CLOSE>
    {
        ...
        public void Transcribe(__GeneratedOdataV2.CstNodes.Inners._OPEN_selectOptionPC_ЖⲤSEMI_selectOptionPCↃ_CLOSE value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV2.Trancsribers.Rules._OPENTranscriber.Instance.Transcribe(value._OPEN_1, builder);
__GeneratedOdataV2.Trancsribers.Rules._selectOptionPCTranscriber.Instance.Transcribe(value._selectOptionPC_1, builder);
