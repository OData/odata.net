namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _primitiveKeyPropertyⳆkeyPropertyAlias
    {
        ...
        {
            public _primitiveKeyProperty(__GeneratedOdataV2.CstNodes.Rules._primitiveKeyProperty _primitiveKeyProperty_1)
            {
                this._primitiveKeyProperty_1 = _primitiveKeyProperty_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitiveKeyProperty _primitiveKeyProperty_1 { get; }
        ...
        {
            public _keyPropertyAlias(__GeneratedOdataV2.CstNodes.Rules._keyPropertyAlias _keyPropertyAlias_1)
            {
                this._keyPropertyAlias_1 = _keyPropertyAlias_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._keyPropertyAlias _keyPropertyAlias_1 { get; }
