...
{
    public sealed class HelperRangedFrom1To19<T> : System.Collections.Generic.IEnumerable<T>
    {
        public HelperRangedFrom1To19(System.Collections.Generic.IEnumerable<T> source)
        {
            this.Source = source;
        }
