namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _qualifiedEntityTypeNameⳆqualifiedComplexTypeName
    {
        ...
        {
            public _qualifiedEntityTypeName(__GeneratedOdataV2.CstNodes.Rules._qualifiedEntityTypeName _qualifiedEntityTypeName_1)
            {
        ...
        {
            public _qualifiedComplexTypeName(__GeneratedOdataV2.CstNodes.Rules._qualifiedComplexTypeName _qualifiedComplexTypeName_1)
            {
                this._qualifiedComplexTypeName_1 = _qualifiedComplexTypeName_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._qualifiedComplexTypeName _qualifiedComplexTypeName_1 { get; }
