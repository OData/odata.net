namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _complexInUriⳆcomplexColInUriⳆprimitiveLiteralInJSONⳆprimitiveColInUri
    {
        ...
        {
            public _complexInUri(__GeneratedOdataV2.CstNodes.Rules._complexInUri _complexInUri_1)
            {
                this._complexInUri_1 = _complexInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._complexInUri _complexInUri_1 { get; }
        ...
        {
            public _complexColInUri(__GeneratedOdataV2.CstNodes.Rules._complexColInUri _complexColInUri_1)
            {
        ...
        {
            public _primitiveLiteralInJSON(__GeneratedOdataV2.CstNodes.Rules._primitiveLiteralInJSON _primitiveLiteralInJSON_1)
            {
                this._primitiveLiteralInJSON_1 = _primitiveLiteralInJSON_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitiveLiteralInJSON _primitiveLiteralInJSON_1 { get; }
        ...
        {
            public _primitiveColInUri(__GeneratedOdataV2.CstNodes.Rules._primitiveColInUri _primitiveColInUri_1)
            {
                this._primitiveColInUri_1 = _primitiveColInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitiveColInUri _primitiveColInUri_1 { get; }
