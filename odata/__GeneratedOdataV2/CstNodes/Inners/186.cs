namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _OPEN_BWS_searchExpr_BWS_CLOSEⳆsearchTerm
    {
        ...
        {
            public _OPEN_BWS_searchExpr_BWS_CLOSE(__GeneratedOdataV2.CstNodes.Rules._OPEN _OPEN_1, __GeneratedOdataV2.CstNodes.Rules._BWS _BWS_1, __GeneratedOdataV2.CstNodes.Rules._searchExpr _searchExpr_1, __GeneratedOdataV2.CstNodes.Rules._BWS _BWS_2, __GeneratedOdataV2.CstNodes.Rules._CLOSE _CLOSE_1)
            {
        ...
        {
            public _searchTerm(__GeneratedOdataV2.CstNodes.Rules._searchTerm _searchTerm_1)
            {
                this._searchTerm_1 = _searchTerm_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._searchTerm _searchTerm_1 { get; }
