namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _ʺx41ʺⳆʺx51ʺⳆʺx67ʺⳆʺx77ʺ
    {
        ...
        public sealed class _ʺx41ʺ : _ʺx41ʺⳆʺx51ʺⳆʺx67ʺⳆʺx77ʺ
        {
            private _ʺx41ʺ()
            {
                this._ʺx41ʺ_1 = __GeneratedOdataV2.CstNodes.Inners._ʺx41ʺ.Instance;
            }
            
            public __GeneratedOdataV2.CstNodes.Inners._ʺx41ʺ _ʺx41ʺ_1 { get; }
        ...
        public sealed class _ʺx51ʺ : _ʺx41ʺⳆʺx51ʺⳆʺx67ʺⳆʺx77ʺ
        {
            private _ʺx51ʺ()
            {
                this._ʺx51ʺ_1 = __GeneratedOdataV2.CstNodes.Inners._ʺx51ʺ.Instance;
            }
            
            public __GeneratedOdataV2.CstNodes.Inners._ʺx51ʺ _ʺx51ʺ_1 { get; }
            public static _ʺx51ʺ Instance { get; } = new _ʺx51ʺ();
        ...
        public sealed class _ʺx67ʺ : _ʺx41ʺⳆʺx51ʺⳆʺx67ʺⳆʺx77ʺ
        {
            private _ʺx67ʺ()
            {
                this._ʺx67ʺ_1 = __GeneratedOdataV2.CstNodes.Inners._ʺx67ʺ.Instance;
            }
            
            public __GeneratedOdataV2.CstNodes.Inners._ʺx67ʺ _ʺx67ʺ_1 { get; }
            public static _ʺx67ʺ Instance { get; } = new _ʺx67ʺ();
        ...
        public sealed class _ʺx77ʺ : _ʺx41ʺⳆʺx51ʺⳆʺx67ʺⳆʺx77ʺ
        {
            private _ʺx77ʺ()
            {
                this._ʺx77ʺ_1 = __GeneratedOdataV2.CstNodes.Inners._ʺx77ʺ.Instance;
            }
            
            public __GeneratedOdataV2.CstNodes.Inners._ʺx77ʺ _ʺx77ʺ_1 { get; }
            public static _ʺx77ʺ Instance { get; } = new _ʺx77ʺ();
