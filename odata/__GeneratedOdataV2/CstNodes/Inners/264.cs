namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _entitySetName_keyPredicateⳆsingletonEntity
    {
        ...
        {
            public _entitySetName_keyPredicate(__GeneratedOdataV2.CstNodes.Rules._entitySetName _entitySetName_1, __GeneratedOdataV2.CstNodes.Rules._keyPredicate _keyPredicate_1)
            {
        ...
        {
            public _singletonEntity(__GeneratedOdataV2.CstNodes.Rules._singletonEntity _singletonEntity_1)
            {
