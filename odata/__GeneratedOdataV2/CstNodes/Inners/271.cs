namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _collectionPathExprⳆsingleNavigationExprⳆcomplexPathExprⳆprimitivePathExpr
    {
        ...
        {
            public _singleNavigationExpr(__GeneratedOdataV2.CstNodes.Rules._singleNavigationExpr _singleNavigationExpr_1)
            {
        ...
        {
            public _complexPathExpr(__GeneratedOdataV2.CstNodes.Rules._complexPathExpr _complexPathExpr_1)
            {
                this._complexPathExpr_1 = _complexPathExpr_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._complexPathExpr _complexPathExpr_1 { get; }
        ...
        {
            public _primitivePathExpr(__GeneratedOdataV2.CstNodes.Rules._primitivePathExpr _primitivePathExpr_1)
            {
                this._primitivePathExpr_1 = _primitivePathExpr_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitivePathExpr _primitivePathExpr_1 { get; }
