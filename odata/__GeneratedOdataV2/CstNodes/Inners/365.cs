namespace __GeneratedOdataV2.CstNodes.Inners
{
    ...
    {
        public _valueⲻseparator_rootExpr(__GeneratedOdataV2.CstNodes.Rules._valueⲻseparator _valueⲻseparator_1, __GeneratedOdataV2.CstNodes.Rules._rootExpr _rootExpr_1)
        {
