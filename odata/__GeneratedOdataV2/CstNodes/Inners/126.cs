namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _STARⳆstreamPropertyⳆnavigationProperty_꘡ʺx2Fʺ_qualifiedEntityTypeName꘡
    {
        ...
        {
            public _streamProperty(__GeneratedOdataV2.CstNodes.Rules._streamProperty _streamProperty_1)
            {
        ...
        {
            public _navigationProperty_꘡ʺx2Fʺ_qualifiedEntityTypeName꘡(__GeneratedOdataV2.CstNodes.Rules._navigationProperty _navigationProperty_1, __GeneratedOdataV2.CstNodes.Inners._ʺx2Fʺ_qualifiedEntityTypeName? _ʺx2Fʺ_qualifiedEntityTypeName_1)
            {
