namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _pcharⳆʺx2FʺⳆʺx3Fʺ
    {
        ...
        {
            public _pchar(__GeneratedOdataV2.CstNodes.Rules._pchar _pchar_1)
            {
                this._pchar_1 = _pchar_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._pchar _pchar_1 { get; }
        ...
        {
            public _ʺx3Fʺ(__GeneratedOdataV2.CstNodes.Inners._ʺx3Fʺ _ʺx3Fʺ_1)
            {
