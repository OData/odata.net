namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _propertyPathExprⳆboundFunctionExprⳆannotationExpr
    {
        ...
        {
            public _propertyPathExpr(__GeneratedOdataV2.CstNodes.Rules._propertyPathExpr _propertyPathExpr_1)
            {
        ...
        {
            public _boundFunctionExpr(__GeneratedOdataV2.CstNodes.Rules._boundFunctionExpr _boundFunctionExpr_1)
            {
        ...
        {
            public _annotationExpr(__GeneratedOdataV2.CstNodes.Rules._annotationExpr _annotationExpr_1)
            {
