namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _annotationInUriⳆprimitivePropertyInUriⳆcomplexPropertyInUriⳆcollectionPropertyInUriⳆnavigationPropertyInUri
    {
        ...
        {
            public _annotationInUri(__GeneratedOdataV2.CstNodes.Rules._annotationInUri _annotationInUri_1)
            {
                this._annotationInUri_1 = _annotationInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._annotationInUri _annotationInUri_1 { get; }
        ...
        {
            public _primitivePropertyInUri(__GeneratedOdataV2.CstNodes.Rules._primitivePropertyInUri _primitivePropertyInUri_1)
            {
                this._primitivePropertyInUri_1 = _primitivePropertyInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitivePropertyInUri _primitivePropertyInUri_1 { get; }
        ...
        {
            public _complexPropertyInUri(__GeneratedOdataV2.CstNodes.Rules._complexPropertyInUri _complexPropertyInUri_1)
            {
                this._complexPropertyInUri_1 = _complexPropertyInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._complexPropertyInUri _complexPropertyInUri_1 { get; }
        ...
        {
            public _collectionPropertyInUri(__GeneratedOdataV2.CstNodes.Rules._collectionPropertyInUri _collectionPropertyInUri_1)
            {
                this._collectionPropertyInUri_1 = _collectionPropertyInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._collectionPropertyInUri _collectionPropertyInUri_1 { get; }
        ...
        {
            public _navigationPropertyInUri(__GeneratedOdataV2.CstNodes.Rules._navigationPropertyInUri _navigationPropertyInUri_1)
            {
                this._navigationPropertyInUri_1 = _navigationPropertyInUri_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._navigationPropertyInUri _navigationPropertyInUri_1 { get; }
