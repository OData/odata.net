namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _parameterAliasⳆkeyPropertyValue
    {
        ...
        {
            public _keyPropertyValue(__GeneratedOdataV2.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1)
            {
                this._keyPropertyValue_1 = _keyPropertyValue_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1 { get; }
