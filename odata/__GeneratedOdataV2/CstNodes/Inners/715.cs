namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _VCHARⳆobsⲻtext
    {
        ...
        {
            public _VCHAR(__GeneratedOdataV2.CstNodes.Rules._VCHAR _VCHAR_1)
            {
                this._VCHAR_1 = _VCHAR_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._VCHAR _VCHAR_1 { get; }
        ...
        {
            public _obsⲻtext(__GeneratedOdataV2.CstNodes.Rules._obsⲻtext _obsⲻtext_1)
            {
                this._obsⲻtext_1 = _obsⲻtext_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._obsⲻtext _obsⲻtext_1 { get; }
