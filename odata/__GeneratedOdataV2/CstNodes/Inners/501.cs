...
{
    public sealed class HelperRangedFrom1To5<T> : System.Collections.Generic.IEnumerable<T>
    {
        public HelperRangedFrom1To5(System.Collections.Generic.IEnumerable<T> source)
        {
            this.Source = source;
        }
