namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _searchPhraseⳆsearchWord
    {
        ...
        {
            public _searchPhrase(__GeneratedOdataV2.CstNodes.Rules._searchPhrase _searchPhrase_1)
            {
                this._searchPhrase_1 = _searchPhrase_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._searchPhrase _searchPhrase_1 { get; }
        ...
        {
            public _searchWord(__GeneratedOdataV2.CstNodes.Rules._searchWord _searchWord_1)
            {
                this._searchWord_1 = _searchWord_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._searchWord _searchWord_1 { get; }
