namespace __GeneratedOdataV2.CstNodes.Inners
{
    public abstract class _ʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minute
    {
        ...
        {
            public _SIGN_hour_ʺx3Aʺ_minute(__GeneratedOdataV2.CstNodes.Rules._SIGN _SIGN_1, __GeneratedOdataV2.CstNodes.Rules._hour _hour_1, __GeneratedOdataV2.CstNodes.Inners._ʺx3Aʺ _ʺx3Aʺ_1, __GeneratedOdataV2.CstNodes.Rules._minute _minute_1)
            {
