namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _primitiveValue
    {
        ...
        {
            public _durationValue(__GeneratedOdataV2.CstNodes.Rules._durationValue _durationValue_1)
            {
                this._durationValue_1 = _durationValue_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._durationValue _durationValue_1 { get; }
        ...
        {
            public _enumValue(__GeneratedOdataV2.CstNodes.Rules._enumValue _enumValue_1)
            {
                this._enumValue_1 = _enumValue_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._enumValue _enumValue_1 { get; }
        ...
        {
            public _fullCollectionLiteral(__GeneratedOdataV2.CstNodes.Rules._fullCollectionLiteral _fullCollectionLiteral_1)
            {
        ...
        {
            public _fullLineStringLiteral(__GeneratedOdataV2.CstNodes.Rules._fullLineStringLiteral _fullLineStringLiteral_1)
            {
        ...
        {
            public _fullMultiPointLiteral(__GeneratedOdataV2.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1)
            {
                this._fullMultiPointLiteral_1 = _fullMultiPointLiteral_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1 { get; }
        ...
        {
            public _fullMultiLineStringLiteral(__GeneratedOdataV2.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1)
            {
                this._fullMultiLineStringLiteral_1 = _fullMultiLineStringLiteral_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1 { get; }
        ...
        {
            public _fullMultiPolygonLiteral(__GeneratedOdataV2.CstNodes.Rules._fullMultiPolygonLiteral _fullMultiPolygonLiteral_1)
            {
        ...
        {
            public _fullPointLiteral(__GeneratedOdataV2.CstNodes.Rules._fullPointLiteral _fullPointLiteral_1)
            {
        ...
        {
            public _fullPolygonLiteral(__GeneratedOdataV2.CstNodes.Rules._fullPolygonLiteral _fullPolygonLiteral_1)
            {
                this._fullPolygonLiteral_1 = _fullPolygonLiteral_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._fullPolygonLiteral _fullPolygonLiteral_1 { get; }
        ...
        {
            public _binaryValue(__GeneratedOdataV2.CstNodes.Rules._binaryValue _binaryValue_1)
            {
                this._binaryValue_1 = _binaryValue_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._binaryValue _binaryValue_1 { get; }
