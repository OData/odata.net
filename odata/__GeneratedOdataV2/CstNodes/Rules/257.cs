namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _function
    {
        ...
        {
            public _entityFunction(__GeneratedOdataV2.CstNodes.Rules._entityFunction _entityFunction_1)
            {
        ...
        {
            public _entityColFunction(__GeneratedOdataV2.CstNodes.Rules._entityColFunction _entityColFunction_1)
            {
        ...
        {
            public _complexFunction(__GeneratedOdataV2.CstNodes.Rules._complexFunction _complexFunction_1)
            {
        ...
        {
            public _complexColFunction(__GeneratedOdataV2.CstNodes.Rules._complexColFunction _complexColFunction_1)
            {
        ...
        {
            public _primitiveFunction(__GeneratedOdataV2.CstNodes.Rules._primitiveFunction _primitiveFunction_1)
            {
        ...
        {
            public _primitiveColFunction(__GeneratedOdataV2.CstNodes.Rules._primitiveColFunction _primitiveColFunction_1)
            {
