namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _primitiveProperty
    {
        ...
        {
            public _primitiveNonKeyProperty(__GeneratedOdataV2.CstNodes.Rules._primitiveNonKeyProperty _primitiveNonKeyProperty_1)
            {
                this._primitiveNonKeyProperty_1 = _primitiveNonKeyProperty_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._primitiveNonKeyProperty _primitiveNonKeyProperty_1 { get; }
