namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _selectOption
    {
        ...
        {
            public _selectOptionPC(__GeneratedOdataV2.CstNodes.Rules._selectOptionPC _selectOptionPC_1)
            {
                this._selectOptionPC_1 = _selectOptionPC_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._selectOptionPC _selectOptionPC_1 { get; }
