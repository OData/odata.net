namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _primitiveLiteralInJSON
    {
        ...
        {
            public _stringInJSON(__GeneratedOdataV2.CstNodes.Rules._stringInJSON _stringInJSON_1)
            {
                this._stringInJSON_1 = _stringInJSON_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._stringInJSON _stringInJSON_1 { get; }
        ...
        {
            public _numberInJSON(__GeneratedOdataV2.CstNodes.Rules._numberInJSON _numberInJSON_1)
            {
                this._numberInJSON_1 = _numberInJSON_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._numberInJSON _numberInJSON_1 { get; }
        ...
        {
            public _ʺx6Ex75x6Cx6Cʺ(__GeneratedOdataV2.CstNodes.Inners._ʺx6Ex75x6Cx6Cʺ _ʺx6Ex75x6Cx6Cʺ_1)
            {
                this._ʺx6Ex75x6Cx6Cʺ_1 = _ʺx6Ex75x6Cx6Cʺ_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Inners._ʺx6Ex75x6Cx6Cʺ _ʺx6Ex75x6Cx6Cʺ_1 { get; }
