namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _inscopeVariableExpr
    {
        ...
        {
            public _implicitVariableExpr(__GeneratedOdataV2.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1)
            {
                this._implicitVariableExpr_1 = _implicitVariableExpr_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1 { get; }
        ...
        {
            public _parameterAlias(__GeneratedOdataV2.CstNodes.Rules._parameterAlias _parameterAlias_1)
            {
        ...
        {
            public _lambdaVariableExpr(__GeneratedOdataV2.CstNodes.Rules._lambdaVariableExpr _lambdaVariableExpr_1)
            {
