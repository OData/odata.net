namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _firstMemberExpr
    {
        ...
        {
            public _memberExpr(__GeneratedOdataV2.CstNodes.Rules._memberExpr _memberExpr_1)
            {
                this._memberExpr_1 = _memberExpr_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._memberExpr _memberExpr_1 { get; }
        ...
        {
            public _inscopeVariableExpr_꘡ʺx2Fʺ_memberExpr꘡(__GeneratedOdataV2.CstNodes.Rules._inscopeVariableExpr _inscopeVariableExpr_1, __GeneratedOdataV2.CstNodes.Inners._ʺx2Fʺ_memberExpr? _ʺx2Fʺ_memberExpr_1)
            {
                this._inscopeVariableExpr_1 = _inscopeVariableExpr_1;
                this._ʺx2Fʺ_memberExpr_1 = _ʺx2Fʺ_memberExpr_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._inscopeVariableExpr _inscopeVariableExpr_1 { get; }
            public __GeneratedOdataV2.CstNodes.Inners._ʺx2Fʺ_memberExpr? _ʺx2Fʺ_memberExpr_1 { get; }
