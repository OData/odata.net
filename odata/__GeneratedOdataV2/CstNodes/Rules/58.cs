namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _entityCastOption
    {
        ...
        {
            public _entityIdOption(__GeneratedOdataV2.CstNodes.Rules._entityIdOption _entityIdOption_1)
            {
                this._entityIdOption_1 = _entityIdOption_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._entityIdOption _entityIdOption_1 { get; }
