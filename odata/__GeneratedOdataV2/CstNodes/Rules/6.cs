namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _collectionNavPath
    {
        ...
        {
            public _keyPredicate_꘡singleNavigation꘡(__GeneratedOdataV2.CstNodes.Rules._keyPredicate _keyPredicate_1, __GeneratedOdataV2.CstNodes.Rules._singleNavigation? _singleNavigation_1)
            {
        ...
        {
            public _filterInPath_꘡collectionNavigation꘡(__GeneratedOdataV2.CstNodes.Rules._filterInPath _filterInPath_1, __GeneratedOdataV2.CstNodes.Rules._collectionNavigation? _collectionNavigation_1)
            {
                this._filterInPath_1 = _filterInPath_1;
                this._collectionNavigation_1 = _collectionNavigation_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._filterInPath _filterInPath_1 { get; }
        ...
        {
            public _each_꘡boundOperation꘡(__GeneratedOdataV2.CstNodes.Rules._each _each_1, __GeneratedOdataV2.CstNodes.Rules._boundOperation? _boundOperation_1)
            {
                this._each_1 = _each_1;
                this._boundOperation_1 = _boundOperation_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._each _each_1 { get; }
        ...
        public sealed class _count : _collectionNavPath
        {
            private _count()
            {
                this._count_1 = __GeneratedOdataV2.CstNodes.Rules._count.Instance;
            }
