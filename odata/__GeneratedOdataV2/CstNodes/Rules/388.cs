namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _host
    {
        ...
        {
            public _IPⲻliteral(__GeneratedOdataV2.CstNodes.Rules._IPⲻliteral _IPⲻliteral_1)
            {
                this._IPⲻliteral_1 = _IPⲻliteral_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._IPⲻliteral _IPⲻliteral_1 { get; }
        ...
        {
            public _regⲻname(__GeneratedOdataV2.CstNodes.Rules._regⲻname _regⲻname_1)
            {
                this._regⲻname_1 = _regⲻname_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._regⲻname _regⲻname_1 { get; }
