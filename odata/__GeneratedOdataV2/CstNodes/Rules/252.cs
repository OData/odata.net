namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _navigationProperty
    {
        ...
        {
            public _entityNavigationProperty(__GeneratedOdataV2.CstNodes.Rules._entityNavigationProperty _entityNavigationProperty_1)
            {
        ...
        {
            public _entityColNavigationProperty(__GeneratedOdataV2.CstNodes.Rules._entityColNavigationProperty _entityColNavigationProperty_1)
            {
