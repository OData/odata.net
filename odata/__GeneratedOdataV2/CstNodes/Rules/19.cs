namespace __GeneratedOdataV2.CstNodes.Rules
{
    public abstract class _complexColPath
    {
        ...
        {
            public _ordinalIndex(__GeneratedOdataV2.CstNodes.Rules._ordinalIndex _ordinalIndex_1)
            {
                this._ordinalIndex_1 = _ordinalIndex_1;
            }
            
            public __GeneratedOdataV2.CstNodes.Rules._ordinalIndex _ordinalIndex_1 { get; }
        ...
        {
            public _꘡ʺx2Fʺ_qualifiedComplexTypeName꘡_꘡countⳆboundOperation꘡(__GeneratedOdataV2.CstNodes.Inners._ʺx2Fʺ_qualifiedComplexTypeName? _ʺx2Fʺ_qualifiedComplexTypeName_1, __GeneratedOdataV2.CstNodes.Inners._countⳆboundOperation? _countⳆboundOperation_1)
            {
            ...
            public __GeneratedOdataV2.CstNodes.Inners._countⳆboundOperation? _countⳆboundOperation_1 { get; }
