namespace __GeneratedOdataV2.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV2.CstNodes.Inners._pcharⳆʺx2FʺⳆʺx3Fʺ> Instance { get; } = (_pcharParser.Instance).Or<char, __GeneratedOdataV2.CstNodes.Inners._pcharⳆʺx2FʺⳆʺx3Fʺ>(_ʺx2FʺParser.Instance).Or<char, __GeneratedOdataV2.CstNodes.Inners._pcharⳆʺx2FʺⳆʺx3Fʺ>(_ʺx3FʺParser.Instance);
        
        public static class _pcharParser
        {
            public static IParser<char, __GeneratedOdataV2.CstNodes.Inners._pcharⳆʺx2FʺⳆʺx3Fʺ._pchar> Instance { get; } = from _pchar_1 in __GeneratedOdataV2.Parsers.Rules._pcharParser.Instance
select new __GeneratedOdataV2.CstNodes.Inners._pcharⳆʺx2FʺⳆʺx3Fʺ._pchar(_pchar_1);
        }
