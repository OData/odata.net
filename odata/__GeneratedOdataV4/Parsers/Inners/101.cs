namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx65x78x70x61x6Ex64ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx65x78x70x61x6Ex64ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx65x78x70x61x6Ex64ʺ> Parse(IInput<char>? input)
            {
                var _x65_1 = __GeneratedOdataV4.Parsers.Inners._x65Parser.Instance.Parse(input);
if (!_x65_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx65x78x70x61x6Ex64ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx65x78x70x61x6Ex64ʺ.Instance, _x64_1.Remainder);
            }
        }
    }
