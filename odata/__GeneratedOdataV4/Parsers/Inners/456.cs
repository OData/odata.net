namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx6Cx79x67x6Fx6Eʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx6Cx79x67x6Fx6Eʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx6Cx79x67x6Fx6Eʺ> Parse(IInput<char>? input)
            {
                var _x4D_1 = __GeneratedOdataV4.Parsers.Inners._x4DParser.Instance.Parse(input);
if (!_x4D_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx6Cx79x67x6Fx6Eʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx6Cx79x67x6Fx6Eʺ.Instance, _x6E_1.Remainder);
            }
        }
    }
