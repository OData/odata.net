namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ> Parse(IInput<char>? input)
            {
                var _x44_1 = __GeneratedOdataV4.Parsers.Inners._x44Parser.Instance.Parse(input);
if (!_x44_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ)!, input);
}

var _x75_1 = __GeneratedOdataV4.Parsers.Inners._x75Parser.Instance.Parse(_x44_1.Remainder);
if (!_x75_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx44x75x72x61x74x69x6Fx6Eʺ.Instance, _x6E_1.Remainder);
            }
        }
    }
