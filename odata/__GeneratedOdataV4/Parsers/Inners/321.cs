namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x74ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x74ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x74ʺ> Parse(IInput<char>? input)
            {
                var _x68_1 = __GeneratedOdataV4.Parsers.Inners._x68Parser.Instance.Parse(input);
if (!_x68_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x74ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x74ʺ.Instance, _x74_1.Remainder);
            }
        }
    }
