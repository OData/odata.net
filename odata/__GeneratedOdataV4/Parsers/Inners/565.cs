namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ> Parse(IInput<char>? input)
            {
                var _x4F_1 = __GeneratedOdataV4.Parsers.Inners._x4FParser.Instance.Parse(input);
if (!_x4F_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ)!, input);
}
...
var _x56_1 = __GeneratedOdataV4.Parsers.Inners._x56Parser.Instance.Parse(_x2D_1.Remainder);
if (!_x56_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx4Fx44x61x74x61x2Dx56x65x72x73x69x6Fx6Eʺ.Instance, _x6E_1.Remainder);
            }
        }
    }
