namespace __GeneratedOdataV4.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx69x6Ex74ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx69x6Ex74ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx69x6Ex74ʺ> Parse(IInput<char>? input)
            {
                var _x4D_1 = __GeneratedOdataV4.Parsers.Inners._x4DParser.Instance.Parse(input);
if (!_x4D_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx69x6Ex74ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV4.CstNodes.Inners._ʺx4Dx75x6Cx74x69x50x6Fx69x6Ex74ʺ.Instance, _x74_2.Remainder);
            }
        }
    }
