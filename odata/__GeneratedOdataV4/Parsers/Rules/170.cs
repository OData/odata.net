namespace __GeneratedOdataV4.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV4.CstNodes.Rules._intersectsMethodCallExpr> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV4.CstNodes.Rules._intersectsMethodCallExpr>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV4.CstNodes.Rules._intersectsMethodCallExpr> Parse(IInput<char>? input)
            {
                var _ʺx67x65x6Fx2Ex69x6Ex74x65x72x73x65x63x74x73ʺ_1 = __GeneratedOdataV4.Parsers.Inners._ʺx67x65x6Fx2Ex69x6Ex74x65x72x73x65x63x74x73ʺParser.Instance.Parse(input);
if (!_ʺx67x65x6Fx2Ex69x6Ex74x65x72x73x65x63x74x73ʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Rules._intersectsMethodCallExpr)!, input);
}

var _OPEN_1 = __GeneratedOdataV4.Parsers.Rules._OPENParser.Instance.Parse(_ʺx67x65x6Fx2Ex69x6Ex74x65x72x73x65x63x74x73ʺ_1.Remainder);
if (!_OPEN_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV4.CstNodes.Rules._intersectsMethodCallExpr)!, input);
}
