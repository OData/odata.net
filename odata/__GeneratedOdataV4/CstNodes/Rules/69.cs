namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _expandOption
    {
        ...
        {
            public _expandRefOption(__GeneratedOdataV4.CstNodes.Rules._expandRefOption _expandRefOption_1)
            {
        ...
        {
            public _levels(__GeneratedOdataV4.CstNodes.Rules._levels _levels_1)
            {
                this._levels_1 = _levels_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._levels _levels_1 { get; }
