namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _singleQualifiedTypeName
    {
        ...
        {
            public _qualifiedTypeDefinitionName(__GeneratedOdataV4.CstNodes.Rules._qualifiedTypeDefinitionName _qualifiedTypeDefinitionName_1)
            {
                this._qualifiedTypeDefinitionName_1 = _qualifiedTypeDefinitionName_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._qualifiedTypeDefinitionName _qualifiedTypeDefinitionName_1 { get; }
        ...
        {
            public _qualifiedEnumTypeName(__GeneratedOdataV4.CstNodes.Rules._qualifiedEnumTypeName _qualifiedEnumTypeName_1)
            {
                this._qualifiedEnumTypeName_1 = _qualifiedEnumTypeName_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._qualifiedEnumTypeName _qualifiedEnumTypeName_1 { get; }
        ...
        {
            public _primitiveTypeName(__GeneratedOdataV4.CstNodes.Rules._primitiveTypeName _primitiveTypeName_1)
            {
                this._primitiveTypeName_1 = _primitiveTypeName_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._primitiveTypeName _primitiveTypeName_1 { get; }
