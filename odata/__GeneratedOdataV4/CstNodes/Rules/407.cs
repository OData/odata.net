namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _unreserved
    {
        ...
        public sealed class _ʺx2Eʺ : _unreserved
        {
            private _ʺx2Eʺ()
            {
                this._ʺx2Eʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx2Eʺ.Instance;
            }
        ...
        public sealed class _ʺx7Eʺ : _unreserved
        {
            private _ʺx7Eʺ()
            {
                this._ʺx7Eʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx7Eʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx7Eʺ _ʺx7Eʺ_1 { get; }
