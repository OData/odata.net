namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _propertyPath
    {
        ...
        {
            public _entityColNavigationProperty_꘡collectionNavigation꘡(__GeneratedOdataV4.CstNodes.Rules._entityColNavigationProperty _entityColNavigationProperty_1, __GeneratedOdataV4.CstNodes.Rules._collectionNavigation? _collectionNavigation_1)
            {
        ...
        {
            public _entityNavigationProperty_꘡singleNavigation꘡(__GeneratedOdataV4.CstNodes.Rules._entityNavigationProperty _entityNavigationProperty_1, __GeneratedOdataV4.CstNodes.Rules._singleNavigation? _singleNavigation_1)
            {
        ...
        {
            public _complexColProperty_꘡complexColPath꘡(__GeneratedOdataV4.CstNodes.Rules._complexColProperty _complexColProperty_1, __GeneratedOdataV4.CstNodes.Rules._complexColPath? _complexColPath_1)
            {
        ...
        {
            public _complexProperty_꘡complexPath꘡(__GeneratedOdataV4.CstNodes.Rules._complexProperty _complexProperty_1, __GeneratedOdataV4.CstNodes.Rules._complexPath? _complexPath_1)
            {
        ...
        {
            public _primitiveColProperty_꘡primitiveColPath꘡(__GeneratedOdataV4.CstNodes.Rules._primitiveColProperty _primitiveColProperty_1, __GeneratedOdataV4.CstNodes.Rules._primitiveColPath? _primitiveColPath_1)
            {
        ...
        {
            public _primitiveProperty_꘡primitivePath꘡(__GeneratedOdataV4.CstNodes.Rules._primitiveProperty _primitiveProperty_1, __GeneratedOdataV4.CstNodes.Rules._primitivePath? _primitivePath_1)
            {
        ...
        {
            public _streamProperty_꘡boundOperation꘡(__GeneratedOdataV4.CstNodes.Rules._streamProperty _streamProperty_1, __GeneratedOdataV4.CstNodes.Rules._boundOperation? _boundOperation_1)
            {
