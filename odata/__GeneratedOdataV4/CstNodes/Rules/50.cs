namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _queryOption
    {
        ...
        {
            public _systemQueryOption(__GeneratedOdataV4.CstNodes.Rules._systemQueryOption _systemQueryOption_1)
            {
                this._systemQueryOption_1 = _systemQueryOption_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._systemQueryOption _systemQueryOption_1 { get; }
        ...
        {
            public _aliasAndValue(__GeneratedOdataV4.CstNodes.Rules._aliasAndValue _aliasAndValue_1)
            {
                this._aliasAndValue_1 = _aliasAndValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._aliasAndValue _aliasAndValue_1 { get; }
        ...
        {
            public _nameAndValue(__GeneratedOdataV4.CstNodes.Rules._nameAndValue _nameAndValue_1)
            {
                this._nameAndValue_1 = _nameAndValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._nameAndValue _nameAndValue_1 { get; }
        ...
        {
            public _customQueryOption(__GeneratedOdataV4.CstNodes.Rules._customQueryOption _customQueryOption_1)
            {
                this._customQueryOption_1 = _customQueryOption_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._customQueryOption _customQueryOption_1 { get; }
