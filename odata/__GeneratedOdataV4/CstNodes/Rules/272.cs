...
{
    public sealed class _nullValue
    {
        private _nullValue()
        {
        ...
        public static __GeneratedOdataV4.CstNodes.Rules._nullValue Instance { get; } = new __GeneratedOdataV4.CstNodes.Rules._nullValue();
    }
