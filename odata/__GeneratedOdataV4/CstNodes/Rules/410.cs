namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _pcharⲻnoⲻSQUOTE
    {
        ...
        {
            public _pctⲻencodedⲻnoⲻSQUOTE(__GeneratedOdataV4.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1)
            {
                this._pctⲻencodedⲻnoⲻSQUOTE_1 = _pctⲻencodedⲻnoⲻSQUOTE_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1 { get; }
