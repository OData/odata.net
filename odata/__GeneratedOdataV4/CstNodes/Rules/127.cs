...
{
    public sealed class _singleNavigationExpr
    {
        public _singleNavigationExpr(__GeneratedOdataV4.CstNodes.Inners._ʺx2Fʺ _ʺx2Fʺ_1, __GeneratedOdataV4.CstNodes.Rules._memberExpr _memberExpr_1)
        {
