namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _geoLiteral
    {
        ...
        {
            public _collectionLiteral(__GeneratedOdataV4.CstNodes.Rules._collectionLiteral _collectionLiteral_1)
            {
                this._collectionLiteral_1 = _collectionLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._collectionLiteral _collectionLiteral_1 { get; }
        ...
        {
            public _lineStringLiteral(__GeneratedOdataV4.CstNodes.Rules._lineStringLiteral _lineStringLiteral_1)
            {
                this._lineStringLiteral_1 = _lineStringLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._lineStringLiteral _lineStringLiteral_1 { get; }
        ...
        {
            public _multiPointLiteral(__GeneratedOdataV4.CstNodes.Rules._multiPointLiteral _multiPointLiteral_1)
            {
                this._multiPointLiteral_1 = _multiPointLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._multiPointLiteral _multiPointLiteral_1 { get; }
        ...
        {
            public _multiLineStringLiteral(__GeneratedOdataV4.CstNodes.Rules._multiLineStringLiteral _multiLineStringLiteral_1)
            {
                this._multiLineStringLiteral_1 = _multiLineStringLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._multiLineStringLiteral _multiLineStringLiteral_1 { get; }
        ...
        {
            public _multiPolygonLiteral(__GeneratedOdataV4.CstNodes.Rules._multiPolygonLiteral _multiPolygonLiteral_1)
            {
                this._multiPolygonLiteral_1 = _multiPolygonLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._multiPolygonLiteral _multiPolygonLiteral_1 { get; }
        ...
        {
            public _pointLiteral(__GeneratedOdataV4.CstNodes.Rules._pointLiteral _pointLiteral_1)
            {
                this._pointLiteral_1 = _pointLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._pointLiteral _pointLiteral_1 { get; }
        ...
        {
            public _polygonLiteral(__GeneratedOdataV4.CstNodes.Rules._polygonLiteral _polygonLiteral_1)
            {
                this._polygonLiteral_1 = _polygonLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._polygonLiteral _polygonLiteral_1 { get; }
