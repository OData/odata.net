namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _keyPredicate
    {
        ...
        {
            public _simpleKey(__GeneratedOdataV4.CstNodes.Rules._simpleKey _simpleKey_1)
            {
                this._simpleKey_1 = _simpleKey_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._simpleKey _simpleKey_1 { get; }
        ...
        {
            public _compoundKey(__GeneratedOdataV4.CstNodes.Rules._compoundKey _compoundKey_1)
            {
                this._compoundKey_1 = _compoundKey_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._compoundKey _compoundKey_1 { get; }
        ...
        {
            public _keyPathSegments(__GeneratedOdataV4.CstNodes.Rules._keyPathSegments _keyPathSegments_1)
            {
                this._keyPathSegments_1 = _keyPathSegments_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._keyPathSegments _keyPathSegments_1 { get; }
