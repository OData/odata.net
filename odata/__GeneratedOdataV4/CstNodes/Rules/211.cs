namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _quotationⲻmark
    {
        ...
        public sealed class _DQUOTE : _quotationⲻmark
        {
            private _DQUOTE()
            {
                this._DQUOTE_1 = __GeneratedOdataV4.CstNodes.Rules._DQUOTE.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._DQUOTE _DQUOTE_1 { get; }
        ...
        public sealed class _ʺx25x32x32ʺ : _quotationⲻmark
        {
            ...
            {
                this._ʺx25x32x32ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx25x32x32ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx25x32x32ʺ _ʺx25x32x32ʺ_1 { get; }
