namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _inscopeVariableExpr
    {
        ...
        {
            public _implicitVariableExpr(__GeneratedOdataV4.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1)
            {
                this._implicitVariableExpr_1 = _implicitVariableExpr_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._implicitVariableExpr _implicitVariableExpr_1 { get; }
        ...
        {
            public _lambdaVariableExpr(__GeneratedOdataV4.CstNodes.Rules._lambdaVariableExpr _lambdaVariableExpr_1)
            {
