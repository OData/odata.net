namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _qcharⲻnoⲻAMP
    {
        ...
        {
            public _otherⲻdelims(__GeneratedOdataV4.CstNodes.Rules._otherⲻdelims _otherⲻdelims_1)
            {
                this._otherⲻdelims_1 = _otherⲻdelims_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._otherⲻdelims _otherⲻdelims_1 { get; }
        ...
        public sealed class _ʺx3Fʺ : _qcharⲻnoⲻAMP
        {
            private _ʺx3Fʺ()
            {
                this._ʺx3Fʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx3Fʺ.Instance;
            }
        ...
        public sealed class _ʺx24ʺ : _qcharⲻnoⲻAMP
        {
            private _ʺx24ʺ()
            {
                this._ʺx24ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx24ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx24ʺ _ʺx24ʺ_1 { get; }
        ...
        public sealed class _ʺx27ʺ : _qcharⲻnoⲻAMP
        {
            private _ʺx27ʺ()
            {
                this._ʺx27ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx27ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx27ʺ _ʺx27ʺ_1 { get; }
        ...
        public sealed class _ʺx3Dʺ : _qcharⲻnoⲻAMP
        {
            private _ʺx3Dʺ()
            {
                this._ʺx3Dʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx3Dʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx3Dʺ _ʺx3Dʺ_1 { get; }
