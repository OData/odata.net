namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _primitiveValue
    {
        ...
        {
            public _durationValue(__GeneratedOdataV4.CstNodes.Rules._durationValue _durationValue_1)
            {
                this._durationValue_1 = _durationValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._durationValue _durationValue_1 { get; }
        ...
        {
            public _enumValue(__GeneratedOdataV4.CstNodes.Rules._enumValue _enumValue_1)
            {
                this._enumValue_1 = _enumValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._enumValue _enumValue_1 { get; }
        ...
        {
            public _fullCollectionLiteral(__GeneratedOdataV4.CstNodes.Rules._fullCollectionLiteral _fullCollectionLiteral_1)
            {
        ...
        {
            public _fullLineStringLiteral(__GeneratedOdataV4.CstNodes.Rules._fullLineStringLiteral _fullLineStringLiteral_1)
            {
        ...
        {
            public _fullMultiPointLiteral(__GeneratedOdataV4.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1)
            {
                this._fullMultiPointLiteral_1 = _fullMultiPointLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._fullMultiPointLiteral _fullMultiPointLiteral_1 { get; }
        ...
        {
            public _fullMultiLineStringLiteral(__GeneratedOdataV4.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1)
            {
                this._fullMultiLineStringLiteral_1 = _fullMultiLineStringLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._fullMultiLineStringLiteral _fullMultiLineStringLiteral_1 { get; }
        ...
        {
            public _fullMultiPolygonLiteral(__GeneratedOdataV4.CstNodes.Rules._fullMultiPolygonLiteral _fullMultiPolygonLiteral_1)
            {
        ...
        {
            public _fullPointLiteral(__GeneratedOdataV4.CstNodes.Rules._fullPointLiteral _fullPointLiteral_1)
            {
                this._fullPointLiteral_1 = _fullPointLiteral_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._fullPointLiteral _fullPointLiteral_1 { get; }
        ...
        {
            public _fullPolygonLiteral(__GeneratedOdataV4.CstNodes.Rules._fullPolygonLiteral _fullPolygonLiteral_1)
            {
        ...
        {
            public _binaryValue(__GeneratedOdataV4.CstNodes.Rules._binaryValue _binaryValue_1)
            {
