namespace __GeneratedOdataV4.CstNodes.Rules
{
    public abstract class _singleEnumValue
    {
        ...
        {
            public _enumerationMember(__GeneratedOdataV4.CstNodes.Rules._enumerationMember _enumerationMember_1)
            {
                this._enumerationMember_1 = _enumerationMember_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._enumerationMember _enumerationMember_1 { get; }
        ...
        {
            public _enumMemberValue(__GeneratedOdataV4.CstNodes.Rules._enumMemberValue _enumMemberValue_1)
            {
                this._enumMemberValue_1 = _enumMemberValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._enumMemberValue _enumMemberValue_1 { get; }
