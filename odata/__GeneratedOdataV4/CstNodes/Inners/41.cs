namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _primitiveKeyPropertyⳆkeyPropertyAlias
    {
        ...
        {
            public _keyPropertyAlias(__GeneratedOdataV4.CstNodes.Rules._keyPropertyAlias _keyPropertyAlias_1)
            {
                this._keyPropertyAlias_1 = _keyPropertyAlias_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._keyPropertyAlias _keyPropertyAlias_1 { get; }
