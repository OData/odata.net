namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _collectionPathExprⳆsingleNavigationExprⳆcomplexPathExprⳆprimitivePathExpr
    {
        ...
        {
            public _singleNavigationExpr(__GeneratedOdataV4.CstNodes.Rules._singleNavigationExpr _singleNavigationExpr_1)
            {
        ...
        {
            public _complexPathExpr(__GeneratedOdataV4.CstNodes.Rules._complexPathExpr _complexPathExpr_1)
            {
        ...
        {
            public _primitivePathExpr(__GeneratedOdataV4.CstNodes.Rules._primitivePathExpr _primitivePathExpr_1)
            {
