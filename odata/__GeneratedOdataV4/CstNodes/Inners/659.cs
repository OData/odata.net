namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _IPv6addressⳆIPvFuture
    {
        ...
        {
            public _IPv6address(__GeneratedOdataV4.CstNodes.Rules._IPv6address _IPv6address_1)
            {
                this._IPv6address_1 = _IPv6address_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._IPv6address _IPv6address_1 { get; }
        ...
        {
            public _IPvFuture(__GeneratedOdataV4.CstNodes.Rules._IPvFuture _IPvFuture_1)
            {
                this._IPvFuture_1 = _IPvFuture_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._IPvFuture _IPvFuture_1 { get; }
