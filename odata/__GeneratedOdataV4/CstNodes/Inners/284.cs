namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _parameterAliasⳆparameterValue
    {
        ...
        {
            public _parameterValue(__GeneratedOdataV4.CstNodes.Rules._parameterValue _parameterValue_1)
            {
                this._parameterValue_1 = _parameterValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._parameterValue _parameterValue_1 { get; }
