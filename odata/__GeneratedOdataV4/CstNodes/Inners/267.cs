namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _propertyPathExprⳆboundFunctionExprⳆannotationExpr
    {
        ...
        {
            public _propertyPathExpr(__GeneratedOdataV4.CstNodes.Rules._propertyPathExpr _propertyPathExpr_1)
            {
        ...
        {
            public _boundFunctionExpr(__GeneratedOdataV4.CstNodes.Rules._boundFunctionExpr _boundFunctionExpr_1)
            {
        ...
        {
            public _annotationExpr(__GeneratedOdataV4.CstNodes.Rules._annotationExpr _annotationExpr_1)
            {
