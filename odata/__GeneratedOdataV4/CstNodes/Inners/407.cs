...
{
    public sealed class HelperRangedExactly4<T> : System.Collections.Generic.IEnumerable<T>
    {
        public HelperRangedExactly4(System.Collections.Generic.IEnumerable<T> source)
        {
            this.Source = source;
        }
