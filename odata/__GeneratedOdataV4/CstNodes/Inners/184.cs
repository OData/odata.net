namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _ʺx24x73x65x61x72x63x68ʺⳆʺx73x65x61x72x63x68ʺ
    {
        ...
        public sealed class _ʺx24x73x65x61x72x63x68ʺ : _ʺx24x73x65x61x72x63x68ʺⳆʺx73x65x61x72x63x68ʺ
        {
            ...
            {
                this._ʺx24x73x65x61x72x63x68ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx24x73x65x61x72x63x68ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx24x73x65x61x72x63x68ʺ _ʺx24x73x65x61x72x63x68ʺ_1 { get; }
        ...
        public sealed class _ʺx73x65x61x72x63x68ʺ : _ʺx24x73x65x61x72x63x68ʺⳆʺx73x65x61x72x63x68ʺ
        {
            ...
            {
                this._ʺx73x65x61x72x63x68ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx73x65x61x72x63x68ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx73x65x61x72x63x68ʺ _ʺx73x65x61x72x63x68ʺ_1 { get; }
