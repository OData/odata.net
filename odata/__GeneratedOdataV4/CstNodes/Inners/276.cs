namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _keyPredicate_꘡singleNavigationExpr꘡ⳆcollectionPathExpr
    {
        ...
        {
            public _keyPredicate_꘡singleNavigationExpr꘡(__GeneratedOdataV4.CstNodes.Rules._keyPredicate _keyPredicate_1, __GeneratedOdataV4.CstNodes.Rules._singleNavigationExpr? _singleNavigationExpr_1)
            {
        ...
        {
            public _collectionPathExpr(__GeneratedOdataV4.CstNodes.Rules._collectionPathExpr _collectionPathExpr_1)
            {
