namespace __GeneratedOdataV4.CstNodes.Inners
{
    ...
    {
        public _SEMI_expandCountOption(__GeneratedOdataV4.CstNodes.Rules._SEMI _SEMI_1, __GeneratedOdataV4.CstNodes.Rules._expandCountOption _expandCountOption_1)
        {
