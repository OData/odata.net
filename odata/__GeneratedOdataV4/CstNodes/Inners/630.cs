namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _SPⳆHTABⳆʺx25x32x30ʺⳆʺx25x30x39ʺ
    {
        ...
        public sealed class _HTAB : _SPⳆHTABⳆʺx25x32x30ʺⳆʺx25x30x39ʺ
        {
            private _HTAB()
            {
                this._HTAB_1 = __GeneratedOdataV4.CstNodes.Rules._HTAB.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._HTAB _HTAB_1 { get; }
        ...
        public sealed class _ʺx25x32x30ʺ : _SPⳆHTABⳆʺx25x32x30ʺⳆʺx25x30x39ʺ
        {
            ...
            {
                this._ʺx25x32x30ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx25x32x30ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx25x32x30ʺ _ʺx25x32x30ʺ_1 { get; }
        ...
        public sealed class _ʺx25x30x39ʺ : _SPⳆHTABⳆʺx25x32x30ʺⳆʺx25x30x39ʺ
        {
            ...
            {
                this._ʺx25x30x39ʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx25x30x39ʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx25x30x39ʺ _ʺx25x30x39ʺ_1 { get; }
