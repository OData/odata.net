namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _searchOrExprⳆsearchAndExpr
    {
        ...
        {
            public _searchOrExpr(__GeneratedOdataV4.CstNodes.Rules._searchOrExpr _searchOrExpr_1)
            {
                this._searchOrExpr_1 = _searchOrExpr_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._searchOrExpr _searchOrExpr_1 { get; }
        ...
        {
            public _searchAndExpr(__GeneratedOdataV4.CstNodes.Rules._searchAndExpr _searchAndExpr_1)
            {
                this._searchAndExpr_1 = _searchAndExpr_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._searchAndExpr _searchAndExpr_1 { get; }
