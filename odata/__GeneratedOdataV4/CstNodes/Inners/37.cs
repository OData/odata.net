namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _parameterAliasⳆkeyPropertyValue
    {
        ...
        {
            public _parameterAlias(__GeneratedOdataV4.CstNodes.Rules._parameterAlias _parameterAlias_1)
            {
                this._parameterAlias_1 = _parameterAlias_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._parameterAlias _parameterAlias_1 { get; }
        ...
        {
            public _keyPropertyValue(__GeneratedOdataV4.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1)
            {
                this._keyPropertyValue_1 = _keyPropertyValue_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._keyPropertyValue _keyPropertyValue_1 { get; }
