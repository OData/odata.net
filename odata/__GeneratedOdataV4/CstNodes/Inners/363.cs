namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _complexInUriⳆcomplexColInUriⳆprimitiveLiteralInJSONⳆprimitiveColInUri
    {
        ...
        {
            public _primitiveLiteralInJSON(__GeneratedOdataV4.CstNodes.Rules._primitiveLiteralInJSON _primitiveLiteralInJSON_1)
            {
                this._primitiveLiteralInJSON_1 = _primitiveLiteralInJSON_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._primitiveLiteralInJSON _primitiveLiteralInJSON_1 { get; }
