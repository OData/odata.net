namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _ʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minute
    {
        ...
        public sealed class _ʺx5Aʺ : _ʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minute
        {
            private _ʺx5Aʺ()
            {
                this._ʺx5Aʺ_1 = __GeneratedOdataV4.CstNodes.Inners._ʺx5Aʺ.Instance;
            }
            
            public __GeneratedOdataV4.CstNodes.Inners._ʺx5Aʺ _ʺx5Aʺ_1 { get; }
        ...
        {
            public _SIGN_hour_ʺx3Aʺ_minute(__GeneratedOdataV4.CstNodes.Rules._SIGN _SIGN_1, __GeneratedOdataV4.CstNodes.Rules._hour _hour_1, __GeneratedOdataV4.CstNodes.Inners._ʺx3Aʺ _ʺx3Aʺ_1, __GeneratedOdataV4.CstNodes.Rules._minute _minute_1)
            {
