namespace __GeneratedOdataV4.CstNodes.Inners
{
    public abstract class _andExprⳆorExpr
    {
        ...
        {
            public _andExpr(__GeneratedOdataV4.CstNodes.Rules._andExpr _andExpr_1)
            {
                this._andExpr_1 = _andExpr_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._andExpr _andExpr_1 { get; }
        ...
        {
            public _orExpr(__GeneratedOdataV4.CstNodes.Rules._orExpr _orExpr_1)
            {
                this._orExpr_1 = _orExpr_1;
            }
            
            public __GeneratedOdataV4.CstNodes.Rules._orExpr _orExpr_1 { get; }
