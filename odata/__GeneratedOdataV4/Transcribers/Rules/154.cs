...
{
    public sealed class _hourMethodCallExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV4.CstNodes.Rules._hourMethodCallExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV4.CstNodes.Rules._hourMethodCallExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV4.Trancsribers.Inners._ʺx68x6Fx75x72ʺTranscriber.Instance.Transcribe(value._ʺx68x6Fx75x72ʺ_1, builder);
