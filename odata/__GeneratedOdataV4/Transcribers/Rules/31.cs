...
{
    public sealed class _boundEntityColFunctionCallTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV4.CstNodes.Rules._boundEntityColFunctionCall>
    {
        ...
        public void Transcribe(__GeneratedOdataV4.CstNodes.Rules._boundEntityColFunctionCall value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV4.Trancsribers.Rules._entityColFunctionTranscriber.Instance.Transcribe(value._entityColFunction_1, builder);
