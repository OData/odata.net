...
{
    public sealed class _geExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV4.CstNodes.Rules._geExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV4.CstNodes.Rules._geExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV4.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV4.Trancsribers.Inners._ʺx67x65ʺTranscriber.Instance.Transcribe(value._ʺx67x65ʺ_1, builder);
