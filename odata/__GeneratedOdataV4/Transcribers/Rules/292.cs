...
{
    public sealed class _dateTimeOffsetValueTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV4.CstNodes.Rules._dateTimeOffsetValue>
    {
        ...
        public void Transcribe(__GeneratedOdataV4.CstNodes.Rules._dateTimeOffsetValue value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV4.Trancsribers.Inners._ʺx54ʺTranscriber.Instance.Transcribe(value._ʺx54ʺ_1, builder);
...
__GeneratedOdataV4.Trancsribers.Inners._Ⲥʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minuteↃTranscriber.Instance.Transcribe(value._Ⲥʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minuteↃ_1, builder);
