namespace __GeneratedPartialV1.Deferred.CstNodes.Inners
{
    ...
    public sealed class _ʺx45ʺ<TMode> : IAstNode<char, _ʺx45ʺ<ParseMode.Realized>>, IFromRealizedable<_ʺx45ʺ<ParseMode.Deferred>> where TMode : ParseMode
    {
        ...
        return this.__x45_1.Value;
        }
        }
        
        internal static _ʺx45ʺ<ParseMode.Deferred> Create(IFuture<IRealizationResult<char>> previousNodeRealizationResult)
        {
            var _x45_1 = Future.Create(() => __GeneratedPartialV1.Deferred.CstNodes.Inners._x45.Create(previousNodeRealizationResult));
return new _ʺx45ʺ<ParseMode.Deferred>(_x45_1);
        }
