namespace __GeneratedPartialV1.Deferred.CstNodes.Rules
{
    ...
    public sealed class _optionValue<TMode> : IAstNode<char, _optionValue<ParseMode.Realized>>, IFromRealizedable<_optionValue<ParseMode.Deferred>> where TMode : ParseMode
    {
        ...
        {
            var _alphaNumeric_1 = Future.Create(() => CombinatorParsingV3.Many.Create<__GeneratedPartialV1.Deferred.CstNodes.Rules._alphaNumeric<ParseMode.Deferred>, __GeneratedPartialV1.Deferred.CstNodes.Rules._alphaNumeric<ParseMode.Realized>>(input => __GeneratedPartialV1.Deferred.CstNodes.Rules._alphaNumeric.Create(input), previousNodeRealizationResult));
return new _optionValue<ParseMode.Deferred>(_alphaNumeric_1);
        }
