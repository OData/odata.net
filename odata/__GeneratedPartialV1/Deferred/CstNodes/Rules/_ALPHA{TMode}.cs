...
{
return new RealizationResult<char, _ALPHA<ParseMode.Realized>>(false, default, this.previousNodeRealizationResult.Value.RemainingTokens);
}
var _Ⰳx41ⲻ5A = _ALPHA<ParseMode.Realized>.Realized._Ⰳx41ⲻ5A.Create(this.previousNodeRealizationResult);
if (_Ⰳx41ⲻ5A.Success)
{
return _Ⰳx41ⲻ5A;
}
var _Ⰳx61ⲻ7A = _ALPHA<ParseMode.Realized>.Realized._Ⰳx61ⲻ7A.Create(this.previousNodeRealizationResult);
if (_Ⰳx61ⲻ7A.Success)
{
return _Ⰳx61ⲻ7A;
}
...
return (node as _ALPHA<TMode>.Realized)!.Dispatch(this, context);
            ...
            {
                private _Ⰳx41ⲻ5A(__GeneratedPartialV1.Deferred.CstNodes.Inners._Ⰳx41ⲻ5A<ParseMode.Realized> _Ⰳx41ⲻ5A_1, ITokenStream<char>? nextTokens)
                {
...
return node.realizationResult;
            ...
            {
                private _Ⰳx61ⲻ7A(__GeneratedPartialV1.Deferred.CstNodes.Inners._Ⰳx61ⲻ7A<ParseMode.Realized> _Ⰳx61ⲻ7A_1, ITokenStream<char>? nextTokens)
                {
                    if (typeof(TMode) != typeof(ParseMode.Realized))
                    {
                        throw new Exception("tODO");
