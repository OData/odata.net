namespace __GeneratedPartialV1.CstNodes.Rules
{
    public abstract class _HEXDIG
    {
        ...
        {
            public _DIGIT(__GeneratedPartialV1.CstNodes.Rules._DIGIT _DIGIT_1)
            {
                this._DIGIT_1 = _DIGIT_1;
            }
            
            public __GeneratedPartialV1.CstNodes.Rules._DIGIT _DIGIT_1 { get; }
        ...
        public sealed class _ʺx42ʺ : _HEXDIG
        {
            private _ʺx42ʺ()
            {
                this._ʺx42ʺ_1 = __GeneratedPartialV1.CstNodes.Inners._ʺx42ʺ.Instance;
            }
            
            public __GeneratedPartialV1.CstNodes.Inners._ʺx42ʺ _ʺx42ʺ_1 { get; }
        ...
        public sealed class _ʺx44ʺ : _HEXDIG
        {
            private _ʺx44ʺ()
            {
                this._ʺx44ʺ_1 = __GeneratedPartialV1.CstNodes.Inners._ʺx44ʺ.Instance;
            }
            
            public __GeneratedPartialV1.CstNodes.Inners._ʺx44ʺ _ʺx44ʺ_1 { get; }
        ...
        public sealed class _ʺx45ʺ : _HEXDIG
        {
            private _ʺx45ʺ()
            {
                this._ʺx45ʺ_1 = __GeneratedPartialV1.CstNodes.Inners._ʺx45ʺ.Instance;
            }
            
            public __GeneratedPartialV1.CstNodes.Inners._ʺx45ʺ _ʺx45ʺ_1 { get; }
        ...
        public sealed class _ʺx46ʺ : _HEXDIG
        {
            private _ʺx46ʺ()
            {
                this._ʺx46ʺ_1 = __GeneratedPartialV1.CstNodes.Inners._ʺx46ʺ.Instance;
            }
            
            public __GeneratedPartialV1.CstNodes.Inners._ʺx46ʺ _ʺx46ʺ_1 { get; }
