namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _ʺx5AʺⳆSIGN_hour_ʺx3Aʺ_minute
    {
        ...
        {
            public _ʺx5Aʺ(__GeneratedOdataV3.CstNodes.Inners._ʺx5Aʺ _ʺx5Aʺ_1)
            {
                this._ʺx5Aʺ_1 = _ʺx5Aʺ_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Inners._ʺx5Aʺ _ʺx5Aʺ_1 { get; }
        ...
        {
            public _SIGN_hour_ʺx3Aʺ_minute(__GeneratedOdataV3.CstNodes.Rules._SIGN _SIGN_1, __GeneratedOdataV3.CstNodes.Rules._hour _hour_1, __GeneratedOdataV3.CstNodes.Inners._ʺx3Aʺ _ʺx3Aʺ_1, __GeneratedOdataV3.CstNodes.Rules._minute _minute_1)
            {
