namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _ʺx24x73x65x61x72x63x68ʺⳆʺx73x65x61x72x63x68ʺ
    {
        ...
        {
            public _ʺx24x73x65x61x72x63x68ʺ(__GeneratedOdataV3.CstNodes.Inners._ʺx24x73x65x61x72x63x68ʺ _ʺx24x73x65x61x72x63x68ʺ_1)
            {
                this._ʺx24x73x65x61x72x63x68ʺ_1 = _ʺx24x73x65x61x72x63x68ʺ_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Inners._ʺx24x73x65x61x72x63x68ʺ _ʺx24x73x65x61x72x63x68ʺ_1 { get; }
        ...
        {
            public _ʺx73x65x61x72x63x68ʺ(__GeneratedOdataV3.CstNodes.Inners._ʺx73x65x61x72x63x68ʺ _ʺx73x65x61x72x63x68ʺ_1)
            {
                this._ʺx73x65x61x72x63x68ʺ_1 = _ʺx73x65x61x72x63x68ʺ_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Inners._ʺx73x65x61x72x63x68ʺ _ʺx73x65x61x72x63x68ʺ_1 { get; }
