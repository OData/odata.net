namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _entitySetName_keyPredicateⳆsingletonEntity
    {
        ...
        {
            public _entitySetName_keyPredicate(__GeneratedOdataV3.CstNodes.Rules._entitySetName _entitySetName_1, __GeneratedOdataV3.CstNodes.Rules._keyPredicate _keyPredicate_1)
            {
        ...
        {
            public _singletonEntity(__GeneratedOdataV3.CstNodes.Rules._singletonEntity _singletonEntity_1)
            {
                this._singletonEntity_1 = _singletonEntity_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._singletonEntity _singletonEntity_1 { get; }
