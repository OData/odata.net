namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _addExprⳆsubExprⳆmulExprⳆdivExprⳆdivbyExprⳆmodExpr
    {
        ...
        {
            public _addExpr(__GeneratedOdataV3.CstNodes.Rules._addExpr _addExpr_1)
            {
                this._addExpr_1 = _addExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._addExpr _addExpr_1 { get; }
        ...
        {
            public _subExpr(__GeneratedOdataV3.CstNodes.Rules._subExpr _subExpr_1)
            {
                this._subExpr_1 = _subExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._subExpr _subExpr_1 { get; }
        ...
        {
            public _mulExpr(__GeneratedOdataV3.CstNodes.Rules._mulExpr _mulExpr_1)
            {
                this._mulExpr_1 = _mulExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._mulExpr _mulExpr_1 { get; }
        ...
        {
            public _divExpr(__GeneratedOdataV3.CstNodes.Rules._divExpr _divExpr_1)
            {
                this._divExpr_1 = _divExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._divExpr _divExpr_1 { get; }
        ...
        {
            public _divbyExpr(__GeneratedOdataV3.CstNodes.Rules._divbyExpr _divbyExpr_1)
            {
                this._divbyExpr_1 = _divbyExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._divbyExpr _divbyExpr_1 { get; }
        ...
        {
            public _modExpr(__GeneratedOdataV3.CstNodes.Rules._modExpr _modExpr_1)
            {
                this._modExpr_1 = _modExpr_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._modExpr _modExpr_1 { get; }
