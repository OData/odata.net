namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _escapeⳆquotationⲻmark
    {
        ...
        {
            public _escape(__GeneratedOdataV3.CstNodes.Rules._escape _escape_1)
            {
        ...
        {
            public _quotationⲻmark(__GeneratedOdataV3.CstNodes.Rules._quotationⲻmark _quotationⲻmark_1)
            {
