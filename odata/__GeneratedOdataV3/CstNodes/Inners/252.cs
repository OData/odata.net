namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _qualifiedActionNameⳆqualifiedFunctionNameⳆselectListProperty
    {
        ...
        {
            public _qualifiedActionName(__GeneratedOdataV3.CstNodes.Rules._qualifiedActionName _qualifiedActionName_1)
            {
                this._qualifiedActionName_1 = _qualifiedActionName_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._qualifiedActionName _qualifiedActionName_1 { get; }
        ...
        {
            public _qualifiedFunctionName(__GeneratedOdataV3.CstNodes.Rules._qualifiedFunctionName _qualifiedFunctionName_1)
            {
                this._qualifiedFunctionName_1 = _qualifiedFunctionName_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._qualifiedFunctionName _qualifiedFunctionName_1 { get; }
        ...
        {
            public _selectListProperty(__GeneratedOdataV3.CstNodes.Rules._selectListProperty _selectListProperty_1)
            {
                this._selectListProperty_1 = _selectListProperty_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._selectListProperty _selectListProperty_1 { get; }
