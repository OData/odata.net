namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _OPEN_selectOption_ЖⲤSEMI_selectOptionↃ_CLOSEⳆʺx2Fʺ_selectProperty
    {
        ...
        {
            public _OPEN_selectOption_ЖⲤSEMI_selectOptionↃ_CLOSE(__GeneratedOdataV3.CstNodes.Rules._OPEN _OPEN_1, __GeneratedOdataV3.CstNodes.Rules._selectOption _selectOption_1, System.Collections.Generic.IEnumerable<Inners._ⲤSEMI_selectOptionↃ> _ⲤSEMI_selectOptionↃ_1, __GeneratedOdataV3.CstNodes.Rules._CLOSE _CLOSE_1)
            {
        ...
        {
            public _ʺx2Fʺ_selectProperty(__GeneratedOdataV3.CstNodes.Inners._ʺx2Fʺ _ʺx2Fʺ_1, __GeneratedOdataV3.CstNodes.Rules._selectProperty _selectProperty_1)
            {
