namespace __GeneratedOdataV3.CstNodes.Inners
{
    public abstract class _SQUOTEⲻinⲻstringⳆpcharⲻnoⲻSQUOTE
    {
        ...
        {
            public _SQUOTEⲻinⲻstring(__GeneratedOdataV3.CstNodes.Rules._SQUOTEⲻinⲻstring _SQUOTEⲻinⲻstring_1)
            {
                this._SQUOTEⲻinⲻstring_1 = _SQUOTEⲻinⲻstring_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._SQUOTEⲻinⲻstring _SQUOTEⲻinⲻstring_1 { get; }
        ...
        {
            public _pcharⲻnoⲻSQUOTE(__GeneratedOdataV3.CstNodes.Rules._pcharⲻnoⲻSQUOTE _pcharⲻnoⲻSQUOTE_1)
            {
                this._pcharⲻnoⲻSQUOTE_1 = _pcharⲻnoⲻSQUOTE_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._pcharⲻnoⲻSQUOTE _pcharⲻnoⲻSQUOTE_1 { get; }
