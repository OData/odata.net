...
{
    public sealed class HelperRangedAtMost6<T> : System.Collections.Generic.IEnumerable<T>
    {
        public HelperRangedAtMost6(System.Collections.Generic.IEnumerable<T> source)
        {
            this.Source = source;
        }
