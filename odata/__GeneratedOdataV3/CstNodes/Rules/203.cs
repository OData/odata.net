namespace __GeneratedOdataV3.CstNodes.Rules
{
    public abstract class _navigationPropertyInUri
    {
        ...
        {
            public _singleNavPropInJSON(__GeneratedOdataV3.CstNodes.Rules._singleNavPropInJSON _singleNavPropInJSON_1)
            {
                this._singleNavPropInJSON_1 = _singleNavPropInJSON_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._singleNavPropInJSON _singleNavPropInJSON_1 { get; }
        ...
        {
            public _collectionNavPropInJSON(__GeneratedOdataV3.CstNodes.Rules._collectionNavPropInJSON _collectionNavPropInJSON_1)
            {
                this._collectionNavPropInJSON_1 = _collectionNavPropInJSON_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._collectionNavPropInJSON _collectionNavPropInJSON_1 { get; }
