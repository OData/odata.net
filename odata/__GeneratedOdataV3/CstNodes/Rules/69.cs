namespace __GeneratedOdataV3.CstNodes.Rules
{
    public abstract class _expandOption
    {
        ...
        {
            public _expandRefOption(__GeneratedOdataV3.CstNodes.Rules._expandRefOption _expandRefOption_1)
            {
                this._expandRefOption_1 = _expandRefOption_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._expandRefOption _expandRefOption_1 { get; }
        ...
        {
            public _select(__GeneratedOdataV3.CstNodes.Rules._select _select_1)
            {
                this._select_1 = _select_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._select _select_1 { get; }
        ...
        {
            public _expand(__GeneratedOdataV3.CstNodes.Rules._expand _expand_1)
            {
                this._expand_1 = _expand_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._expand _expand_1 { get; }
        ...
        {
            public _compute(__GeneratedOdataV3.CstNodes.Rules._compute _compute_1)
            {
                this._compute_1 = _compute_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._compute _compute_1 { get; }
        ...
        {
            public _levels(__GeneratedOdataV3.CstNodes.Rules._levels _levels_1)
            {
        ...
        {
            public _aliasAndValue(__GeneratedOdataV3.CstNodes.Rules._aliasAndValue _aliasAndValue_1)
            {
                this._aliasAndValue_1 = _aliasAndValue_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._aliasAndValue _aliasAndValue_1 { get; }
