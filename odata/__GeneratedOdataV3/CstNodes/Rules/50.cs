namespace __GeneratedOdataV3.CstNodes.Rules
{
    public abstract class _queryOption
    {
        ...
        {
            public _systemQueryOption(__GeneratedOdataV3.CstNodes.Rules._systemQueryOption _systemQueryOption_1)
            {
                this._systemQueryOption_1 = _systemQueryOption_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._systemQueryOption _systemQueryOption_1 { get; }
        ...
        {
            public _nameAndValue(__GeneratedOdataV3.CstNodes.Rules._nameAndValue _nameAndValue_1)
            {
                this._nameAndValue_1 = _nameAndValue_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._nameAndValue _nameAndValue_1 { get; }
