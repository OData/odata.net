namespace __GeneratedOdataV3.CstNodes.Rules
{
    public abstract class _functionImportCallNoParens
    {
        ...
        {
            public _entityFunctionImport(__GeneratedOdataV3.CstNodes.Rules._entityFunctionImport _entityFunctionImport_1)
            {
                this._entityFunctionImport_1 = _entityFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._entityFunctionImport _entityFunctionImport_1 { get; }
        ...
        {
            public _entityColFunctionImport(__GeneratedOdataV3.CstNodes.Rules._entityColFunctionImport _entityColFunctionImport_1)
            {
                this._entityColFunctionImport_1 = _entityColFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._entityColFunctionImport _entityColFunctionImport_1 { get; }
        ...
        {
            public _complexFunctionImport(__GeneratedOdataV3.CstNodes.Rules._complexFunctionImport _complexFunctionImport_1)
            {
                this._complexFunctionImport_1 = _complexFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._complexFunctionImport _complexFunctionImport_1 { get; }
        ...
        {
            public _complexColFunctionImport(__GeneratedOdataV3.CstNodes.Rules._complexColFunctionImport _complexColFunctionImport_1)
            {
                this._complexColFunctionImport_1 = _complexColFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._complexColFunctionImport _complexColFunctionImport_1 { get; }
        ...
        {
            public _primitiveFunctionImport(__GeneratedOdataV3.CstNodes.Rules._primitiveFunctionImport _primitiveFunctionImport_1)
            {
                this._primitiveFunctionImport_1 = _primitiveFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._primitiveFunctionImport _primitiveFunctionImport_1 { get; }
        ...
        {
            public _primitiveColFunctionImport(__GeneratedOdataV3.CstNodes.Rules._primitiveColFunctionImport _primitiveColFunctionImport_1)
            {
                this._primitiveColFunctionImport_1 = _primitiveColFunctionImport_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._primitiveColFunctionImport _primitiveColFunctionImport_1 { get; }
