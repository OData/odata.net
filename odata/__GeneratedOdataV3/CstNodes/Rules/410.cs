namespace __GeneratedOdataV3.CstNodes.Rules
{
    public abstract class _pcharⲻnoⲻSQUOTE
    {
        ...
        {
            public _pctⲻencodedⲻnoⲻSQUOTE(__GeneratedOdataV3.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1)
            {
                this._pctⲻencodedⲻnoⲻSQUOTE_1 = _pctⲻencodedⲻnoⲻSQUOTE_1;
            }
            
            public __GeneratedOdataV3.CstNodes.Rules._pctⲻencodedⲻnoⲻSQUOTE _pctⲻencodedⲻnoⲻSQUOTE_1 { get; }
