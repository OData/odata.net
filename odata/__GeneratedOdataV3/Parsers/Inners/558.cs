namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ> Parse(IInput<char>? input)
            {
                var _x43_1 = __GeneratedOdataV3.Parsers.Inners._x43Parser.Instance.Parse(input);
if (!_x43_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ)!, input);
}
...
var _x6E_2 = __GeneratedOdataV3.Parsers.Inners._x6EParser.Instance.Parse(_x65_1.Remainder);
if (!_x6E_2.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ)!, input);
}
...
var _x2D_1 = __GeneratedOdataV3.Parsers.Inners._x2DParser.Instance.Parse(_x74_2.Remainder);
if (!_x2D_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx43x6Fx6Ex74x65x6Ex74x2Dx49x44ʺ.Instance, _x44_1.Remainder);
            }
        }
    }
