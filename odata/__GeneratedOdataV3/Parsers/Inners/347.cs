namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_complexInUri> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_complexInUri>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_complexInUri> Parse(IInput<char>? input)
            {
...
var _complexInUri_1 = __GeneratedOdataV3.Parsers.Rules._complexInUriParser.Instance.Parse(_valueⲻseparator_1.Remainder);
