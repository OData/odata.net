namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ> Parse(IInput<char>? input)
            {
                var _x68_1 = __GeneratedOdataV3.Parsers.Inners._x68Parser.Instance.Parse(input);
if (!_x68_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ)!, input);
}
...
var _x75_2 = __GeneratedOdataV3.Parsers.Inners._x75Parser.Instance.Parse(_x71_1.Remainder);
if (!_x75_2.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ)!, input);
}

var _x65_2 = __GeneratedOdataV3.Parsers.Inners._x65Parser.Instance.Parse(_x75_2.Remainder);
if (!_x65_2.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ)!, input);
}
...
var _x65_3 = __GeneratedOdataV3.Parsers.Inners._x65Parser.Instance.Parse(_x63_1.Remainder);
if (!_x65_3.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ)!, input);
}

return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ.Instance, _x65_3.Remainder);
            }
        }
    }
