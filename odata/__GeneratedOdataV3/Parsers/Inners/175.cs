namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx24x73x63x68x65x6Dx61x76x65x72x73x69x6Fx6Eʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx24x73x63x68x65x6Dx61x76x65x72x73x69x6Fx6Eʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx24x73x63x68x65x6Dx61x76x65x72x73x69x6Fx6Eʺ> Parse(IInput<char>? input)
            {
                var _x24_1 = __GeneratedOdataV3.Parsers.Inners._x24Parser.Instance.Parse(input);
if (!_x24_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx24x73x63x68x65x6Dx61x76x65x72x73x69x6Fx6Eʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx24x73x63x68x65x6Dx61x76x65x72x73x69x6Fx6Eʺ.Instance, _x6E_1.Remainder);
            }
        }
    }
