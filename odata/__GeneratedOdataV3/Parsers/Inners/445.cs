namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx53x74x72x69x6Ex67ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx53x74x72x69x6Ex67ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx53x74x72x69x6Ex67ʺ> Parse(IInput<char>? input)
            {
                var _x53_1 = __GeneratedOdataV3.Parsers.Inners._x53Parser.Instance.Parse(input);
if (!_x53_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx53x74x72x69x6Ex67ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx53x74x72x69x6Ex67ʺ.Instance, _x67_1.Remainder);
            }
        }
    }
