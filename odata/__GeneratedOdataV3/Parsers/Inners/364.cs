namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_rootExpr> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_rootExpr>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._valueⲻseparator_rootExpr> Parse(IInput<char>? input)
            {
...
var _rootExpr_1 = __GeneratedOdataV3.Parsers.Rules._rootExprParser.Instance.Parse(_valueⲻseparator_1.Remainder);
