namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._Ж6Ⲥh16_ʺx3AʺↃ_h16> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._Ж6Ⲥh16_ʺx3AʺↃ_h16>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._Ж6Ⲥh16_ʺx3AʺↃ_h16> Parse(IInput<char>? input)
            {
                var _Ⲥh16_ʺx3AʺↃ_1 = __GeneratedOdataV3.Parsers.Inners._Ⲥh16_ʺx3AʺↃParser.Instance.Repeat(0, 6).Parse(input);
