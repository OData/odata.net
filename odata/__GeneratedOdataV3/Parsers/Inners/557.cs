namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx67x65x6Fx6Dx65x74x72x79ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx67x65x6Fx6Dx65x74x72x79ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx67x65x6Fx6Dx65x74x72x79ʺ> Parse(IInput<char>? input)
            {
                var _x67_1 = __GeneratedOdataV3.Parsers.Inners._x67Parser.Instance.Parse(input);
if (!_x67_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx67x65x6Fx6Dx65x74x72x79ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx67x65x6Fx6Dx65x74x72x79ʺ.Instance, _x79_1.Remainder);
            }
        }
    }
