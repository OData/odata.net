namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx2Fx24x63x6Fx75x6Ex74ʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._ʺx2Fx24x63x6Fx75x6Ex74ʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._ʺx2Fx24x63x6Fx75x6Ex74ʺ> Parse(IInput<char>? input)
            {
                var _x2F_1 = __GeneratedOdataV3.Parsers.Inners._x2FParser.Instance.Parse(input);
if (!_x2F_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._ʺx2Fx24x63x6Fx75x6Ex74ʺ)!, input);
}
...
return Output.Create(true, __GeneratedOdataV3.CstNodes.Inners._ʺx2Fx24x63x6Fx75x6Ex74ʺ.Instance, _x74_1.Remainder);
            }
        }
    }
