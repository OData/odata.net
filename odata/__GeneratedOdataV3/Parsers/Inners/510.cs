namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._1ЖDIGIT_ʺx4Dʺ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._1ЖDIGIT_ʺx4Dʺ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._1ЖDIGIT_ʺx4Dʺ> Parse(IInput<char>? input)
            {
...
var _ʺx4Dʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx4DʺParser.Instance.Parse(_DIGIT_1.Remainder);
if (!_ʺx4Dʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Inners._1ЖDIGIT_ʺx4Dʺ)!, input);
}
