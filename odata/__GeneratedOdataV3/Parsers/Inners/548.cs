namespace __GeneratedOdataV3.Parsers.Inners
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Inners._pointData_ЖⲤCOMMA_pointDataↃ> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Inners._pointData_ЖⲤCOMMA_pointDataↃ>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Inners._pointData_ЖⲤCOMMA_pointDataↃ> Parse(IInput<char>? input)
            {
                var _pointData_1 = __GeneratedOdataV3.Parsers.Rules._pointDataParser.Instance.Parse(input);
