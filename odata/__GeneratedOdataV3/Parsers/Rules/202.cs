namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._primitivePropertyInUri> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._primitivePropertyInUri>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._primitivePropertyInUri> Parse(IInput<char>? input)
            {
...
var _primitiveProperty_1 = __GeneratedOdataV3.Parsers.Rules._primitivePropertyParser.Instance.Parse(_quotationⲻmark_1.Remainder);
if (!_primitiveProperty_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._primitivePropertyInUri)!, input);
}

var _quotationⲻmark_2 = __GeneratedOdataV3.Parsers.Rules._quotationⲻmarkParser.Instance.Parse(_primitiveProperty_1.Remainder);
...
var _primitiveLiteralInJSON_1 = __GeneratedOdataV3.Parsers.Rules._primitiveLiteralInJSONParser.Instance.Parse(_nameⲻseparator_1.Remainder);
