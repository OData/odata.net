...
select new __GeneratedOdataV3.CstNodes.Rules._selectItem._allOperationsInSchema(_allOperationsInSchema_1);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._selectItem._꘡ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2Fʺ꘡_ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃ> Instance { get; } = from _ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2Fʺ_1 in __GeneratedOdataV3.Parsers.Inners._ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2FʺParser.Instance.Optional()
from _ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃ_1 in __GeneratedOdataV3.Parsers.Inners._ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃParser.Instance
select new __GeneratedOdataV3.CstNodes.Rules._selectItem._꘡ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2Fʺ꘡_ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃ(_ⲤqualifiedEntityTypeNameⳆqualifiedComplexTypeNameↃ_ʺx2Fʺ_1.GetOrElse(null), _ⲤselectPropertyⳆqualifiedActionNameⳆqualifiedFunctionNameↃ_1);
        }
    }
