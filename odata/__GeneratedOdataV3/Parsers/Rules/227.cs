namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedTypeDefinitionName> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedTypeDefinitionName>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedTypeDefinitionName> Parse(IInput<char>? input)
            {
...
var _typeDefinitionName_1 = __GeneratedOdataV3.Parsers.Rules._typeDefinitionNameParser.Instance.Parse(_ʺx2Eʺ_1.Remainder);
