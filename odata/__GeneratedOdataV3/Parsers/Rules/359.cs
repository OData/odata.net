namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._annotationsList> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._annotationsList>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._annotationsList> Parse(IInput<char>? input)
            {
                var _annotationIdentifier_1 = __GeneratedOdataV3.Parsers.Rules._annotationIdentifierParser.Instance.Parse(input);
