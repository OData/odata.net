namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._geometryCollection> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._geometryCollection>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._geometryCollection> Parse(IInput<char>? input)
            {
...
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._geometryCollection)!, input);
}
...
return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._geometryCollection(_geometryPrefix_1.Parsed, _SQUOTE_1.Parsed, _fullCollectionLiteral_1.Parsed,  _SQUOTE_2.Parsed), _SQUOTE_2.Remainder);
            }
        }
    }
