...
var _collectionNavPath_1 = __GeneratedOdataV3.Parsers.Rules._collectionNavPathParser.Instance.Optional().Parse(input);

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._collectionNavigation(null, _collectionNavPath_1.Parsed.GetOrElse(null)), _collectionNavPath_1.Remainder);
            }
        }
    }
