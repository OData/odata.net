namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    public static class _contextPropertyPathParser
    {
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveProperty> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveProperty>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveProperty> Parse(IInput<char>? input)
                {
...
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveProperty)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveProperty(_primitiveProperty_1.Parsed), _primitiveProperty_1.Remainder);
                }
            }
        }
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveColProperty> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveColProperty>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveColProperty> Parse(IInput<char>? input)
                {
...
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveColProperty)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._primitiveColProperty(_primitiveColProperty_1.Parsed), _primitiveColProperty_1.Remainder);
                }
            }
        }
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._complexColProperty> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._complexColProperty>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._complexColProperty> Parse(IInput<char>? input)
                {
...
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._complexColProperty)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._contextPropertyPath._complexColProperty(_complexColProperty_1.Parsed), _complexColProperty_1.Remainder);
                }
            }
        }
