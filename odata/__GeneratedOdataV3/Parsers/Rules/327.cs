namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._fullPointLiteral> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._fullPointLiteral>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._fullPointLiteral> Parse(IInput<char>? input)
            {
...
var _pointLiteral_1 = __GeneratedOdataV3.Parsers.Rules._pointLiteralParser.Instance.Parse(_sridLiteral_1.Remainder);
