namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._prefer> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._prefer>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._prefer> Parse(IInput<char>? input)
            {
                var _ʺx50x72x65x66x65x72ʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx50x72x65x66x65x72ʺParser.Instance.Parse(input);
if (!_ʺx50x72x65x66x65x72ʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._prefer)!, input);
}

var _ʺx3Aʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx3AʺParser.Instance.Parse(_ʺx50x72x65x66x65x72ʺ_1.Remainder);
if (!_ʺx3Aʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._prefer)!, input);
}
...
var _preference_1 = __GeneratedOdataV3.Parsers.Rules._preferenceParser.Instance.Parse(_OWS_1.Remainder);
