namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._enumValue> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._enumValue>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._enumValue> Parse(IInput<char>? input)
            {
                var _singleEnumValue_1 = __GeneratedOdataV3.Parsers.Rules._singleEnumValueParser.Instance.Parse(input);
