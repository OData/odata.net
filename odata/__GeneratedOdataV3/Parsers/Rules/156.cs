namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._secondMethodCallExpr> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._secondMethodCallExpr>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._secondMethodCallExpr> Parse(IInput<char>? input)
            {
                var _ʺx73x65x63x6Fx6Ex64ʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx73x65x63x6Fx6Ex64ʺParser.Instance.Parse(input);
if (!_ʺx73x65x63x6Fx6Ex64ʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._secondMethodCallExpr)!, input);
}

var _OPEN_1 = __GeneratedOdataV3.Parsers.Rules._OPENParser.Instance.Parse(_ʺx73x65x63x6Fx6Ex64ʺ_1.Remainder);
if (!_OPEN_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._secondMethodCallExpr)!, input);
}
