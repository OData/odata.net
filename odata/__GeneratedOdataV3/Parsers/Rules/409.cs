namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims> Instance { get; } = (_ʺx21ʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx28ʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx29ʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx2AʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx2BʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx2CʺParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._otherⲻdelims>(_ʺx3BʺParser.Instance);
