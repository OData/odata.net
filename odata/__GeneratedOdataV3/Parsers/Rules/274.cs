namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._binaryValue> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._binaryValue>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._binaryValue> Parse(IInput<char>? input)
            {
...
var _base64b16Ⳇbase64b8_1 = __GeneratedOdataV3.Parsers.Inners._base64b16Ⳇbase64b8Parser.Instance.Optional().Parse(_Ⲥ4base64charↃ_1.Remainder);
