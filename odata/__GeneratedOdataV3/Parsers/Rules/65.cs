namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    public static class _expandItemParser
    {
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._expandItem._STAR_꘡refⳆOPEN_levels_CLOSE꘡> Instance { get; } = from _STAR_1 in __GeneratedOdataV3.Parsers.Rules._STARParser.Instance
from _refⳆOPEN_levels_CLOSE_1 in __GeneratedOdataV3.Parsers.Inners._refⳆOPEN_levels_CLOSEParser.Instance.Optional()
select new __GeneratedOdataV3.CstNodes.Rules._expandItem._STAR_꘡refⳆOPEN_levels_CLOSE꘡(_STAR_1, _refⳆOPEN_levels_CLOSE_1.GetOrElse(null));
        }
...
select new __GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ(_ʺx24x76x61x6Cx75x65ʺ_1);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._expandItem._expandPath_꘡ref_꘡OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE꘡Ⳇcount_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡ⳆOPEN_expandOption_ЖⲤSEMI_expandOptionↃ_CLOSE꘡> Instance { get; } = from _expandPath_1 in __GeneratedOdataV3.Parsers.Rules._expandPathParser.Instance
from _ref_꘡OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE꘡Ⳇcount_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡ⳆOPEN_expandOption_ЖⲤSEMI_expandOptionↃ_CLOSE_1 in __GeneratedOdataV3.Parsers.Inners._ref_꘡OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE꘡Ⳇcount_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡ⳆOPEN_expandOption_ЖⲤSEMI_expandOptionↃ_CLOSEParser.Instance.Optional()
select new __GeneratedOdataV3.CstNodes.Rules._expandItem._expandPath_꘡ref_꘡OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE꘡Ⳇcount_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡ⳆOPEN_expandOption_ЖⲤSEMI_expandOptionↃ_CLOSE꘡(_expandPath_1, _ref_꘡OPEN_expandRefOption_ЖⲤSEMI_expandRefOptionↃ_CLOSE꘡Ⳇcount_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡ⳆOPEN_expandOption_ЖⲤSEMI_expandOptionↃ_CLOSE_1.GetOrElse(null));
        }
    }
