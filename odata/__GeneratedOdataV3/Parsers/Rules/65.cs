...
return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._expandItem._STAR_꘡refⳆOPEN_levels_CLOSE꘡(_STAR_1.Parsed, _refⳆOPEN_levels_CLOSE_1.Parsed.GetOrElse(null)), _refⳆOPEN_levels_CLOSE_1.Remainder);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ> Parse(IInput<char>? input)
                {
                    var _ʺx24x76x61x6Cx75x65ʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx24x76x61x6Cx75x65ʺParser.Instance.Parse(input);
if (!_ʺx24x76x61x6Cx75x65ʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._expandItem._ʺx24x76x61x6Cx75x65ʺ(_ʺx24x76x61x6Cx75x65ʺ_1.Parsed), _ʺx24x76x61x6Cx75x65ʺ_1.Remainder);
                }
            }
        }
