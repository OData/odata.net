namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._entityCastOption> Instance { get; } = (_entityIdOptionParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._entityCastOption>(_expandParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._entityCastOption>(_selectParser.Instance);
