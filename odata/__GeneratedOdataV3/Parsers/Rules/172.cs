namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._hasSubsequenceMethodCallExpr> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._hasSubsequenceMethodCallExpr>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._hasSubsequenceMethodCallExpr> Parse(IInput<char>? input)
            {
                var _ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ_1 = __GeneratedOdataV3.Parsers.Inners._ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺParser.Instance.Parse(input);
if (!_ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._hasSubsequenceMethodCallExpr)!, input);
}

var _OPEN_1 = __GeneratedOdataV3.Parsers.Rules._OPENParser.Instance.Parse(_ʺx68x61x73x73x75x62x73x65x71x75x65x6Ex63x65ʺ_1.Remainder);
if (!_OPEN_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._hasSubsequenceMethodCallExpr)!, input);
}
