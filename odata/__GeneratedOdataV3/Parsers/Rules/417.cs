...
select new __GeneratedOdataV3.CstNodes.Rules._qcharⲻnoⲻAMPⲻDQUOTE._qcharⲻunescaped(_qcharⲻunescaped_1);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._qcharⲻnoⲻAMPⲻDQUOTE._escape_ⲤescapeⳆquotationⲻmarkↃ> Instance { get; } = from _escape_1 in __GeneratedOdataV3.Parsers.Rules._escapeParser.Instance
from _ⲤescapeⳆquotationⲻmarkↃ_1 in __GeneratedOdataV3.Parsers.Inners._ⲤescapeⳆquotationⲻmarkↃParser.Instance
select new __GeneratedOdataV3.CstNodes.Rules._qcharⲻnoⲻAMPⲻDQUOTE._escape_ⲤescapeⳆquotationⲻmarkↃ(_escape_1, _ⲤescapeⳆquotationⲻmarkↃ_1);
        }
    }
