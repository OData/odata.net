namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._month> Instance { get; } = (_ʺx30ʺ_oneToNineParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._month>(_ʺx31ʺ_Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃParser.Instance);
        
        public static class _ʺx30ʺ_oneToNineParser
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx30ʺ_oneToNine> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx30ʺ_oneToNine>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx30ʺ_oneToNine> Parse(IInput<char>? input)
                {
...
return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._month._ʺx30ʺ_oneToNine(_ʺx30ʺ_1.Parsed,  _oneToNine_1.Parsed), _oneToNine_1.Remainder);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx31ʺ_Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃ> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx31ʺ_Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃ>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._month._ʺx31ʺ_Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃ> Parse(IInput<char>? input)
                {
...
var _Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃ_1 = __GeneratedOdataV3.Parsers.Inners._Ⲥʺx30ʺⳆʺx31ʺⳆʺx32ʺↃParser.Instance.Parse(_ʺx31ʺ_1.Remainder);
