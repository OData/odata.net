namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._namespace> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._namespace>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._namespace> Parse(IInput<char>? input)
            {
                var _namespacePart_1 = __GeneratedOdataV3.Parsers.Rules._namespacePartParser.Instance.Parse(input);
