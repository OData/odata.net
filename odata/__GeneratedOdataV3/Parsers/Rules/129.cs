namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._collectionPathExpr> Instance { get; } = (_count_꘡OPEN_expandCountOption_ЖⲤSEMI_expandCountOptionↃ_CLOSE꘡Parser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._collectionPathExpr>(_ʺx2Fʺ_boundFunctionExprParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._collectionPathExpr>(_ʺx2Fʺ_annotationExprParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._collectionPathExpr>(_ʺx2Fʺ_anyExprParser.Instance).Or<char, __GeneratedOdataV3.CstNodes.Rules._collectionPathExpr>(_ʺx2Fʺ_allExprParser.Instance);
