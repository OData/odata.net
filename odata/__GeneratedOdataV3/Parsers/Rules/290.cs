namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._SQUOTEⲻinⲻstring> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._SQUOTEⲻinⲻstring>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._SQUOTEⲻinⲻstring> Parse(IInput<char>? input)
            {
...
var _SQUOTE_2 = __GeneratedOdataV3.Parsers.Rules._SQUOTEParser.Instance.Parse(_SQUOTE_1.Remainder);
