namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    public static class _charInJSONParser
    {
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻunescaped> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻunescaped>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻunescaped> Parse(IInput<char>? input)
                {
...
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻunescaped)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻunescaped(_qcharⲻunescaped_1.Parsed), _qcharⲻunescaped_1.Remainder);
                }
            }
        }
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻJSONⲻspecial> Instance { get; } = new Parser();
            
            private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻJSONⲻspecial>
            {
                public Parser()
                {
                }
                
                public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻJSONⲻspecial> Parse(IInput<char>? input)
                {
                    var _qcharⲻJSONⲻspecial_1 = __GeneratedOdataV3.Parsers.Rules._qcharⲻJSONⲻspecialParser.Instance.Parse(input);
if (!_qcharⲻJSONⲻspecial_1.Success)
{
    return Output.Create(false, default(__GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻJSONⲻspecial)!, input);
}

return Output.Create(true, new __GeneratedOdataV3.CstNodes.Rules._charInJSON._qcharⲻJSONⲻspecial(_qcharⲻJSONⲻspecial_1.Parsed), _qcharⲻJSONⲻspecial_1.Remainder);
                }
            }
        }
