namespace __GeneratedOdataV3.Parsers.Rules
{
    ...
    {
        public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedEnumTypeName> Instance { get; } = new Parser();
        
        private sealed class Parser : IParser<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedEnumTypeName>
        {
            public Parser()
            {
            }
            
            public IOutput<char, __GeneratedOdataV3.CstNodes.Rules._qualifiedEnumTypeName> Parse(IInput<char>? input)
            {
...
var _enumerationTypeName_1 = __GeneratedOdataV3.Parsers.Rules._enumerationTypeNameParser.Instance.Parse(_ʺx2Eʺ_1.Remainder);
