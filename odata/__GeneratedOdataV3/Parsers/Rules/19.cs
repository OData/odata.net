...
select new __GeneratedOdataV3.CstNodes.Rules._complexColPath._ordinalIndex(_ordinalIndex_1);
        ...
        {
            public static IParser<char, __GeneratedOdataV3.CstNodes.Rules._complexColPath._꘡ʺx2Fʺ_qualifiedComplexTypeName꘡_꘡countⳆboundOperation꘡> Instance { get; } = from _ʺx2Fʺ_qualifiedComplexTypeName_1 in __GeneratedOdataV3.Parsers.Inners._ʺx2Fʺ_qualifiedComplexTypeNameParser.Instance.Optional()
from _countⳆboundOperation_1 in __GeneratedOdataV3.Parsers.Inners._countⳆboundOperationParser.Instance.Optional()
select new __GeneratedOdataV3.CstNodes.Rules._complexColPath._꘡ʺx2Fʺ_qualifiedComplexTypeName꘡_꘡countⳆboundOperation꘡(_ʺx2Fʺ_qualifiedComplexTypeName_1.GetOrElse(null), _countⳆboundOperation_1.GetOrElse(null));
        }
    }
