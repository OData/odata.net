...
{
    public sealed class _anyExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._anyExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._anyExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Inners._ʺx61x6Ex79ʺTranscriber.Instance.Transcribe(value._ʺx61x6Ex79ʺ_1, builder);
...
{
__GeneratedOdataV3.Trancsribers.Inners._lambdaVariableExpr_BWS_COLON_BWS_lambdaPredicateExprTranscriber.Instance.Transcribe(value._lambdaVariableExpr_BWS_COLON_BWS_lambdaPredicateExpr_1, builder);
}
