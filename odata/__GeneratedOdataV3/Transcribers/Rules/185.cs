...
{
    public sealed class _addExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._addExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._addExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV3.Trancsribers.Inners._ʺx61x64x64ʺTranscriber.Instance.Transcribe(value._ʺx61x64x64ʺ_1, builder);
