...
{
    public sealed class _neExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._neExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._neExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV3.Trancsribers.Inners._ʺx6Ex65ʺTranscriber.Instance.Transcribe(value._ʺx6Ex65ʺ_1, builder);
