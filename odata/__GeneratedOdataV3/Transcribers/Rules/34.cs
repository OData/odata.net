...
{
    public sealed class _boundPrimitiveFunctionCallTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._boundPrimitiveFunctionCall>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._boundPrimitiveFunctionCall value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV3.Trancsribers.Rules._primitiveFunctionTranscriber.Instance.Transcribe(value._primitiveFunction_1, builder);
