...
{
    public sealed class _entitySetTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._entitySet>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._entitySet value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._entitySetNameTranscriber.Instance.Transcribe(value._entitySetName_1, builder);
