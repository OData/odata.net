...
{
    public sealed class _stringInJSONTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._stringInJSON>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._stringInJSON value, System.Text.StringBuilder builder)
        {
...
{
__GeneratedOdataV3.Trancsribers.Rules._charInJSONTranscriber.Instance.Transcribe(_charInJSON_1, builder);
}
