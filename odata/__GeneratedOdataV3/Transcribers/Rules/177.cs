...
{
    public sealed class _eqExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._eqExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._eqExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV3.Trancsribers.Inners._ʺx65x71ʺTranscriber.Instance.Transcribe(value._ʺx65x71ʺ_1, builder);
