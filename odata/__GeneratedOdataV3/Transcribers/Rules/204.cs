...
{
    public sealed class _singleNavPropInJSONTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._singleNavPropInJSON>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._singleNavPropInJSON value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._quotationⲻmarkTranscriber.Instance.Transcribe(value._quotationⲻmark_1, builder);
__GeneratedOdataV3.Trancsribers.Rules._entityNavigationPropertyTranscriber.Instance.Transcribe(value._entityNavigationProperty_1, builder);
