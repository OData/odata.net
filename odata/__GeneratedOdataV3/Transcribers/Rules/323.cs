...
{
    public sealed class _geographyMultiPolygonTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._geographyMultiPolygon>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._geographyMultiPolygon value, System.Text.StringBuilder builder)
        {
...
__GeneratedOdataV3.Trancsribers.Rules._fullMultiPolygonLiteralTranscriber.Instance.Transcribe(value._fullMultiPolygonLiteral_1, builder);
