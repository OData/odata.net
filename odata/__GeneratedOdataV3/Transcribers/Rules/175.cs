...
{
    public sealed class _andExprTranscriber : GeneratorV3.ITranscriber<__GeneratedOdataV3.CstNodes.Rules._andExpr>
    {
        ...
        public void Transcribe(__GeneratedOdataV3.CstNodes.Rules._andExpr value, System.Text.StringBuilder builder)
        {
            __GeneratedOdataV3.Trancsribers.Rules._RWSTranscriber.Instance.Transcribe(value._RWS_1, builder);
__GeneratedOdataV3.Trancsribers.Inners._ʺx61x6Ex64ʺTranscriber.Instance.Transcribe(value._ʺx61x6Ex64ʺ_1, builder);
