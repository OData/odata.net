namespace __GeneratedV2.CstNodes.Inners
{
    public abstract class _WSPⳆCRLF_WSP
    {
        ...
        {
            public _WSP(__GeneratedV2.CstNodes.Rules._WSP _WSP_1)
            {
                this._WSP_1 = _WSP_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._WSP _WSP_1 { get; }
        ...
        {
            public _CRLF_WSP(__GeneratedV2.CstNodes.Rules._CRLF _CRLF_1, __GeneratedV2.CstNodes.Rules._WSP _WSP_1)
            {
                this._CRLF_1 = _CRLF_1;
                this._WSP_1 = _WSP_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._CRLF _CRLF_1 { get; }
            public __GeneratedV2.CstNodes.Rules._WSP _WSP_1 { get; }
