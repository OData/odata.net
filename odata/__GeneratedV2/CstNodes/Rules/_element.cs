namespace __GeneratedV2.CstNodes.Rules
{
    public abstract class _element
    {
        ...
        {
            public _rulename(__GeneratedV2.CstNodes.Rules._rulename _rulename_1)
            {
                this._rulename_1 = _rulename_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._rulename _rulename_1 { get; }
        ...
        {
            public _group(__GeneratedV2.CstNodes.Rules._group _group_1)
            {
                this._group_1 = _group_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._group _group_1 { get; }
        ...
        {
            public _option(__GeneratedV2.CstNodes.Rules._option _option_1)
            {
                this._option_1 = _option_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._option _option_1 { get; }
        ...
        {
            public _charⲻval(__GeneratedV2.CstNodes.Rules._charⲻval _charⲻval_1)
            {
                this._charⲻval_1 = _charⲻval_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._charⲻval _charⲻval_1 { get; }
        ...
        {
            public _numⲻval(__GeneratedV2.CstNodes.Rules._numⲻval _numⲻval_1)
            {
                this._numⲻval_1 = _numⲻval_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._numⲻval _numⲻval_1 { get; }
        ...
        {
            public _proseⲻval(__GeneratedV2.CstNodes.Rules._proseⲻval _proseⲻval_1)
            {
                this._proseⲻval_1 = _proseⲻval_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._proseⲻval _proseⲻval_1 { get; }
