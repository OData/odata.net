namespace __GeneratedV2.CstNodes.Rules
{
    public abstract class _cⲻnl
    {
        ...
        {
            public _comment(__GeneratedV2.CstNodes.Rules._comment _comment_1)
            {
                this._comment_1 = _comment_1;
            }
            
            public __GeneratedV2.CstNodes.Rules._comment _comment_1 { get; }
        ...
        {
            public _CRLF(__GeneratedV2.CstNodes.Rules._CRLF _CRLF_1)
            {
