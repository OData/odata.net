...
namespace Microsoft.Test.OData.Services.ODataWCFService
{
    ...
    class ODataResponseMessage : IODataResponseMessage, IServiceCollectionProvider
    {
        ...
        public ODataResponseMessage(Stream memoryStream, int statusCode)
        {
        ...
        public int StatusCode
        {
            ...
            set
            {
                ...
                if (WebOperationContext.Current.OutgoingResponse.StatusCode == HttpStatusCode.NoContent)
                {
