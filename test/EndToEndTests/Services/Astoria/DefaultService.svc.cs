//---------------------------------------------------------------------
// <copyright file="DefaultService.svc.cs" company="Microsoft">
...
namespace Microsoft.Test.OData.Services.AstoriaDefaultService
{
    ...
    public class Service : DataService<DefaultContainer>, IDataServiceDataSourceCreator, System.IServiceProvider
    {
        ...
        public Service()
        {
            this.ODataWriterFactory = (odataWriter) =>
            {
        ...
        {
            System.Threading.Monitor.Enter(Service.lockObject);
            try
            {
                if (Service.streamDataInitialized == false)
                {
                    PopulateStreamData(this.CurrentDataSource, inMemoryProvider);
                    Service.streamDataInitialized = true;
                }
            }
            finally
            {
                System.Threading.Monitor.Exit(Service.lockObject);
            }
        }
        ...
        public void ChangeCustomerAuditInfo(Customer customer, AuditInfo auditInfo)
        {
            customer.Auditing.ModifiedBy = auditInfo.ModifiedBy;
            customer.Auditing.ModifiedDate = auditInfo.ModifiedDate;
        }
