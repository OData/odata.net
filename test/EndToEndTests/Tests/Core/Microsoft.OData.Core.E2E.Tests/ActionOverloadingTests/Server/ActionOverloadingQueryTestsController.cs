//-----------------------------------------------------------------------------
// <copyright file="ActionOverloadingQueryTestsController.cs" company=".NET Foundation">
...
namespace Microsoft.OData.Core.E2E.Tests.ActionOverloadingTests.Server
{
    internal class ActionOverloadingQueryTestsController : ODataController
    {
        ...
        [HttpPost("odata/actionoverloadingquery/Default.ResetDataSource")]
