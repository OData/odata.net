...
using Microsoft.OData.E2E.TestCommon.Common.Server.Deltas;
...
namespace Microsoft.OData.Core.E2E.Tests.DeltaTests
{
    public class DeltaTests : EndToEndTestBase<DeltaTests.TestsStartup>
    {
        ...
        [InlineData("Customers(1)", "{\"FirstName\": \"Jane_1\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"changed\" }, \"OrderID\": 8 }]}", 8)]
        [InlineData("Customers(1)", "{\"FirstName\": \"Jane_2\", \"Orders@delta\": [{\"Id\": 8, \"@removed\": { \"reason\": \"changed\" }}]}", 8)]
        [InlineData("Customers(2)", "{\"FirstName\": \"Doe_1\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"changed\" }, \"OrderID\": 7 }, {\"OrderID\": 9, \"@removed\": { \"reason\": \"changed\" }}]}", 9)]
        ...
        [InlineData("Customers(1)", "{\"FirstName\": \"Jane_3\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"deleted\" }, \"OrderID\": 8 }]}", 8)]
        [InlineData("Customers(1)", "{\"FirstName\": \"Jane_4\", \"Orders@delta\": [{\"OrderID\": 8, \"@removed\": { \"reason\": \"deleted\" }}]}", 8)]
        [InlineData("Customers(2)", "{\"FirstName\": \"Doe_2\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"deleted\" }, \"OrderID\": 7 }, {\"OrderID\": 9, \"@removed\": { \"reason\": \"deleted\" }}]}", 9)]
        [InlineData("Customers(2)", "{\"FirstName\": \"Doe_3\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"changed\" }, \"OrderID\": 7 }, {\"OrderID\": 9, \"@removed\": { \"reason\": \"deleted\" }}]}", 7)]
        [InlineData("Customers(2)", "{\"FirstName\": \"Doe_4\", \"Orders@delta\": [{\"@removed\": { \"reason\": \"changed\" }, \"OrderID\": 7 }, {\"@removed\": { \"reason\": \"deleted\" }, \"OrderID\": 9}]}", 7)]
