...
using Microsoft.OData.Core.E2E.Tests.SingletonTests.Server;
...
public class SingletonQueryTests : EndToEndTestBase<SingletonQueryTests.TestsStartup>
{
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceEntriesAsync("Company", mimeType);
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceEntriesAsync("Boss/Microsoft.OData.E2E.TestCommon.Common.Server.Default.Customer", mimeType);
        var entry = entries.SingleOrDefault(e => e != null && e.TypeName.EndsWith("Customer"));
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceEntriesAsync("Boss", mimeType);
        var entry = entries.SingleOrDefault(e => e != null && e.TypeName.EndsWith("Customer"));
    ...
    {
        // Arrange & Act
        var resources = await TestsHelper.QueryResourceEntriesAsync("VipCustomer?$expand=Orders", mimeType);
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceEntriesAsync("VipCustomer?$select=PersonID,FirstName", mimeType);
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceEntriesAsync("Boss/Microsoft.OData.E2E.TestCommon.Common.Server.Default.Customer?$select=City", mimeType);
        var customer = entries.SingleOrDefault(e => e != null && e.TypeName.EndsWith("Customer"));
    ...
    {
        // Arrange & Act
        var resources = await TestsHelper.QueryResourceEntriesAsync("VipCustomer?$expand=Orders($select=OrderID,OrderDate)", mimeType);
        var entries = resources.Where(r => r != null && r.Id != null).ToList();
    ...
    {
        // Arrange & Act
        var resources = await TestsHelper.QueryResourceEntriesAsync("VipCustomer?$select=FirstName,HomeAddress&$expand=Orders", mimeType);
        var entries = resources.Where(r => r != null && r.Id != null).ToList();
    ...
    {
        // Arrange & Act
        var property = await TestsHelper.QueryPropertyAsync("VipCustomer/PersonID", mimeType);
    ...
    public async Task QuerySingletonPropertyUnderComplexProperty(string mimeType)
    {
        ...
        // Arrange & Act
        var property = await TestsHelper.QueryPropertyAsync("VipCustomer/HomeAddress/City", mimeType);
    ...
    {
        // Arrange & Act
        var property = await TestsHelper.QueryPropertyAsync("Company/CompanyCategory", mimeType);
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceSetsAsync("VipCustomer/Orders", mimeType);
    ...
    {
        // Arrange & Act
        var property = await TestsHelper.QueryPropertyAsync("VipCustomer/Orders(8)/OrderDate", mimeType);
    ...
    {
        // Arrange & Act
        var property = await TestsHelper.QueryPropertyAsync("Boss/Microsoft.OData.E2E.TestCommon.Common.Server.Default.Customer/City", mimeType);
    ...
    {
        // Arrange & Act
        var entries = await TestsHelper.QueryResourceSetsAsync("VipCustomer/Orders?$filter=OrderID eq 8", mimeType);
        var entry = entries.FirstOrDefault();
