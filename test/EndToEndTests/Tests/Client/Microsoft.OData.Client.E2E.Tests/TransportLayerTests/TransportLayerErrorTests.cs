...
namespace Microsoft.OData.Client.E2E.Tests.TransportLayerTests
{
    public class TransportLayerErrorTests : EndToEndTestBase<TransportLayerErrorTests.TestsStartup>
    {
        ...
        [Fact]
        public async Task JsonQueryWithInvalidDataServiceVersion_DoesNotThrowException()
        {
            ...
            Exception? exception = await Record.ExceptionAsync(async () => await _context.Customers.ExecuteAsync());
