...
namespace Microsoft.OData.Client.E2E.Tests.QueryOptionTests.Tests
{
    public class ExpandQueryOptionTests : EndToEndTestBase<ExpandQueryOptionTests.TestsStartup>
    {
        ...
        #region $expand and $search Query Options
        ...
        #region $expand query option with nested $expand and $ref options.
        [Theory]
        [MemberData(nameof(MimeTypesData))]
        ...
        #region $expand query option with nested $search and $filter options.
