...
namespace Microsoft.OData.Client.E2E.Tests.ClientWithoutTypeResolverTests.Server
{
    public class JsonWithoutTypeResolverTestsController : ODataController
    {
        ...
        {
            var customerPrimaryContactInfo = CommonEndToEndDataSource.Customers.SingleOrDefault(a => a.CustomerId == key);
        ...
        {
            var customerPrimaryContactInfoPhoneBag = CommonEndToEndDataSource.Customers.SingleOrDefault(a => a.CustomerId == key);
        ...
        {
            var customerPrimaryContactInfoContactAlias = CommonEndToEndDataSource.Customers.SingleOrDefault(a => a.CustomerId == key);
        ...
        {
            var contactAliasAlternativeNames = CommonEndToEndDataSource.Customers.SingleOrDefault(a => a.CustomerId == key);
        ...
        {
            var customers = CommonEndToEndDataSource.Customers.Where(a => a.Name == name);
        ...
        {
            var discontinuedProduct = CommonEndToEndDataSource.Products.OfType<DiscontinuedProduct>().SingleOrDefault(a => a.ProductId == key);
        ...
        {
            var mappedEntityType = CommonEndToEndDataSource.MappedEntityTypes.SingleOrDefault(a => a.Id == key);
