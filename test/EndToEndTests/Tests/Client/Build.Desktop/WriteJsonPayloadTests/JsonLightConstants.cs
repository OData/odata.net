...
namespace Microsoft.Test.OData.Tests.Client.WriteJsonPayloadTests
{
    ...
    public static class JsonLightConstants
    {
        ...
        public const string ODataAnnotationGroupAnnotationName = "odata.annotationGroup";

        /// <summary>The 'name' property name of an annotation group declaration.</summary>
        public const string ODataAnnotationGroupNamePropertyName = "name";

        /// <summary>The 'odata.annotationGroupReference' annotation name.</summary>
        public const string ODataAnnotationGroupReferenceAnnotationName = "odata.annotationGroupReference";
