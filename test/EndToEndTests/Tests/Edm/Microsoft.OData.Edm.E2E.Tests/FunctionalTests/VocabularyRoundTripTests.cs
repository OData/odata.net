...
public class VocabularyRoundTripTests : EdmLibTestCaseBase
{
    ...
    public void RoundTripOutOfLineAnnotationAmbiguousFunction()
    {
        ...
        Assert.True(errors.Count() > 0, "Invalid error count.");
        Assert.Equal(2, model.VocabularyAnnotations.Count(), "Invalid annotation count.");

        var annotationTarget = model.VocabularyAnnotations.First().Target;
        Assert.True(annotationTarget.ToString().Contains("AmbiguousFunctionBinding"), "Invalid target");
    ...
    public void RoundTripOutOfLineAnnotationAmbiguousFunctionImport()
    {
        ...
        var annotationTarget = model.VocabularyAnnotations.First().Target;
        Assert.True(annotationTarget.ToString().Contains("AmbiguousFunctionImportBinding"), "Invalid target");
    ...
    public void RoundTripOutOfLineAnnotationUnresolvedOperationImportAndParameterTarget()
    {
        ...
        Assert.Equal(EdmErrorCode.BadUnresolvedParameter, errors.First().ErrorCode, "Expecting BadUnresolvedFunctionParameter error");
    ...
    public void RoundTripOutOfLineAnnotationUnresolvedFunctionImportTarget()
    {
        ...
        Assert.Equal(1, errors.Count(), "Invalid error count.");
        Assert.Equal(EdmErrorCode.BadUnresolvedProperty, errors.First().ErrorCode, "Expecting BadUnresolvedProperty error");
