...
public class XElementAnnotationTest : EdmLibTestCaseBase
{
    ...
    public void XElementAnnotationTestSetNullAnnotationNameModel()
    {
        ...
        Assert.Equal(3, errors.Length, "error count");
        Assert.Equal(EdmErrorCode.InterfaceCriticalPropertyValueMustNotBeNull, errors.Select(e => e.ErrorCode).Distinct().Single(), "InterfaceCriticalPropertyValueMustNotBeNull");
    }
    ...
    public void XElementAnnotationTestOutOfLineVocabularyAnnotationWithAnnotationCsdl()
    {
        ...
        Assert.Equal(1, vocabularyAnnotation.Count(), "Invalid vocabulary count.");
        ...
        Assert.True(expectedAnnotationValue.ToString().Equals(actualAnnotationValue), "XElement annotation are not the same.");
    ...
    private void AnnotationRoundTripCsdlCheck(IEnumerable<XElement> csdls, XElement expectedAnnotation, AnnotationInfo annotationInfo, ElementLocation annotationLocation, IEdmModel model)
    {
        ...
        Assert.True(isValid, "Invalid XElement annotation.");
        ...
        Assert.Equal(0, serializationErrors.Count(), "Round trip test should not have serialization errors: " + Environment.NewLine + String.Join(Environment.NewLine, serializationErrors));
