...
public class EdmToClrConversion : EdmLibTestCaseBase
{
    ...
    public void ConvertPrimitiveTypes()
    {
        ...
        // OverflowException is expected here, since the value is out of range for byte
    ...
    public void ConvertCollections()
    {
        ...
        {
            Assert.Equal(elements[i], converted[i]);
        }
    ...
    public void TestConversionOfDuplicatePropValues()
    {
        ...
        Assert.Throws<InvalidCastException>(() => cv.AsClrValue<Cc2>(cc1));
    }
    ...
    public void ConvertNotSupportedCollectionProps()
    {
        ...
        Assert.Contains("EdmLibTests.FunctionalTests.EdmToClrConversion+NotSupportedCollectionProps", exception3.Message);
    }
    ...
    public void TryCreateObjectInstanceReturnsWrongObject()
    {
        ...
        Assert.Contains("EdmLibTests.FunctionalTests.EdmToClrConversion+NotSupportedCollectionProps2", exception.Message);
    }
