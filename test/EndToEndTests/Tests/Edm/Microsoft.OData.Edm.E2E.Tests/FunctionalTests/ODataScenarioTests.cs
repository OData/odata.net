...
<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    ...
    public void MultithreadedAnnotationsOnLargerModel()
    {
        ...
        Assert.True(setters.Count() >= 330, "Setters count");
        Assert.True(getters.Count() >= 60, "Getters count");
    ...
    public void MultithreadedPropertyAccess()
    {
        ...
        Assert.True(nonNullBaseTypeCount > 50000, "Many base types");
        Assert.True(nonNullPropertiesCount > 50000, "Many properties enumerables");
        Assert.True(nonNullPropertyTypeCount > 500000, "Many property types");
    }
