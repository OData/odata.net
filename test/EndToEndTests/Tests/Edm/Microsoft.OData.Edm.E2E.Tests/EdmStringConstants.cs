...
/// </summary>
public static class EdmStringConstants
{
    ...
    /// <summary>
    /// The namespace for EDM annotations
    /// </summary>
    public const string AnnotationNamespace = "http://schemas.microsoft.com/ado/2009/02/edm/annotation";

    /// <summary>
    /// The namespace for codegen
    /// </summary>
    public const string CodegenNamespace = "http://schemas.microsoft.com/ado/2006/04/codegeneration";
