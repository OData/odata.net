//---------------------------------------------------------------------
// <copyright file="BroadCoverageTestsDataSource.cs" company="Microsoft">
...
public class BroadCoverageTestsDataSource
{
    public static BroadCoverageTestsDataSource CreateInstance()
    {
        return new BroadCoverageTestsDataSource();
    }

    public BroadCoverageTestsDataSource()
    {
        ResetData();
        InitializeData();
    }
    ...
    public IList<Airline>? Airlines { get; private set; }
    ...
    private void InitializeData()
    {
        ...
        Event event1 = new Event()
        {
            ...
            StartsAt = new DateTimeOffset(new DateTime(2014, 5, 2, 13, 30, 50)),
        ...
        Event event2 = new Event()
        {
            ...
            ConfirmationCode = "",
            StartsAt = new DateTimeOffset(new DateTime(2014, 1, 1, 15, 21, 7)),
        ...
        Trip sampleTrip = new()
        {
            ...
            StartsAt = new DateTimeOffset(new DateTime(2014, 1, 1, 13, 30, 50)),
            EndsAt = new DateTimeOffset(new DateTime(2014, 1, 4)),
            Photos = new Collection<Photo>() { Photos[6], Photos[7], },
            PlanItems = new Collection<PlanItem>()
            {
                new Flight()
                {
                    PlanItemId = 11,
        ...
        this.Me = new Person()
        {
            ...
            [
                ...
                new Trip()
                {
                    ...
                    Photos = new Collection<Photo>() { Photos[3], Photos[4] },
                    PlanItems = new Collection<PlanItem>()
                    {
                        new Flight()
                        {
        ...
        [
            ...
            new Person()
            {
                ...
                Trips =
                {
                    ...
                    new Trip()
                    {
                        ...
                        StartsAt = new DateTimeOffset(new DateTime(2014, 2, 1)),
                        EndsAt = new DateTimeOffset(new DateTime(2014, 2, 4)),
                        Photos = new Collection<Photo>() { Photos[8], Photos[9], },
                        PlanItems = new Collection<PlanItem>()
                        {
                            new Flight()
                            {
                    ...
                    new Trip()
                    {
                        ...
                        Description = "Happy honeymoon trip",
                        Tags = new Collection<string>{"Travel", "honeymoon"},
                        StartsAt = new DateTime(2014, 2, 5, 10, 21, 7),
                        EndsAt = new DateTime(2014, 2, 4)
                    },
                    new Trip()
                    {
                        TripId = 001010,
                        ShareId = new Guid("5ce142c3-5fd6-4a71-848e-3220ebf1e9f3"),
                        Name = "Honeymoon",
                        Budget = 2650.10f,
                        Description = "Happy honeymoon trip23",
                        Tags = new Collection<string>{"Travel2", "honeymoon2"},
                        StartsAt = new DateTime(2014, 2, 5, 10, 21, 7),
                        EndsAt = new DateTime(2014, 2, 4)
                    },
                }
            ...
            new Person()
            {
                ...
                Trips =
                {
                    ...
                    new Trip()
                    {
                        ...
                        StartsAt = new DateTimeOffset(new DateTime(2014, 2, 1)),
                        EndsAt = new DateTimeOffset(new DateTime(2014, 2, 4)),
                        Photos = new Collection<Photo>() { Photos[13], Photos[14], },
                        PlanItems = new Collection<PlanItem>()
                        {
                            new Flight()
                            {
            ...
            new SpecialPerson()
            {
                FirstName = "Special",
                LastName = "Special",
                UserName = "thespecialperson",
                Gender = PersonGender.Female,
                SpecialID = "SP-123456789",
                Emails = new Collection<string> { "specialperson@example.com" },
            },
            new Person()
            {
                FirstName = "Marshall",
        ...
        People[0].Friends = [ People[1], People[2], People[3], People[14] ];
        People[1].Friends = [ People[0], People[2] ];
        People[2].Friends = [ People[0], People[1] ];
        People[3].Friends = [ People[4], People[5], People[13] ];
        People[4].Friends = [ People[3], People[5] ];
        People[5].Friends = [ People[3], People[4] ];
        People[6].Friends = [ People[7], People[17] ];
        People[7].Friends = [ People[6], People[8] ];
        People[8].Friends = [ People[7], People[10], People[12] ];
        People[10].Friends = [ People[8] ];
        People[12].Friends = [ People[8] ];
        People[13].Friends = [ People[3] ];
        People[14].Friends = [ People[0] ];
        People[15].Friends = [ People[16] ];
        People[16].Friends = [ People[15] ];
        People[17].Friends = [ People[7] ];
        People[18].Friends = [ People[19] ];
        People[19].Friends = [ People[18] ];
    ...
    private static Stream CreateDefaultStream()
    {
        ...
        try
        {
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Microsoft.OData.E2E.TestCommon.Common.Server.BroadCoverageTests.ODataLogo.jpg"))
            {
        ...
        {
            throw new Exception("The data source initialization of TripPin service failed.", ex);
        }
