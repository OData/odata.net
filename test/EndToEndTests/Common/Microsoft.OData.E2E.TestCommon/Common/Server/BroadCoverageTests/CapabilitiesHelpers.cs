...
public static class CapabilitiesHelpers
{
    ...
    {
        using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("Microsoft.OData.E2E.TestCommon.Common.Server.BroadCoverageTests.Vocabularies.CapabilitiesVocabularies.xml"))
        {
...
public enum CapabilitiesConformanceLevelType
{
    Minimal,
    Intermediate,
    Advanced
