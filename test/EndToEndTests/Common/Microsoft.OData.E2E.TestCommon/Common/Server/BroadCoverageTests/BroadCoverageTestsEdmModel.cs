//---------------------------------------------------------------------
// <copyright file="BroadCoverageTestsEdmModel.cs" company="Microsoft">
...
public class BroadCoverageTestsEdmModel
{
    public static IEdmModel GetEdmModel()
    {
        var model = new EdmModel();
        var ns = typeof(BroadCoverageTestsEdmModel).Namespace;
        ...
        var specialPersonType = new EdmEntityType(ns, "SpecialPerson", personType, false, true);
        specialPersonType.AddProperty(new EdmStructuralProperty(specialPersonType, "SpecialID", EdmCoreModel.Instance.GetString(false)));
        model.AddElement(specialPersonType);
        ...
        var path = new EdmPathExpression($"Trips/PlanItems/{ns}.Flight/Airline");
        ...
        path = new EdmPathExpression($"Trips/PlanItems/{ns}.Flight/From");
        ...
        path = new EdmPathExpression($"Trips/PlanItems/{ns}.Flight/To");
        ...
        var getFavoriteAirlineFunction = new EdmFunction(ns, "GetFavoriteAirline",
            ...
            new EdmPathExpression($"person/Trips/PlanItems/{ns}.Flight/Airline"), true);
        ...
        model.SetResourcePathCoreAnnotation(getNearestAirportFunctionImport, $"{ns}.GetNearestAirport");
