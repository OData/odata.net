...
namespace Microsoft.OData.E2E.TestCommon.Common.Server.Default
{
    public class DefaultDataSource
    {
        ...
        public void Initialize()
        {
            ...
            Products[0].Details = [ProductDetails[1], ProductDetails[2], ProductDetails[3], ProductDetails[4], ProductDetails[5]];
            ...
            ProductDetails[0].Reviews = new List<ProductReview>
            {
                ProductReviews[0],
                ProductReviews[1],
                ProductReviews[2],
            ...
            ProductDetails[1].Reviews = new List<ProductReview>
            {
                ProductReviews[1],
                ProductReviews[2],
                ProductReviews[3]
            ...
            (People[0] as Customer).Orders = [Orders[1]];
            (People[1] as Customer).Orders = [Orders[0], Orders[2]];
            (VipCustomer as Customer).Orders = [Orders[0], Orders[1]];
            ...
            Orders[0].OrderDetails = [OrderDetails[0]];
            ...
            Company.Departments = [Departments[0], Departments[1]];
                ...
                new Account()
                {
                    ...
                    [
                        new PaymentInstrument()
                        {
                            ...
                            TheStoredPI = StoredPIs.SingleOrDefault((it)=> it.StoredPIID == 802),
                        ...
                        new CreditCardPI()
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2012, 11, 1)),
                            TheStoredPI = StoredPIs.SingleOrDefault((it)=> it.StoredPIID == 801),
                            BackupStoredPI = DefaultStoredPI,
                            CVV = "234",
                        ...
                        new CreditCardPI()
                        {
                            ...
                            CreatedDate = new DateTimeOffset(new DateTime(2012, 11, 1)),
                            TheStoredPI = StoredPIs.SingleOrDefault((it)=> it.StoredPIID == 804),
                            BackupStoredPI = DefaultStoredPI,
                            CVV = "012",
                ...
                new Account()
                {
                    ...
                    [
                        ...
                        new PaymentInstrument()
                        {
                            ...
                            TheStoredPI = StoredPIs.SingleOrDefault((it)=> it.StoredPIID == 803),
                            BackupStoredPI = DefaultStoredPI
                        },
                        new PaymentInstrument()
                        {
                            ...
                            TheStoredPI = StoredPIs.SingleOrDefault((it)=> it.StoredPIID == 805),
                            BackupStoredPI = DefaultStoredPI
                        },
                        new PaymentInstrument()
                        {
