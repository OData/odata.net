...
namespace Microsoft.OData.E2E.TestCommon.Common.Server.EndToEnd
{
    public class CommonEndToEndDataSource
    {
        ...
        private void PopulateAllTypesSet()
        {
            ...
            [
                new()
                {
                    ...
                    GeogCollection = null,
                    GeogMultiPoint = null,
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeogMultiPolygon = null,
                    Geom = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0)")),
                    GeomPoint = WellKnownTextSqlFormatter.Create().Read<GeometryPoint>(new StringReader("SRID=0;POINT(0 0)")),
                    GeomLine = null,
                    GeomPolygon = null,
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION EMPTY")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT EMPTY")),
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeomMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPolygon>(new StringReader("SRID=0;MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 45 20, 30 5, 10 10," +
                            " 10 30, 20 35), (30 20, 20 25, 20 15, 30 20)))"))
                },
                new()
                {
                    Id = -9,
                    Geog = WellKnownTextSqlFormatter.Create().Read<GeographyPoint>(new StringReader("SRID=4326;POINT EMPTY")),
                    GeogPoint = GeographyPoint.Create(52.7892D, 172.826D),
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING EMPTY")),
                    GeogPolygon = null,
                    GeogCollection = null,
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((-122.7 47.38))")),
                    GeogMultiLine = null,
                    GeogMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPolygon>(new StringReader("SRID=4326;MULTIPOLYGON EMPTY")),
                    Geom = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeomPoint = GeometryPoint.Create(4369367.0586663447D, 6352015.6916818349D),
                    GeomLine = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0)")),
                    GeomPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))")),
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION EMPTY")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT ((0 0))")),
                    GeomMultiLine = null,
                ...
                new()
                {
                    ...
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (10 10, 20 20, 10 40)")),
                    GeogPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON EMPTY")),
                    GeogCollection = WellKnownTextSqlFormatter.Create().Read<GeographyCollection>(new StringReader("SRID=4326;GEOMETRYCOLLECTION EMPTY")),
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((-122.7 47.38))")),
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING ((10.5 10.5, 20.5 20.5, 10.5 40.5), (40.5 40.5, 30.5 30.5, 40.5 20.5, 30.5 10.5))")),
                    GeogMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPolygon>(new StringReader("SRID=4326;MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20)))")),
                    ...
                    GeomLine = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0)")),
                    GeomPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((30 20, 10 40, 45 40, 30 20))")),
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION (POINT (4 6), LINESTRING (4 6, 7 10))")),
                    GeomMultiPoint = null,
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING EMPTY")),
                    GeomMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPolygon>(new StringReader("SRID=0;MULTIPOLYGON EMPTY"))
                },
                new()
                {
                    Id = -7,
                    ...
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (10.5 10.5, 20.5 20.5, 10.5 40.5)")),
                    GeogPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeogCollection = null,
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((-122.7 47.38))")),
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    ...
                    GeomLine = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3)")),
                    GeomPolygon = null,
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION EMPTY")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT ((0 0))")),
                    GeomMultiLine = null,
                ...
                new()
                {
                    ...
                    GeogMultiPoint = null,
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeogMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPolygon>(new StringReader("SRID=4326;MULTIPOLYGON (((30 20, 10 40, 45 40, 30 20)), ((15 5, 40 10, 10 20, 5 10, 15 5)))")),
                ...
                {
                    Id = -5,
                    Geog = WellKnownTextSqlFormatter.Create().Read<GeographyCollection>(new StringReader("SRID=4326;GEOMETRYCOLLECTION EMPTY")),
                    GeogPoint = null,
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (10.5 10.5, 20.5 20.5, 10.5 40.5)")),
                    GeogPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeogCollection = WellKnownTextSqlFormatter.Create().Read<GeographyCollection>(new StringReader("SRID=4326;GEOMETRYCOLLECTION (GEOMETRYCOLLECTION EMPTY, GEOMETRYCOLLECTION (POINT (1 2)))")),
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((-122.7 47.38))")),
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING EMPTY")),
                    GeogMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPolygon>(new StringReader("SRID=4326;MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20)))")),
                    Geom = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON EMPTY")),
                    ...
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION (GEOMETRYCOLLECTION EMPTY, GEOMETRYCOLLECTION (POINT (1 2)))")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT EMPTY")),
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeomMultiPolygon = null
                },
                ...
                {
                    Id = -4,
                    Geog = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeogPoint = GeographyPoint.Create(52.8606D, 173.334D),
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING EMPTY")),
                    GeogPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeogCollection = null,
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((178.94 51.5961), (172.826 52.7892), (177.539 52.1022), (177.508 51.9917), (173.153 52.8453), (173.045 52.8103), (177.76 51.9461))")),
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING EMPTY")),
                    GeogMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPolygon>(new StringReader("SRID=4326;MULTIPOLYGON EMPTY")),
                    ...
                    GeomLine = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3)")),
                    GeomPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION EMPTY")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT ((4541876.7599749668 5944203.8929384714), (4358017.0935490858 6362964.504044747), (4515785.037825482 6055723.864035368), (4505479.22279754 6049837.1931612007), (4377000.868172125 6348217.1067010015))")),
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING ((10 10, 20 20, 10 40), (40 40, 30 30, 40 20, 30 10))")),
                    GeomMultiPolygon = null
                },
                new()
                {
                    ...
                    GeogPoint = GeographyPoint.Create(51.65D, 178.7D),
                    GeogLine = WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (40 40, 30 30, 40 20, 30 10)")),
                    GeogPolygon = null,
                    GeogCollection = null,
                    GeogMultiPoint = null,
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING EMPTY")),
                    GeogMultiPolygon = null,
                    Geom = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3)")),
                    GeomPoint = null,
                    GeomLine = WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0, 1 1)")),
                    GeomPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeomCollection = WellKnownTextSqlFormatter.Create().Read<GeometryCollection>(new StringReader("SRID=0;GEOMETRYCOLLECTION EMPTY")),
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT EMPTY")),
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING ((10.5 10.5, 20.5 20.5, 10.5 40.5), (40.5 40.5, 30.5 30.5, 40.5 20.5, 30.5 10.5))")),
                    GeomMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPolygon>(new StringReader("SRID=0;MULTIPOLYGON (((40 40, 20 45, 45 30, 40 40)), ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20)))"))
                },
                new()
                {
                    Id = -2,
                    ...
                    GeogPolygon = WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    GeogCollection = WellKnownTextSqlFormatter.Create().Read<GeographyCollection>(new StringReader("SRID=4326;GEOMETRYCOLLECTION (GEOMETRYCOLLECTION EMPTY, GEOMETRYCOLLECTION (POINT (1 2)))")),
                    GeogMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeographyMultiPoint>(new StringReader("SRID=4326;MULTIPOINT ((173.334 52.8606), (178.7 51.65), (179.5 51.9125), (179.728 51.9222), (173.105 52.795), (172.914 52.9778))")),
                    GeogMultiLine = WellKnownTextSqlFormatter.Create().Read<GeographyMultiLineString>(new StringReader("SRID=4326;MULTILINESTRING EMPTY")),
                    GeogMultiPolygon = null,
                ...
                new()
                {
                    ...
                    GeomMultiPoint = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPoint>(new StringReader("SRID=0;MULTIPOINT ((4541876.7599749668 5944203.8929384714), (4358017.0935490858 6362964.504044747), (4515785.037825482 6055723.864035368), (4505479.22279754 6049837.1931612007), (4377000.868172125 6348217.1067010015))")),
                    GeomMultiLine = WellKnownTextSqlFormatter.Create().Read<GeometryMultiLineString>(new StringReader("SRID=0;MULTILINESTRING EMPTY")),
                    GeomMultiPolygon = WellKnownTextSqlFormatter.Create().Read<GeometryMultiPolygon>(new StringReader("SRID=0;MULTIPOLYGON (((30 20, 10 40, 45 40, 30 20)), ((15 5, 40 10, 10 20, 5 10, 15 5)))"))
                }
            ];
        }
        ...
        private void PopulateAllCollectionTypesSet()
        {
            ...
            [
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (40 40, 30 30, 40 20, 30 10)"))
                    },
                    ManyGeogPolygon = new List<GeographyPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))"))
                    },
                    ...
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0)"))
                    },
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))"))
                    }
                },
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeomLine = new List<GeometryLineString>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3)"))
                    },
                    ManyGeomPolygon = new List<GeometryPolygon>()
                },
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((30 20, 10 40, 45 40, 30 20))")),
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))"))
                    }
                },
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeogPolygon = new List<GeographyPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((30 20, 10 40, 45 40, 30 20))")),
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))"))
                    },
                    ManyGeomPoint = new List<GeometryPoint>
                    {
                ...
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON EMPTY"))
                    }
                },
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeogLine = new List<GeographyLineString>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (10.5 10.5, 20.5 20.5, 10.5 40.5)")),
                        WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING (40.5 40.5, 30.5 30.5, 40.5 20.5, 30.5 10.5)"))
                    },
                    ManyGeogPolygon = new List<GeographyPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
                    ...
                    ManyGeomLine = new List<GeometryLineString>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0, 1 1)")),
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3, 2 4, 2 0)"))
                    },
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                ...
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    ManyGeomPoint = new List<GeometryPoint>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryPoint>(new StringReader("SRID=0;POINT EMPTY"))
                    },
                    ManyGeomLine = new List<GeometryLineString>(),
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                ...
                new AllSpatialCollectionTypes_Simple()
                {
                    ...
                    {
                        GeographyPoint.Create(51.9917D, 177.508D),
                        WellKnownTextSqlFormatter.Create().Read<GeographyPoint>(new StringReader("SRID=4326;POINT EMPTY"))
                    },
                    ManyGeogLine = new List<GeographyLineString>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyLineString>(new StringReader("SRID=4326;LINESTRING EMPTY"))
                    },
                    ManyGeogPolygon = new List<GeographyPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeographyPolygon>(new StringReader("SRID=4326;POLYGON ((20 35, 45 20, 30 5, 10 10, 10 30, 20 35), (30 20, 20 25, 20 15, 30 20))")),
                    ...
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING (1 1, 3 3)")),
                        WellKnownTextSqlFormatter.Create().Read<GeometryLineString>(new StringReader("SRID=0;LINESTRING EMPTY"))
                    },
                    ManyGeomPolygon = new List<GeometryPolygon>
                    {
                        WellKnownTextSqlFormatter.Create().Read<GeometryPolygon>(new StringReader("SRID=0;POLYGON ((15 5, 40 10, 10 20, 5 10, 15 5))")),
        ...
        private void PopulateCustomers() => Customers =
            [
