...
namespace Microsoft.OData.E2E.TestCommon.Common.Server.ComplexTypes
{
    public class ComplexTypeTestsController : ODataController
    {
        ...
        [EnableQuery]
        [HttpGet("odata/People({key})/HomeAddress/Microsoft.OData.E2E.TestCommon.Common.Server.Default.HomeAddress/FamilyName")]
