...
namespace Microsoft.OData.E2E.TestCommon.Common.Server.MultipleKeys
{
    public class MultipleKeysEnumKeyDataSource
    {
        ...
        {
            Employees = new List<EmployeeWithEnumKey>
            {
                new()
                {
                    EmployeeNumber = 1,
                    ...
                    Salary = 10000,
                    OrganizationId = 1,
                    Organization = Organizations.First(a => a.Id == 1)
                },
                new()
                {
                    EmployeeNumber = 2,
                    ...
                    Salary = 20000,
                    OrganizationId = 2,
                    Organization = Organizations.First(a => a.Id == 2)
                },
                new()
                {
                    EmployeeNumber = 3,
                    ...
                    Salary = 30000,
                    OrganizationId = 3,
                    Organization = Organizations.First(a => a.Id == 3)
                },
                new()
                {
                    EmployeeNumber = 4,
            ...
            {
                org.Employees = Employees.Where(e => e.OrganizationId == org.Id).ToList();
            }
        }
