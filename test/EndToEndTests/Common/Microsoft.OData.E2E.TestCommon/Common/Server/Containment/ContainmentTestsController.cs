...
namespace Microsoft.OData.E2E.TestCommon.Common.Server.Containment
{
    public class ContainmentTestsController : ODataController
    {
        ...
        [EnableQuery]
        [HttpGet("odata/Accounts({key})/MyPaymentInstruments({paymentInstrumentId})/Microsoft.OData.E2E.TestCommon.Common.Server.Default.CreditCardPI")]
        ...
        [EnableQuery]
        [HttpGet("odata/Accounts({key})/MyPaymentInstruments/Microsoft.OData.E2E.TestCommon.Common.Server.Default.CreditCardPI")]
        ...
        [EnableQuery]
        [HttpGet("odata/Accounts({key})/MyPaymentInstruments({paymentInstrumentId})/Microsoft.OData.E2E.TestCommon.Common.Server.Default.CreditCardPI/CreditRecords")]
