...
{
    // Regression tests guarding against re-introduction of the Blazor Server / WPF Dispatcher
    // deadlock reported in https://github.com/OData/odata.net/issues/3521.
    //
    // The deadlock arises when an await inside the OData client transport layer captures the caller's
