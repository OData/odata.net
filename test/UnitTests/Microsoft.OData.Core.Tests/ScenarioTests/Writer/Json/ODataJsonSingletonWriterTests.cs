//---------------------------------------------------------------------
// <copyright file="ODataJsonSingletonWriterTests.cs" company="Microsoft">
...
{
    public class ODataJsonSingletonWriterTests
    {
        ...
        public ODataJsonSingletonWriterTests()
        {
        ...
        private void WriteEntryAndValidatePayloadWithoutModel(ODataResource entry, string expectedPayload, bool writingResponse = true, bool setMetadataDocumentUri = true)
        {
            ...
            ODataJsonOutputContext outputContext = CreateJsonOutputContext(stream, writingResponse, this.userModel, setMetadataDocumentUri ? this.serviceDocumentUri : null);
            ...
            ODataJsonWriter writer = new ODataJsonWriter(outputContext, /*navigationSource*/ null, /*entityType*/ null, /*writingFeed*/ false);
        ...
        private void WriteEntryAndValidatePayloadWithModel(ODataResource entry, string expectedPayload, bool writingResponse = true, bool setMetadataDocumentUri = true)
        {
            ...
            ODataJsonWriter writer = new ODataJsonWriter(outputContext, /*navigationSource*/ singleton, /*entityType*/ webType, /*writingFeed*/ false);
            WriteEntryAndValidatePayload(entry, stream, writer, expectedPayload);
        }

        private static void WriteEntryAndValidatePayload(ODataResource entry, MemoryStream stream, ODataJsonWriter writer, string expectedPayload)
        {
