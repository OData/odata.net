//---------------------------------------------------------------------
// <copyright file="WritingJsonWithoutModelAcceptanceTests.cs" company="Microsoft">
...
{
    public class WritingJsonWithoutModelAcceptanceTests
    {
        [Fact]
        public void ShouldBeAbleToWriteFeedAndEntryResponseInJsonWithoutModel()
        {
