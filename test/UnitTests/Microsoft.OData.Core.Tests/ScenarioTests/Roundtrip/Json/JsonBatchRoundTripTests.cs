...
namespace Microsoft.OData.Tests.ScenarioTests.Roundtrip.Json
{
    public class JsonBatchRoundTripTests
    {
        ...
        [Fact]
        public void BatchJsonAtomicGroupIdAndTopLevelDataModificationRequestTest()
        {
        ...
        [Fact]
        public void BatchJsonMultipleAtomicGroupsIdTest()
        {
        ...
        [Fact]
        public void BatchJsonAtomicGroupCannotCreateGroupIdWithNullValue()
        {
                ...
                using (ODataMessageWriter operationMessageWriter = new ODataMessageWriter(createOperationMessage))
                {
                    ...
                    ODataResource entry = new ODataResource()
                    {
                        ...
                        Properties = new[]
                        {
                            ...
                            new ODataProperty() { Name = "Name", Value = "SingletonWebForBatchJsonAtomicGroupIdTest" }
                        }
                    };
                    ...
                    using (ODataMessageWriter operationMessageWriter = new ODataMessageWriter(createOperationMessage))
                    {
                        ...
                        ODataResource entry = new ODataResource()
                        {
                            ...
                            Properties = new[]
                            {
                                ...
                                {
                                    Name = "Name",
                                    Value = "SingletonWebForBatchJsonAtomicGroupIdTest"
                                }
                            }
                        };
                        entryWriter.WriteStart(entry);
