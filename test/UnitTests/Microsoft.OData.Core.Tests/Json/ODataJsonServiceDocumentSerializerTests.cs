//---------------------------------------------------------------------
// <copyright file="ODataJsonServiceDocumentSerializerTests.cs" company="Microsoft">
...
{
    public class ODataJsonServiceDocumentSerializerTests
    {
        [Fact]
        ...
        private static ODataJsonServiceDocumentSerializer CreateODataJsonServiceDocumentSerializer(Stream memoryStream, IODataPayloadUriConverter urlResolver = null, bool isAsync = false)
        {
        ...
        private static Action WriteServiceDocumentShouldError(ODataServiceDocument serviceDocument, IODataPayloadUriConverter urlResolver = null)
        {
            ...
            var serializer = CreateODataJsonServiceDocumentSerializer(memoryStream, urlResolver);
        ...
        {
            MemoryStream memoryStream = new MemoryStream();
            var serializer = CreateODataJsonServiceDocumentSerializer(memoryStream);
