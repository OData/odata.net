...
{
    [Fact]
    public async Task WhenNoConditionProvided_SkipPropertiesWithODataIgnoreAttribute()
    {
        // Arrange
    ...
    [Fact]
    public async Task WhenConditionIsAlways_SkipPropertiesWithODataIgnoreAttribute()
    {
        // Arrange
    ...
    [Fact]
    public async Task WhenConditionIsNever_DoesNotSkipProperty()
    {
        // Arrange
