//---------------------------------------------------------------------
// <copyright file="LateBoundBaseExpressionVisitor.cs" company="Microsoft">
    ...
    internal abstract class ExpressionVisitor
    {
        ...
        internal virtual Expression Visit(Expression exp)
        {
            ...
            switch (exp.NodeType)
            {
                ...
                default:
                    throw new NotSupportedException("Not supported - " + exp.NodeType.ToString());
            }
        }
        ...
        internal virtual MemberBinding VisitBinding(MemberBinding binding)
        {
            switch (binding.BindingType)
            {
                ...
                default:
                    throw new NotSupportedException("Not supported - " + binding.BindingType.ToString());
            }
        }
