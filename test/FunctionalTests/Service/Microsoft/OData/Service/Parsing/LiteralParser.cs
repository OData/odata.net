...
#endif
{
    ...
    internal abstract class LiteralParser
    {
        ...
        /// </summary>
        private static readonly IDictionary<Type, PrimitiveParser> Parsers = new Dictionary<Type, PrimitiveParser>(Microsoft.OData.Service.ReferenceEqualityComparer<Type>.Instance)
        {
            ...
            // Types with suffixes.
            { typeof(Int64), DelegatingPrimitiveParser<long>.WithSuffix(XmlConvert.ToInt64, XmlConstants.LiteralSuffixInt64, /*required*/ false) },
        ...
        private sealed class DecimalPrimitiveParser : DelegatingPrimitiveParser<decimal>
        {
            ...
            internal DecimalPrimitiveParser()
                : base(ConvertDecimal, XmlConstants.LiteralSuffixDecimal, false)
            {
            }
