...
namespace Microsoft.OData.Service.Serializers
{
    ...
    internal abstract class Serializer
    {
        ...
        private static readonly String[] NextPageQueryParametersToCopy =
        {
            ...
            XmlConstants.HttpQueryStringQueryCount,
        ...
        internal static IEnumerable GetCollectionEnumerable(object collectionPropertyValue, string propertyName)
        {
            ...
            {
                throw new InvalidOperationException(Microsoft.OData.Service.Strings.Serializer_CollectionCanNotBeNull(propertyName));
            }

            IEnumerable enumerable;
            if (!WebUtil.IsElementIEnumerable(collectionPropertyValue, out enumerable))
            {
                throw new InvalidOperationException(Microsoft.OData.Service.Strings.Serializer_CollectionPropertyValueMustImplementIEnumerable(propertyName));
            }
        ...
        internal static object GetPrimitiveValue(object propertyValue)
        {
            ...
            // For spatial data, ODataLib only understands the types in Microsoft.Spatial, not the ones defined
            ...
            {
                return WebUtil.ConvertDateTimeToDateTimeOffset((DateTime)propertyValue);
            }
        ...
        internal void WriteRequest(QueryResultInfo queryResults)
        {
            ...
            if (this.requestDescription.IsSingleResult)
            {
                ...
                {
                    throw new InvalidOperationException(Microsoft.OData.Service.Strings.SingleResourceExpected);
                }
            }
            else
            {
        ...
        protected bool AddToComplexTypeCollection(object complexTypeInstance)
        {
            ...
            {
                this.complexTypeCollection = new HashSet<object>(Microsoft.OData.Service.ReferenceEqualityComparer<object>.Instance);
            }
        ...
        protected void IncrementSegmentResultCount()
        {
            if (this.segmentInfo != null)
            {
                ...
                if (max != Int32.MaxValue || this.IsCustomPaged)
                {
                    ...
                    {
                        throw DataServiceException.CreateBadRequestError(Microsoft.OData.Service.Strings.Serializer_ResultsExceedMax(max));
                    }
        ...
        private IEnumerable<ODataProperty> GetPropertiesOfComplexType(object resource, ResourceType resourceType, string propertyName)
        {
            ...
            {
                throw new InvalidOperationException(Microsoft.OData.Service.Strings.Serializer_LoopsNotAllowedInComplexTypes(propertyName));
            }
