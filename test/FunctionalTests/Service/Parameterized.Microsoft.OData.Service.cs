...
namespace Microsoft.OData.Service {
    ...
    internal static class Strings {
        ...
        /// <summary>
        /// A string like "The value '{0}' given in the '{1}' header was not recognized. Expected values are '{2}' and '{3}'."
        /// </summary>
        internal static string UrlConvention_BadRequestIfUnknown(object p0, object p1, object p2, object p3) {
            return Microsoft.OData.Service.TextRes.GetString(Microsoft.OData.Service.TextRes.UrlConvention_BadRequestIfUnknown, p0, p1, p2, p3);
        }
