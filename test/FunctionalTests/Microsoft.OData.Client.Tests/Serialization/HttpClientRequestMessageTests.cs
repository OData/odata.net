    ...
    public class HttpClientRequestMessageTests
    {
        ...
        public void WhenHttpClientHandlerProviderIsSet_UsesReturnedHttpClientHandler_ToMakeRequest()
        {
            ...
            using (var handler = new MockHttpClientHandler(expectedResponse))
            {
                ...
                var httpClientHandlerProvider = new MockHttpClientProvider(handler);
        ...
        {
            // Arrange
            using (var handler = new MockDelayedHttpClientHandler("Success", 3000))
            {
                var httpClientProvider = new MockHttpClientProvider(handler);
                var args1 = new DataServiceClientRequestMessageArgs(
                    "GET",
        ...
        {
            // Arrange
            using (var handler = new MockDelayedHttpClientHandler("success", delayMilliseconds: 3000))
            {
