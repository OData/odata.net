//---------------------------------------------------------------------
// <copyright file="EdmStructsTests.cs" company="Microsoft">
    ...
    public class EdmStructsTests
    {
        ...
        public void TestDateGetHashCode()
        {
            ...
            foreach (var tuple in list)
            {
                ...
                Assert.AreEqual(tuple.Item3, hashCode1 == hashCode2);
            }
        }
        ...
        public void TestDateToString()
        {
            ...
            foreach (var tuple in list)
            {
                Assert.AreEqual(tuple.Item2, tuple.Item1.ToString());
            }
        }
        ...
        public void TestTimeOfDayCtor()
        {
            ...
            foreach (var tuple in list)
            {
                ...
                Assert.AreEqual(tuple.Item1, time.Hours);
                Assert.AreEqual(tuple.Item2, time.Minutes);
                Assert.AreEqual(tuple.Item3, time.Seconds);
                Assert.AreEqual(tuple.Item4, time.Milliseconds);
            }
        }
        ...
        public void TestTimeOfDayTicksCtor()
        {
            ...
            foreach (var tuple in list)
            {
                ...
                Assert.AreEqual(tuple.Item2, time);
                Assert.AreEqual(tuple.Item1, time.Ticks);
            }
        }
        ...
        public void TestTimeOfDayToTimeSpan()
        {
            ...
            foreach (var timeOfDay in list)
            {
                ...
                Assert.AreEqual(timeOfDay.Ticks, timeSpan.Ticks);
            }
        }
        ...
        public void TestTimeSpanToTimeOfDay()
        {
            ...
            foreach (var timeSpan in list)
            {
                ...
                Assert.AreEqual(timeSpan.Ticks, timeOfDay.Ticks);
            }
        }
        ...
        public void TestTimeOfDayGetHashCode()
        {
            ...
            foreach (var tuple in list)
            {
                var hashCode1 = tuple.Item1.GetHashCode();
                var hashCode2 = tuple.Item2.GetHashCode();
                Assert.AreEqual<bool>(tuple.Item3, hashCode1 == hashCode2);
            }
        }
