...
namespace Microsoft.Test.Edm.TDD.Tests.Library
{
    ...
    public class EdmSingletonTests
    {
        ...
        public void EdmSingletonAnnotationTests() 
        {
            ...
            Assert.AreEqual(vipCustomer, singletonAnnotation.Target);
            Assert.AreEqual("SingletonAnnotation", singletonAnnotation.Term.Name);
            ...
            Assert.AreEqual(customerProperty, singletonPropertyAnnotation.Target);
            Assert.AreEqual("SingletonPropertyAnnotation", singletonPropertyAnnotation.Term.Name);
        }
    }
}
