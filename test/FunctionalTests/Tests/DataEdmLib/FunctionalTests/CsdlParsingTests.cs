...
namespace EdmLibTests.FunctionalTests
{
    ...
    {
        [TestMethod]
        public void CsdlReadEmptyModel()
        {
        ...
        [TestMethod]
        public void CsdlReadEmptyModel2()
        {
        ...
        [TestMethod]
        public void CsdlReadSimpleModel()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    ...
    <EntityType Name=""Customer"">
      ...
      <Property Name=""CustomerID"" Type=""String"" Nullable=""false"" />
        ...
        [TestMethod]
        public void CsdlReadNonNullableCollection()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <EntityContainer Name=""C1"">
    ...
    <EntityType Name=""Customer"">
      ...
      <Property Name=""Names"" Type=""Collection(String)"" Nullable=""false"" />
        ...
        [TestMethod]
        public void CsdlReadNullableCollection()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <EntityContainer Name=""C1"">
    ...
    <EntityType Name=""Customer"">
      ...
      <Property Name=""Names"" Type=""Collection(String)"" Nullable=""true"" />
        ...
        [TestMethod]
        public void CsdlReadCollectionNavigationProperty()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <EntityContainer Name=""C1"">
    ...
    <EntityType Name=""Pet"">
        ...
        [TestMethod]
        public void CsdlReadNullableCollectionNavigationPropertyShouldFail()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <EntityContainer Name=""C1"">
    ...
    <Property Name=""OwnerId"" Type=""Int32"" Nullable=""false"" />
        ...
        [TestMethod]
        public void CsdlReadNonNullableCollectionNavigationPropertyShouldFail()
        {
            var csdl =
@"<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <EntityContainer Name=""C1"">
    ...
    <Property Name=""OwnerId"" Type=""Int32"" Nullable=""false"" />
        ...
        [TestMethod]
        public void CsdlReadEntityContainer()
        {
            const string csdl =
  ...
  <EntityContainer Name=""Wild"">
    ...
    <EntitySet Name=""People"" EntityType=""Hot.Person"">
      <NavigationPropertyBinding Path=""Pet"" Target=""Pets"" />
        ...
        [TestMethod]
        public void CsdlReadNonContainedEntityInContainedEntity()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Hot"" Alias=""Fuzz"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <EntityContainer Name=""Wild"">
    ...
    <EntitySet Name=""People"" EntityType=""Hot.Person"" >
        ...
        [TestMethod]
        public void CsdlReadNonContainedEntityInContainedEntityWithWrongPath()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Hot"" Alias=""Fuzz"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <EntityContainer Name=""Wild"">
    ...
    <EntitySet Name=""People"" EntityType=""Hot.Person"" >
        ...
        [TestMethod]
        public void CsdlReadNonContainedDerivedEntityInContainedEntity()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Hot"" Alias=""Fuzz"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <EntityContainer Name=""Wild"">
    ...
    <Singleton Name=""SingletonPeople"" Type=""Hot.Person"">
      <NavigationPropertyBinding Path=""Pet"" Target=""Pets"" />
        ...
        [TestMethod]
        public void CsdlReadParseDocumentation()
        {
  ...
  <EntityType Name=""Person"">
    ...
    <Documentation>
      ...
      <LongDescription>Or at length</LongDescription>
        ...
        [TestMethod]
        public void CsdlReadAssociationAndNavigationProperty()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Cold"" Alias=""Comfort"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <EntityType Name=""Reckless"">
    ...
    <NavigationProperty Name=""MyFecklesses"" Type=""Collection(Comfort.Feckless)"" ContainsTarget=""true"" Partner=""MyReckless"" />
        ...
        [TestMethod]
        public void CsdlReadSelfReferencingNavigationProperty()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Cold"" Alias=""Comfort"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  <EntityType Name=""Feckless"">
    ...
    <NavigationProperty Name=""MyFeckless"" Type=""Comfort.Feckless"" Partner=""MyFeckless"">
      ...
      <OnDelete Action=""Cascade"" />
        ...
        [TestMethod]
        public void CsdlReadSelfReferencingOneToManyNavigationProperty()
        {
            const string csdl =
@"<?xml version=""1.0"" encoding=""utf-16""?>
<Schema Namespace=""Cold"" Alias=""Comfort"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
...
<Schema Namespace=""Mumble"" Alias=""Self"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  <ComplexType Name=""Clod"" BaseType=""Stumble.Smod"">
    ...
    <Property Name=""Address"" Type=""String"" MaxLength=""2048"" />
            ...
            IEdmModel model;
            IEnumerable<EdmError> errors;
            bool parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl1)), XmlReader.Create(new StringReader(csdl2)) }, out model, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
<Schema Namespace=""NameSpace3"" Alias=""NS3"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <ComplexType Name=""MyComplex2"" BaseType=""NS3.MyComplex1"" OpenType=""false"">
    ...
    <Property Name=""Name"" Type=""Int32"" Nullable=""false"" />
            ...
            IEdmModel model;
            IEnumerable<EdmError> errors;
            bool parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl1)), XmlReader.Create(new StringReader(csdl2)), XmlReader.Create(new StringReader(csdl3)) }, out model, out errors);
            //Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
      ...
      <EntityContainer Name=""fooContainer"">
        ...
        <FunctionImport Name=""peopleWhoAreAwesomeFunction"" Function=""foo.peopleWhoAreAwesome"" EntitySet=""People"" />
            ...
            IEdmEntitySet eset;
            Assert.IsTrue(peopleWhoAreAwesome.TryGetStaticEntitySet(out eset), "peopleWhoAreAwesome.TryGetStaticEntitySet");
            Assert.AreEqual(peopleSet, eset, "Return EntitySet name is correct");
            IEdmEntitySet fiEntitySet;
            Assert.IsTrue(peopleWhoAreAwesome.TryGetStaticEntitySet(out fiEntitySet), "peopleWhoAreAwesome.TryGetStaticEntitySet");
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  ...
  <EntityContainer Name=""fooContainer"">
    ...
    <FunctionImport Name=""pathWithCasts3"" Function=""foo.pathWithCasts3"" />
            ...
            Assert.IsTrue(operationImports[0].TryGetStaticEntitySet(out eset), "operationImports[0].TryGetStaticEntitySet");
            ...
            IEdmEntitySet eset2;
            Assert.IsTrue(operationImports[3].TryGetStaticEntitySet(out eset2), "operationImports[3].TryGetStaticEntitySet");
            Assert.IsFalse(operationImports[0].TryGetRelativeEntitySetPath(model, out p, out np, out entitySetPathErrors), "operationImports[0].TryGetRelativeEntitySetPath");
            ...
            Assert.IsFalse(operationImports[6].TryGetStaticEntitySet(out eset), "operationImports[6].TryGetStaticEntitySet");
            ...
            Assert.IsFalse(operationImports[7].TryGetStaticEntitySet(out eset), "operationImports[7].TryGetStaticEntitySet");
            ...
            Assert.IsFalse(operationImports[8].TryGetStaticEntitySet(out eset), "operationImports[8].TryGetStaticEntitySet");
            ...
            Assert.IsFalse(operationImports[9].TryGetStaticEntitySet(out eset), "operationImports[9].TryGetStaticEntitySet");
            ...
            Assert.IsFalse(operationImports[10].TryGetStaticEntitySet(out eset), "operationImports[10].TryGetStaticEntitySet");
...
<Schema Namespace=""Real3"" Alias=""Real3_Alias"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
  <ComplexType Name=""Complex3"" BaseType=""Real1_Alias.Complex1"">
    <Property Name=""Prop3"" Type=""Edm.Int32"" Nullable=""false"" />
            ...
            IEdmModel model;
            IEnumerable<EdmError> errors;
            bool parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(inputText1)), XmlReader.Create(new StringReader(inputText2)), XmlReader.Create(new StringReader(inputText3)) }, out model, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
      ...
      <EntityContainer Name=""fooContainer"">
        ...
        <ActionImport Name=""peopleWhoAreAwesome"" Action=""foo.peopleWhoAreAwesome"" EntitySet=""BadEntitySet"" />
            ...
            Assert.IsTrue(peopleWhoAreAwesome.TryGetStaticEntitySet(out badSet), "peopleWhoAreAwesome.TryGetStaticEntitySet");
            Assert.AreEqual(EdmErrorCode.BadUnresolvedEntitySet, badSet.EntityType().Errors().First().ErrorCode, "Type is bad by association");
            Assert.AreEqual(String.Empty, badSet.EntityType().Name, "Bad set's entity has empty name");
            Assert.AreEqual(EdmContainerElementKind.EntitySet, badSet.ContainerElementKind, "Bad set has correct container element kind");

            Assert.IsFalse(EdmValidator.Validate(model, EdmConstants.EdmVersion4, out errors), "EdmValidator.Validate(model");
            Assert.AreEqual(1, errors.Count(), "Correct number of errors");
            Assert.AreEqual(EdmErrorCode.BadUnresolvedEntitySet, errors.First().ErrorCode, "Correct error code");
        }
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    ...
    <Annotations Target=""foo.Person"">
        ...
        <Annotation Term=""foo.DistantAge"" Int=""99"" />
            ...
            IEdmModel model1;
            IEnumerable<EdmError> errors;
            bool parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl1)) }, out model1, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");

            IEdmModel model2;
            parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl2)) }, new IEdmModel[] { model1 }, out model2, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <Annotations Target=""foo.bar/PersonsOfInterest"">
        <Annotation Term=""Funk.Strange"" Int=""13"" />
            ...
            IEdmModel model2;
            parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl2)) }, new IEdmModel[] { model }, out model2, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
@"<Schema Namespace=""foo"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    <Annotations Target=""foo.Person/Birthday"">
        <Annotation Term=""Funk.Strange"" Int=""13"" />
            ...
            IEdmModel model2;
            parsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl2)) }, model, out model2, out errors);
            Assert.IsTrue(parsed, "parsed");
            Assert.IsTrue(errors.Count() == 0, "No errors");
...
<Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
    ...
    <Function Name=""Foo"">
        <ReturnType>
            ...
            IEdmModel edmModel;
            IEnumerable<EdmError> errors;
            var isParsed = CsdlReader.TryParse(new XmlReader[] { XmlReader.Create(new StringReader(csdl)) }, out edmModel, out errors);
            Assert.IsFalse(isParsed, "CsdlReader.TryParse failed");
            Assert.IsTrue(errors.Count() == 4, "CsdlReader.TryParse returned errors");
