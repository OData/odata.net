//---------------------------------------------------------------------
// <copyright file="EdmxParsingTests.cs" company="Microsoft">
  ...
  <edmx:DataServices>
    <Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
        ...
        <EntityContainer Name=""C1"">
            ...
            action = () => EdmxReader.TryParse(XmlReader.Create(new StringReader(edmx)), refs, new EdmxReaderSettings(), out model, out errors);
            action.ShouldThrow<ArgumentNullException>().WithMessage("Value cannot be null.\r\nParameter name: references");
        }
  ...
  <edmx:DataServices>
    <Schema Namespace=""NS1"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
        <EntityType Name=""Customer"">
            ...
            Assert.AreEqual(3, model.ReferencedModels.Count());
        }
