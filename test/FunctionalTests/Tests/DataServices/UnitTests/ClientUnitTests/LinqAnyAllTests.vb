...
Public Class AnyAllFilterTests
    ...
    Public Sub FilterNavigationWithAnyAll()
        Using CustomDataContext.CreateChangeScope()
            Using request = TestWebRequest.CreateForInProcessWcf
                ...
                Dim queries = _MakeArray(
                    customers.Where(Function(c) c.Orders.Any()),
                    customers.Where(Function(c) c.Orders.Any(Function(o) True)),
                    customers.Where(Function(c) c.ID < 100 And c.Orders.Any()),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.ID < 100)),
                    customers.Where(Function(c) c.ID < 100 And c.Orders.Any(Function(o) o.Customer.ID < 100)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.Customer.ID = c.ID)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.Customer.Orders.Any()))
                    )
                ...
                queries = _MakeArray(
                    customers.Where(Function(c) c.Orders.Any() = False),
                    customers.Where(Function(c) c.Orders.Any() And c.ID > 100),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.ID > 1000)),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.ID > 100)),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.ID = c.ID) = False),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.Customer.ID = c.ID) = False),
                    customers.Where(Function(c) c.Orders.Any(Function(o) TypeOf o.Customer Is CustomerWithBirthday And o.Customer.ID <> 1)),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.ID = 1 And c.ID <> 1)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.ID = 100)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.ID = c.ID)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.Customer.Orders.Any() = False)),
                    customers.Where(Function(c) c.Orders.All(Function(o) c.ID = 1 And o.Customer.Orders.Any(Function(o1) o1.ID = 500)))
                    )
                ...
                queries = _MakeArray(
                    customers.Where(Function(c) c.Orders.Any() And c.ID = 1),
                    customers.Where(Function(c) c.Orders.Any() And TypeOf c Is CustomerWithBirthday),
                    customers.Where(Function(c) c.Orders.Any(Function(o) c.ID = 1)),
                    customers.Where(Function(c) c.Orders.All(Function(o) o.Customer.ID = 1)),
                    customers.Where(Function(c) c.Orders.All(Function(o) TypeOf o.Customer Is CustomerWithBirthday)),
                    customers.Where(Function(c) c.Orders.All(Function(o) TypeOf o.Customer Is CustomerWithBirthday And CType(o.Customer, CustomerWithBirthday).Birthday > New Date(1900, 1, 1))),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.ID = 1) And c.Orders.All(Function(o) o.Customer.ID = 1)),
                    customers.Where(Function(c) c.Orders.Any(Function(o) o.Customer.Orders.Any(Function(o1) o1.Customer.Orders.All(Function(o2) o2.Customer.ID = 1))))
                    )

                For Each q In queries
                    Dim c = q.Single()
                    Assert.IsInstanceOfType(c, GetType(CustomerWithBirthday))
                Next
            End Using
        End Using
    End Sub
