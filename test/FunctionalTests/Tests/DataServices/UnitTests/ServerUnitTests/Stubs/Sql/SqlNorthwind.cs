//---------------------------------------------------------------------
// <copyright file="SqlNorthwind.cs" company="Microsoft">
...
// Last generated by mruiz with the following command:
...
namespace AstoriaUnitTests.Stubs.Sql
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="Northwind_mruiz-ado-dev_c4b8f193700f41dfadc439556be740f6")]
    ...
    partial void DeleteTerritories(Territories instance);
		...
		public SqlNorthwindDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SqlNorthwindDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SqlNorthwindDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public SqlNorthwindDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
