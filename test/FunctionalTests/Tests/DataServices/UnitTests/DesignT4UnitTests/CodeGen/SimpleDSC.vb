...
'Generation date: 2/9/2015 9:27:05 AM
Namespace Simple.DSC
    ...
    Public Module ExtensionMethods
        ...
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Simple.DSC.TestType), ByVal keys As Global.System.Collections.Generic.Dictionary(Of String, Object)) As Simple.DSC.TestTypeSingle
            Return New Simple.DSC.TestTypeSingle(source.Context, source.GetKeyPath(Global.Microsoft.OData.Client.Serializer.GetKeyString(source.Context, keys)))
        End Function
        ''' <summary>
        ''' Get an entity of type Simple.DSC.TestType as Simple.DSC.TestTypeSingle specified by key from an entity set
        ''' </summary>
        ...
        <Global.System.Runtime.CompilerServices.Extension()>
        Public Function ByKey(ByVal source As Global.Microsoft.OData.Client.DataServiceQuery(Of Simple.DSC.TestType),
