...
namespace Microsoft.Test.Taupo.OData.Atom
{
    ...
    public static class TestAtomConstants
    {
        ...
        public const string ODataStreamPropertyMediaResourceRelatedLinkRelationPrefix = "http://docs.oasis-open.org/odata/ns/mediaresource/";

        /// <summary>OData stream property 'edit-media' Uri segment name used in named stream link relations.</summary>
        public const string ODataStreamPropertyEditMediaSegmentName = "edit-media";

        /// <summary>OData stream property prefix for named stream 'edit-media' related link relations.</summary>
        public const string ODataStreamPropertyEditMediaRelatedLinkRelationPrefix = "http://docs.oasis-open.org/odata/ns/edit-media/";

        /// <summary>OData navigation properties prefix for navigation link relations.</summary>
        public const string ODataNavigationPropertiesRelatedLinkRelationPrefix = "http://docs.oasis-open.org/odata/ns/related/";

        /// <summary>OData association link prefix for relation attribute.</summary>
        public const string ODataNavigationPropertiesAssociationLinkRelationPrefix = "http://docs.oasis-open.org/odata/ns/relatedlinks/";
        ...
        public const string ODataRefElementName = "ref";
