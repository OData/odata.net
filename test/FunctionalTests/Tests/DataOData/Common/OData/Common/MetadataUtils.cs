...
namespace Microsoft.Test.Taupo.OData.Common
{
    ...
    public static class MetadataUtils
    {
        ...
        public static EntityType CreateEntityMetadata(out EntityModelSchema model, string namespaceName, ODataEntry entry)
        {
            ...
            string typeName = entry.TypeName.Substring(namespaceName.Length + 1);

            EntityType entityType = model.EntityType(typeName, namespaceName);
            CreateMetadataProperties(model, entityType, entry.Properties);
