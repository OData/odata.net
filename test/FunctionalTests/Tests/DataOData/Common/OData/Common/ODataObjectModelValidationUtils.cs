//---------------------------------------------------------------------
// <copyright file="ODataObjectModelValidationUtils.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Common
{
    ...
    /// </summary>
    public static class ODataObjectModelValidationUtils
    {
        /// <summary>
        ...
        public static bool AreEqual(ODataInnerError first, ODataInnerError second)
        {
            if (first == null && second == null) return true;
            if (first == null || second == null) return false;
