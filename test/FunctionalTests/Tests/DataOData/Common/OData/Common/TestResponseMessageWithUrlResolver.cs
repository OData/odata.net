...
namespace Microsoft.Test.Taupo.OData.Common
{
    ...
    /// </summary>
    public class TestResponseMessageWithUrlResolver : TestResponseMessage, IODataUrlResolver
    {
        /// <summary>
        ...
        public TestResponseMessageWithUrlResolver(Stream stream, IODataUrlResolver urlResolver, TestMessageFlags flags = TestMessageFlags.None)
            : base(stream, flags)
        {
