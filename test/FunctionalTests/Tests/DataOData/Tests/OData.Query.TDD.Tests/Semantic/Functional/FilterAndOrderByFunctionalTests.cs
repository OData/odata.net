...
namespace Microsoft.Test.OData.Query.TDD.Tests.Semantic
{
    ...
    public class FilterAndOrderByFunctionalTests
    {
        ...
        public void ParseFilterFloatValuesNeedPromotion()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_IncompatibleOperandsError("Edm.Single", "Edm.Decimal", "Equal"));
        ...
        public void ParseFilterDoubleValuesWithOptionalSuffix()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_IncompatibleOperandsError("Edm.Double", "Edm.Decimal", "Equal"));
        }
        ...
        public void ParseFilterDecimalValuesWithOptionalSuffix()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.ExpressionLexer_InvalidNumericString("1.79769313486232E+30700"));
        }
        ...
        public void ParseFilterWithBoolean()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_IncompatibleOperandsError("Edm.Boolean", "Edm.Int32", "Equal"));
        ...
        public void ParseFilterNodeInComplexExpression()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_IncompatibleOperandsError("Edm.Double", "Edm.Decimal", "Add"));
        }
        ...
        public void FilterWithKeyLookupOnNavPropIsNotAllowed()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_UnknownFunction("MyPeople"));
        }
        ...
        public void FilterWithIncompatibleTypeShouldThrow()
        {
            ...
            action.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_NoApplicableFunctionFound("contains", "contains(Edm.String Nullable=true, Edm.String Nullable=true)"));
        }
        ...
        public void FilterWithInvalidParameterShouldThrow()
        {
            ...
            action.ShouldThrow<ODataException>().WithMessage(Strings.MetadataBinder_PropertyNotDeclared("Edm.Int32", "$It"));
        }
        ...
        public void BadCastShouldResultInNiceException()
        {
            ...
            parse.ShouldThrow<ODataException>().WithMessage(Strings.CastBinder_ChildTypeIsNotEntity("Missing.Type"));
        }
