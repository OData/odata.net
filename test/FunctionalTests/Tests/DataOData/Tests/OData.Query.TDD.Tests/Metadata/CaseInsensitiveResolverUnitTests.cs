//---------------------------------------------------------------------
// <copyright file="CaseInsensitiveResolverUnitTests.cs" company="Microsoft">
...
namespace Microsoft.Test.OData.Query.TDD.Tests
{
    ...
    /// </summary>
    [TestClass]
    public class CaseInsensitiveResolverUnitTests : ExtensionTestBase
    {
        #region type cases
        ...
        [Ignore] // TODO: Do not support built-in type name case insensitive. EnumValue's type name case insensitve also not supported.
        [TestMethod]
