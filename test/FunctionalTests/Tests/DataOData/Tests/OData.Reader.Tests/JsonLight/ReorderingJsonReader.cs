...
namespace Microsoft.Test.Taupo.OData.Reader.Tests.JsonLight
{
    ...
    public class ReorderingJsonReader : BufferingJsonReader
    {
        ...
        private static Type ReorderingJsonReaderType = typeof(Microsoft.OData.Core.ODataAnnotatable).Assembly.GetType("Microsoft.OData.Core.JsonLight.ReorderingJsonReader");
