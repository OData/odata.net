//---------------------------------------------------------------------
// <copyright file="RemoveCollectionNameAnnotationForCollectionPayloadElementVisitor.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Reader.Tests
{
    ...
    /// </summary>
    public class RemoveCollectionNameAnnotationForCollectionPayloadElementVisitor : ODataPayloadElementVisitorBase
    {
        /// <summary>
