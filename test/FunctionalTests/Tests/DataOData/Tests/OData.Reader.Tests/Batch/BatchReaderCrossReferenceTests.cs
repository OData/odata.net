    ...
    public class BatchReaderCrossReferenceTests : ODataReaderTestCase
    {
        ...
        public void BatchReaderCrossReferenceLinksInPayloadTest()
        {
            var testCases = new[]
            {
                new CrossReferenceTestCase
                {
                    DebugDescription = "Valid cross-reference link in request payload (reference only).",
                    ChangeSets = new[]
                    {
                        new CrossReferenceChangeSet 
                        { 
                            ...
                            {
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "1", },
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", PayloadCrossReferenceLink = "$1", },
                            }
                        },
                    },
                },
                new CrossReferenceTestCase
                {
                    DebugDescription = "Valid cross-reference link in request payload (segment after reference).",
                    ChangeSets = new[]
                    {
                        new CrossReferenceChangeSet 
                        { 
                            ...
                            {
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "1", },
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", PayloadCrossReferenceLink = "$1/foo", },
                            }
                        },
                    },
                },
                new CrossReferenceTestCase
                {
                    DebugDescription = "Valid cross-reference link in request payload (special name '').",
                    ChangeSets = new[]
                    {
                        new CrossReferenceChangeSet 
                        { 
                            ...
                            {
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "", },
                                new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", PayloadCrossReferenceLink = "$/foo" },
                            }
                        },
                    },
                },
                new CrossReferenceTestCase
                {
                 ...
                 new CrossReferenceTestCase
                 {
                     DebugDescription = "Invalid cross-reference link in request payload (content ID does not exist).",
                     ChangeSets = new[]
                     {
                         new CrossReferenceChangeSet 
                         { 
                             ...
                             {
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "1", },
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", PayloadCrossReferenceLink = "$DoesNotExist/foo" },
                             }
                         },
                     },
                     ExpectedException = ODataExpectedExceptions.ODataException("ODataAtomDeserializer_RelativeUriUsedWithoutBaseUriSpecified", "$DoesNotExist/foo"),
                 },
                 new CrossReferenceTestCase
                 {
                     DebugDescription = "Invalid cross-reference link in request payload (content ID will only appear later in the batch).",
                     ChangeSets = new[]
                     {
                         new CrossReferenceChangeSet 
                         { 
                             Operations = new [] 
                             {
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "1", PayloadCrossReferenceLink = "$2/foo" },
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", },
                             }
                         },
                     },
                     ExpectedException = ODataExpectedExceptions.ODataException("ODataAtomDeserializer_RelativeUriUsedWithoutBaseUriSpecified", "$2/foo"),
                 },
                 new CrossReferenceTestCase
                 {
                     DebugDescription = "Invalid cross-reference link in request payload (reference content ID in different changeset).",
                     ChangeSets = new[]
                     {
                         new CrossReferenceChangeSet 
                         { 
                     ...
                     ExpectedException = ODataExpectedExceptions.ODataException("ODataAtomDeserializer_RelativeUriUsedWithoutBaseUriSpecified", "$1"),
                 },
                 new CrossReferenceTestCase
                 {
                     DebugDescription = "Invalid cross-reference link in request header (reference to current content ID).",
                     ChangeSets = new[]
                     {
                         ...
                         { 
                             ...
                             {
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/1"), ContentId = "1", },
                                 new CrossReferenceOperation { Uri = new Uri("http://foo.com/2"), ContentId = "2", PayloadCrossReferenceLink = "$2" },
                             }
                         },
                     },
                     ExpectedException = ODataExpectedExceptions.ODataException("ODataAtomDeserializer_RelativeUriUsedWithoutBaseUriSpecified", "$2"),
                 },
            };
