...
namespace Microsoft.Test.OData.TDD.Tests.Roundtripping.JsonLight
{
    ...
    public class AsyncRoundtripJsonLightTests
    {
        ...
        public void AsyncRoundtripJsonLightTest()
        {
            ...
            Assert.AreEqual(entry.TypeName, entryRead.TypeName, "TypeName should be equal");
            Assert.IsTrue(this.PropertiesEqual(entry.Properties, entryRead.Properties), "Properties should be equal");
        }
