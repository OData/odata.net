...
namespace Microsoft.Test.OData.TDD.Tests.Reader.JsonLight
{
    ...
    public class ODataJsonLightUtilsTests
    {
        ...
        public void CreateODataOperationFromFunctionImportShouldCreateODataAction()
        {
            ...
            Assert.AreEqual("http://www.example.com/$metadata#Foo", operation.Metadata.AbsoluteUri);
            Assert.IsInstanceOfType(operation, typeof(ODataAction));
        }
        ...
        public void CreateODataOperationFromFunctionImportShouldCreateODataFunction()
        {
            ...
            Assert.AreEqual("http://www.example.com/$metadata#Foo", operation.Metadata.AbsoluteUri);
            Assert.IsInstanceOfType(operation, typeof(ODataFunction));
        }
    }
}
