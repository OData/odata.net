//---------------------------------------------------------------------
// <copyright file="JsonNavigationLinkWriterTests.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Writer.Tests.Json
{
    ...
    /// </summary>
    [TestClass, TestCase]
    public class JsonNavigationLinkWriterTests : ODataWriterTestCase
    {
        ...
        public void WriteEntityReferenceLinkAfterFeedJsonErrorTest()
        {
            ...
            var testCases = new WriterNavigationLinkTests.NavigationLinkTestCase[]
            {
                ...
                new WriterNavigationLinkTests.NavigationLinkTestCase
                {
                    ...
                    ExpectedException = ODataExpectedExceptions.ODataException("ODataJsonWriter_EntityReferenceLinkAfterResourceSetInRequest")
                },
