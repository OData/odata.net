//---------------------------------------------------------------------
// <copyright file="JsonPropertyWriterTests.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Writer.Tests.Json
{
    ...
    /// </summary>
    [TestClass, TestCase]
    public class JsonPropertyWriterTests : ODataWriterTestCase
    {
                ...
                new PayloadWriterTestDescriptor<ODataProperty>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(
                            ...
                            testCase.Json,
                            JsonWriterUtils.GetMetadataUrlPropertyForProperty(testCase.PropertyType)),
            ...
            IEnumerable<PropertyPayloadTestCase> testCases = new[]
            {
                ...
                new PropertyPayloadTestCase
                {
                    ...
                    ExpectedException = ODataExpectedExceptions.ODataException(
                                            TextRes.ODataJsonValueSerializer_MissingRawValueOnUntyped),
                },
                new PropertyPayloadTestCase
                {
                ...
                new PayloadWriterTestDescriptor<ODataProperty>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(
                            CultureInfo.InvariantCulture,
                            JsonFormat,
                            JsonWriterUtils.GetMetadataUrlPropertyForEntry("EntitySet"),
