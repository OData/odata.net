//---------------------------------------------------------------------
// <copyright file="JsonEntryWriterTests.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Writer.Tests.Json
{
    ...
    /// </summary>
    [TestClass, TestCase]
    public class JsonEntryWriterTests : ODataWriterTestCase
    {
            ...
            {   
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{1}" +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"TestModel.NonMLEType\"{0}",
                        "}}")
                },
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{1}" +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"TestModel.MLEType\"{0},\"ID\":\"42\",\"Name\":\"test\"",
                        "}}")
                },
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{1}" +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"TestModel.NonMLEType\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataIdAnnotationName + "\":\"urn:id\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataETagAnnotationName + "\":\"etag\"{0}",
                        "}}")
                },
                new EntryPayloadTestCase
                {
                ...
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{1}" +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"TestModel.MLEType\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataIdAnnotationName + "\":\"urn:id\"," +
                        ...
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaEditLinkAnnotationName + "\":\"http://odata.org/mediaeditlink\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaReadLinkAnnotationName + "\":\"http://odata.org/mediareadlink\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaContentTypeAnnotationName + "\":\"media/contenttype\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaETagAnnotationName + "\":\"mediaetag\"{0}," +
                        "\"ID\":\"42\"," +
                        "\"Name\":\"test\"",
                        "}}")
                },
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        ...
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataETagAnnotationName + "\":\"etag\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataReadLinkAnnotationName + "\":\"http://odata.org/readlink\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaReadLinkAnnotationName + "\":\"http://odata.org/mediareadlink\"{0}," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataEditLinkAnnotationName + "\":\"http://odata.org/editlink\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaEditLinkAnnotationName + "\":\"http://odata.org/mediaeditlink\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaContentTypeAnnotationName + "\":\"media/contenttype\"," +
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataMediaETagAnnotationName + "\":\"mediaetag\"," +
                        "\"ID\":\"42\"," +
                        "\"Name\":\"test\"",
                        "}}")
                },
                ...
                new PayloadWriterTestDescriptor<ODataItem>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(CultureInfo.InvariantCulture, testCase.Json, 
                            string.Empty,
                            JsonWriterUtils.GetMetadataUrlPropertyForEntry(testCase.EntitySet.Name) + ","),
            ...
            testDescriptors = testDescriptors.Concat(testCases.Select(testCase =>
                new PayloadWriterTestDescriptor<ODataItem>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(CultureInfo.InvariantCulture, testCase.Json,
                            tc.IsRequest ?
                                ",\"" + JsonUtils.GetPropertyAnnotationName("NavProp", JsonConstants.ODataBindAnnotationName) + "\":[$(NL)\"http://odata.org/navprop/uri\"$(NL)]" :
                                ",\"" + JsonUtils.GetPropertyAnnotationName("NavProp", JsonConstants.ODataNavigationLinkUrlAnnotationName) + "\":\"http://odata.org/navprop/uri\"",
                            JsonWriterUtils.GetMetadataUrlPropertyForEntry(testCase.EntitySet.Name) + ","),
                        FragmentExtractor = (result) => result.RemoveAllAnnotations(true)
                    })
                {
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(CultureInfo.InvariantCulture, testCase.Json,
                            tc.IsRequest ?
                                ",\"" + JsonUtils.GetPropertyAnnotationName("NavProp", JsonConstants.ODataBindAnnotationName) + "\":[$(NL)\"http://odata.org/navprop/uri\"$(NL)]" :
                                ",\"" + JsonUtils.GetPropertyAnnotationName("NavProp", JsonConstants.ODataNavigationLinkUrlAnnotationName) + "\":\"http://odata.org/navprop/uri\"" +
                                ",\"" + JsonUtils.GetPropertyAnnotationName("NavProp", JsonConstants.ODataAssociationLinkUrlAnnotationName) + "\":\"http://odata.org/assoclink\"",
                            JsonWriterUtils.GetMetadataUrlPropertyForEntry(testCase.EntitySet.Name) + ","),
                        FragmentExtractor = (result) => result.RemoveAllAnnotations(true)
                    })
                {
        ...
        public void ActionAndFunctionPayloadOrderTest()
        {
            ...
            string defaultJson = string.Join("$(NL)",
                "{{",
                "{1}" +
                "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"#TestModel.NonMLEType\"{0},\"#defaultAction\":{{",
            ...
            IEnumerable<PayloadWriterTestDescriptor<ODataItem>> testDescriptors = testCases.Select(testCase =>
                new PayloadWriterTestDescriptor<ODataItem>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(CultureInfo.InvariantCulture, testCase.Json,
                            string.Empty,
                            tc.IsRequest ? string.Empty : (JsonWriterUtils.GetMetadataUrlPropertyForEntry(testCase.EntitySet.Name) + ",")),
                        FragmentExtractor = (result) => result.RemoveAllAnnotations(true)
                    })
                {
                    DebugDescription = testCase.DebugDescription,
            ...
            this.CombinatorialEngineProvider.RunCombinations(
                ...
                this.WriterTestConfigurationProvider.JsonFormatConfigurationsWithIndent.Where(tc => !tc.IsRequest),
                (testDescriptor, testConfiguration) =>
                {
                    TestWriterUtils.WriteAndVerifyODataEdmPayload(testDescriptor.DeferredLinksToEntityReferenceLinksInRequest(testConfiguration), testConfiguration, this.Assert, this.Logger);
                });
        ...
        public void OpenPropertiesInEntryTest()
        {
            ...
            IEnumerable<EntryPayloadTestCase> testCases = new[]
            {
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{0}\"" + JsonUtils.GetPropertyAnnotationName("Age", JsonConstants.ODataTypeAnnotationName) + "\":\"Edm.Int64\",\"Age\":\"42\"",
                        "}}")
                },
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{0}" +
                        "\"" + JsonUtils.GetPropertyAnnotationName("Location", JsonConstants.ODataTypeAnnotationName) + "\":\"Edm.GeographyPoint\"," +
                        "\"Location\":{{",
                ...
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        ...
                        "{0}" +
                        "\"Address\":{{",
                        "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataTypeAnnotationName + "\":\"TestModel.AddressType\"",
                        "}}",
                        "}}")
                },
            };
            ...
            IEnumerable<EntryPayloadTestCase> testCases = new[]
            {
                new EntryPayloadTestCase
                {
                    ...
                    Json = string.Join("$(NL)",
                        "{{",
                        "{0}" +
                        "\"" + JsonUtils.GetPropertyAnnotationName("Location1", JsonConstants.ODataTypeAnnotationName) + "\":\"GeographyPoint\"," +
                        "\"Location1\":{{",
                        "\"type\":\"Point\",\"coordinates\":[",
                        "-100.0,32.0",
                        "],\"crs\":{{",
                ...
                new PayloadWriterTestDescriptor<ODataItem>(
                    ...
                    tc => new JsonWriterTestExpectedResults(this.Settings.ExpectedResultSettings)
                    {
                        Json = string.Format(
                            CultureInfo.InvariantCulture, 
                            testCase.Json,
                            JsonWriterUtils.GetMetadataUrlPropertyForProperty(testCase.EntityType.FullTypeName()) + ","),
                        FragmentExtractor = (result) => result.RemoveAllAnnotations(true)
                    })
                {
                    DebugDescription = testCase.DebugDescription,
