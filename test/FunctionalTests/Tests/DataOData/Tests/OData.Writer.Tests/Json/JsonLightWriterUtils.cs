//---------------------------------------------------------------------
// <copyright file="JsonWriterUtils.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.OData.Writer.Tests.Json
{
    ...
    public static class JsonWriterUtils
    {
        ...
        public static string GetMetadataUrlPropertyForEntry(string fragment, string metadataUrl = null)
        {
            if (metadataUrl == null)
            {
                metadataUrl = JsonConstants.DefaultMetadataDocumentUri.OriginalString;
            }

            return "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataContextAnnotationName + "\":\"" + metadataUrl + "#" + fragment + "/$entity\"";
        }
        ...
        public static string GetMetadataUrlPropertyForFeed(string fragment, string metadataUrl = null)
        {
            ...
            return "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataContextAnnotationName + "\":\"" + metadataUrl + "#" + fragment + "\"";
        }
        ...
        public static string GetMetadataUrlPropertyForProperty(string propertyType, string metadataUrl = null)
        {
            ...
            return "\"" + JsonConstants.ODataPropertyAnnotationSeparator + JsonConstants.ODataContextAnnotationName + "\":\"" + metadataUrl + "#" + propertyType + "\"";
        }
    }
}