//---------------------------------------------------------------------
// <copyright file="SpatialFormatRoundTrip.cs" company="Microsoft">
...
namespace DataSpatialUnitTests.Tests
{
    ...
    [TestClass]
    public class SpatialFormatRoundTripTests
    {
        ...
        private static DataServicesSpatialImplementation implementation;
        ...
        public SpatialFormatRoundTripTests()
        {
