...
namespace DataSpatialUnitTests.Tests
{
    ...
    public class WellKnownTextSqlFormatterTests
    {
        ...
        public void ReadPoint_Ordering()
        {
            ...
            Assert.AreEqual(20, point.Latitude);
            Assert.AreEqual(10, point.Longitude);
        }
        ...
        public void NullPipelineTest()
        {
            ...
            Assert.AreEqual(12345, point.X);
            Assert.AreEqual(567890, point.Y);
        }
        ...
        public void ReadCollection_Empty()
        {
            ...
            Assert.IsNotNull(p);
            Assert.IsTrue(p is GeographyCollection);
        ...
        public void ReadUnknownTagTest()
        {
            ...
            Assert.IsNotNull(ex);
            Assert.AreEqual(Strings.WellKnownText_UnknownTaggedText("FOO"), ex.Message);
        ...
        public void ReadUnexpectedCharacter()
        {
            ...
            Assert.IsNotNull(ex);
            Assert.AreEqual(Strings.WellKnownText_UnexpectedCharacter(":"), ex.Message);
        }
    ...
    public class WellKnownTextWriterTests
    {
        ...
        private static void GeographyToWktTest(WellKnownTextSqlFormatter formatter, Action<GeographyPipeline> pipelineAction, string expectedWkt)
        {
            ...
            Assert.AreEqual(expectedWkt, stringWriter.GetStringBuilder().ToString());
        }
    }
}
