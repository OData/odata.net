...
namespace DataSpatialUnitTests.Utils
{
    ...
    public class GeographyLoggingPipeline : ICommonLoggingPipeline
    {
        ...
        {
            Assert.IsTrue(coordinateSystem.TopologyIs(CoordinateSystem.Topology.Geography));
    ...
    public class GeometryLoggingPipeline : ICommonLoggingPipeline
    {
        ...
        public void SetCoordinateSystem(CoordinateSystem coordinateSystem)
        {
            Assert.IsTrue(coordinateSystem.TopologyIs(CoordinateSystem.Topology.Geometry));
