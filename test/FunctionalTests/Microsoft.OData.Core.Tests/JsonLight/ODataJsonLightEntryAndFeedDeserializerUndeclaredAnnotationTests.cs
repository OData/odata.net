...
namespace Microsoft.Test.OData.TDD.Tests.Reader.JsonLight
{
    public class ODataJsonLightEntryAndFeedDeserializerUndeclaredAnnotationTests
    {
        ...
        private void ReadEntryPayload(string payload, EdmEntitySet entitySet, EdmEntityType entityType, Action<ODataReader> action, ODataMessageReaderSettings settings = null)
        {
