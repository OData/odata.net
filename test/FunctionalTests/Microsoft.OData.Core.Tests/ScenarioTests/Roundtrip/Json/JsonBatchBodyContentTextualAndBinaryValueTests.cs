        ...
        private string GetEncodedStringContent(BodyContentType bodyContentType, bool forRequest)
        {
            ...
            switch (bodyContentType)
            {
                case BodyContentType.Textual:
                    string text = JsonUtils.GetJsonEncodedString(forRequest ? this.textualSampleStringA : this.textualSampleStringB);
                ...
                case BodyContentType.Binary:
                    ...
                    result = string.Format(CultureInfo.InvariantCulture, "\"{0}\"", JsonUtils.GetBase64UrlEncodedString(bytes));
                    break;
