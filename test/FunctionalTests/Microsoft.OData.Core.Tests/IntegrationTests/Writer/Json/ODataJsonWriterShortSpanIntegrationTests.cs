//---------------------------------------------------------------------
// <copyright file="ODataJsonWriterShortSpanIntegrationTests.cs" company="Microsoft">
...
{
    public class ODataJsonWriterShortSpanIntegrationTests
    {
        ...
        public ODataJsonWriterShortSpanIntegrationTests()
        {
        ...
        public void ShouldThrowWhenCreatingResponseWriterWithoutMetadataDocumentUri()
        {
            ...
            ODataJsonOutputContext outputContext = CreateJsonOutputContext(stream, writingResponse: true, userModel: null, serviceDocumentUri: null);
            Action action = () => new ODataJsonWriter(outputContext, navigationSource: null, resourceType: null, writingResourceSet: true);
        ...
        public void ShouldWriteStreamPropertyForRequestEntryPayloadWithUserModel()
        {
            ...
            action.Throws<ODataException>(Error.Format(SRResources.WriterValidationUtils_StreamPropertyInRequest, "StreamProperty"));
        }
        ...
        public void ShouldWriteActionForRequestEntryPayloadWithoutUserModel()
        {
            ...
            action.Throws<ODataException>(Error.Format(SRResources.WriterValidationUtils_OperationInRequest, "#Action1"));
        }
        ...
        public void ShouldWriteFunctionForRequestEntryPayloadWithoutUserModel()
        {
            ...
            Action action = () => this.WriteNestedItemsAndValidatePayload(entitySetFullName: null, derivedEntityTypeFullName: null, nestedItemToWrite: new[] { entry }, expectedPayload: expectedPayload, writingResponse: false);
            action.Throws<ODataException>(Error.Format(SRResources.WriterValidationUtils_OperationInRequest, "#Function1"));
        }
        ...
        private void WriteNestedItemsAndValidatePayload(IEdmEntitySet entitySet, IEdmEntityType entityType, ODataItem[] nestedItemToWrite, string expectedPayload, bool writingResponse = true, bool setMetadataDocumentUri = true)
        {
            ...
            ODataJsonOutputContext outputContext = CreateJsonOutputContext(stream, writingResponse, this.userModel, setMetadataDocumentUri ? this.metadataDocumentUri : null);
            ODataJsonWriter writer = new ODataJsonWriter(outputContext, entitySet, entityType, nestedItemToWrite[0] is ODataResourceSet);
        ...
        private void WriteNestedItemsAndValidatePayload(IEdmEntitySet entitySet, IEdmEntityType entityType, ODataItem topLevelItem, Action<ODataWriter> writeItems, string expectedPayload, bool writingResponse = true, bool setMetadataDocumentUri = true)
        {
            MemoryStream stream = new MemoryStream();
            ODataJsonOutputContext outputContext = CreateJsonOutputContext(stream, writingResponse, this.userModel, setMetadataDocumentUri ? this.metadataDocumentUri : null);
            ODataJsonWriter writer = new ODataJsonWriter(outputContext, entitySet, entityType, topLevelItem is ODataResourceSet);
            writeItems(writer);
            ValidateWrittenPayload(stream, writer, expectedPayload);
        }
        ...
        {
            MemoryStream stream = new MemoryStream();
            ODataJsonOutputContext outputContext = CreateJsonOutputContext(stream, writingResponse, EdmCoreModel.Instance, setMetadataDocumentUri ? this.metadataDocumentUri : null);
            ...
            ODataJsonWriter writer = new ODataJsonWriter(outputContext, /*entitySet*/ null, /*entityType*/ null, /*writingFeed*/ topLevelFeed != null);
            WriteNestedItems(nestedItemToWrite, writer);
            ValidateWrittenPayload(stream, writer, expectedPayload);
        }
        ...
        private static void WriteNestedItems(ODataItem[] nestedItemsToWrite, ODataJsonWriter writer)
        {
        ...
        private static void ValidateWrittenPayload(MemoryStream stream, ODataJsonWriter writer, string expectedPayload)
        {
            writer.Flush();
        ...
        private static ODataJsonOutputContext CreateJsonOutputContext(MemoryStream stream, bool writingResponse = true, IEdmModel userModel = null, Uri serviceDocumentUri = null)
        {
