//---------------------------------------------------------------------
// <copyright file="ODataJsonOutputContextApiTests.cs" company="Microsoft">
...
{
    public class ODataJsonOutputContextApiTests
    {
        ...
        public ODataJsonOutputContextApiTests()
        {
            InitializeEdmModel();
        ...
        {
            var orderResource = CreateOrderResource();
            var nestedResourceInfos = new List<ODataJsonReaderNestedResourceInfo>
            {
                ODataJsonReaderNestedResourceInfo.CreateResourceReaderNestedResourceInfo(
