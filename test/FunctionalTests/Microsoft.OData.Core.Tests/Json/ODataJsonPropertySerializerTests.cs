//---------------------------------------------------------------------
// <copyright file="ODataJsonPropertySerializerTests.cs" company="Microsoft">
...
{
    public class ODataJsonPropertySerializerTests
    {
        ...
        public ODataJsonPropertySerializerTests()
        {
        ...
        [Fact]
        public void WritingTypeDefinitionOfInt32PropertyShouldWorkJson()
        {
            Assert.Contains("\"MyInt32Property\":12345", this.SerializeProperty(this.entityType, this.declaredPropertyMyInt32));
        }

        [Fact]
        public void WritingTypeDefinitionOfStringPropertyShouldWorkJson()
        {
        ...
        [Fact]
        public void WritingDatePropertyShouldWorkJson()
        {
        ...
        [Fact]
        public void WritingDeclaredPropertyInOpenComplexTypeShouldWorkJson()
        {
            Assert.Contains("\"CountryRegion\":\"China\"", this.SerializeProperty(this.openAddressType, this.declaredPropertyCountryRegion));
        }

        [Fact]
        public void WritingDynamicPropertyInOpenComplexTypeShouldWorkJson()
        {
        ...
        private ODataJsonOutputContext CreateJsonOutputContext(MemoryStream stream, Action<IServiceCollection> configureServices = null)
        {
