...
namespace Microsoft.OData.Tests.Json
{
    ...
    {
        /// <summary>The default streaming Json media type.</summary>
        internal static readonly ODataMediaType JsonStreamingMediaType = new ODataMediaType(
        ...
        {
            return propertyName + ODataJsonConstants.ODataPropertyAnnotationSeparatorChar + annotationName;
        }
