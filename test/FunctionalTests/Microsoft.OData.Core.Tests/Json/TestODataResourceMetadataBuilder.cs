...
{
    /// <summary>
    /// Metadata builder class specifically designed to help support test scenarios for ODataJsonResourceSerializer
    /// </summary>
    internal class TestODataResourceMetadataBuilder : ODataResourceMetadataBuilder
    {
        ...
        private readonly Func<IEnumerable<ODataJsonReaderNestedResourceInfo>> unprocessedNavigationLinksFactory;
        ...
        public TestODataResourceMetadataBuilder(
            Uri resourceId,
            Func<IEnumerable<ODataJsonReaderNestedResourceInfo>> unprocessedNavigationLinksFactory = null,
