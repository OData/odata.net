//---------------------------------------------------------------------
// <copyright file="ODataJsonOutputContextTests.cs" company="Microsoft">
...
{
    public class ODataJsonOutputContextTests
    {
        ...
        public ODataJsonOutputContextTests()
        {
            InitializeEdmModel();
        ...
        {
            var outputContext = CreateJsonOutputContext(new MemoryStream(), isResponse);
        ...
        {
            var outputContext = CreateJsonOutputContext(new MemoryStream(), isResponse, true, false, ODataVersion.V401);
            ...
            bool use6x = false)
        {
            ...
            var outputContext = CreateJsonOutputContext(stream, writingResponse, synchronous, use6x);
            test(outputContext);
        ...
        private static ODataJsonOutputContext CreateJsonOutputContext(
            MemoryStream stream,
            bool writingResponse = true,
            bool synchronous = true,
            bool use6x = false,
        ...
        private async Task<string> SetupJsonOutputContextAndRunTestAsync(
            Func<ODataJsonOutputContext, Task> func,
            bool writingResponse = true)
        {
