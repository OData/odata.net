...
namespace Microsoft.OData.Tests.UriParser.Parsers
{
    ...
    public class SelectExpandParserTests
    {
        ...
        [Fact]
        public void SelectParsesEachTermOnce2()
        {
            // Arrange
            SelectExpandParser parser = new SelectExpandParser("foo($select=abc),foo($select=xyz)", ODataUriParserSettings.DefaultSelectExpandLimit);
