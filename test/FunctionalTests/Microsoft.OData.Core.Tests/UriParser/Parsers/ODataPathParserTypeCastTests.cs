...
namespace Microsoft.OData.Tests.UriParser.Parsers
{
    public class ODataPathParserTypeCastTests
    {
        ...
        public void ParseTypeCastOnSingletonWithoutAliasSettingThrows()
        {
            ...
            parsePath.Throws<ODataUnrecognizedPathException>(Error.Format(SRResources.RequestUriProcessor_ResourceNotFound, "MyAlias.VipCustomer"));
        }
        ...
        public void ParseTypeCastOnSingletonWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.NormalCustomer", "singleton", "Me"));
        }
        ...
        public void ParseTypeCastOnSingletonWithDerivedTypeConstraintButEmptyCollectionAnnotationWorks(bool isInLine)
        {
            ...
            parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.VipCustomer", "singleton", "Me"));
      ...
      <Annotations Target=""NS.Default/Me"">
        ...
        public void ParseTypeCastOnEntitySetWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            foreach (string segment in new[] { "Customers", "Customers(1)" })
            {
                ...
                parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.NormalCustomer", "entity set", "Customers"));
      ...
      <Annotations Target=""NS.Default/Customers"">
        ...
        public void ParseTypeCastOnPropertyWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            foreach (string segment in new[] { "Address", "Locations" })
            {
                ...
                parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.CnAddress", "property", segment));
                index++;
            }
        }
      ...
      <Annotations Target=""NS.Customer/Locations"">
        ...
        public void ParseTypeCastOnNavigationPropertyWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            foreach (string segment in new[] { "DirectReport", "SubCustomers" })
            {
                ...
                parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.NormalCustomer", "navigation property", segment));
                index++;
            }
        }
        ...
        public void ParseTypeCastOnNavigationPropertyWithKeySegmentWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.NormalCustomer", "navigation property", "SubCustomers"));
        }
    ...
    <Schema Namespace=""NS"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
      ...
      <Annotations Target=""NS.Customer/SubCustomers"">
        ...
        public void ParseTypeCastOnTypeDefinitionPropertyWithDerivedTypeConstraintAnnotationWorks(bool isInLine)
        {
            ...
            parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "Edm.Double", "type definition", "Data"));
        }
    ...
    <Schema Namespace=""NS"" xmlns=""http://docs.oasis-open.org/odata/ns/edm"">
      ...
      <Annotations Target=""NS.DataType"">
        ...
        public void ParseBoundOperationWithDerivedTypeConstraintAnnotationWorks(bool inLineAnnotation)
        {
            ...
            parsePath.Throws<ODataException>(Error.Format(SRResources.PathParser_TypeCastOnlyAllowedInDerivedTypeConstraint, "NS.NormalCustomer", "operation", "Image"));
        }
