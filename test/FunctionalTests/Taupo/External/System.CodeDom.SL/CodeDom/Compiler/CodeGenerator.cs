...
namespace System.CodeDom.Compiler {
    ...
    public abstract class CodeGenerator : ICodeGenerator {
        ...
        private SafeCodeGeneratorOptions options;
        ...
        /// </devdoc>
        protected SafeCodeGeneratorOptions Options {
            get {
                return options;
            }
        }
        ...
        /// <internalonly/>
        void ICodeGenerator.GenerateCodeFromType(CodeTypeDeclaration e, TextWriter w, SafeCodeGeneratorOptions o) {
            bool setLocal = false;
        ...
        /// <internalonly/>
        void ICodeGenerator.GenerateCodeFromExpression(CodeExpression e, TextWriter w, SafeCodeGeneratorOptions o) {
            bool setLocal = false;
            if (output != null && w != output.InnerWriter) {
                throw new InvalidOperationException(SR.GetString(SR.CodeGenOutputWriter));
            }
        ...
        /// <internalonly/>
        void ICodeGenerator.GenerateCodeFromCompileUnit(CodeCompileUnit e, TextWriter w, SafeCodeGeneratorOptions o) {
            bool setLocal = false;
            if (output != null && w != output.InnerWriter) {
                throw new InvalidOperationException(SR.GetString(SR.CodeGenOutputWriter));
            }
        ...
        /// <internalonly/>
        void ICodeGenerator.GenerateCodeFromNamespace(CodeNamespace e, TextWriter w, SafeCodeGeneratorOptions o) {
            bool setLocal = false;
            if (output != null && w != output.InnerWriter) {
                throw new InvalidOperationException(SR.GetString(SR.CodeGenOutputWriter));
            }
        ...
        public virtual void GenerateCodeFromMember(CodeTypeMember member, TextWriter writer, SafeCodeGeneratorOptions options) {
            if (this.output != null) {
        ...
        protected void GenerateStatement(CodeStatement e) {        
            ...
            if (e is CodeCommentStatement) {
                ...
                //throw new ArgumentException(SR.GetString(SR.InvalidElementType, e.GetType().FullName), "e");
                throw new ArgumentException(string.Format("SR.InvalidElementType {0}", e.GetType().FullName), "e");
            }
        ...
        protected virtual void GenerateCommentStatement(CodeCommentStatement e) {
            if (e.Comment == null)
            {
                throw new ArgumentException(string.Format("SR.Argument_NullComment {0}", "e"), "e");
        ...
        protected virtual void ValidateIdentifier(string value) {
            if (!IsValidIdentifier(value)) {
                ...
                throw new ArgumentException(string.Format("SR.InvalidIdentifier {0}", value));
            }
        }
        ...
        private static bool IsValidTypeNameOrIdentifier(string value, bool isTypeName) {
            ...
            for(int i = 0; i < value.Length; i++) {
                char ch = value[i];
                UnicodeCategory uc = ch.GetUnicodeCategory();
                switch (uc) {
