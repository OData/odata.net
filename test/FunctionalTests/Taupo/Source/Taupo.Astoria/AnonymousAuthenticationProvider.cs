//---------------------------------------------------------------------
// <copyright file="AnonymousAuthenticationProvider.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria
{
    ...
    /// <summary>
    /// Provides anonymous authentication support for test request calls to the Data Service
    /// </summary>
    [ImplementationName(typeof(IAuthenticationProvider), "Anonymous")]
