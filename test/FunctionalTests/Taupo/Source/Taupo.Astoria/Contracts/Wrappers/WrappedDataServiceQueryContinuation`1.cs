//---------------------------------------------------------------------
// <copyright file="WrappedDataServiceQueryContinuation`1.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.Wrappers
{
    ...
    /// <summary>
    /// Wraps the 'Microsoft.OData.Client.DataServiceQueryContinuation`1' type.
    /// </summary>
    /// <typeparam name="T">The wrapper type for the 'T' generic parameter.</typeparam>
    public partial class WrappedDataServiceQueryContinuation<T> : WrappedDataServiceQueryContinuation
