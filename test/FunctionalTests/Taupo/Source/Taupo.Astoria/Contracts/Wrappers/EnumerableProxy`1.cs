//---------------------------------------------------------------------
// <copyright file="EnumerableProxy`1.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.Wrappers
{
    ...
    /// <summary>
    /// Wraps the 'System.Collections.Generic.IEnumerable`1' type.
    /// </summary>
    /// <typeparam name="T">The wrapper type for the 'T' generic parameter.</typeparam>
    public partial class EnumerableProxy<T> : System.Collections.Generic.IEnumerable<T>, IProxyObject, IDisposable
    {
        ...
        private System.Collections.Generic.IEnumerable<T> underlyingImplementation;
        ...
        public EnumerableProxy(IWrapperScope wrapperScope, System.Collections.Generic.IEnumerable<T> underlyingImplementation)
        {
        ...
        /// <summary>
        /// Wraps the 'System.Collections.Generic.IEnumerator`1[T] GetEnumerator()' on the 'System.Collections.Generic.IEnumerable`1' type.
        /// </summary>
        ...
        /// <summary>
        /// Wraps the 'System.Collections.IEnumerator GetEnumerator()' on the 'System.Collections.Generic.IEnumerable`1' type.
        /// </summary>
        /// <returns>The value returned by the underlying method.</returns>
