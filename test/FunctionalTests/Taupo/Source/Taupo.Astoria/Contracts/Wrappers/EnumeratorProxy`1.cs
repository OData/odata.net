//---------------------------------------------------------------------
// <copyright file="EnumeratorProxy`1.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.Wrappers
{
    ...
    public partial class EnumeratorProxy<T> : System.Collections.Generic.IEnumerator<T>, IProxyObject, IDisposable
    {
        ...
        private System.Collections.Generic.IEnumerator<T> underlyingImplementation;
        ...
        public virtual T Current
        {
            get
            {
                var type = WrapperUtilities.GetTypeFromCache("System.Collections.Generic.IEnumerator`1", "mscorlib", TypeCache);
                var methodInfo = WrapperUtilities.GetMethodInfo(type, MethodInfoCache, "T get_Current()");
                return WrapperUtilities.InvokeMethodAndCast<T>(this, methodInfo, new object[] { });
            }
        }
        
        /// <summary>
        /// Wraps the 'Boolean MoveNext()' on the 'System.Collections.Generic.IEnumerator`1' type.
        /// </summary>
        ...
        /// <summary>
        /// Wraps the 'Void Reset()' on the 'System.Collections.Generic.IEnumerator`1' type.
        /// </summary>
