//---------------------------------------------------------------------
// <copyright file="OrderedQueryableProxy`1.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.Wrappers
{
    ...
    /// <summary>
    /// Wraps the 'System.Linq.IOrderedQueryable`1' type.
    /// </summary>
    /// <typeparam name="T">The wrapper type for the 'T' generic parameter.</typeparam>
    public partial class OrderedQueryableProxy<T> : System.Linq.IOrderedQueryable<T>, IProxyObject, IDisposable
    {
        ...
        private System.Linq.IOrderedQueryable<T> underlyingImplementation;
        ...
        /// <summary>
        /// Gets a value of the 'ElementType' property on 'System.Linq.IOrderedQueryable`1'
        /// </summary>
        ...
        /// <summary>
        /// Gets a value of the 'Expression' property on 'System.Linq.IOrderedQueryable`1'
        /// </summary>
        ...
        /// <summary>
        /// Gets a value of the 'Provider' property on 'System.Linq.IOrderedQueryable`1'
        /// </summary>
        ...
        /// <summary>
        /// Wraps the 'System.Collections.Generic.IEnumerator`1[T] GetEnumerator()' on the 'System.Linq.IOrderedQueryable`1' type.
        /// </summary>
        /// <returns>The value returned by the underlying method.</returns>
        System.Collections.Generic.IEnumerator<T> System.Collections.Generic.IEnumerable<T>.GetEnumerator()
        {
            var type = WrapperUtilities.GetTypeFromCache("System.Collections.Generic.IEnumerable`1", "mscorlib", TypeCache);
            var methodInfo = WrapperUtilities.GetMethodInfo(type, MethodInfoCache, "System.Collections.Generic.IEnumerator`1[T] GetEnumerator()");
            return (System.Collections.Generic.IEnumerator<T>)ProxyFactory.CreateProxyIfPossible(this.Scope, WrapperUtilities.InvokeMethodAndCast<System.Collections.Generic.IEnumerator<T>>(this, methodInfo, new object[] { }), typeof(System.Collections.Generic.IEnumerator<T>));
        }
        
        /// <summary>
        /// Wraps the 'System.Collections.IEnumerator GetEnumerator()' on the 'System.Linq.IOrderedQueryable`1' type.
        /// </summary>
        /// <returns>The value returned by the underlying method.</returns>
