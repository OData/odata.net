//---------------------------------------------------------------------
// <copyright file="IJsonValueVisitor`1.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.Json
{
    ...
    public interface IJsonValueVisitor<TReturn>
    {
        /// <summary>
        ...
        TReturn Visit(JsonObject jsonObject);
        ...
        /// <returns>The result of visiting this value.</returns>
        TReturn Visit(JsonArray jsonArray);
        ...
        /// <returns>The result of visiting this value.</returns>
        TReturn Visit(JsonPrimitiveValue primitive);
        ...
        /// <returns>The result of visiting this value.</returns>
        TReturn Visit(JsonProperty jsonProperty);
    }
}