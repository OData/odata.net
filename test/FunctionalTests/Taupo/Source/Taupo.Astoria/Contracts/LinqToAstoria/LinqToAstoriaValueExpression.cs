//---------------------------------------------------------------------
// <copyright file="LinqToAstoriaValueExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Astoria.Contracts.LinqToAstoria
{
    ...
    /// <summary>
    /// Expression node representing the '$value' segment in a uri.
    /// </summary>
    public class LinqToAstoriaValueExpression : LinqQueryMethodExpression
    {
        internal LinqToAstoriaValueExpression(QueryExpression source, QueryType type)
            : base(source, type)
        {
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Value()", this.Source);
        }
