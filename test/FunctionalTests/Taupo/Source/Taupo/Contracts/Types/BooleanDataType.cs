//---------------------------------------------------------------------
// <copyright file="BooleanDataType.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Contracts.Types
{
    ...
    /// Boolean data type.
    /// </summary>
    public sealed class BooleanDataType : PrimitiveDataType
    {
        /// <summary>
        /// Initializes a new instance of the BooleanDataType class.
        /// </summary>
        ...
        private BooleanDataType(bool isNullable, IEnumerable<PrimitiveDataTypeFacet> facets)
        ...
        {
            return new BooleanDataType(isNullable, facets);
        }
