//---------------------------------------------------------------------
// <copyright file="FloatingPointDataType.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Contracts.Types
{
    ...
    /// </summary>
    public sealed class FloatingPointDataType : PrimitiveDataType
    {
        /// <summary>
        /// Initializes a new instance of the FloatingPointDataType class.
        /// </summary>
        internal FloatingPointDataType()
            : this(false, null)
        {
        }
        ...
        private FloatingPointDataType(bool isNullable, IEnumerable<PrimitiveDataTypeFacet> facets)
        ...
        {
            return new FloatingPointDataType(isNullable, facets);
        }
