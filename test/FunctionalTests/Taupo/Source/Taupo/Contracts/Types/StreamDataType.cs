//---------------------------------------------------------------------
// <copyright file="StreamDataType.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Contracts.Types
{
    ...
    /// Stream Data Type.
    /// </summary>
    public sealed class StreamDataType : PrimitiveDataType
    {
        /// <summary>
        /// Initializes a new instance of the StreamDataType class.
        /// </summary>
        internal StreamDataType()
            : this(false, null)
        {
        }
        ...
        private StreamDataType(bool isNullable, IEnumerable<PrimitiveDataTypeFacet> facets)
        ...
        {
            return new StreamDataType(isNullable, facets);
        }
