...
namespace Microsoft.Test.Taupo.Utilities
{
    ...
    /// </summary>
    public class StringResourceVerifier : IStringResourceVerifier
    {
        ...
        public void VerifyMatch(string expectedResourceKey, string actualMessage, bool isExactMatch, params object[] stringParameters)
        {
            ...
            {
                throw new DataComparisonException("Actual string does not match the message defined in resources.")
                {
                    ExpectedValue = messageFromResources,
