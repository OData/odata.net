...
namespace Microsoft.Test.Taupo.Common
{
    ...
    public static class ExceptionUtilities
    {
        ...
        public static void CheckArgumentNotNull(object argument, string argumentName)
        {
            if (argument == null)
            {
                throw new TaupoArgumentNullException(argumentName);
            }
        }
            ...
            where TValue : struct, IComparable<TValue>
        {
            ...
            {
                throw new TaupoArgumentException(string.Format(CultureInfo.InvariantCulture, "Invalid range specified - '{0}' must be greater than or equal to '{1}'.", rightParameterName, leftParameterName));
            }
        }
        ...
        public static void CheckStringArgumentIsNotNullOrEmpty(string argument, string argumentName)
        {
            ...
            if (string.IsNullOrEmpty(argument))
            {
                ...
                throw new TaupoArgumentException(message);
            }
        }
        ...
        public static void CheckStringNotNullOrEmpty(string value, string exceptionMessageFormatText, params object[] messageArguments)
        {
            ...
            {
                throw new TaupoInvalidOperationException(string.Format(CultureInfo.InvariantCulture, exceptionMessageFormatText, messageArguments));
            }
        }
        ...
        public static TaupoNotSupportedException CreateIEnumerableNotImplementedException()
        {
            return new TaupoNotSupportedException(EnumerableNotImplementedExceptionMessage);
        }

        /// <summary>
        /// Verifies that all required dependencies have been specified.
        /// </summary>
        /// <param name="instance">Object instance to verify.</param>
        public static void CheckAllRequiredDependencies(object instance)
        {
            CheckArgumentNotNull(instance, "instance");

            foreach (PropertyInfo pi in instance.GetType().GetProperties().Where(pi => pi.IsDefined(typeof(InjectDependencyAttribute), false)))
            {
                object value = pi.GetValue(instance, null);
                if (value == null)
                {
                    var ida = PlatformHelper.GetCustomAttribute<InjectDependencyAttribute>(pi);
                    if (ida.IsRequired)
                    {
                        throw new TaupoInvalidOperationException("Required dependency '" + pi.Name + "' was not set on " + instance);
                    }
                }
            }
        }
