...
namespace Microsoft.Test.Taupo.Edmlib.StubEdm
{
    ...
    public class StubEdmEntityContainer : StubEdmElement, IEdmEntityContainer
    {
        ...
        /// Finds an element by name
        /// </summary>
        /// <param name="singletonName">the name of the element</param>
        /// <returns>the element.</returns>
        public IEdmSingleton FindSingleton(string singletonName)
        {
            ...
            return (IEdmSingleton)this.elements.FirstOrDefault(e => (e.Name == singletonName && e.ContainerElementKind == EdmContainerElementKind.Singleton));
        }
