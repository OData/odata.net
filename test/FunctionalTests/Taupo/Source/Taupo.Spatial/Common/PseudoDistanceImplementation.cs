...
#if !NO_TAUPO_DEPENDENCY
// use this one first because it matches the real file path
namespace Microsoft.Test.Taupo.Spatial.Common
#else
namespace Microsoft.Test.Taupo.DataServices.Common
#endif
{
    using System;
    using Microsoft.Spatial;
#if NO_TAUPO_DEPENDENCY
    using Microsoft.Test.Taupo.DataServices.Common;
#else
