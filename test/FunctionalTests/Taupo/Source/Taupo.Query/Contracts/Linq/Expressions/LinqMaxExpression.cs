//---------------------------------------------------------------------
// <copyright file="LinqMaxExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Max expression in a Linq query.
    /// </summary>
    public class LinqMaxExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqMaxExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Max({1})", this.Source, this.Lambda);
        }
