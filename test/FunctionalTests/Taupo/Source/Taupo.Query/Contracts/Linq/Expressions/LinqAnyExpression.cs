//---------------------------------------------------------------------
// <copyright file="LinqAnyExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Any expression in a Linq query.
    /// </summary>
    public class LinqAnyExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqAnyExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Any({1})", this.Source, this.Lambda);
        }
