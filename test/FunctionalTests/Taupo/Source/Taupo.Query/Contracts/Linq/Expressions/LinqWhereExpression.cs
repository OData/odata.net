//---------------------------------------------------------------------
// <copyright file="LinqWhereExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Where expression in a Linq query.
    /// </summary>
    public class LinqWhereExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqWhereExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Where({1})", this.Source, this.Lambda);
        }
