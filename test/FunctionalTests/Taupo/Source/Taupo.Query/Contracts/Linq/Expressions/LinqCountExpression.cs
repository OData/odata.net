//---------------------------------------------------------------------
// <copyright file="LinqCountExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Count expression in a Linq query.
    /// </summary>
    public class LinqCountExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqCountExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Count({1})", this.Source, this.Lambda);
        }
