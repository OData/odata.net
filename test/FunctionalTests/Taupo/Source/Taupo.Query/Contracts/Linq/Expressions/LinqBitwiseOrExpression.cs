//---------------------------------------------------------------------
// <copyright file="LinqBitwiseOrExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the BitwiseOr expression in queries.
    /// </summary>
    public class LinqBitwiseOrExpression : QueryBinaryExpression
    {
