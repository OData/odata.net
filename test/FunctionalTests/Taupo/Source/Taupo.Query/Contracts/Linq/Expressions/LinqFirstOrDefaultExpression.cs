//---------------------------------------------------------------------
// <copyright file="LinqFirstOrDefaultExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the FirstOrDefault expression in a Linq query.
    /// </summary>
    public class LinqFirstOrDefaultExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqFirstOrDefaultExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.FirstOrDefault({1})", this.Source, this.Lambda);
        }
