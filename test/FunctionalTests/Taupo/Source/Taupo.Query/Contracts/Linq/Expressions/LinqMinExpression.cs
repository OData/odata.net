//---------------------------------------------------------------------
// <copyright file="LinqMinExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Min expression in a Linq query.
    /// </summary>
    public class LinqMinExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqMinExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Min({1})", this.Source, this.Lambda);
        }
