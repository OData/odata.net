//---------------------------------------------------------------------
// <copyright file="LinqUnionExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the Union expression in a Linq query.
    /// </summary>
    public class LinqUnionExpression : LinqSetOperationExpression
    {
        internal LinqUnionExpression(QueryExpression firstSource, QueryExpression secondSource, QueryType type)
            : base(firstSource, secondSource, type)
        {
        }
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.Union({1})", this.FirstSource, this.SecondSource);
        }
