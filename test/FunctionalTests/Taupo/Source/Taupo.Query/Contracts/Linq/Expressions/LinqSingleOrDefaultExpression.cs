//---------------------------------------------------------------------
// <copyright file="LinqSingleOrDefaultExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the SingleOrDefault expression in a Linq query.
    /// </summary>
    public class LinqSingleOrDefaultExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqSingleOrDefaultExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.SingleOrDefault({1})", this.Source, this.Lambda);
        }
