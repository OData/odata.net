//---------------------------------------------------------------------
// <copyright file="LinqLongCountExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the LongCount expression in a Linq query.
    /// </summary>
    public class LinqLongCountExpression : LinqQueryMethodWithLambdaExpression
    {
        internal LinqLongCountExpression(QueryExpression source, LinqLambdaExpression predicate, QueryType type)
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.LongCount({1})", this.Source, this.Lambda);
        }
