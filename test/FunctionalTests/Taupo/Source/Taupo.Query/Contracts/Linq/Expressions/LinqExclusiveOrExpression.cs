//---------------------------------------------------------------------
// <copyright file="LinqExclusiveOrExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.Linq.Expressions
{
    ...
    /// <summary>
    /// Expression node representing the ExclusiveOr expression in queries.
    /// </summary>
    public class LinqExclusiveOrExpression : QueryBinaryExpression
    {
        internal LinqExclusiveOrExpression(QueryExpression left, QueryExpression right, QueryType type)
