//---------------------------------------------------------------------
// <copyright file="QueryEqualToExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the EqualTo expression in queries.
    /// </summary>
    public class QueryEqualToExpression : QueryBinaryExpression
    {
