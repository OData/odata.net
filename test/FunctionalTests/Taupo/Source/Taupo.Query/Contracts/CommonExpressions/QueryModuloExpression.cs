//---------------------------------------------------------------------
// <copyright file="QueryModuloExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the Modulo expression in queries.
    /// </summary>
    public class QueryModuloExpression : QueryBinaryExpression
    {
        internal QueryModuloExpression(QueryExpression left, QueryExpression right, QueryType type)
