//---------------------------------------------------------------------
// <copyright file="QuerySubtractExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the Subtract expression in queries.
    /// </summary>
    public class QuerySubtractExpression : QueryBinaryExpression
    {
        internal QuerySubtractExpression(QueryExpression left, QueryExpression right, QueryType type)
