//---------------------------------------------------------------------
// <copyright file="QueryLessThanOrEqualToExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the LessThanOrEqualTo expression in queries.
    /// </summary>
    public class QueryLessThanOrEqualToExpression : QueryBinaryExpression
    {
        internal QueryLessThanOrEqualToExpression(QueryExpression left, QueryExpression right, QueryType type)
