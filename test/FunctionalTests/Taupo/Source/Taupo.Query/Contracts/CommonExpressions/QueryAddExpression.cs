//---------------------------------------------------------------------
// <copyright file="QueryAddExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the Add expression in queries.
    /// </summary>
    public class QueryAddExpression : QueryBinaryExpression
    {
        internal QueryAddExpression(QueryExpression left, QueryExpression right, QueryType type)
