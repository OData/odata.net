//---------------------------------------------------------------------
// <copyright file="QueryNotEqualToExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the NotEqualTo expression in queries.
    /// </summary>
    public class QueryNotEqualToExpression : QueryBinaryExpression
    {
        internal QueryNotEqualToExpression(QueryExpression left, QueryExpression right, QueryType type)
