//---------------------------------------------------------------------
// <copyright file="QueryMultiplyExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the Multiply expression in queries.
    /// </summary>
    public class QueryMultiplyExpression : QueryBinaryExpression
    {
        internal QueryMultiplyExpression(QueryExpression left, QueryExpression right, QueryType type)
