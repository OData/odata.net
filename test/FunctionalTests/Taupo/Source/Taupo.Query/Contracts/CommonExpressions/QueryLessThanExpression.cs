//---------------------------------------------------------------------
// <copyright file="QueryLessThanExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the LessThan expression in queries.
    /// </summary>
    public class QueryLessThanExpression : QueryBinaryExpression
    {
        internal QueryLessThanExpression(QueryExpression left, QueryExpression right, QueryType type)
