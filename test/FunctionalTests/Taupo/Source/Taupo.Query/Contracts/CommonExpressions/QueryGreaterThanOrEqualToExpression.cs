//---------------------------------------------------------------------
// <copyright file="QueryGreaterThanOrEqualToExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the GreaterThanOrEqualTo expression in queries.
    /// </summary>
    public class QueryGreaterThanOrEqualToExpression : QueryBinaryExpression
    {
        internal QueryGreaterThanOrEqualToExpression(QueryExpression left, QueryExpression right, QueryType type)
