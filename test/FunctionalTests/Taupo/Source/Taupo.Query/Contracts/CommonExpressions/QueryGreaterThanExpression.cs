//---------------------------------------------------------------------
// <copyright file="QueryGreaterThanExpression.cs" company="Microsoft">
...
namespace Microsoft.Test.Taupo.Query.Contracts.CommonExpressions
{
    ...
    /// <summary>
    /// Expression node representing the GreaterThan expression in queries.
    /// </summary>
    public class QueryGreaterThanExpression : QueryBinaryExpression
    {
        internal QueryGreaterThanExpression(QueryExpression left, QueryExpression right, QueryType type)
