...
namespace Microsoft.OData.Edm.Tests.Csdl.Serialization
{
    ...
    public class EdmModelCsdlSerializationVisitorTests
    {
        ...
        public void VerifyComplexTypeWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitSchemaType(complexType),
                @"<ComplexType Name=""Dimensions""><Property Name=""Height"" Type=""Edm.Decimal"" Precision=""6"" Scale=""2"" /><Property Name=""Weight"" Type=""Edm.Decimal"" Precision=""6"" Scale=""Variable"" /><Property Name=""Length"" Type=""Edm.Decimal"" Nullable=""false"" /></ComplexType>");
    ...
    ""Length"": {
      ""$Type"": ""Edm.Decimal""
        ...
        public void VerifyComplexTypeWithNavigationPropertiesWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaType(complexType),
                @"<ComplexType Name=""Address""><Property Name=""Street"" Type=""Collection(Edm.String)"" MaxLength=""42"" Unicode=""false"" /><NavigationProperty Name=""City"" Type=""NS.City"" Nullable=""false"" ContainsTarget=""true""><OnDelete Action=""Cascade"" /></NavigationProperty></ComplexType>");
    ...
    ""City"": {
      ...
      ""$OnDelete"": ""Cascade""
        ...
        public void VerifyComplexTypeWithAnnotationWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaType(complexType),
                @"<ComplexType Name=""Sub"" BaseType=""NS.Base"" Abstract=""true"" OpenType=""true""><Property Name=""Data"" Type=""Edm.Int32"" Nullable=""false"" /><Annotation Term=""Org.OData.Core.V1.Description"" String=""Sub's Description"" /></ComplexType>");
    ...
    ""@Org.OData.Core.V1.Description"": ""Sub's Description""
        ...
        public void VerifyEntityTypeWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitSchemaType(entityType),
                @"<EntityType Name=""Customer""><Property Name=""Name"" Type=""Edm.String"" /><Property Name=""GeoPoint"" Type=""Edm.GeographyPoint"" Nullable=""false"" SRID=""8"" /></EntityType>");
      ...
      ""$SRID"": 8
        ...
        public void VerifyEntityTypeWithNavigationPropertiesWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitSchemaType(customer),
                @"<EntityType Name=""Customer""><Property Name=""Locations"" Type=""Collection(NS.Address)"" Nullable=""false"" /><NavigationProperty Name=""Orders"" Type=""Collection(NS.Order)""><OnDelete Action=""Cascade"" /></NavigationProperty></EntityType>");
      ...
      ""$OnDelete"": ""Cascade""
        ...
        public void VerifyEntityTypeWithAnnotationWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitSchemaType(subType),
                @"<EntityType Name=""Sub"" BaseType=""NS.Base"" Abstract=""true"" OpenType=""true""><Property Name=""Data"" Type=""Edm.PrimitiveType"" Nullable=""false"" /><Annotation Term=""Org.OData.Core.V1.LongDescription"" String=""Sub's Long Description"" /></EntityType>");
    ...
    ""@Org.OData.Core.V1.LongDescription"": ""Sub's Long Description""
        ...
        public void VerifyEnumTypeWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitSchemaType(enumType),
                @"<EnumType Name=""Color""><Member Name=""Blue"" Value=""0"" /><Member Name=""White"" Value=""1"" /></EnumType>");
  ...
  ""Color"": {
    ...
    ""White"": 1
        ...
        public void VerifyEnumTypeAllWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaType(enumType),
                @"<EnumType Name=""Color"" UnderlyingType=""Edm.Int16"" IsFlags=""true""><Member Name=""Blue"" Value=""0"" /><Member Name=""White"" Value=""1"" /><Annotation Term=""Org.OData.Core.V1.Description"" String=""Color Description"" /></EnumType>");
  ...
  ""Color"": {
    ...
    ""@Org.OData.Core.V1.Description"": ""Color Description""
        ...
        public void VerifyEnumTypeWithEnumMemberAnnotationWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaType(enumType),
                @"<EnumType Name=""Color"" UnderlyingType=""Edm.Int16"" IsFlags=""true""><Member Name=""Blue"" Value=""0"" /><Member Name=""White"" Value=""1""><Annotation Term=""Org.OData.Core.V1.Description"" String=""With overnight"" /></Member><Annotation Term=""Org.OData.Core.V1.Description"" String=""color description"" /></EnumType>");
  ...
  ""$Parameter"": [
    {
      ...
      ""$Nullable"": true
        ...
        public void VerifyActionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(action),
                @"<Action Name=""DoStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.String"" /><ReturnType Type=""Edm.String"" /></Action>");
  ...
  ""$ReturnType"": {
    ""$Nullable"": true
        ...
        public void VerifyActionWithAnnotationsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(action),
                @"<Action Name=""DoStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.String""><Annotation Term=""Org.OData.Core.V1.Description"" String=""parameter annotation"" /></Parameter><ReturnType Type=""Edm.String""><Annotation Term=""Org.OData.Core.V1.Description"" String=""return annotation"" /></ReturnType><Annotation Term=""Org.OData.Core.V1.Description"" String=""action annotation"" /></Action>");
  ...
  ""@Org.OData.Core.V1.Description"": ""action annotation""
        ...
        public void VerifySchemaWithActionsWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitEdmSchema(schema, null),
                @"<Schema Namespace=""NS"" xmlns=""http://docs.oasis-open.org/odata/ns/edm""><Action Name=""DoStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.String"" /><ReturnType Type=""Edm.String"" /></Action><Action Name=""DoStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.Int32"" /><ReturnType Type=""Edm.String"" /></Action></Schema>");
  ...
  ""$ReturnType"": {
    ...
    ""$Nullable"": true
        ...
        public void VerifyFunctionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(function),
                @"<Function Name=""DoStuff"" IsBound=""true"" EntitySetPath=""Customers/Orders"" IsComposable=""true""><Parameter Name=""bindingParameter"" Type=""Edm.String"" /><Parameter Name=""param"" Type=""Collection(Edm.Int32)"" /><ReturnType Type=""Edm.String"" /></Function>");
  ...
  ""$ReturnType"": {
    ""$Nullable"": true
        ...
        public void VerifyFunctionWithAnnotationsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(function),
                @"<Function Name=""DoStuff"" IsBound=""true"" EntitySetPath=""Customers/Orders"" IsComposable=""true""><Parameter Name=""param1"" Type=""Edm.String""><Annotation Term=""Org.OData.Core.V1.Description"" String=""parameter annotation"" /></Parameter><ReturnType Type=""Edm.String""><Annotation Term=""Org.OData.Core.V1.Description"" String=""return annotation"" /></ReturnType><Annotation Term=""Org.OData.Core.V1.Description"" String=""action annotation"" /></Function>");
  ...
  ""@Org.OData.Core.V1.Description"": ""action annotation""
        ...
        public void VerifySchemaWithFunctionsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitEdmSchema(schema, null),
                @"<Schema Namespace=""NS"" xmlns=""http://docs.oasis-open.org/odata/ns/edm""><Function Name=""GetStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.String"" /><ReturnType Type=""Edm.String"" /></Function><Function Name=""GetStuff"" IsBound=""true""><Parameter Name=""param1"" Type=""Edm.String"" /><Parameter Name=""param2"" Type=""Edm.Int32"" Nullable=""false"" /><ReturnType Type=""Edm.Guid"" Nullable=""false"" /></Function></Schema>");
  ...
  ""MyAnnotation"": {
    ...
    ""$Nullable"": true
        ...
        public void VerifyTermWithAnnotationsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(term),
                @"<Term Name=""MyAnnotation"" Type=""Edm.Int32"" AppliesTo=""Function,Action,EntitySet""><Annotation Term=""Org.OData.Core.V1.Description"" String=""term description"" /></Term>");
  ...
  ""MyTypeDefinition"": {
    ...
    ""$UnderlyingType"": ""Edm.PrimitiveType""
        ...
        public void VerifyTypeDefinitionWithMoreInformationsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(definition),
                @"<TypeDefinition Name=""MyTypeDefinition"" UnderlyingType=""Edm.Int32""><Annotation Term=""Measures.Unit"" String=""Centimeters"" /></TypeDefinition>");
  ...
  ""Default"": {
    ""$Kind"": ""EntityContainer""
        ...
        public void VerifyEntityContainerWithElementsWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitSchemaElement(container),
                @"<EntityContainer Name=""Default""><EntitySet Name=""Set"" EntityType=""NS.Entity"" /><Singleton Name=""Me"" Type=""NS.Entity"" /><Annotation Term=""Org.OData.Core.V1.Description"" String=""Desciption for EntitySet container"" /></EntityContainer>");
    ...
    ""$Type"": ""NS.EntityType""
        ...
        public void VerifyEntitySetWithAllInformationsWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitEntityContainerElements(new[] { people }),
                @"<EntitySet Name=""People"" EntityType=""NS.Person""><NavigationPropertyBinding Path=""Addresses/City"" Target=""City"" /><NavigationPropertyBinding Path=""HomeAddress/City"" Target=""City"" /><NavigationPropertyBinding Path=""WorkAddress/NS.WorkAddress/CountryOrRegion"" Target=""CountryOrRegion"" /><Annotation Term=""UI.ReadOnly"" Bool=""true"" /></EntitySet>");
  ...
  ""Me"": {
    ...
    ""$Type"": ""NS.EntityType""
        ...
        public void VerifySingletonWithAnnotationWrittenCorrectly()
        {
            ...
            VisitAndVerifyXml(v => v.VisitEntityContainerElements(new[] { singleton }),
                @"<Singleton Name=""Me"" Type=""NS.EntityType""><Annotation Term=""NS.MyTerm""><EnumMember>NS.Permission/Read NS.Permission/Write</EnumMember></Annotation></Singleton>");
  ...
  ""@Task.Duration"": {
    ""$Duration"": ""PT2H3M4S""
        ...
        public void VerifyAnnotationWithEnumMemberExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""Self.HasPattern""><EnumMember>NS.Permission/Read NS.Permission/Write</EnumMember></Annotation>");
  ...
  ""@Self.HasPattern"": {
    ""$EnumMember"": ""NS.Permission/Read NS.Permission/Write""
        ...
        public void VerifyAnnotationWithFloatExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for Json
            VisitAndVerifyJson(v => v.VisitVocabularyAnnotation(annotation), @"{
  ""@UI.FloatWidth"": 3.14000010490417
}");
        }
  ...
  ""@UI.EndTime"": {
    ""$TimeOfDay"": ""00:21:45.0040000""
        ...
        public void VerifyAnnotationWithApplyExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""UI.DisplayName""><Apply Function=""odata.concat""><Path>ProductName</Path><Path>Available/Quantity</Path><Path>Available/Unit</Path></Apply></Annotation>");
  ...
  ""@UI.DisplayName"": {
    ...
    ""$Function"": ""odata.concat""
        ...
        public void VerifyAnnotationWithCastExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""UI.Threshold""><Cast Type=""Edm.Decimal"" Nullable=""false"" Precision=""3"" Scale=""4""><Path>Average</Path></Cast></Annotation>");
  ...
  ""@UI.Threshold"": {
    ...
    ""$Scale"": 4
        ...
        public void VerifyAnnotationWithCollectionExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""Seo.SeoTerms""><Collection><String>Product</String><String>Supplier</String><String>Customer</String></Collection></Annotation>");
  ...
  ""@Seo.SeoTerms"": [
    ...
    ""Customer""
        ...
        public void VerifyAnnotationWithIfThenElseExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""Person.Gender""><If><Path>IsFemale</Path><String>Female</String><String>Male</String></If></Annotation>");
    ...
    ""$If"": [
      ...
      ""Male""
        ...
        public void VerifyAnnotationWithIsOfThenElseExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""Self.IsPreferredCustomer""><IsType Type=""Collection(Edm.String)"" MaxLength=""42""><Path>Customer</Path></IsType></Annotation>");
  ...
  ""@Self.IsPreferredCustomer"": {
    ...
    ""$MaxLength"": 42
        ...
        public void VerifyAnnotationWithLabeledElementExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""org.example.display.DisplayName""><LabeledElement Name=""CustomerFirstName""><Path>FirstName</Path></LabeledElement></Annotation>");
  ...
  ""@org.example.display.DisplayName"": {
    ""$LabeledElementReference"": ""CustomerFirstName""
        ...
        public void VerifyAnnotationWithNullExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""UI.DisplayName""><Null /></Annotation>");
  ...
  ""@UI.DisplayName"": null
        ...
        public void VerifyAnnotationWithRecordExpressionWrittenCorrectly()
        {
            ...
            // Act & Assert for XML
            VisitAndVerifyXml(v => v.VisitVocabularyAnnotation(annotation),
                @"<Annotation Term=""Person.Employee""><Record Type=""NS.Address""><PropertyValue Property=""Street"" String=""148th ave"" /><PropertyValue Property=""City"" String=""Redmond"" /></Record></Annotation>");
