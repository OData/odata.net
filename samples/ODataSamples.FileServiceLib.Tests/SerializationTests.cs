...
public class SerializationTests
{
    ...
    [Fact]
    public async Task SerializesSingleFileItem()
    {
        // Arrange
        var serializerOptions = ODataSerializerOptionsFactory.Create();
        FindFileResponse collection = DataGenerator.CreateMultiFileResponseData(count: 1);
        ...
        var expectedOutput = """
        {
            "@odata.context":"http://service/odata/$metadata#Users('id')/Files/$entity",
            "@odata.id": "http://service/odata/Users('id')/Files('file-1')",
            "@odata.etag": "W/\"1\"",
            "Id": "file-1",
            "FileName": "MarketingReport01.pdf",
