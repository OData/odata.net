...
namespace Microsoft.OData.Edm.Csdl.Internal.CsdlSemantics
{
    ...
    internal class CsdlSemanticsNavigationProperty : CsdlSemanticsElement, IEdmNavigationProperty, IEdmCheckable
    {
        ...
        private IEdmAssociationEnd ComputeFrom()
        {
            ...
            else
            {
                return new BadCsdlSemanticsNavigationPropertyToEnd(
                    ...
                    new EdmError[]
                    {
                        new EdmError(this.Location, EdmErrorCode.BadNavigationProperty, Microsoft.OData.Edm.Strings.EdmModel_Validator_Semantic_BadNavigationPropertyUndefinedRole(this.Name, fromRole, association.Name))
                    });
            }
        }
        ...
        private IEdmAssociationEnd ComputeTo()
        {
            ...
            if (toRole == fromRole)
            {
                return new BadCsdlSemanticsNavigationPropertyToEnd(association, toRole, new EdmError[] { new EdmError(this.Location, EdmErrorCode.BadNavigationProperty, Microsoft.OData.Edm.Strings.EdmModel_Validator_Semantic_BadNavigationPropertyRolesCannotBeTheSame(this.Name)) });
            }
            ...
            else
            {
                return new BadCsdlSemanticsNavigationPropertyToEnd(
                    ...
                    new EdmError[]
                    {
                        new EdmError(this.Location, EdmErrorCode.BadNavigationProperty, Microsoft.OData.Edm.Strings.EdmModel_Validator_Semantic_BadNavigationPropertyUndefinedRole(this.Name, toRole, association.Name))
                    });
            }
        }
