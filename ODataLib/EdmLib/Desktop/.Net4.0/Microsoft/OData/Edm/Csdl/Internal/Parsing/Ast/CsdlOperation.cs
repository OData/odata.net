...
namespace Microsoft.OData.Edm.Csdl.Internal.Parsing.Ast
{
    ...
    {
        public CsdlOperation(string name, IEnumerable<CsdlOperationParameter> parameters, CsdlTypeReference returnType, CsdlDocumentation documentation, CsdlLocation location)
