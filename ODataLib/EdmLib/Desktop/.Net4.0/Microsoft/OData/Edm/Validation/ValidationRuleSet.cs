    ...
    public sealed class ValidationRuleSet : IEnumerable<ValidationRule>
    {
        ...
        private static readonly ValidationRuleSet BaseRuleSet = 
            new ValidationRuleSet(new ValidationRule[]
            {
                ...
                ValidationRules.OperationImportReturnEntitiesButDoesNotSpecifyEntitySet,
                ValidationRules.OperationImportEntityTypeDoesNotMatchEntitySet,
                ValidationRules.ComposableOperationImportMustHaveReturnType,
                ...
                ValidationRules.OperationImportBindableOperationImportMustHaveParameters,
                ValidationRules.OperationImportComposableOperationImportCannotBeSideEffecting,
        ...
        private static readonly ValidationRuleSet V4RuleSet = 
            new ValidationRuleSet(
                ...
                new ValidationRule[]
                {
                    ValidationRules.OperationImportUnsupportedReturnType,
