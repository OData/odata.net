...
namespace Microsoft.OData.Edm.Csdl.Internal.Parsing.Ast
{
    ...
    {
        public CsdlFunction(string name, IEnumerable<CsdlOperationParameter> parameters, CsdlTypeReference returnType, CsdlDocumentation documentation, CsdlLocation location)
