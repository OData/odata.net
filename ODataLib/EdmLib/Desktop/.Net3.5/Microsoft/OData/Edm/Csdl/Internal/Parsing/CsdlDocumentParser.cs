...
using Microsoft.OData.Edm.Csdl.Internal.Parsing.Common;
using Microsoft.OData.Edm.Validation;
using Microsoft.OData.Edm.Values;

namespace Microsoft.OData.Edm.Csdl.Internal.Parsing
{
    /// <summary>
    ...
    internal class CsdlDocumentParser : EdmXmlDocumentParser<CsdlSchema>
    {
        ...
        private CsdlOperation OnFunctionElement(XmlElementInfo element, XmlElementValueCollection childValues)
        {
            string name = Required(CsdlConstants.Attribute_Name);
            ...
            // Can't switch this to a CsdlAction or CsdlFunction yet as we don't know which it is based on the old csdl schema syntax.
            return new CsdlOperation(name, parameters, returnType, Documentation(childValues), element.Location);
        }
        ...
        private CsdlOperationImport OnFunctionImportElement(XmlElementInfo element, XmlElementValueCollection childValues)
        {
            string name = Required(CsdlConstants.Attribute_Name);
            string returnTypeName = OptionalType(CsdlConstants.Attribute_ReturnType);
