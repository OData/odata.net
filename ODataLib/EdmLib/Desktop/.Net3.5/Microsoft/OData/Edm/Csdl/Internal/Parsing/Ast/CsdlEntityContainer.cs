...
namespace Microsoft.OData.Edm.Csdl.Internal.Parsing.Ast
{
    ...
    internal class CsdlEntityContainer : CsdlNamedElement
    {
        ...
        public CsdlEntityContainer(string name, string extends, IEnumerable<CsdlEntitySet> entitySets, IEnumerable<CsdlAssociationSet> associationSets, IEnumerable<CsdlOperationImport> operationImports, CsdlDocumentation documentation, CsdlLocation location)
