...
namespace Microsoft.OData.Core
{
    ...
    public sealed class ODataMessageWriter : IDisposable
    {
        ...
        public ODataParameterWriter CreateODataParameterWriter(IEdmOperationImport operationImport)
        {
            this.VerifyCanCreateODataParameterWriter(operationImport);
            return this.WriteToOutput(
                ODataPayloadKind.Parameter,
                null,
                (context) => context.CreateODataParameterWriter(operationImport));
        }
        ...
        public Task<ODataParameterWriter> CreateODataParameterWriterAsync(IEdmOperationImport operationImport)
        {
            this.VerifyCanCreateODataParameterWriter(operationImport);
            return this.WriteToOutputAsync(
                ODataPayloadKind.Parameter,
                null,
                (context) => context.CreateODataParameterWriterAsync(operationImport));
        }
#endif
        ...
        /// </summary>
        /// <param name="operationImport">The operation import whose parameters will be written.</param>
        private void VerifyCanCreateODataParameterWriter(IEdmOperationImport operationImport)
        {
        ...
        private void VerifyMetadataDocumentHeaders()
        {
            ...
            Version odataVersion = this.model.GetDataServiceVersion();
            if (odataVersion == null)
            {
                odataVersion = this.settings.Version.Value.ToDataServiceVersion();
                this.model.SetDataServiceVersion(odataVersion);
            }
        }
