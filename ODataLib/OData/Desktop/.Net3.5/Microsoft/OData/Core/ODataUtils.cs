...
namespace Microsoft.OData.Core
{
    ...
    public static class ODataUtils
    {
        ...
        /// <summary>
        /// Gets the value of IsAlwaysBindable annotation on the <paramref name="operationImport"/>.
        /// </summary>
        /// <param name="model">The <see cref="IEdmModel"/> containing the annotation.</param>
        /// <param name="operationImport">The <see cref="IEdmOperationImport"/> to get the annotation from.</param>
        /// <returns>The value of the annotation if it exists; false otherwise.</returns>
        /// <exception cref="ODataException">Thrown if the IsAlwaysBindable annotation is set to true for a non-bindable <paramref name="operationImport"/>.</exception>
        public static bool IsAlwaysBindable(this IEdmModel model, IEdmOperationImport operationImport)
        {
            ExceptionUtils.CheckArgumentNotNull(model, "model");
            ...
            if (TryGetBooleanAnnotation(model, operationImport, EdmConstants.IsAlwaysBindableAttributeName, out isAlwaysBindable))
            {
                if (!operationImport.IsBindable && isAlwaysBindable)
                {
        ...
        /// <summary>
        /// Sets the value of IsAlwaysBindable annotation of the <paramref name="operationImport"/> to <paramref name="isAlwaysBindable"/>
        /// </summary>
        /// <param name="model">The <see cref="IEdmModel"/> containing the annotation.</param>
        /// <param name="operationImport">The <see cref="IEdmOperationImport"/> to set the annotation on.</param>
        /// <param name="isAlwaysBindable">The value of the annotation to set.</param>
        /// <exception cref="ODataException">Thrown if IsAlwaysBindable is set to true for a non-bindable <paramref name="operationImport"/>.</exception>
        public static void SetIsAlwaysBindable(this IEdmModel model, IEdmOperationImport operationImport, bool isAlwaysBindable)
        {
            ExceptionUtils.CheckArgumentNotNull(model, "model");
            ExceptionUtils.CheckArgumentNotNull(operationImport, "operationImport");
            ...
            SetBooleanAnnotation(model, operationImport, EdmConstants.IsAlwaysBindableAttributeName, isAlwaysBindable);
        }
