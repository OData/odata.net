...
namespace Microsoft.Data.OData.Json
{
    ...
    internal static class ODataJsonReaderUtils
    {
        ...
        internal static void ValidateMetadataStringProperty(string propertyValue, string propertyName)
        {
            ...
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_MetadataPropertyWithNullValue(propertyName));
            }
        }
        ...
        internal static void ValidateEntityReferenceLinksStringProperty(string propertyValue, string propertyName)
        {
            ...
            if (propertyValue == null)
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_EntityReferenceLinksPropertyWithNullValue(propertyName));
            }
        }
        ...
        internal static void ValidateCountPropertyInEntityReferenceLinks(long? propertyValue)
        {
            ...
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_EntityReferenceLinksInlineCountWithNullValue(JsonConstants.ODataCountName));
            }
        }
        ...
        internal static void ValidateMediaResourceStringProperty(string propertyValue, string propertyName)
        {
            ...
            if (propertyValue == null)
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_MediaResourcePropertyWithNullValue(propertyName));
            }
        }
        ...
        internal static void ValidateFeedProperty(object propertyValue, string propertyName)
        {
            ...
            if (propertyValue == null)
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_FeedPropertyWithNullValue(propertyName));
            }
        }
        ...
        internal static void ValidateOperationJsonProperty(object propertyValue, string propertyName, string metadata, string operationsHeader)
        {
            ...
            Debug.Assert(operationsHeader == "actions" || operationsHeader == "functions", "operationsHeader should be either 'actions' or 'functions'");

            if (propertyValue == null)
            {
                throw new ODataException(o.Strings.ODataJsonReaderUtils_OperationPropertyCannotBeNull(
                    propertyName,
                    metadata,
                    operationsHeader));
            }
        ...
        internal static string GetPayloadTypeName(object payloadItem)
        {
            ...
            TypeCode typeCode = o.PlatformHelper.GetTypeCode(payloadItem.GetType());
            switch (typeCode)
            {
            ...
            throw new ODataException(o.Strings.General_InternalError(InternalErrorCodes.ODataJsonReader_ReadEntryStart));
        }
