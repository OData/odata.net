...
namespace Microsoft.OData.Core {
    ...
    internal sealed class TextRes {
        ...
        internal const string ODataJsonLightContextUriBuilder_ValidateDerivedType = "ODataJsonLightContextUriBuilder_ValidateDerivedType";
        internal const string ODataJsonLightContextUriBuilder_TypeNameMissingForTopLevelCollectionWhenWritingResponsePayload = "ODataJsonLightContextUriBuilder_TypeNameMissingForTopLevelCollectionWhenWritingResponsePayload";
        internal const string ODataJsonLightContextUriBuilder_EntitySetOrNavigationPropertyMissingForTopLevelEntityReferenceLinkResponse = "ODataJsonLightContextUriBuilder_EntitySetOrNavigationPropertyMissingForTopLevelEntityReferenceLinkResponse";
        internal const string ODataJsonLightContextUriBuilder_EntitySetOrNavigationPropertyMissingForTopLevelEntityReferenceLinksResponse = "ODataJsonLightContextUriBuilder_EntitySetOrNavigationPropertyMissingForTopLevelEntityReferenceLinksResponse";
        ...
        internal const string ODataJsonLightContextUriParser_InvalidEntityWithTypeCastUriSuffix = "ODataJsonLightContextUriParser_InvalidEntityWithTypeCastUriSuffix";
        internal const string ODataJsonLightContextUriParser_InvalidEntityTypeInTypeCast = "ODataJsonLightContextUriParser_InvalidEntityTypeInTypeCast";
        internal const string ODataJsonLightContextUriParser_IncompatibleEntityTypeInTypeCast = "ODataJsonLightContextUriParser_IncompatibleEntityTypeInTypeCast";
        internal const string ODataJsonLightContextUriParser_InvalidEntityReferenceLinkUriSuffix = "ODataJsonLightContextUriParser_InvalidEntityReferenceLinkUriSuffix";
        internal const string ODataJsonLightContextUriParser_InvalidPropertyForEntityReferenceLinkUri = "ODataJsonLightContextUriParser_InvalidPropertyForEntityReferenceLinkUri";
        internal const string ODataJsonLightContextUriParser_InvalidSingletonNavPropertyForEntityReferenceLinkUri = "ODataJsonLightContextUriParser_InvalidSingletonNavPropertyForEntityReferenceLinkUri";
        internal const string ODataJsonLightContextUriParser_FragmentWithInvalidNumberOfParts = "ODataJsonLightContextUriParser_FragmentWithInvalidNumberOfParts";
        ...
        internal const string ODataJsonLightContextUriParser_InvalidAssociationLink = "ODataJsonLightContextUriParser_InvalidAssociationLink";
        internal const string ODataJsonLightContextUriParser_InvalidEntitySetName = "ODataJsonLightContextUriParser_InvalidEntitySetName";
        ...
        internal const string ODataJsonLightEntryAndFeedDeserializer_InvalidFunctionImportName = "ODataJsonLightEntryAndFeedDeserializer_InvalidFunctionImportName";
