...
namespace Microsoft.OData.Core.UriParser.Visitors
{
    ...
    internal sealed class V4SelectPropertyVisitor : PathSegmentTokenVisitor
    {
        /// <summary>
        ...
        public V4SelectPropertyVisitor(IEdmModel model, IEdmStructuredType edmType, int maxDepth, SelectExpandClause expandClauseToDecorate)
        {
            this.model = model;
