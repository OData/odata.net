...
namespace Microsoft.OData.Core.UriParser.Parsers
{
    ...
    /// <summary>
    /// Sub-parser that <see cref="V4SelectExpandParser"/> uses to parse a single select or expand term.
    /// Uses a provided Lexer, which must be positioned at the term, to parse the term.
    /// TODO Rename this to SelectExpandTermParser later. Leaving as this to avoid confusion right now.
    /// </summary>
    internal sealed class V4TermParser
    {
        /// <summary>
        /// Lexer provided by <see cref="V4SelectExpandParser"/>.
        /// </summary>
        ...
        internal V4TermParser(ExpressionLexer lexer, int maxPathLength, bool isSelect)
        {
            this.lexer = lexer;
