...
namespace Microsoft.Data.OData.Json
{
    ...
    internal static class JsonWriterExtensions
    {
        ...
        internal static void WritePrimitiveValue(this JsonWriter jsonWriter, object value, ODataVersion odataVersion)
        {
            ...
            TypeCode typeCode = o.PlatformHelper.GetTypeCode(value.GetType());
            switch (typeCode)
            {
                ...
                default:
                    ...
                    throw new ODataException(o.Strings.ODataJsonWriter_UnsupportedValueType(value.GetType().FullName));
            }
        }
