    ...
    public sealed class ODataMessageWriter : IDisposable
    {
        ...
        public ODataWriter CreateODataFeedWriter()
        {
            ...
            return this.WriteToOutput(
                ...
                null /* verifyHeaders */,
                (context) => context.CreateODataFeedWriter());
        }
        ...
        public Task<ODataWriter> CreateODataFeedWriterAsync()
        {
            ...
            return this.WriteToOutputAsync(
                ODataPayloadKind.Feed,
                null /* verifyHeaders */,
                (context) => context.CreateODataFeedWriterAsync());
        }
#endif
        ...
        public ODataWriter CreateODataEntryWriter()
        {
            ...
            return this.WriteToOutput(
                ...
                null /* verifyHeaders */,
                (context) => context.CreateODataEntryWriter());
        }
        ...
        public Task<ODataWriter> CreateODataEntryWriterAsync()
        {
            ...
            return this.WriteToOutputAsync(
                ODataPayloadKind.Entry,
                null /* verifyHeaders */,
                (context) => context.CreateODataEntryWriterAsync());
        }
#endif
        ...
        public ODataCollectionWriter CreateODataCollectionWriter()
        {
            ...
            return this.WriteToOutput(
                ...
                null /* verifyHeaders */,
                (context) => context.CreateODataCollectionWriter());
        }
        ...
        public Task<ODataCollectionWriter> CreateODataCollectionWriterAsync()
        {
            ...
            return this.WriteToOutputAsync(
                ODataPayloadKind.Collection,
                null /* verifyHeaders */,
                (context) => context.CreateODataCollectionWriterAsync());
        }
#endif
        ...
        private void EnsureODataFormatAndContentType()
        {
            ...
            if (!string.IsNullOrEmpty(contentType))
            {
                ...
                MediaType mediaType;
                this.format = MediaTypeUtils.GetFormatFromContentType(contentType, new ODataPayloadKind[] { this.writerPayloadKind }, MediaTypeResolver.DefaultMediaTypeResolver, out mediaType, out this.encoding, out computedPayloadKind, out this.batchBoundary);
            ...
            else
            {
                ...
                MediaType mediaType;
                this.format = MediaTypeUtils.GetContentTypeFromSettings(this.settings, this.writerPayloadKind, MediaTypeResolver.DefaultMediaTypeResolver, out mediaType, out this.encoding);
        ...
        private void WriteToOutput(ODataPayloadKind payloadKind, Action verifyHeaders, Action<ODataOutputContext> writeAction)
        {
            ...
            this.outputContext = ODataOutputContext.CreateOutputContext(
                this.format,
                this.message,
                this.encoding,
                this.settings,
        ...
        private Task WriteToOutputAsync(ODataPayloadKind payloadKind, Action verifyHeaders, Func<ODataOutputContext, Task> writeAsyncAction)
        {
            ...
            // Create the output context
            return ODataOutputContext.CreateOutputContextAsync(
                this.format,
                this.message,
                this.encoding,
                this.settings,
