...
namespace Microsoft.Data.OData.Atom
{
    ...
    internal sealed class ODataAtomEntryAndFeedDeserializer : ODataAtomPropertyAndValueDeserializer
    {
        ...
        internal void VerifyEntryStart()
        {
            ...
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_ElementExpected(this.XmlReader.NodeType));
            }

            if (!this.XmlReader.NamespaceEquals(this.AtomNamespace) || !this.XmlReader.LocalNameEquals(this.AtomEntryElementName))
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_EntryElementWrongName(this.XmlReader.LocalName, this.XmlReader.NamespaceURI));
            }
        }
        ...
        internal void ReadFeedStart()
        {
            ...
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_FeedElementWrongName(this.XmlReader.LocalName, this.XmlReader.NamespaceURI));
            }
        ...
        internal void ReadNavigationLinkContentAfterExpansion(bool emptyInline)
        {
            ...
            if (!emptyInline)
            {
                ...
                if (expandedNavigationLinkContent != ODataAtomDeserializerExpandedNavigationLinkContent.Empty)
                {
                    ...
                    throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_MultipleExpansionsInInline(expandedNavigationLinkContent.ToString()));
                }
            }
            ...
            if (this.ReadNavigationLinkContent())
            {
                ...
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_MultipleInlineElementsInLink);
            }
                            ...
                            case XmlNodeType.Element:
                                if (this.XmlReader.NamespaceEquals(this.AtomNamespace) && this.XmlReader.LocalNameEquals(this.AtomCategoryElementName))
                                {
                                    ...
                                    while (this.XmlReader.MoveToNextAttribute())
                                    {
                                        ...
                                        if (isEmptyNamespace || (this.UseClientFormatBehavior && this.XmlReader.NamespaceEquals(this.AtomNamespace)))
                                        {
                                            if (this.XmlReader.LocalNameEquals(this.AtomCategorySchemeAttributeName))
                                            {
                                                if (string.CompareOrdinal(this.XmlReader.Value, this.MessageReaderSettings.ReaderBehavior.ODataTypeScheme) == 0)
                                                {
                                            ...
                                            {
                                                if (typeName == null || !isEmptyNamespace)
                                                {
        ...
        private void ValidateDuplicateElement(bool duplicateElementFound)
        {
            ...
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_DuplicateElements(this.XmlReader.NamespaceURI, this.XmlReader.LocalName));
            }
        }
        ...
        private void ReadAtomContentAttributes(out string contentType, out string contentSource)
        {
            ...
            while (this.XmlReader.MoveToNextAttribute())
            {
                bool isEmptyNamespace = this.XmlReader.NamespaceEquals(this.EmptyNamespace);
                if (isEmptyNamespace ||
                    (this.UseClientFormatBehavior && this.XmlReader.NamespaceEquals(this.AtomNamespace)))
                {
                    if (this.XmlReader.LocalNameEquals(this.AtomTypeAttributeName))
                    {
                        // type or atom:type attribute
                        if (!isEmptyNamespace || contentType == null)
                        {
                    ...
                    else if (this.XmlReader.LocalNameEquals(this.MediaLinkEntryContentSourceAttributeName))
                    {
                        ...
                        if (!isEmptyNamespace || contentSource == null)
                        {
        ...
        private void ReadAtomIdElementInEntry(IODataAtomReaderEntryState entryState)
        {
            ...
            if (!(this.AtomInputContext.UseClientFormatBehavior && entryState.HasId))
            {
        ...
        private bool TryReadAtomStandardRelationLinkInEntry(IODataAtomReaderEntryState entryState, string linkRelation, string linkHRef)
        {
            ...
            if (string.CompareOrdinal(linkRelation, AtomConstants.AtomEditRelationAttributeValue) == 0)
            {
                ...
                if (entryState.HasEditLink && this.AtomInputContext.UseDefaultFormatBehavior)
                {
                    throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_MultipleLinksInEntry(AtomConstants.AtomEditRelationAttributeValue));
                }

                if (linkHRef != null && !(this.AtomInputContext.UseClientFormatBehavior && entryState.HasEditLink))
                {
            ...
            if (string.CompareOrdinal(linkRelation, AtomConstants.AtomSelfRelationAttributeValue) == 0)
            {
                ...
                if (entryState.HasReadLink && this.AtomInputContext.UseDefaultFormatBehavior)
                {
                    throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_MultipleLinksInEntry(AtomConstants.AtomSelfRelationAttributeValue));
                }

                if (linkHRef != null && !(this.AtomInputContext.UseClientFormatBehavior && entryState.HasReadLink))
                {
            ...
            {
                // edit-media link
                if (entryState.HasEditMediaLink && this.AtomInputContext.UseDefaultFormatBehavior)
                {
                    throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_MultipleLinksInEntry(AtomConstants.AtomEditMediaRelationAttributeValue));
                }

                if (!(this.AtomInputContext.UseClientFormatBehavior && entryState.HasEditMediaLink))
                {
                    ...
                    EnsureMediaResource(entryState, /*validateMLEPresence*/ !this.UseClientFormatBehavior);
                    ODataEntry entry = entryState.Entry;
        ...
        private bool TryReadOperation(IODataAtomReaderEntryState entryState)
        {
            ...
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_OperationMissingMetadataAttribute(operationName));
            }

            if (operation.Target == null)
            {
                throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_OperationMissingTargetAttribute(operationName));
            }
                ...
                switch (this.XmlReader.NodeType)
                {
                    ...
                    case XmlNodeType.Element:
                        if (this.XmlReader.NamespaceEquals(this.AtomNamespace))
                        {
                            ...
                            throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_UnknownElementInInline(this.XmlReader.LocalName));
                        }
        ...
        private string VerifyAtomContentMediaType(string contentType)
        {
                ...
                !HttpUtils.CompareMediaTypeNames(MimeConstants.MimeApplicationAtomXml, contentType))
            {
                ...
                if (!(HttpUtils.CompareMediaTypeNames(mediaType, MimeConstants.MimeApplicationXml) || HttpUtils.CompareMediaTypeNames(mediaType, MimeConstants.MimeApplicationAtomXml)))
                {
                    ...
                    {
                        throw new ODataException(o.Strings.ODataAtomEntryAndFeedDeserializer_ContentWithWrongType(mediaType));
                    }
                }
            }
