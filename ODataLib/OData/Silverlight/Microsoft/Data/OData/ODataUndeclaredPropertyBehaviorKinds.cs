...
namespace Microsoft.Data.OData
{
    ...
    /// <summary>
    /// Behavior of readers when reading undeclared property.
    /// </summary>
    [Flags]
    public enum ODataUndeclaredPropertyBehaviorKinds
    {
        ...
        /// <summary>
        /// The reader will skip reading the property if it's not declared by the model.
        /// </summary>
        /// <remarks>
        /// This flag can only be used when reading responses.
        /// Note that this setting is not compatible with open types. The reader will fail if it finds undeclared property on an open type
        /// while this setting is used.
