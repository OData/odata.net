...
namespace Microsoft.Data.OData.JsonLight
{
    ...
    internal sealed class ODataJsonLightOutputContext : ODataJsonOutputContextBase
    {
        ...
        {
            DebugUtils.CheckNoExternalCallers();
            return ODataJsonLightMetadataUriBuilder.CreateFromSettings(this.MetadataLevel, this.WritingResponse, this.MessageWriterSettings, this.Model);
        }
        ...
        {
            ODataJsonLightParameterWriter jsonLightParameterWriter = new ODataJsonLightParameterWriter(this, functionImport);
