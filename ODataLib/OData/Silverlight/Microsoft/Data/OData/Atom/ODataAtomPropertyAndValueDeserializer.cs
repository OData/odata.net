...
namespace Microsoft.Data.OData.Atom
{
    ...
    internal class ODataAtomPropertyAndValueDeserializer : ODataAtomDeserializer
    {
        ...
        internal ODataProperty ReadTopLevelProperty(IEdmTypeReference expectedPropertyTypeReference)
        {
            ...
            {
                throw new ODataException(o.Strings.ODataAtomPropertyAndValueDeserializer_TopLevelPropertyElementWrongNamespace(this.XmlReader.NamespaceURI, this.XmlReader.ODataNamespace));
            }
