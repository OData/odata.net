            ...
            else
            {
                ...
                if (authors != null)
                {
                    foreach (AtomPersonMetadata author in authors)
                    {
                        if (author == null)
                        {
                            throw new ODataException(o.Strings.ODataAtomWriterMetadataUtils_AuthorMetadataMustNotContainNull);
                        }
                ...
                if (contributors != null)
                {
                    foreach (AtomPersonMetadata contributor in contributors)
                    {
                        if (contributor == null)
                        {
                            throw new ODataException(o.Strings.ODataAtomWriterMetadataUtils_ContributorMetadataMustNotContainNull);
                        }
                ...
                if (links != null)
                {
                    foreach (AtomLinkMetadata link in links)
                    {
                        if (link == null)
                        {
                            throw new ODataException(o.Strings.ODataAtomWriterMetadataUtils_LinkMetadataMustNotContainNull);
                        }
                ...
                if (categories != null)
                {
                    foreach (AtomCategoryMetadata category in categories)
                    {
                        if (category == null)
                        {
                            throw new ODataException(o.Strings.ODataAtomWriterMetadataUtils_CategoryMetadataMustNotContainNull);
                        }
