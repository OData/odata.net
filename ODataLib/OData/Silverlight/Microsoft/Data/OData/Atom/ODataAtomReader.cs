    ...
    internal sealed class ODataAtomReader : ODataReaderCore
    {
            ...
            else
            {
                ...
                if (expandedNavigationLinkContent != ODataAtomDeserializerExpandedNavigationLinkContent.None)
                {
                    if (navigationProperty == null && this.atomInputContext.Model.IsUserModel() &&
                        this.atomInputContext.MessageReaderSettings.UndeclaredPropertyBehaviorKinds.HasFlag(ODataUndeclaredPropertyBehaviorKinds.ReportUndeclaredLinkProperty))
                    {
                        ...
                        {
                            throw new ODataException(o.Strings.ValidationUtils_PropertyDoesNotExistOnType(currentNavigationLink.Name, this.LinkParentEntityScope.EntityType.ODataFullName()));
                        }
                    }
                }
                ...
                switch (expandedNavigationLinkContent)
                {
                    ...
                    case ODataAtomDeserializerExpandedNavigationLinkContent.Entry:
                        ...
                        {
                            throw new ODataException(o.Strings.ODataAtomReader_ExpandedEntryInFeedNavigationLink);
                        }
                    ...
                    case ODataAtomDeserializerExpandedNavigationLinkContent.Feed:
                        ...
                        {
                            throw new ODataException(o.Strings.ODataAtomReader_ExpandedFeedInEntryNavigationLink);
                        }
                    ...
                    default:
                        throw new ODataException(o.Strings.General_InternalError(InternalErrorCodes.ODataAtomReader_ReadAtNavigationLinkStartImplementation));
                }
            }
        ...
        private void EndEntry()
        {
            ...
            if (entry != null)
            {
                ...
                if (entryState.CachedEpm != null)
                {
                    ...
                    if (entryScope.HasAtomEntryMetadata)
                    {
                ...
                {
                    ODataAtomEntryAndFeedDeserializer.EnsureMediaResource(entryState, /*validateMLEPresense*/ true);
                }
        ...
        private void StartNavigationLink(ODataAtomReaderNavigationLinkDescriptor navigationLinkDescriptor)
        {
            ...
            if (navigationLinkDescriptor.NavigationProperty != null)
            {
                ...
                if (!navigationPropertyType.IsCollection())
                {
                    ...
                    {
                        throw new ODataException(o.Strings.ODataAtomReader_FeedNavigationLinkForResourceReferenceProperty(navigationLinkDescriptor.NavigationLink.Name));
                    }
        ...
        private void ReadAtNonExpandedNavigatLinkStart()
        {
            ...
            if (this.atomInputContext.ReadingResponse)
            {
                ...
                {
                    throw new ODataException(o.Strings.ODataAtomReader_DeferredEntryInFeedNavigationLink);
                }
        ...
        private sealed class AtomScope : Scope, IODataAtomReaderEntryState, IODataAtomReaderFeedState
        {
            ...
            public bool? MediaLinkEntry
            {
                ...
                set
                {
                    ...
                    {
                        throw new ODataException(o.Strings.ODataAtomReader_MediaLinkEntryMismatch);
                    }
