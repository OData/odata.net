            ...
            while (this.XmlReader.NodeType != XmlNodeType.EndElement)
            {
                ...
                else if (this.XmlReader.NamespaceEquals(this.XmlReader.ODataMetadataNamespace))
                {
                    ...
                    if (this.XmlReader.LocalNameEquals(this.AtomPropertiesElementName))
                    {
                        ...
                        this.ReadProperties(entryState.EntityType, entryState.Entry.Properties.ToReadOnlyEnumerable("Properties"), entryState.DuplicatePropertyNamesChecker, /* epmPresent */ entryState.CachedEpm != null);
