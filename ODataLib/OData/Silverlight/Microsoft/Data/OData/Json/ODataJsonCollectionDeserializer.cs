        ...
        internal ODataCollectionStart ReadCollectionStart(bool isResultsWrapperExpected)
        {
            ...
            if (isResultsWrapperExpected)
            {
                ...
                if (!resultsPropertyFound)
                {
                    ...
                    throw new ODataException(o.Strings.ODataJsonCollectionDeserializer_MissingResultsPropertyForCollection);
                }
            }
            ...
            {
                throw new ODataException(o.Strings.ODataJsonCollectionDeserializer_CannotReadCollectionContentStart(this.JsonReader.NodeType));
            }
        ...
        internal void ReadCollectionEnd(bool isResultsWrapperExpected)
        {
            ...
            while (this.JsonReader.NodeType == JsonNodeType.Property)
            {
                ...
                if (string.CompareOrdinal(JsonConstants.ODataResultsName, propertyName) == 0)
                {
                    ...
                    throw new ODataException(o.Strings.ODataJsonCollectionDeserializer_MultipleResultsPropertiesForCollection);
                }
