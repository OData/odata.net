...
namespace Microsoft.OData.Core.UriParser.Parsers
{
    ...
    /// </summary>
    /// TODO 1466134 This class is renamed to SelectBinder when we dump V3 support.
    internal sealed class V4SelectBinder : ISelectBinder
    {
        /// <summary>
        /// Visitor object to walk the select tree
        /// </summary>
        private readonly V4SelectPropertyVisitor visitor;
        ...
        public V4SelectBinder(IEdmModel model, IEdmStructuredType edmType, int maxDepth, SelectExpandClause expandClauseToDecorate)
        {
            ExceptionUtils.CheckArgumentNotNull(model, "tokenIn");
            ExceptionUtils.CheckArgumentNotNull(edmType, "entityType");

            this.visitor = new V4SelectPropertyVisitor(model, edmType, maxDepth, expandClauseToDecorate);
        }
