...
namespace Microsoft.OData.Service.Http
{
    ...
    /// </remarks>
    internal sealed class XHRHttpWebRequest : Microsoft.OData.Service.Http.HttpWebRequest
    {
        ...
        private Microsoft.OData.Service.Http.XHRWebHeaderCollection headers;
        ...
        private Microsoft.OData.Service.Http.HttpWebResponse response;
        ...
        public override string Accept
        {
            get
            {
                return this.Headers[Microsoft.OData.Service.Http.HttpRequestHeader.Accept];
            }

            set
            {
                ((Microsoft.OData.Service.Http.XHRWebHeaderCollection)this.Headers).SetSpecialHeader("accept", value);
            }
        }
        ...
        public override long ContentLength
        {
            set
            {
                this.Headers[Microsoft.OData.Service.Http.HttpRequestHeader.ContentLength] = value.ToString(CultureInfo.InvariantCulture);
            }
        }
        ...
        public override string ContentType
        {
            get
            {
                return this.Headers[Microsoft.OData.Service.Http.HttpRequestHeader.ContentType];
            }

            set
            {
                ((Microsoft.OData.Service.Http.XHRWebHeaderCollection)this.Headers).SetSpecialHeader("content-type", value);
            }
        }
        ...
        public override Microsoft.OData.Service.Http.WebHeaderCollection Headers
        {
            get
            {
                ...
                {
                    this.headers = new Microsoft.OData.Service.Http.XHRWebHeaderCollection(Microsoft.OData.Service.Http.WebHeaderCollectionType.HttpWebRequest);
                }
        ...
        public override System.Net.ICredentials Credentials
        {
            ...
            set
            {
                throw new NotSupportedException(Microsoft.OData.Client.Strings.HttpWebRequest_XmlHttpCredentialsNotSupported);
            }
        }
        ...
        public override bool UseDefaultCredentials
        {
            ...
            set
            {
                if (true != value)
                {
                    throw new NotSupportedException(Microsoft.OData.Client.Strings.HttpWebRequest_XmlHttpNonDefaultCredentialsNotSupported);
                }
            }
        }
        ...
        public override Stream EndGetRequestStream(IAsyncResult asyncResult)
        {
            ...
            if (this.asyncRequestResult != asyncResult)
            {
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebRequest.EndGetRequestStream"));
            }
            
            if (this.asyncRequestResult.EndCalled)
            {
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebRequest.EndGetRequestStream.2"));
            }
        ...
        public override Microsoft.OData.Service.Http.WebResponse EndGetResponse(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebRequest.EndGetResponse"));
            }
            
            if (this.asyncResponseResult.EndCalled)
            {
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebRequest.EndGetResponse.2"));
            }
        ...
        private static Microsoft.OData.Service.Http.WebException CreateAbortException()
        {
            return new Microsoft.OData.Service.Http.WebException(Microsoft.OData.Client.Strings.HttpWebRequest_Aborted);
        }
        ...
        private void CreateResponse()
        {
            ...
            if (statusCode != -1)
            {
                ...
                this.response = new Microsoft.OData.Service.Http.XHRHttpWebResponse(this, statusCode, responseHeaders);
            }
        }
        ...
        private void InvokeRequest()
        {
            ...
            if (this.invoked)
            {
                // Already invoked.
                throw new InvalidOperationException(
                    Microsoft.OData.Client.Strings.HttpWeb_Internal("HttpWebRequest.InvokeRequest"));
            }
