...
#pragma warning restore 0169, 0649
        ...
        public string DataNamespace
        {
            ...
            set
            {
                ...
                // BUG 356104 : OData v3 and default message format behavior
                // We will prevent users from setting this property's value to anything other than the default dataweb namespace
                // max protocol version on the client is set to a value greater than v2.
        ...
        public Uri TypeScheme
        {
            ...
            set
            {
                ...
                // BUG 356104 : OData v3 and default message format behavior
                // We will prevent users from setting this property's value to anything other than the default data web scheme namespace
                // when the max protocol version on the client is set to a value greater than v2.
        ...
        protected Type DefaultResolveType(string typeName, string fullNamespace, string languageDependentNamespace)
        {
            if (typeName != null && typeName.StartsWith(fullNamespace, StringComparison.Ordinal))
            {
                ...
                return this.GetType().Assembly.GetType(string.Concat(languageDependentNamespace, typeName.Substring(namespaceLength)), false);
            }
