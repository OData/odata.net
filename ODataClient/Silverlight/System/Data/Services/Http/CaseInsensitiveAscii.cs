...
// </copyright>
// <summary>
//      Case-insensitive string comparer for ASCII strings.
// </summary>
//
// @owner  markash
//---------------------------------------------------------------------
...
namespace System.Data.Services.Http
{
    ...
    /// <summary>Provides a string equality comparer for ASCII strings that is case-insensitive.</summary>
    internal class CaseInsensitiveAscii : IEqualityComparer<string>, IComparer<string>
    {
        /// <summary>Map of ASCII character codes to their lowercase counterpart.</summary>
        /// <remarks>
        /// This table actually goes into 8-bit characters, which means this is some
        /// specific code page that tests confirm is a superset of ASCII.
        /// </remarks>
        ...
        /// <summary>Static singleton instance.</summary>
        ...
        /// <returns>
        /// A value smaller than zero if <paramref name="firstString"/> is less than 
        /// <paramref name="secondString"/>, zero if equal, or greater than zero if more.
        /// </returns>
        /// <remarks>
        /// <paramref name="firstString"/> and <paramref name="secondString"/> should have
        /// all characters in the ASCII range, otherwise this method will thrown or
        /// return results from some code page.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="text">The Object for which a hash code is to be returned.</param>
        ...
        /// <summary>
        /// This method returns a fast hash of the specified <paramref name="text"/>,
        /// suitable only to quickly determine that two values are different.
        /// </summary>
        /// <param name="text">Value to get has code for.</param>
        /// <returns>A hash code for the specified <paramref name="text"/> value.</returns>
