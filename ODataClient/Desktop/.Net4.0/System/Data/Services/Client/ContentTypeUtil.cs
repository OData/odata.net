...
#endif
{
    ...
    internal static class ContentTypeUtil
    {
        ...
        private static readonly string[] MediaTypesForEntityOrFeedV2 = new string[]
            { 
                ...
                XmlConstants.MimeApplicationJsonODataVerbose,
        ...
        internal static string SelectResponseMediaType(string acceptTypesText, bool entityTarget, Version effectiveMaxResponseVersion)
        {
            ...
            {
                contentType = effectiveMaxResponseVersion < VersionUtil.Version3Dot0 ? XmlConstants.MimeApplicationJsonODataVerbose : XmlConstants.MimeApplicationJsonODataMinimalMetadata;
            }
        ...
        {
            // In V2, we will never return json light.
    ...
    // Coordinate any change to this with the HttpWebRequest.ReadResponse()
        ...
        private static string[] GetAvailableMediaTypes(Version effectiveMaxResponseVersion, bool isEntityOrFeed)
        {
            if (effectiveMaxResponseVersion < VersionUtil.Version3Dot0)
            {
                // JSON light is not a recognized mime type and should be treated like any other unrecognized mime type.
                return isEntityOrFeed ? MediaTypesForEntityOrFeedV2 : MediaTypesForOtherV2;
            }
