...
// </copyright>
// <summary>
// Class that contains the logic to resolve type names to clr type
// messages
// </summary>
//---------------------------------------------------------------------
...
namespace System.Data.Services.Client
{
    ...
    internal class TypeResolver
    {
        ...
        internal bool TryResolveEntitySetBaseTypeName(string entitySetName, out string serverTypeName)
        {
            ...
            var entitySet = this.serviceModel.ResolveEntitySet(entitySetName);
            if (entitySet != null)
            {
                serverTypeName = ExtensionMethods.FullName(entitySet.ElementType);
                return true;
            }
