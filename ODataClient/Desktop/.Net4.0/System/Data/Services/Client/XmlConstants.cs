...
#endif
{
    ...
    internal static class XmlConstants
    {
        ...
        internal const string MimeApplicationJsonODataMinimalMetadata = "application/json;odata=minimalmetadata";

        /// <summary>MIME type for JSON bodies in light mode with full metadata.</summary>
        internal const string MimeApplicationJsonODataFullMetadata = "application/json;odata=fullmetadata";

        /// <summary>MIME type for JSON bodies in light mode with no metadata.</summary>
        internal const string MimeApplicationJsonODataNoMetadata = "application/json;odata=nometadata";
