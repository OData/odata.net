...
namespace System.Data.Services
{
    ...
    internal static class WebUtil
    {
        ...
        internal static void SetResponseHeadersForBatchRequests(IODataResponseMessage operationResponseMessage, BatchServiceHost batchHost)
        {
            ...
            {
                operationResponseMessage.SetHeader(XmlConstants.HttpContentID, batchHost.ContentId);
            }
        ...
        internal static ODataMessageReaderSettings CreateMessageReaderSettings(IDataService dataService, bool enableWcfDataServicesServerBehavior)
        {
            ...
            // In V2 we allow V2 requests to be read even when MPV is set to V1.
            DataServiceProtocolVersion maxProtocolVersion = dataService.Configuration.DataServiceBehavior.MaxProtocolVersion;
            messageReaderSettings.MaxProtocolVersion = maxProtocolVersion == DataServiceProtocolVersion.V1
                ? ODataVersion.V2
            ...
            {
                messageReaderSettings.EnableWcfDataServicesServerBehavior(dataService.Provider.HasReflectionOrEFProviderQueryBehavior);
            }
