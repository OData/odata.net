...
namespace System.Data.Services.Providers
{
    ...
    internal class ResourceSetWrapper
    {
        ...
        internal Version MinimumResponsePayloadVersion(IDataService service, bool considerEpmInVersion)
        {
            ...
            // If target type contains navigation property and IncludeAssociationLinksInResponse is on, we need v3.0
            ...
            {
                Version epmMinVersion = this.VerifyEpmProtocolVersion(service.Provider).ToVersion();
            ...
            // (when ShouldIncludeAssociationLinksInResponse and considerEpmInVersion are false)
        ...
        private void CheckHierarchy(DataServiceProviderWrapper provider)
        {
            ...
            if (this.epmMinDSPV == null)
            {
                ...
                bool hasEpm = baseType.HasEntityPropertyMappings;
                DataServiceProtocolVersion epmMinVersion = baseType.EpmMinimumDataServiceProtocolVersion;
                ...
                if (this.hasDerivedTypes)
                {
                    ...
                    {
                        if (derivedType.EpmMinimumDataServiceProtocolVersion > epmMinVersion)
                        {
                            epmMinVersion = derivedType.EpmMinimumDataServiceProtocolVersion;
                        }

                        hasEpm |= derivedType.HasEntityPropertyMappings;
                        ...
                        if (epmMinVersion == DataServiceProtocolVersion.V3 &&
                            resourceSetVersion == VersionUtil.Version3Dot0 &&
                ...
                this.hasEntityPropertyMappings = hasEpm;
                this.epmMinDSPV = epmMinVersion;
