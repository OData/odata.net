...
namespace System.Data.Services
{
    ...
    internal class HttpContextServiceHost : IDataServiceHost2
    {
            ...
            get
            {
                ...
                else if (methodValues.Length == 1)
                {
                    ...
                    if (string.CompareOrdinal(XmlConstants.HttpMethodDelete, result) != 0 &&
                        ...
                        string.CompareOrdinal(XmlConstants.HttpMethodMerge, result) != 0 &&
        ...
        string IDataServiceHost.ResponseVersion
        {
            ...
            set { UpdateHeaderOrRemoveHeaderIfNull(this.operationContext.OutgoingResponse.Headers, XmlConstants.HttpDataServiceVersion, value); }
        }
