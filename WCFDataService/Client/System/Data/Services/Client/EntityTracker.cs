...
namespace System.Data.Services.Client
{
    ...
    internal class EntityTracker : EntityTrackerBase
    {
        ...
        internal Dictionary<LinkDescriptor, LinkDescriptor> LinkBindings
        {
            get
            {
                this.EnsureLinkBindings();
            ...
            set
            {
                ...
                {
                    this.EnsureLinkBindings();
                    foreach (var linkBinding in value)
                    {
                        this.bindings.Add(linkBinding.Key, linkBinding.Value);
                    }
                }
            }
        }
        ...
        /// <summary>
        /// Map of identity to entity descriptor lookups.
        /// </summary>
        [DataMember]
        internal Dictionary<string, EntityDescriptor> IdentityToDescriptor
        {
            get
            {
                return this.identityToDescriptor;
            }
            ...
            set
            {
                ...
                Debug.Assert(this.deserializing, "This property can only be set during deserialization");
#endif
                this.identityToDescriptor = value;
            }
        }

        /// <summary>
        /// Entity Descriptors for entities tracked by this instance.
        /// </summary>
        [DataMember]
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811", Justification = "The setter is called during de-serialization")]
        internal Dictionary<object, EntityDescriptor> EntityDescriptors
        {
            get
            {
            ...
            set
            {
                ...
                if (value != null)
                {
                    this.entityDescriptors = new Dictionary<object, EntityDescriptor>(EqualityComparer<object>.Default);
                    foreach (var entityDescriptor in value)
                    {
                        this.entityDescriptors.Add(entityDescriptor.Key, entityDescriptor.Value);
                    }
                }
            }
        }
        ...
        private void EnsureIdentityToResource()
        {
            if (null == this.identityToDescriptor)
            {
                System.Threading.Interlocked.CompareExchange(ref this.identityToDescriptor, new Dictionary<String, EntityDescriptor>(StringComparer.Ordinal), null);
            }
        }
