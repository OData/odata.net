...
namespace System.Data.Services.Client
{
    ...
    internal sealed class PrimitiveType
    {
        ...
        private static void InitializeTypes()
        {
            ...
            RegisterKnownType(typeof(DateTime), XmlConstants.EdmDateTimeTypeName, EdmPrimitiveTypeKind.DateTime, new DateTimeTypeConverter(), true);
            ...
            RegisterKnownType(typeof(TimeSpan), XmlConstants.EdmTimeTypeName, EdmPrimitiveTypeKind.Time, new TimeSpanTypeConverter(), true);
