...
namespace Microsoft.Data.Edm.Csdl.Internal.CsdlSemantics
{
    ...
    internal class CsdlSemanticsFunctionParameter : CsdlSemanticsElement, IEdmFunctionParameter
    {
        ...
        private readonly static Func<CsdlSemanticsFunctionParameter, IEdmTypeReference> s_computeType = (me) => me.ComputeType();

        public CsdlSemanticsFunctionParameter(CsdlSemanticsSchema context, CsdlFunctionParameter parameter)
        {
        ...
        {
            return CsdlSemanticsModel.WrapTypeReference(this.context, this.parameter.Type);
        }
