...
namespace Microsoft.Data.Edm.Library
{
        ...
        where TElement: class, IEdmNamedElement
    {
        ...
        /// <summary>
        /// Removes a binding. If removing the specified binding leaves only one binding, RemoveBinding returns the remaining binding.
        /// Otherwise, RemoveBinding returns the ambiguous binding.
        /// </summary>
        /// <param name="binding">Binding to be removed.</param>
        /// <returns>The remaining binding if only one remains; otherwise an ambiguous binding containing the remaining bindings.</returns>
        public TElement RemoveBinding(TElement binding)
        {
            this.bindings.Remove(binding);
            if (this.bindings.Count == 1)
            {
