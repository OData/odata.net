...
namespace System.Data.Services.Common
{
    ...
    public sealed class EntityPropertyMappingAttribute : Attribute
    {
        ...
        public EntityPropertyMappingAttribute(string sourcePath, SyndicationItemProperty targetSyndicationItem, bool keepInContent, string criteriaValue)
        {
            ...
            // Some clients may ignore the leading and trailing spaces in XML attribute values and can end up with ambiguities during
            // deserialization. e.g. ambiguity between <link rel="http://customurl" /> and <link rel=" http://customurl" />.
            // We are disallowing leading and trailing whitespaces in criteria values.
            if (criteriaValue != criteriaValue.Trim())
            {
                throw new ArgumentException(Strings.EntityPropertyMapping_LeadingAndTrialingWhitespacesNotAllowedOnCriteriaValue("criteriaValue"));
            }
