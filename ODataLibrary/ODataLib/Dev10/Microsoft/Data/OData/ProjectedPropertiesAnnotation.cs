...
namespace Microsoft.Data.OData
{
    ...
    public sealed class ProjectedPropertiesAnnotation
    {
        ...
        /// </summary>
        private static ProjectedPropertiesAnnotation emptyProjectedPropertiesMarker = new ProjectedPropertiesAnnotation(new string[0]);

        /// <summary>
        /// A hash set with the projected property names.
        /// </summary>
        private HashSet<string> projectedProperties;
