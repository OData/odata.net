...
namespace Microsoft.Data.OData
{
    ...
    internal static class HttpUtils
    {
        ...
        internal static IList<MediaType> MediaTypesFromString(string text)
        {
            DebugUtils.CheckNoExternalCallers();
        ...
        internal static IList<MediaType> ReadMediaTypes(string text)
        {
            DebugUtils.CheckNoExternalCallers();
        ...
        internal static Encoding EncodingFromAcceptableCharsets(string acceptableCharsets, MediaType mediaType, Encoding utf8Encoding, Encoding defaultEncoding)
        {
            ...
            if (!string.IsNullOrEmpty(acceptableCharsets))
            {
                ...
                parts.StableSort(delegate(CharsetPart x, CharsetPart y)
                {
        ...
        internal static string ToText(this MediaType mediaType, Encoding encoding)
        {
            ...
            if (mediaType.Parameters == null || mediaType.Parameters.Count == 0)
            {
                ...
                if (encoding != null)
                {
                    typeName = string.Concat(typeName, ";", HttpConstants.Charset, "=", encoding.WebName);
                }
            ...
            else
            {
                ...
                for (int i = 0; i < mediaType.Parameters.Count; ++i)
                {
                    ...
                    if (string.CompareOrdinal(HttpConstants.Charset, parameter.Key) != 0)
                    {
                        builder.Append(";");
                ...
                {
                    builder.Append(";");
                    builder.Append(HttpConstants.Charset);
                    builder.Append("=");
