...
namespace Microsoft.Data.OData.Atom
{
    ...
    internal class EpmValueCache
    {
        ...
        /// </summary>
        /// <remarks>The key is the complex value, or multivalue for the property in question.
            ...
            bool writingContent)
        {
            ...
            {
                return epmValueCache.GetMultiValueItems(multiValue, writingContent);
            }
        }
        ...
        /// <param name="writingContent">true if we're writing entry content or false when writing out-of-content EPM.</param>
        /// <returns>The items enumeration for the multivalue.</returns>
        private IEnumerable GetMultiValueItems(ODataMultiValue multiValue, bool writingContent)
        {
            Debug.Assert(multiValue != null, "multiValue != null");
            ...
            if (this.epmValuesCache != null && this.epmValuesCache.TryGetValue(multiValue, out cachedItemsValue))
            {
            ...
            this.epmValuesCache.Add(multiValue, cachedItems);
            return cachedItems;
        }
    }
}
