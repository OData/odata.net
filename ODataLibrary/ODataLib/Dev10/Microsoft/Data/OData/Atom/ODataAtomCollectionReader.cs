...
namespace Microsoft.Data.OData.Atom
{
    ...
    internal sealed class ODataAtomCollectionReader : ODataCollectionReaderCore
    {
        ...
        internal ODataAtomCollectionReader(ODataAtomInputContext atomInputContext, IEdmTypeReference expectedItemTypeReference)
            : base(atomInputContext, expectedItemTypeReference)
        {
        ...
        protected override bool ReadAtStartImplementation()
        {
            ...
            ODataCollectionResult collection = this.atomCollectionDeserializer.ReadCollectionStart(out isCollectionElementEmpty);
            Debug.Assert(collection != null, "collection != null");

            this.EnterScope(ODataCollectionReaderState.CollectionStart, collection, isCollectionElementEmpty);
        ...
        protected override bool ReadAtCollectionStartImplementation()
        {
            ...
            {
                object item = this.atomCollectionDeserializer.ReadCollectionItem(this.ExpectedItemTypeReference);
