...
namespace Microsoft.Data.OData
{
    ...
    /// </summary>
    internal sealed class ODataBatchUrlResolver
    {
        ...
        /// </returns>
        internal Uri ResolveUrl(Uri payloadUri)
        {
            DebugUtils.CheckNoExternalCallers();
            Debug.Assert(payloadUri != null, "payloadUri != null");
            ...
            // Returning null means no custom resolution; use default ODataLib resolution.
            return null;
        }
