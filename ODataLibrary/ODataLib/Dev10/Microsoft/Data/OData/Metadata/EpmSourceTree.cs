    ...
    internal sealed class EpmSourceTree
    {
        ...
        internal void Add(EntityPropertyMappingInfo epmInfo)
        {
            ...
            for (int sourcePropertyIndex = 0; sourcePropertyIndex < propertyPath.Length; sourcePropertyIndex++)
            {
                ...
                IEdmTypeReference currentTypeReference = GetPropertyType(currentType, propertyName, out isMultiValueProperty);
                currentType = currentTypeReference == null ? null : currentTypeReference.Definition;
                ...
                if (isMultiValueProperty)
                {
                    ...
                    if (multiValuePropertySegment != null)
                    {
                        ...
                        throw new ODataException(Strings.EpmSourceTree_NestedMultiValue(
                            ...
                            multiValuePropertySegment.EpmInfo.DefiningType.ODataFullName(),
                    ...
                    if (currentSourceSegment.EpmInfo == null || !currentSourceSegment.EpmInfo.DefiningTypesAreEqual(epmInfo))
                    {
                        ...
                        multiValueEpmInfo.MultiValueItemTypeReference = currentTypeReference;
                    ...
                    else
                    {
                        ...
                        {
                            throw new ODataException(Strings.EpmSourceTree_PropertiesFromSameMultiValueMappedToDifferentTopLevelElements(currentSourceSegment.EpmInfo.Attribute.SourcePath, currentSourceSegment.EpmInfo.DefiningType.ODataFullName()));
                        }
                        ...
                        {
                            throw new ODataException(Strings.EpmSourceTree_PropertiesFromSameMultiValueMappedWithDifferentKeepInContent(currentSourceSegment.EpmInfo.Attribute.SourcePath, currentSourceSegment.EpmInfo.DefiningType.ODataFullName()));
                        }
                    }
                }
            }
            ...
            if (currentType != null)
            {
                ...
                {
                    if (((IEdmPrimitiveType)currentType).PrimitiveKind != EdmPrimitiveTypeKind.String)
                    {
                        throw new ODataException(Strings.EpmSourceTree_NonStringPropertyMappedToConditionAttribute(
            ...
            if (multiValuePropertySegment != null)
            {
                ...
                epmInfo.MultiValueItemTypeReference = multiValuePropertySegment.EpmInfo.MultiValueItemTypeReference;
                ...
                Debug.Assert(
                    !multiValuePropertySegment.EpmInfo.MultiValueItemTypeReference.IsODataPrimitiveTypeKind() || epmInfo.PropertyValuePath.Length == 0,
        ...
        private static void Validate(EpmSourcePathSegment pathSegment, IEdmType type)
        {
            ...
            {
                bool isMultiValueProperty;
                IEdmTypeReference subSegmentTypeReference = GetPropertyType(type, subSegment.PropertyName, out isMultiValueProperty);
                IEdmType subSegmentType = subSegmentTypeReference == null ? null : subSegmentTypeReference.Definition;
                if (isMultiValueProperty)
                {
                    ValidateMultiValueSegment(subSegment.EpmInfo, subSegment, subSegmentType);
                }
                else
                {
        ...
        /// <param name="type">The type of the property represented by this segment (item type for the MultiValue property itself).</param>
            ...
            IEdmType type)
        {
            ...
            if (type.IsODataComplexTypeKind())
            {
                Debug.Assert(
                ...
                foreach (IEdmProperty property in complexType.Properties())
                {
                    ...
                    if (subSegment == null)
                    {
                        ...
                        throw new ODataException(Strings.EpmSourceTree_NotAllMultiValueItemPropertiesMapped(
                            ...
                            multiValuePropertyInfo.DefiningType.ODataFullName(),
                            propertyName,
                            TypeName));
                    }
                    else
                    {
                        IEdmTypeReference propertyTypeReference = property.Type;
                        IEdmType propertyType = propertyTypeReference == null ? null : propertyTypeReference.Definition;
            ...
            else
            {
                ...
                if (multiValueSegment.EpmInfo.MultiValueStatus == EntityPropertyMappingMultiValueStatus.MultiValueProperty)
                {
                    ...
                    if (leafSegment.EpmInfo.IsAtomLinkMapping)
                    {
                        ...
                        if (leafSegment.EpmInfo.Attribute.TargetSyndicationItem != SyndicationItemProperty.LinkHref)
                        {
        ...
        private static IEdmTypeReference GetPropertyType(IEdmType type, string propertyName, out bool isMultiValueProperty)
        {
            ...
            if (property != null)
            {
                ...
                if (propertyType.IsODataMultiValueTypeKind())
                {
                    isMultiValueProperty = true;
                    return propertyType.GetMultiValueItemType();
                }
                
                if (propertyType.IsStream())
                {
                    throw new ODataException(Strings.EpmSourceTree_NamedStreamCannotBeMapped(propertyName, type.ODataFullName()));
                }
