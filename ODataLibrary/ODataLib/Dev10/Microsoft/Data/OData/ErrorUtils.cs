...
namespace Microsoft.Data.OData
{
    ...
    internal static class ErrorUtils
    {
        ...
        internal static void WriteXmlError(XmlWriter writer, ODataError error, bool includeDebugInformation)
        {
            DebugUtils.CheckNoExternalCallers();
            ...
            WriteXmlError(writer, code, message, messageLanguage, innerError);
        }
        ...
        private static void WriteXmlError(XmlWriter writer, string code, string message, string messageLanguage, ODataInnerError innerError)
        {
            Debug.Assert(writer != null, "writer != null");
            ...
            if (innerError != null)
            {
                WriteXmlInnerError(writer, innerError, AtomConstants.ODataInnerErrorElementName);
            }
        ...
        private static void WriteXmlInnerError(XmlWriter writer, ODataInnerError innerError, string innerErrorElementName)
        {
            Debug.Assert(writer != null, "writer != null");
            ...
            {
                WriteXmlInnerError(writer, innerError.InnerError, AtomConstants.ODataInnerErrorInnerErrorElementName);
            }
