...
#endif
{
    ...
    internal class JsonReader
    {
        ...
        /// </summary>
        /// <remarks>This treshhold is copied from the XmlReader implementation.</remarks>
        ...
        internal JsonReader(TextReader reader)
        {
        ...
        /// </summary>
        internal virtual JsonNodeType NodeType
        {
            get
            {
                DebugUtils.CheckNoExternalCallers();
        ...
        [SuppressMessage("Microsoft.Maintainability", "CA1502:AvoidExcessiveComplexity", Justification = "Not realy feasible to extract code to methods without introducing unnecessary complexity.")]
        ...
        private static object TryParseDateTimePrimitiveValue(string stringValue)
        {
            ...
            // TODO: For now only DateTime values are supported, no offset.
