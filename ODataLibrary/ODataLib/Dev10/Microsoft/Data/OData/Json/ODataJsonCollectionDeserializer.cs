...
namespace Microsoft.Data.OData.Json
{
    ...
    internal sealed class ODataJsonCollectionDeserializer : ODataJsonPropertyAndValueDeserializer
    {
        ...
        /// <returns>An <see cref="ODataCollectionResult"/> representing the collection-level information. Currently this is only the name of the collection in ATOM.</returns>
        /// <remarks>
        ...
        /// </remarks>
        internal ODataCollectionResult ReadCollectionStart(bool isResultsWrapperExpected)
        {
            DebugUtils.CheckNoExternalCallers();
            Debug.Assert(
            ...
            {
                throw new ODataException(Strings.ODataJsonCollectionDeserializer_CannotReadCollectionContentStart(this.JsonReader.NodeType));
            }
            ...
            return new ODataCollectionResult
            {
                Name = null
            };
        }
        ...
        /// </remarks>
        internal object ReadCollectionItem(IEdmTypeReference expectedItemTypeReference)
        {
            DebugUtils.CheckNoExternalCallers();
            Debug.Assert(
            ...
            object item = this.ReadNonEntityValue(expectedItemTypeReference, this.duplicatePropertyNamesChecker);
