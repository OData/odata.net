...
namespace Microsoft.Data.OData
{
    ...
    internal abstract class ODataCollectionWriterCore : ODataCollectionWriter
    {
        ...
        /// <summary>true if we are writing a response, false if it's a request.</summary>
        private readonly bool writingResponse;

        /// <summary>The writer behavior.</summary>
        ...
        protected ODataCollectionWriterCore(ODataVersion version, bool writingResponse, ODataWriterBehavior writerBehavior, IEdmModel model, bool synchronous)
        {
        ...
        /// <summary>
        /// true if we are writing a response, false if it's a request.
        /// </summary>
        ...
        protected DuplicatePropertyNamesChecker DuplicatePropertyNamesChecker
        {
            get
            {
                ...
                {
                    this.duplicatePropertyNamesChecker = new DuplicatePropertyNamesChecker(this.writerBehavior.AllowDuplicatePropertyNames, this.WritingResponse);
                }
        ...
        public sealed override Task FlushAsync()
        {
            ...
            return this.FlushAsynchronously().ContinueWithOnFault(t => this.ReplaceScope(CollectionWriterState.Error, null));
        }
#endif
        ...
        public sealed override void WriteStart(ODataCollectionResult collection)
        {
            this.VerifyCanWriteStart(true, collection);
        ...
        public sealed override Task WriteStartAsync(ODataCollectionResult collection)
        {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="ODataCollectionResult"/> representing the collection.</param>
        protected abstract void StartCollection(ODataCollectionResult collection);
        ...
        /// </summary>
        /// <param name="item">The collection item to write.</param>
        protected abstract void WriteCollectionItem(object item);
        ...
        /// <param name="collection">The <see cref="ODataCollectionResult"/> representing the collection.</param>
        private void VerifyCanWriteStart(bool synchronousCall, ODataCollectionResult collection)
        {
        ...
        /// </summary>
        /// <param name="collection">The <see cref="ODataCollectionResult"/> representing the collection.</param>
        private void WriteStartImplementation(ODataCollectionResult collection)
        {
            this.StartPayloadInStartState();
            this.EnterScope(CollectionWriterState.Collection, collection);
            this.InterceptException(() => this.StartCollection(collection));
        }
        ...
        private void WriteItemImplementation(object item)
        {
            ...
            {
                ValidationUtils.ValidateCollectionItem(item);
                this.WriteCollectionItem(item);
            });
        }
