...
namespace Microsoft.Data.OData
{
    ...
    internal abstract class ODataCollectionReaderCore : ODataCollectionReader
    {
        ...
        public override sealed Task<bool> ReadAsync()
        {
            ...
            return this.ReadAsynchronously().ContinueWithOnFault(t => this.EnterScope(ODataCollectionReaderState.Exception, null));
        }
#endif
        ...
        protected bool ReadImplementation()
        {
            ...
            switch (this.State)
            {
                ...
                case ODataCollectionReaderState.Completed:
                    ...
                    throw new ODataException(Strings.General_InternalError(InternalErrorCodes.ODataCollectionReader_ReadImplementation));
        ...
        protected void ReplaceScope(ODataCollectionReaderState state, object item)
        {
            ...
            Scope replacementScope = new Scope(state, item);
            this.scopes.Pop();
            this.scopes.Push(replacementScope);
        }
        ...
        protected sealed class Scope
        {
            ...
            public Scope(ODataCollectionReaderState state, object item, bool isCollectionElementEmpty)
            {
                Debug.Assert(
                   ...
                   state == ODataCollectionReaderState.CollectionStart && item is ODataCollectionResult ||
                   state == ODataCollectionReaderState.Value && (item == null || item is ODataComplexValue || MetadataUtils.IsPrimitiveType(item.GetType())) ||
                   state == ODataCollectionReaderState.CollectionEnd && item is ODataCollectionResult ||
