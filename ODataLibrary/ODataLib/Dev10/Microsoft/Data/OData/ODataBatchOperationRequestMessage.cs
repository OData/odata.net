...
namespace Microsoft.Data.OData
{
...
#endif
    {
        ...
        /// <summary>
        /// The batch-specific URL resolver to perform custom URL resolution for URLs written to the payload.
        /// </summary>
        ...
        internal ODataBatchOperationRequestMessage(Stream outputStream, HttpMethod method, Uri requestUrl, IODataBatchOperationListener operationListener, ODataBatchUrlResolver urlResolver)
        {
        ...
        Uri IODataUrlResolver.ResolveUrl(Uri baseUri, Uri payloadUri)
        {
            ...
            {
                return this.urlResolver.ResolveUrl(payloadUri);
            }
