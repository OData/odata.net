//-----------------------------------------------------------------------------
// <copyright file="DataServiceContextWrapper.cs" company=".NET Foundation">
...
namespace Microsoft.OData.E2E.TestCommon.Client
{
    /// <summary>
    ...
    public class DataServiceContextWrapper<TContext> where TContext : DataServiceContext
    {
        ...
        {
            return this.wrappedInstance.ExecuteAsync<TElement>(requestUri, CancellationToken.None);
        }
